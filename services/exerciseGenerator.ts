...
const QUESTION_DATABASE: Record<string, Record<string, ExerciseBlueprint[]>> = {
    ...
    [TopicId.Dates]: {
        [Difficulty.Easy]: [
            { titleTemplate: "Estrazione Anno Ordine", descTemplate: "Analizziamo le tendenze annuali. Estrai l'anno dalla data di ogni ordine.", queryTemplate: "SELECT YEAR(data_ordine) FROM ordini", brokenCode: "SELECT YEAR(data_ordine FROM ordini", debugHint: "Manca una parentesi di chiusura nella funzione YEAR.", hints: ["Usa la funzione YEAR(data_ordine)."], explanation: "YEAR() estrae la parte anno da una data.", replacements: {} },
            { titleTemplate: "Filtro Anno {year}", descTemplate: "Seleziona tutti gli ordini effettuati esclusivamente nel {year}.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) = {year}", brokenCode: "SELECT * FROM ordini WHERE YEAR(data_ordine = {year}", debugHint: "Manca una parentesi di chiusura nella funzione YEAR.", hints: ["Usa WHERE YEAR(data_ordine) = {year}."], explanation: "Filtro su componente data.", replacements: { year: DATA.years } },
            { titleTemplate: "Estrazione Mese Spedizione", descTemplate: "Per reportistica mensile, estrai il mese numerico dalle date di spedizione.", queryTemplate: "SELECT MONTH(data_spedizione) FROM spedizioni", brokenCode: "SELECT MONTH(data_spedizione FROM spedizioni", debugHint: "Manca una parentesi di chiusura nella funzione MONTH.", hints: ["Usa la funzione MONTH(data_spedizione)."], explanation: "MONTH() restituisce da 1 a 12.", replacements: {} },
            ...
            { titleTemplate: "Anno e Data Ordine", descTemplate: "Mostra la data ordine completa e l'anno estratto.", queryTemplate: "SELECT data_ordine, YEAR(data_ordine) FROM ordini", brokenCode: "SELECT data_ordine, YEAR(data_ordine FROM ordini", debugHint: "Manca una parentesi di chiusura nella funzione YEAR.", hints: ["Seleziona data_ordine e YEAR(data_ordine)."], explanation: "Data completa e anno estratto.", replacements: {} },
            { titleTemplate: "Mese e Data Spedizione", descTemplate: "Mostra la data spedizione completa e il mese estratto.", queryTemplate: "SELECT data_spedizione, MONTH(data_spedizione) FROM spedizioni", brokenCode: "SELECT data_spedizione, MONTH(data_spedizione FROM spedizioni", debugHint: "Manca una parentesi di chiusura nella funzione MONTH.", hints: ["Seleziona data_spedizione e MONTH(data_spedizione)."], explanation: "Data completa e mese estratto.", replacements: {} },
            { titleTemplate: "Anno e Mese Ordini", descTemplate: "Estrai anno e mese da ogni data ordine.", queryTemplate: "SELECT YEAR(data_ordine), MONTH(data_ordine) FROM ordini", brokenCode: "SELECT YEAR(data_ordine), MONTH(data_ordine FROM ordini", debugHint: "Manca una parentesi di chiusura nella funzione MONTH.", hints: ["Usa YEAR(data_ordine) e MONTH(data_ordine)."], explanation: "YEAR e MONTH insieme.", replacements: {} },
            { titleTemplate: "Anno e Mese Spedizioni", descTemplate: "Estrai anno e mese da ogni data spedizione.", queryTemplate: "SELECT YEAR(data_spedizione), MONTH(data_spedizione) FROM spedizioni", brokenCode: "SELECT YEAR(data_spedizione), MONTH(data_spedizione FROM spedizioni", debugHint: "Manca una parentesi di chiusura nella funzione MONTH.", hints: ["Usa YEAR(data_spedizione) e MONTH(data_spedizione)."], explanation: "YEAR e MONTH su spedizioni.", replacements: {} },
            { titleTemplate: "Filtro Anno 2022", descTemplate: "Trova tutti gli ordini effettuati nel 2022.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) = 2022", brokenCode: "SELECT * FROM ordini WHERE YEAR(data_ordine) == 2022", debugHint: "In SQL si usa un solo uguale per il confronto.", hints: ["Usa WHERE YEAR(data_ordine) = 2022."], explanation: "Filtro per anno specifico.", replacements: {} },
            { titleTemplate: "Filtro Anno 2023", descTemplate: "Trova tutti gli ordini effettuati nel 2023.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) = 2023", brokenCode: "SELECT * FROM ordini WHERE YEAR(data_ordine) 2023", debugHint: "Manca l'operatore di confronto (=).", hints: ["Usa WHERE YEAR(data_ordine) = 2023."], explanation: "Filtro per anno 2023.", replacements: {} },
            { titleTemplate: "Filtro Anno 2024", descTemplate: "Trova tutti gli ordini effettuati nel 2024.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) = 2024", brokenCode: "SELECT * FROM ordini WHERE YEAR(data_ordine) = '2024", debugHint: "Manca l'apice di chiusura per l'anno.", hints: ["Usa WHERE YEAR(data_ordine) = 2024."], explanation: "Filtro per anno 2024.", replacements: {} },
            { titleTemplate: "Filtro Mese Gennaio", descTemplate: "Trova tutti gli ordini effettuati a Gennaio (mese 1).", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) = 1", brokenCode: "SELECT * FROM ordini WHERE MONTH(data_ordine) = 1)", debugHint: "C'è una parentesi di troppo.", hints: ["Usa WHERE MONTH(data_ordine) = 1."], explanation: "Filtro per mese specifico.", replacements: {} },
            { titleTemplate: "Filtro Mese {month}", descTemplate: "Trova tutti gli ordini effettuati nel mese {month}.", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) = {month}", brokenCode: "SELECT * FROM ordini WHERE MONTH(data_ordine = {month}", debugHint: "Manca una parentesi di chiusura nella funzione MONTH.", hints: ["Usa WHERE MONTH(data_ordine) = {month}."], explanation: "Filtro per mese variabile.", replacements: { month: DATA.months } },
            { titleTemplate: "Filtro Mese Spedizione {month}", descTemplate: "Trova tutte le spedizioni avvenute nel mese {month}.", queryTemplate: "SELECT * FROM spedizioni WHERE MONTH(data_spedizione) = {month}", brokenCode: "SELECT * FROM spedizioni WHERE MONTH(data_spedizione = {month}", debugHint: "Manca una parentesi di chiusura nella funzione MONTH.", hints: ["Usa WHERE MONTH(data_spedizione) = {month}."], explanation: "Filtro mese su spedizioni.", replacements: { month: DATA.months } },
            { titleTemplate: "Data Ordine Completa", descTemplate: "Mostra tutte le date ordine senza estrazioni.", queryTemplate: "SELECT data_ordine FROM ordini", brokenCode: "SELECT data_ordine FORM ordini", debugHint: "Errore di battitura nella parola chiave FROM.", hints: ["Scrivi SELECT data_ordine FROM ordini."], explanation: "Visualizzazione date complete.", replacements: {} },
            { titleTemplate: "Data Spedizione Completa", descTemplate: "Mostra tutte le date spedizione senza estrazioni.", queryTemplate: "SELECT data_spedizione FROM spedizioni", brokenCode: "SELECT data_spedizione FORM spedizioni", debugHint: "Errore di battitura nella parola chiave FROM.", hints: ["Scrivi SELECT data_spedizione FROM spedizioni."], explanation: "Visualizzazione date spedizioni.", replacements: {} },
            { titleTemplate: "Ordini con Anno", descTemplate: "Mostra ID ordine, data ordine e anno estratto.", queryTemplate: "SELECT id, data_ordine, YEAR(data_ordine) FROM ordini", brokenCode: "SELECT id, data_ordine, YEAR(data_ordine FROM ordini", debugHint: "Manca una parentesi di chiusura nella funzione YEAR.", hints: ["Seleziona id, data_ordine e YEAR(data_ordine)."], explanation: "ID, data e anno insieme.", replacements: {} },
            { titleTemplate: "Spedizioni con Mese", descTemplate: "Mostra ID spedizione, data spedizione e mese estratto.", queryTemplate: "SELECT id, data_spedizione, MONTH(data_spedizione) FROM spedizioni", brokenCode: "SELECT id, data_spedizione, MONTH(data_spedizione FROM spedizioni", debugHint: "Manca una parentesi di chiusura nella funzione MONTH.", hints: ["Seleziona id, data_spedizione e MONTH(data_spedizione)."], explanation: "ID, data e mese insieme.", replacements: {} },
            { titleTemplate: "Ordini con Anno e Mese", descTemplate: "Mostra data ordine, anno e mese estratti.", queryTemplate: "SELECT data_ordine, YEAR(data_ordine), MONTH(data_ordine) FROM ordini", brokenCode: "SELECT data_ordine, YEAR(data_ordine), MONTH(data_ordine FROM ordini", debugHint: "Manca una parentesi di chiusura nella funzione MONTH.", hints: ["Seleziona data_ordine, YEAR(data_ordine) e MONTH(data_ordine)."], explanation: "Data completa con anno e mese.", replacements: {} },
            { titleTemplate: "Spedizioni con Anno e Mese", descTemplate: "Mostra data spedizione, anno e mese estratti.", queryTemplate: "SELECT data_spedizione, YEAR(data_spedizione), MONTH(data_spedizione) FROM spedizioni", brokenCode: "SELECT data_spedizione, YEAR(data_spedizione), MONTH(data_spedizione FROM spedizioni", debugHint: "Manca una parentesi di chiusura nella funzione MONTH.", hints: ["Seleziona data_spedizione, YEAR(data_spedizione) e MONTH(data_spedizione)."], explanation: "Data completa con anno e mese spedizioni.", replacements: {} },
            { titleTemplate: "Filtro Data Specifica", descTemplate: "Trova tutti gli ordini effettuati il 1 Gennaio 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine = '2023-01-01'", brokenCode: "SELECT * FROM ordini WHERE data_ordine = 2023-01-01", debugHint: "Le date devono essere racchiuse tra apici singoli.", hints: ["Usa WHERE data_ordine = '2023-01-01'.", "Le date sono stringhe 'YYYY-MM-DD'."], explanation: "Filtro per data specifica.", replacements: {} },
            { titleTemplate: "Filtro Data Dopo", descTemplate: "Trova tutti gli ordini effettuati dopo il 1 Gennaio 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine > '2023-01-01'", brokenCode: "SELECT * FROM ordini WHERE data_ordine > 2023-01-01", debugHint: "Le date devono essere racchiuse tra apici singoli.", hints: ["Usa WHERE data_ordine > '2023-01-01'."], explanation: "Filtro per data maggiore.", replacements: {} },
            { titleTemplate: "Filtro Data Prima", descTemplate: "Trova tutti gli ordini effettuati prima del 1 Gennaio 2024.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine < '2024-01-01'", brokenCode: "SELECT * FROM ordini WHERE data_ordine < 2024-01-01", debugHint: "Le date devono essere racchiuse tra apici singoli.", hints: ["Usa WHERE data_ordine < '2024-01-01'."], explanation: "Filtro per data minore.", replacements: {} },
            { titleTemplate: "Filtro Data Dopo o Uguale", descTemplate: "Trova tutti gli ordini dal 1 Gennaio 2023 in poi.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine >= '2023-01-01'", brokenCode: "SELECT * FROM ordini WHERE data_ordine >= 2023-01-01", debugHint: "Le date devono essere racchiuse tra apici singoli.", hints: ["Usa WHERE data_ordine >= '2023-01-01'."], explanation: "Filtro per data maggiore o uguale.", replacements: {} },
            { titleTemplate: "Filtro Data Prima o Uguale", descTemplate: "Trova tutti gli ordini fino al 31 Dicembre 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine <= '2023-12-31'", brokenCode: "SELECT * FROM ordini WHERE data_ordine <= 2023-12-31", debugHint: "Le date devono essere racchiuse tra apici singoli.", hints: ["Usa WHERE data_ordine <= '2023-12-31'."], explanation: "Filtro per data minore o uguale.", replacements: {} },
            { titleTemplate: "Filtro Range Date", descTemplate: "Trova tutti gli ordini tra il 1 Gennaio 2023 e il 31 Dicembre 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine BETWEEN '2023-01-01' AND '2023-12-31'", brokenCode: "SELECT * FROM ordini WHERE data_ordine BETWEEN 2023-01-01 AND 2023-12-31", debugHint: "Le date devono essere racchiuse tra apici singoli.", hints: ["Usa WHERE data_ordine BETWEEN '2023-01-01' AND '2023-12-31'."], explanation: "BETWEEN per range di date.", replacements: {} },
            {
                titleTemplate: "Anno con Alias", descTemplate: "Estrai l'anno dalla data ordine e rinominalo come 'Anno_Ordine'.",
                queryTemplate: "SELECT YEAR(data_ordine) AS Anno_Ordine FROM ordini", brokenCode: "SELECT YEAR(data_ordine) ASS Anno_Ordine FROM ordini", debugHint: "Errore di battitura nella parola chiave AS.", hints: ["Usa YEAR(data_ordine) AS Anno_Ordine."], explanation: "YEAR con alias.", replacements: {}
            },
            {
                titleTemplate: "Mese con Alias", descTemplate: "Estrai il mese dalla data spedizione e rinominalo come 'Mese_Spedizione'.",
                queryTemplate: "SELECT MONTH(data_spedizione) AS Mese_Spedizione FROM spedizioni", brokenCode: "SELECT MONTH(data_spedizione) AS Mese_Spedizione FORM spedizioni", debugHint: "Errore di battitura nella parola chiave FROM.", hints: ["Usa MONTH(data_spedizione) AS Mese_Spedizione."], explanation: "MONTH con alias.", replacements: {}
            },
            // NEW EXERCISES FOR DATES EASY
            { titleTemplate: "Giorno Ordine", descTemplate: "Estrai il giorno (1-31) dalla data ordine.", queryTemplate: "SELECT DAY(data_ordine) FROM ordini", brokenCode: "SELECT DAY(data_ordine FROM ordini", debugHint: "Manca una parentesi di chiusura nella funzione DAY.", hints: ["Usa la funzione DAY(data_ordine)."], explanation: "Estrai giorno.", replacements: {} },
            { titleTemplate: "Giorno Spedizione", descTemplate: "Estrai il giorno (1-31) dalla data spedizione.", queryTemplate: "SELECT DAY(data_spedizione) FROM spedizioni", brokenCode: "SELECT DAY(data_spedizione FROM spedizioni", debugHint: "Manca una parentesi di chiusura nella funzione DAY.", hints: ["Usa la funzione DAY(data_spedizione)."], explanation: "Estrai giorno spedizione.", replacements: {} },
            { titleTemplate: "Data Corrente", descTemplate: "Mostra la data e ora corrente.", queryTemplate: "SELECT NOW()", brokenCode: "SELECT NOW", debugHint: "Le funzioni richiedono le parentesi, anche se vuote.", hints: ["Usa la funzione NOW()."], explanation: "Timestamp attuale.", replacements: {} },
            { titleTemplate: "Filtro Giorno 1", descTemplate: "Trova ordini fatti il primo del mese.", queryTemplate: "SELECT * FROM ordini WHERE DAY(data_ordine) = 1", brokenCode: "SELECT * FROM ordini WHERE DAY(data_ordine) = 1)", debugHint: "C'è una parentesi di troppo.", hints: ["Usa WHERE DAY(data_ordine) = 1."], explanation: "Inizio mese.", replacements: {} },
            { titleTemplate: "Filtro Giorno 15", descTemplate: "Trova ordini fatti a metà mese (15).", queryTemplate: "SELECT * FROM ordini WHERE DAY(data_ordine) = 15", brokenCode: "SELECT * FROM ordini WHERE DAY(data_ordine) = 15)", debugHint: "C'è una parentesi di troppo.", hints: ["Usa WHERE DAY(data_ordine) = 15."], explanation: "Metà mese.", replacements: {} },
            { titleTemplate: "Filtro Anno Passato", descTemplate: "Trova ordini del 2022.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) = 2022", brokenCode: "SELECT * FROM ordini WHERE YEAR(data_ordine) = 2022)", debugHint: "C'è una parentesi di troppo.", hints: ["Usa WHERE YEAR(data_ordine) = 2022."], explanation: "Storico.", replacements: {} },
            { titleTemplate: "Filtro Mese Dicembre", descTemplate: "Trova ordini di Dicembre (12).", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) = 12", brokenCode: "SELECT * FROM ordini WHERE MONTH(data_ordine) = 12)", debugHint: "C'è una parentesi di troppo.", hints: ["Usa WHERE MONTH(data_ordine) = 12."], explanation: "Fine anno.", replacements: {} },
            { titleTemplate: "Data Ordine Alias", descTemplate: "Seleziona data ordine rinominandola 'Data'.", queryTemplate: "SELECT data_ordine AS Data FROM ordini", brokenCode: "SELECT data_ordine AS Data FORM ordini", debugHint: "Errore di battitura nella parola chiave FROM.", hints: ["Usa AS Data."], explanation: "Alias semplice.", replacements: {} },
            { titleTemplate: "Data Spedizione Alias", descTemplate: "Seleziona data spedizione rinominandola 'Spedito_Il'.", queryTemplate: "SELECT data_spedizione AS Spedito_Il FROM spedizioni", brokenCode: "SELECT data_spedizione AS Spedito_Il FORM spedizioni", debugHint: "Errore di battitura nella parola chiave FROM.", hints: ["Usa AS Spedito_Il."], explanation: "Alias descrittivo.", replacements: {} },
            { titleTemplate: "Anno Corrente Alias", descTemplate: "Estrai anno ordine come 'Anno_Rif'.", queryTemplate: "SELECT YEAR(data_ordine) AS Anno_Rif FROM ordini", brokenCode: "SELECT YEAR(data_ordine) AS Anno_Rif FORM ordini", debugHint: "Errore di battitura nella parola chiave FROM.", hints: ["Usa YEAR(data_ordine) AS Anno_Rif."], explanation: "Alias su funzione.", replacements: {} }
        ],
        [Difficulty.Medium]: [
            { titleTemplate: "Spedizioni nel Mese {month}", descTemplate: "Trova tutte le spedizioni avvenute nel mese numero {month} (indipendentemente dall'anno).", queryTemplate: "SELECT * FROM spedizioni WHERE MONTH(data_spedizione) = {month}", hints: ["Filtra basandoti sul mese estratto dalla data."], explanation: "Utile per analisi stagionali.", replacements: { month: DATA.months } },
            { titleTemplate: "Data Corrente (Simulata)", descTemplate: "Seleziona la data odierna (in questo ambiente simulato usa NOW() o DATE()).", queryTemplate: "SELECT NOW()", hints: ["Quale funzione restituisce la data e ora attuali?"], explanation: "Restituisce timestamp corrente.", replacements: {} },
            { titleTemplate: "Ordini Post-2023", descTemplate: "Trova tutti gli ordini fatti dopo il 1 Gennaio 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine > '2023-01-01'", hints: ["Filtra per data maggiore di '2023-01-01'."], explanation: "Confronto diretto tra stringhe data ISO.", replacements: {} },
            { titleTemplate: "Ordini Pre-2024", descTemplate: "Trova tutti gli ordini fatti prima del 1 Gennaio 2024.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine < '2024-01-01'", hints: ["Filtra per data minore di '2024-01-01'."], explanation: "Filtro per date precedenti.", replacements: {} },
            { titleTemplate: "Ordini Dopo Data", descTemplate: "Trova tutti gli ordini fatti dopo il 1 Giugno 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine > '2023-06-01'", hints: ["Filtra per data successiva al 1 Giugno."], explanation: "Filtro per data successiva.", replacements: {} },
            { titleTemplate: "Ordini Prima Data", descTemplate: "Trova tutti gli ordini fatti prima del 1 Luglio 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine < '2023-07-01'", hints: ["Filtra per data precedente al 1 Luglio."], explanation: "Filtro per data precedente.", replacements: {} },
            { titleTemplate: "Spedizioni Dopo Data", descTemplate: "Trova tutte le spedizioni avvenute dopo il 1 Marzo 2023.", queryTemplate: "SELECT * FROM spedizioni WHERE data_spedizione > '2023-03-01'", hints: ["Filtra le spedizioni successive a Marzo."], explanation: "Filtro data su spedizioni.", replacements: {} },
            { titleTemplate: "Spedizioni Prima Data", descTemplate: "Trova tutte le spedizioni avvenute prima del 1 Dicembre 2023.", queryTemplate: "SELECT * FROM spedizioni WHERE data_spedizione < '2023-12-01'", hints: ["Filtra le spedizioni precedenti a Dicembre."], explanation: "Filtro data precedente su spedizioni.", replacements: {} },
            { titleTemplate: "Range Date Ordini", descTemplate: "Trova tutti gli ordini tra il 1 Gennaio 2023 e il 30 Giugno 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine BETWEEN '2023-01-01' AND '2023-06-30'", hints: ["Usa l'operatore per filtrare in un intervallo di date."], explanation: "BETWEEN per range date.", replacements: {} },
            { titleTemplate: "Range Date Spedizioni", descTemplate: "Trova tutte le spedizioni tra il 1 Aprile 2023 e il 30 Settembre 2023.", queryTemplate: "SELECT * FROM spedizioni WHERE data_spedizione BETWEEN '2023-04-01' AND '2023-09-30'", hints: ["Filtra le spedizioni in un intervallo di date."], explanation: "BETWEEN per range date spedizioni.", replacements: {} },
            { titleTemplate: "Anno e Mese con Filtro", descTemplate: "Mostra anno e mese degli ordini del 2023.", queryTemplate: "SELECT YEAR(data_ordine), MONTH(data_ordine) FROM ordini WHERE YEAR(data_ordine) = 2023", hints: ["Estrai anno e mese, filtrando per anno."], explanation: "Funzioni data con filtro.", replacements: {} },
            { titleTemplate: "Anno e Mese Spedizioni 2023", descTemplate: "Mostra anno e mese delle spedizioni del 2023.", queryTemplate: "SELECT YEAR(data_spedizione), MONTH(data_spedizione) FROM spedizioni WHERE YEAR(data_spedizione) = 2023", hints: ["Estrai i componenti della data e filtra per anno."], explanation: "Funzioni data con filtro su spedizioni.", replacements: {} },
            { titleTemplate: "Filtro Mese e Anno", descTemplate: "Trova tutti gli ordini di Gennaio 2023 (mese 1, anno 2023).", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) = 1 AND YEAR(data_ordine) = 2023", hints: ["Combina due condizioni sulla data."], explanation: "Filtro combinato mese e anno.", replacements: {} },
            { titleTemplate: "Filtro Mese e Anno Spedizioni", descTemplate: "Trova tutte le spedizioni di Dicembre 2023 (mese 12, anno 2023).", queryTemplate: "SELECT * FROM spedizioni WHERE MONTH(data_spedizione) = 12 AND YEAR(data_spedizione) = 2023", hints: ["Filtra sia per mese che per anno."], explanation: "Filtro combinato su spedizioni.", replacements: {} },
            { titleTemplate: "Data e Anno Estratto", descTemplate: "Mostra data ordine e anno estratto per ordini del 2023.", queryTemplate: "SELECT data_ordine, YEAR(data_ordine) FROM ordini WHERE YEAR(data_ordine) = 2023", hints: ["Mostra la data completa e l'anno, filtrando i risultati."], explanation: "Data completa e anno con filtro.", replacements: {} },
            { titleTemplate: "Data e Mese Estratto", descTemplate: "Mostra data spedizione e mese estratto per spedizioni di Gennaio.", queryTemplate: "SELECT data_spedizione, MONTH(data_spedizione) FROM spedizioni WHERE MONTH(data_spedizione) = 1", hints: ["Mostra la data completa e il mese, filtrando i risultati."], explanation: "Data completa e mese con filtro.", replacements: {} },
            { titleTemplate: "Anno con Alias e Filtro", descTemplate: "Estrai l'anno dalla data ordine come 'Anno', solo per ordini del 2023.", queryTemplate: "SELECT YEAR(data_ordine) AS Anno FROM ordini WHERE YEAR(data_ordine) = 2023", hints: ["Estrai l'anno con un alias e applica un filtro."], explanation: "YEAR con alias e filtro.", replacements: {} },
            { titleTemplate: "Mese con Alias e Filtro", descTemplate: "Estrai il mese dalla data spedizione come 'Mese', solo per spedizioni di Gennaio.", queryTemplate: "SELECT MONTH(data_spedizione) AS Mese FROM spedizioni WHERE MONTH(data_spedizione) = 1", hints: ["Estrai il mese con un alias e applica un filtro."], explanation: "MONTH con alias e filtro.", replacements: {} },
            { titleTemplate: "Range Anno", descTemplate: "Trova tutti gli ordini degli anni 2022 o 2023.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) IN (2022, 2023)", hints: ["Usa l'operatore per confrontare con una lista di anni."], explanation: "IN con YEAR per anni multipli.", replacements: {} },
            { titleTemplate: "Range Mese", descTemplate: "Trova tutti gli ordini dei mesi estivi (6, 7, 8).", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) IN (6, 7, 8)", hints: ["Confronta il mese con una lista di valori."], explanation: "IN con MONTH per mesi multipli.", replacements: {} },
            { titleTemplate: "Range Mese Spedizioni", descTemplate: "Trova tutte le spedizioni dei mesi invernali (12, 1, 2).", queryTemplate: "SELECT * FROM spedizioni WHERE MONTH(data_spedizione) IN (12, 1, 2)", hints: ["Filtra i mesi invernali usando una lista."], explanation: "IN con MONTH per mesi invernali.", replacements: {} },
            { titleTemplate: "Anno Maggiore", descTemplate: "Trova tutti gli ordini dell'anno 2023 o successivi.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) >= 2023", hints: ["Filtra per anni a partire dal 2023."], explanation: "Confronto su YEAR con >=", replacements: {} },
            { titleTemplate: "Anno Minore", descTemplate: "Trova tutti gli ordini dell'anno 2022 o precedenti.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) <= 2022", hints: ["Filtra per anni fino al 2022."], explanation: "Confronto su YEAR con <=", replacements: {} },
            { titleTemplate: "Mese Maggiore", descTemplate: "Trova tutti gli ordini dal mese 6 in poi (estate e autunno).", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) >= 6", hints: ["Filtra per mesi nella seconda metà dell'anno."], explanation: "Confronto su MONTH con >=", replacements: {} },
            { titleTemplate: "Mese Minore", descTemplate: "Trova tutti gli ordini fino al mese 3 (primo trimestre).", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) <= 3", hints: ["Filtra per i primi mesi dell'anno."], explanation: "Confronto su MONTH con <=", replacements: {} },
            { titleTemplate: "Data e Funzioni Multiple", descTemplate: "Mostra data ordine, anno e mese estratti per ordini del 2023.", queryTemplate: "SELECT data_ordine, YEAR(data_ordine), MONTH(data_ordine) FROM ordini WHERE YEAR(data_ordine) = 2023", hints: ["Estrai più componenti dalla data e filtra."], explanation: "Data completa con funzioni e filtro.", replacements: {} },
            { titleTemplate: "Anno e Mese con Alias", descTemplate: "Estrai anno e mese dalla data ordine con alias 'Anno' e 'Mese'.", queryTemplate: "SELECT YEAR(data_ordine) AS Anno, MONTH(data_ordine) AS Mese FROM ordini", hints: ["Usa alias per rinominare le colonne estratte."], explanation: "Funzioni data con alias multipli.", replacements: {} },
            { titleTemplate: "Filtro Data e Anno", descTemplate: "Trova tutti gli ordini dopo il 1 Gennaio 2023 E dell'anno 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine > '2023-01-01' AND YEAR(data_ordine) = 2023", hints: ["Combina un filtro sulla data completa e uno sull'anno."], explanation: "Filtro combinato data e funzione.", replacements: {} },
            { titleTemplate: "Filtro Data e Mese", descTemplate: "Trova tutti gli ordini dopo il 1 Gennaio 2023 E del mese 6 o successivi.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine > '2023-01-01' AND MONTH(data_ordine) >= 6", hints: ["Combina un filtro sulla data e uno sul mese."], explanation: "Filtro combinato data e mese.", replacements: {} },
            { titleTemplate: "Range Completo", descTemplate: "Trova tutti gli ordini tra il 1 Gennaio 2023 e il 31 Dicembre 2023, mostrando anche anno e mese.", queryTemplate: "SELECT data_ordine, YEAR(data_ordine), MONTH(data_ordine) FROM ordini WHERE data_ordine BETWEEN '2023-01-01' AND '2023-12-31'", hints: ["Filtra per intervallo di date e mostra i componenti."], explanation: "BETWEEN con funzioni data multiple.", replacements: {} },
            // NEW EXERCISES FOR DATES MEDIUM
            { titleTemplate: "Ordini di Capodanno", descTemplate: "Trova gli ordini effettuati il primo dell'anno (2023-01-01).", queryTemplate: "SELECT * FROM ordini WHERE data_ordine = '2023-01-01'", hints: ["Filtra per una data specifica esatta."], explanation: "Filtro su data specifica.", replacements: {} },
            { titleTemplate: "Trimestre 1", descTemplate: "Trova ordini del primo trimestre (Mesi 1, 2, 3).", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) BETWEEN 1 AND 3", hints: ["Filtra i mesi compresi tra 1 e 3."], explanation: "Analisi trimestrale.", replacements: {} },
            { titleTemplate: "Trimestre 4", descTemplate: "Trova ordini dell'ultimo trimestre (Mesi 10, 11, 12).", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) >= 10", hints: ["Filtra i mesi finali dell'anno."], explanation: "Chiusura anno.", replacements: {} },
            { titleTemplate: "Giorni Trascorsi", descTemplate: "Calcola giorni passati dal 2023-01-01 ad oggi (NOW).", queryTemplate: "SELECT DATEDIFF(day, '2023-01-01', NOW())", hints: ["Usa la funzione per calcolare la differenza tra date."], explanation: "Calcolo delta temporale.", replacements: {} },
            { titleTemplate: "Età Ordine", descTemplate: "Calcola giorni passati dalla data ordine ad oggi.", queryTemplate: "SELECT id, DATEDIFF(day, data_ordine, NOW()) FROM ordini", hints: ["Calcola la differenza in giorni rispetto alla data attuale."], explanation: "Invecchiamento ordini.", replacements: {} },
            { titleTemplate: "Ordini Futuri (Check)", descTemplate: "Trova ordini con data > NOW() (controllo errori).", queryTemplate: "SELECT * FROM ordini WHERE data_ordine > NOW()", hints: ["Cerca date che sono nel futuro rispetto ad oggi."], explanation: "Data integrity check.", replacements: {} },
            { titleTemplate: "Spedizioni Veloci (< 2gg)", descTemplate: "Trova spedizioni avvenute entro 2 giorni dall'ordine (Join implicita simulata o filtro diretto se tabella unica, qui usiamo filtro su date note).", queryTemplate: "SELECT * FROM ordini WHERE data_ordine BETWEEN '2023-01-01' AND '2023-01-03'", hints: ["Filtra per un intervallo di date molto breve."], explanation: "Analisi performance.", replacements: {} },
            { titleTemplate: "Ordini Stesso Giorno", descTemplate: "Trova ordini fatti e spediti lo stesso giorno (Join necessaria, ma qui usiamo filtro placeholder).", queryTemplate: "SELECT * FROM ordini WHERE data_ordine = '2023-01-01'", hints: ["Filtra per una data specifica."], explanation: "Same day delivery.", replacements: {} },
            { titleTemplate: "Filtro Anno Mese Giorno", descTemplate: "Trova ordini del 2023-12-25.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine)=2023 AND MONTH(data_ordine)=12 AND DAY(data_ordine)=25", hints: ["Combina filtri su anno, mese e giorno."], explanation: "Data esatta scomposta.", replacements: {} },
            { titleTemplate: "Ordini Metà Anno", descTemplate: "Trova ordini fatti dopo il 30 Giugno.", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) > 6", hints: ["Filtra per i mesi della seconda metà dell'anno."], explanation: "Secondo semestre.", replacements: {} }
        ],
        [Difficulty.Hard]: [
            { titleTemplate: "Calcolo Giorni Consegna", descTemplate: "Calcola quanti giorni sono passati tra l'ordine e la spedizione per ogni ordine spedito.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Calcola la differenza in giorni tra le due date.", "Unisci le tabelle per avere entrambe le date."], explanation: "DATEDIFF calcola intervalli.", replacements: {} },
            { titleTemplate: "Spedizioni Lente (> 5gg)", descTemplate: "Trova gli ordini che hanno impiegato più di 5 giorni per essere spediti.", queryTemplate: "SELECT * FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) > 5", hints: ["Filtra i risultati basandoti sull'intervallo temporale calcolato.", "Unisci le tabelle ordini e spedizioni."], explanation: "Filtro su intervallo calcolato.", replacements: {} },
            { titleTemplate: "Ordini Ultimi 30 Giorni", descTemplate: "Simulando che oggi sia '2023-12-31', trova gli ordini dell'ultimo mese.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine > DATEADD(day, -30, '2023-12-31')", hints: ["Calcola la data limite sottraendo giorni alla data di riferimento."], explanation: "Finestra temporale mobile.", replacements: {} },
            { titleTemplate: "Ordini Mese Scorso", descTemplate: "Simulando che oggi sia '2023-12-31', trova gli ordini del mese precedente.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine > DATEADD(month, -1, '2023-12-31')", hints: ["Calcola la data limite sottraendo un mese alla data di riferimento."], explanation: "Intervallo mese precedente.", replacements: {} },
            { titleTemplate: "Media Giorni Spedizione", descTemplate: "Calcola il tempo medio di spedizione in giorni.", queryTemplate: "SELECT AVG(DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione)) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Calcola la media delle differenze temporali.", "Unisci le tabelle per accedere alle date."], explanation: "Media su intervallo calcolato.", replacements: {} },
            { titleTemplate: "Ordini Weekend", descTemplate: "Trova gli ordini effettuati nel weekend (Sabato o Domenica). Nota: WEEKDAY restituisce 5 per Sabato, 6 per Domenica (o simile a seconda del DB).", queryTemplate: "SELECT * FROM ordini WHERE WEEKDAY(data_ordine) IN (5, 6)", hints: ["Usa una funzione per ottenere il giorno della settimana e filtra."], explanation: "Filtro su giorno settimana.", replacements: {} },
            { titleTemplate: "Ritardi > {days} Giorni", descTemplate: "Trova le spedizioni che hanno impiegato più di {days} giorni a partire dalla data ordine.", queryTemplate: "SELECT * FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE DATEDIFF(day, data_ordine, data_spedizione) > {days}", hints: ["Filtra i risultati basandoti sulla differenza di giorni calcolata."], explanation: "Filtro su intervallo calcolato.", replacements: { days: [2, 3, 5, 7, 10] } },
            { titleTemplate: "DATEDIFF Ordini Spedizioni", descTemplate: "Calcola i giorni tra ordine e spedizione per ogni ordine spedito.", queryTemplate: "SELECT ordini.id, DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Calcola la differenza di giorni e unisci le tabelle."], explanation: "DATEDIFF con JOIN per calcolare intervalli.", replacements: {} },
            { titleTemplate: "DATEDIFF con Alias", descTemplate: "Calcola i giorni tra ordine e spedizione e rinominalo come 'Giorni_Consegna'.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) AS Giorni_Consegna FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Calcola la differenza e assegna un alias al risultato."], explanation: "DATEDIFF con alias.", replacements: {} },
            { titleTemplate: "Filtro DATEDIFF", descTemplate: "Trova le spedizioni che hanno impiegato più di 3 giorni.", queryTemplate: "SELECT * FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE DATEDIFF(day, data_ordine, data_spedizione) > 3", hints: ["Filtra dove la differenza di giorni è maggiore di 3."], explanation: "Filtro su DATEDIFF.", replacements: {} },
            { titleTemplate: "Filtro DATEDIFF Minore", descTemplate: "Trova le spedizioni che hanno impiegato meno di 2 giorni.", queryTemplate: "SELECT * FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE DATEDIFF(day, data_ordine, data_spedizione) < 2", hints: ["Filtra dove la differenza di giorni è minore di 2."], explanation: "Filtro DATEDIFF per consegne veloci.", replacements: {} },
            { titleTemplate: "DATEDIFF con Range", descTemplate: "Trova le spedizioni che hanno impiegato tra 2 e 5 giorni.", queryTemplate: "SELECT * FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE DATEDIFF(day, data_ordine, data_spedizione) BETWEEN 2 AND 5", hints: ["Filtra dove la differenza di giorni è in un intervallo specifico."], explanation: "BETWEEN con DATEDIFF.", replacements: {} },
            { titleTemplate: "Anno e DATEDIFF", descTemplate: "Mostra anno ordine e giorni di consegna per ogni spedizione.", queryTemplate: "SELECT YEAR(ordini.data_ordine), DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Estrai l'anno e calcola la differenza di giorni."], explanation: "YEAR combinato con DATEDIFF.", replacements: {} },
            { titleTemplate: "Mese e DATEDIFF", descTemplate: "Mostra mese ordine e giorni di consegna per ogni spedizione.", queryTemplate: "SELECT MONTH(ordini.data_ordine), DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Estrai il mese e calcola la differenza di giorni."], explanation: "MONTH combinato con DATEDIFF.", replacements: {} },
            { titleTemplate: "Data Ordine e DATEDIFF", descTemplate: "Mostra data ordine e giorni di consegna per ogni spedizione.", queryTemplate: "SELECT ordini.data_ordine, DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Seleziona la data e calcola la differenza in giorni."], explanation: "Data completa con DATEDIFF.", replacements: {}, brokenCode: "SELECT ordini.data_ordine, DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", debugHint: "Manca la parentesi di chiusura della funzione DATEDIFF." },
            { titleTemplate: "Data Spedizione e DATEDIFF", descTemplate: "Mostra data spedizione e giorni di consegna per ogni spedizione.", queryTemplate: "SELECT spedizioni.data_spedizione, DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Seleziona la data e calcola la differenza in giorni."], explanation: "Data spedizione con DATEDIFF.", replacements: {}, brokenCode: "SELECT spedizioni.data_spedizione, DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", debugHint: "Manca la parentesi di chiusura della funzione DATEDIFF." },
            { titleTemplate: "DATEDIFF e Filtro Anno", descTemplate: "Calcola giorni consegna solo per ordini del 2023.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE YEAR(ordini.data_ordine) = 2023", hints: ["Calcola la differenza e filtra per anno."], explanation: "DATEDIFF con filtro anno.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE YEAR(ordini.data_ordine = 2023", debugHint: "Manca la parentesi di chiusura della funzione YEAR." },
            { titleTemplate: "DATEDIFF e Filtro Mese", descTemplate: "Calcola giorni consegna solo per ordini di Gennaio.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE MONTH(ordini.data_ordine) = 1", hints: ["Calcola la differenza e filtra per mese."], explanation: "DATEDIFF con filtro mese.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE MONTH(ordini.data_ordine = 1", debugHint: "Manca la parentesi di chiusura della funzione MONTH." },
            { titleTemplate: "DATEDIFF e Filtro Data", descTemplate: "Calcola giorni consegna solo per ordini dopo il 1 Gennaio 2023.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE ordini.data_ordine > '2023-01-01'", hints: ["Calcola la differenza e filtra per data."], explanation: "DATEDIFF con filtro data.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE ordini.data_ordine > 2023-01-01", debugHint: "Le date letterali devono essere racchiuse tra apici singoli." },
            { titleTemplate: "DATEDIFF con Alias e Filtro", descTemplate: "Calcola giorni consegna come 'Ritardo' solo per consegne > 3 giorni.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) AS Ritardo FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) > 3", hints: ["Calcola la differenza, assegna un alias e filtra sul calcolo originale."], explanation: "DATEDIFF con alias e filtro su stesso calcolo.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) AS Ritardo FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE Ritardo > 3", debugHint: "Non puoi usare un alias di colonna nella clausola WHERE. Devi ripetere l'espressione o usare una subquery." },
            { titleTemplate: "Anno Ordine e Anno Spedizione", descTemplate: "Mostra anno ordine e anno spedizione per ogni spedizione.", queryTemplate: "SELECT YEAR(ordini.data_ordine), YEAR(spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Estrai l'anno da entrambe le date."], explanation: "YEAR su date multiple con JOIN.", replacements: {}, brokenCode: "SELECT YEAR(ordini.data_ordine), YEAR(spedizioni.data_spedizione FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", debugHint: "Manca la parentesi di chiusura della seconda funzione YEAR." },
            { titleTemplate: "Mese Ordine e Mese Spedizione", descTemplate: "Mostra mese ordine e mese spedizione per ogni spedizione.", queryTemplate: "SELECT MONTH(ordini.data_ordine), MONTH(spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Estrai il mese da entrambe le date."], explanation: "MONTH su date multiple con JOIN.", replacements: {}, brokenCode: "SELECT MONTH(ordini.data_ordine), MONTH(spedizioni.data_spedizione FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", debugHint: "Manca la parentesi di chiusura della seconda funzione MONTH." },
            { titleTemplate: "Date Complete e DATEDIFF", descTemplate: "Mostra data ordine, data spedizione e giorni di consegna.", queryTemplate: "SELECT ordini.data_ordine, spedizioni.data_spedizione, DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Mostra le date originali e la loro differenza."], explanation: "Date complete con DATEDIFF.", replacements: {}, brokenCode: "SELECT ordini.data_ordine, spedizioni.data_spedizione, DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", debugHint: "Manca la parentesi di chiusura della funzione DATEDIFF." },
            { titleTemplate: "Anno, Mese e DATEDIFF", descTemplate: "Mostra anno ordine, mese ordine e giorni di consegna.", queryTemplate: "SELECT YEAR(ordini.data_ordine), MONTH(ordini.data_ordine), DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Estrai anno e mese e calcola la differenza."], explanation: "Funzioni data multiple con DATEDIFF.", replacements: {}, brokenCode: "SELECT YEAR(ordini.data_ordine), MONTH(ordini.data_ordine), DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", debugHint: "Manca la parentesi di chiusura della funzione DATEDIFF." },
            { titleTemplate: "DATEDIFF con ORDER BY", descTemplate: "Calcola giorni consegna e ordina dal più lungo al più corto.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id ORDER BY DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) DESC", hints: ["Calcola la differenza e ordina i risultati in base ad essa."], explanation: "DATEDIFF con ORDER BY.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id ORDER BY DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione DES", debugHint: "Errore di sintassi nella parola chiave DESC." },
            { titleTemplate: "DATEDIFF con LIMIT", descTemplate: "Trova le 5 spedizioni con il tempo di consegna più lungo.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id ORDER BY DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) DESC LIMIT 5", hints: ["Ordina per differenza decrescente e limita i risultati."], explanation: "DATEDIFF con ORDER BY e LIMIT.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id ORDER BY DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) DESC LIMIT", debugHint: "Manca il valore numerico per la clausola LIMIT." },
            { titleTemplate: "DATEDIFF e Filtro Combinato", descTemplate: "Calcola giorni consegna per ordini del 2023 con consegna > 2 giorni.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE YEAR(ordini.data_ordine) = 2023 AND DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) > 2", hints: ["Combina filtro sull'anno e sulla differenza calcolata."], explanation: "DATEDIFF con filtri combinati.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE YEAR(ordini.data_ordine) = 2023 AND DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione > 2", debugHint: "Manca la parentesi di chiusura della funzione DATEDIFF nella clausola WHERE." },
            { titleTemplate: "DATEDIFF e Range Date", descTemplate: "Calcola giorni consegna per ordini tra il 1 Gennaio e 30 Giugno 2023.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE ordini.data_ordine BETWEEN '2023-01-01' AND '2023-06-30'", hints: ["Calcola la differenza filtrando per un intervallo di date."], explanation: "DATEDIFF con range date.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE ordini.data_ordine BETWEEN '2023-01-01' '2023-06-30'", debugHint: "Manca la parola chiave AND tra i due valori del BETWEEN." },
            { titleTemplate: "DATEDIFF con Alias Completo", descTemplate: "Calcola giorni consegna come 'Giorni' e ordina per questo valore.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) AS Giorni FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id ORDER BY Giorni DESC", hints: ["Usa l'alias definito per ordinare i risultati."], explanation: "DATEDIFF con alias usato in ORDER BY.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) AS Giorni FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id ORDER BY Giorni", debugHint: "Manca la direzione dell'ordinamento (DESC) richiesta dalla traccia." },
            { titleTemplate: "Funzioni Data Multiple", descTemplate: "Mostra anno ordine, mese ordine, anno spedizione, mese spedizione e giorni consegna.", queryTemplate: "SELECT YEAR(ordini.data_ordine), MONTH(ordini.data_ordine), YEAR(spedizioni.data_spedizione), MONTH(spedizioni.data_spedizione), DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Usa più funzioni di data nella stessa query."], explanation: "Funzioni data multiple con DATEDIFF.", replacements: {}, brokenCode: "SELECT YEAR(ordini.data_ordine), MONTH(ordini.data_ordine), YEAR(spedizioni.data_spedizione), MONTH(spedizioni.data_spedizione), DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", debugHint: "Manca la parentesi di chiusura della funzione DATEDIFF." },
            { titleTemplate: "DATEDIFF e Filtro Mese Ordine", descTemplate: "Calcola giorni consegna solo per ordini di Gennaio o Febbraio.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE MONTH(ordini.data_ordine) IN (1, 2)", hints: ["Calcola la differenza filtrando per mesi specifici."], explanation: "DATEDIFF con filtro mese multiplo.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE MONTH(ordini.data_ordine) IN (1, 2", debugHint: "Manca la parentesi di chiusura della lista IN." },
            { titleTemplate: "DATEDIFF e Filtro Anno Spedizione", descTemplate: "Calcola giorni consegna solo per spedizioni del 2023.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE YEAR(spedizioni.data_spedizione) = 2023", hints: ["Calcola la differenza filtrando per anno di spedizione."], explanation: "DATEDIFF con filtro anno spedizione.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE YEAR(spedizioni.data_spedizione = 2023", debugHint: "Manca la parentesi di chiusura della funzione YEAR." },
            { titleTemplate: "DATEDIFF Complesso Finale", descTemplate: "Calcola giorni consegna (alias 'Giorni') per ordini del 2023 con consegna tra 2 e 5 giorni, ordinati per giorni decrescente.", queryTemplate: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) AS Giorni FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE YEAR(ordini.data_ordine) = 2023 AND DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) BETWEEN 2 AND 5 ORDER BY Giorni DESC", hints: ["Combina filtri, calcoli e ordinamento."], explanation: "DATEDIFF complesso con filtri multipli e ordinamento.", replacements: {}, brokenCode: "SELECT DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) AS Giorni FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE YEAR(ordini.data_ordine) = 2023 AND DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) BETWEEN 2 AND 5 ORDER BY Giorni", debugHint: "Manca la direzione dell'ordinamento (DESC) richiesta dalla traccia." },
            // NEW EXERCISES FOR DATES HARD
            { titleTemplate: "Giorni alla Spedizione Media", descTemplate: "Calcola la media dei giorni di consegna (AVG DATEDIFF).", queryTemplate: "SELECT AVG(DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione)) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Calcola la media delle differenze."], explanation: "KPI logistico.", replacements: {} },
            { titleTemplate: "Max Giorni Consegna", descTemplate: "Trova il massimo numero di giorni impiegati per una consegna.", queryTemplate: "SELECT MAX(DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione)) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Trova il valore massimo della differenza."], explanation: "Worst case delivery.", replacements: {} },
            { titleTemplate: "Min Giorni Consegna", descTemplate: "Trova il minimo numero di giorni impiegati per una consegna.", queryTemplate: "SELECT MIN(DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione)) FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id", hints: ["Trova il valore minimo della differenza."], explanation: "Best case delivery.", replacements: {} },
            { titleTemplate: "Ordini Spediti in 1 Giorno", descTemplate: "Trova ordini spediti entro 1 giorno (DATEDIFF <= 1).", queryTemplate: "SELECT * FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) <= 1", hints: ["Filtra per differenze molto brevi."], explanation: "Consegna lampo.", replacements: {} },
            { titleTemplate: "Ordini Spediti Dopo 1 Settimana", descTemplate: "Trova ordini spediti dopo più di 7 giorni.", queryTemplate: "SELECT * FROM ordini JOIN spedizioni ON ordini.id = spedizioni.ordine_id WHERE DATEDIFF(day, ordini.data_ordine, spedizioni.data_spedizione) > 7", hints: ["Filtra per differenze lunghe."], explanation: "Ritardi gravi.", replacements: {} },
            { titleTemplate: "Consegne Mese Corrente (Simulato)", descTemplate: "Trova spedizioni avvenute questo mese (MONTH = MONTH(NOW)).", queryTemplate: "SELECT * FROM spedizioni WHERE MONTH(data_spedizione) = MONTH(NOW()) AND YEAR(data_spedizione) = YEAR(NOW())", hints: ["Confronta mese e anno con la data corrente."], explanation: "Report corrente.", replacements: {} },
            { titleTemplate: "Consegne Anno Corrente", descTemplate: "Trova spedizioni di quest'anno.", queryTemplate: "SELECT * FROM spedizioni WHERE YEAR(data_spedizione) = YEAR(NOW())", hints: ["Confronta l'anno con quello corrente."], explanation: "YTD report.", replacements: {} },
            { titleTemplate: "Giorni da Ultimo Ordine", descTemplate: "Calcola giorni passati dall'ordine più recente.", queryTemplate: "SELECT DATEDIFF(day, MAX(data_ordine), NOW()) FROM ordini", hints: ["Calcola la differenza tra l'ultima data e oggi."], explanation: "Recency.", replacements: {} },
            { titleTemplate: "Giorni da Primo Ordine", descTemplate: "Calcola giorni passati dal primo ordine mai effettuato.", queryTemplate: "SELECT DATEDIFF(day, MIN(data_ordine), NOW()) FROM ordini", hints: ["Calcola la differenza tra la prima data e oggi."], explanation: "Customer lifetime start.", replacements: {} },
            { titleTemplate: "Intervallo Ordini", descTemplate: "Calcola giorni tra primo e ultimo ordine.", queryTemplate: "SELECT DATEDIFF(day, MIN(data_ordine), MAX(data_ordine)) FROM ordini", hints: ["Calcola la differenza tra la prima e l'ultima data."], explanation: "Durata attività.", replacements: {} }
        ]
    },
    [TopicId.Joins]: {
        [Difficulty.Easy]: [
    ...
    [TopicId.Aggregation]: {
        [Difficulty.Easy]: [
            { titleTemplate: "Totale Utenti", descTemplate: "Quanti utenti sono registrati nella piattaforma?", queryTemplate: "SELECT COUNT(*) FROM utenti", brokenCode: "SELECT COUNT(*) FORM utenti", debugHint: "C'è un errore di battitura nella clausola che specifica la tabella.", hints: ["Usa la funzione COUNT(*)"], explanation: "COUNT(*) restituisce il numero totale di righe nella tabella.", replacements: {} },
            { titleTemplate: "Totale Prodotti", descTemplate: "Quanti prodotti abbiamo attualmente a catalogo?", queryTemplate: "SELECT COUNT(*) FROM prodotti", brokenCode: "SELECT COUNT(*) prodotti", debugHint: "Manca la parola chiave che introduce la tabella.", hints: ["Usa COUNT(*) sulla tabella prodotti"], explanation: "Restituisce il numero totale di prodotti.", replacements: {} },
            { titleTemplate: "Totale Ordini", descTemplate: "Quanti ordini sono stati ricevuti in totale?", queryTemplate: "SELECT COUNT(*) FROM ordini", brokenCode: "SELECT COUNT* FROM ordini", debugHint: "La funzione di conteggio richiede le parentesi.", hints: ["Usa COUNT(*) sulla tabella ordini"], explanation: "Restituisce il numero totale di ordini registrati.", replacements: {} },
            { titleTemplate: "Totale Recensioni", descTemplate: "Quante recensioni sono state scritte dai clienti?", queryTemplate: "SELECT COUNT(*) FROM recensioni", brokenCode: "SELECT COUNT(*) FROM recensioni;", debugHint: "In questo editor non serve il punto e virgola finale.", hints: ["Usa COUNT(*) sulla tabella recensioni"], explanation: "Restituisce il numero totale di recensioni.", replacements: {} },
            { titleTemplate: "Totale Spedizioni", descTemplate: "Quante spedizioni sono state effettuate?", queryTemplate: "SELECT COUNT(*) FROM spedizioni", brokenCode: "SELECT COUNT(*) FROM spedizioni)", debugHint: "C'è un carattere di troppo alla fine della query.", hints: ["Usa COUNT(*) sulla tabella spedizioni"], explanation: "Restituisce il numero totale di spedizioni.", replacements: {} },
            { titleTemplate: "Totale Stock", descTemplate: "Qual è la quantità totale di pezzi fisicamente presenti in magazzino?", queryTemplate: "SELECT SUM(stock) FROM prodotti", brokenCode: "SELECT SUM(stock) FROM prodotti;", debugHint: "Rimuovi il carattere finale non necessario.", hints: ["Usa la funzione SUM(stock)"], explanation: "SUM(stock) calcola la somma di tutti i valori nella colonna stock.", replacements: {} },
            { titleTemplate: "Valore Magazzino", descTemplate: "Qual è il valore economico totale del magazzino (calcolato come prezzo * stock)?", queryTemplate: "SELECT SUM(prezzo * stock) FROM prodotti", brokenCode: "SELECT SUM(prezzo * stock) FROM prodotti)", debugHint: "Controlla le parentesi di chiusura.", hints: ["Usa SUM(prezzo * stock)"], explanation: "Moltiplica prezzo e stock per ogni riga e poi somma i risultati.", replacements: {} },
            { titleTemplate: "Totale Pezzi Ordinati", descTemplate: "Quanti pezzi sono stati ordinati complessivamente da tutti i clienti?", queryTemplate: "SELECT SUM(quantita) FROM ordini", brokenCode: "SELECT SUM(quantita) FORM ordini", debugHint: "Errore di battitura nella parola chiave che precede la tabella.", hints: ["Usa SUM(quantita)"], explanation: "Restituisce la somma totale delle quantità ordinate.", replacements: {} },
            { titleTemplate: "Prezzo Medio", descTemplate: "Qual è il prezzo medio di vendita dei nostri prodotti?", queryTemplate: "SELECT AVG(prezzo) FROM prodotti", brokenCode: "SELECT AVG(prezzo FROM prodotti", debugHint: "Assicurati di chiudere la parentesi della funzione.", hints: ["Usa la funzione AVG(prezzo)"], explanation: "AVG() calcola la media aritmetica dei valori.", replacements: {} },
            { titleTemplate: "Voto Medio", descTemplate: "Qual è la media dei voti lasciati nelle recensioni?", queryTemplate: "SELECT AVG(voto) FROM recensioni", brokenCode: "SELECT AVG voto FROM recensioni", debugHint: "Le funzioni SQL richiedono le parentesi per i loro argomenti.", hints: ["Usa la funzione AVG(voto)"], explanation: "Indica il livello medio di soddisfazione.", replacements: {} },
            { titleTemplate: "Stock Medio", descTemplate: "Qual è la giacenza media per prodotto nel nostro magazzino?", queryTemplate: "SELECT AVG(stock) FROM prodotti", brokenCode: "SELECT AVG(stock) FROM prodotti;", debugHint: "Rimuovi il punto e virgola finale.", hints: ["Usa AVG(stock)"], explanation: "Restituisce la quantità media di pezzi per prodotto.", replacements: {} },
            { titleTemplate: "Quantità Media Ordine", descTemplate: "Qual è la quantità media di pezzi per ogni ordine ricevuto?", queryTemplate: "SELECT AVG(quantita) FROM ordini", brokenCode: "SELECT AVG(quantita) FROM ordini)", debugHint: "C'è una parentesi di troppo.", hints: ["Usa AVG(quantita)"], explanation: "Indica la dimensione media di un ordine.", replacements: {} },
            { titleTemplate: "Prezzo Più Alto", descTemplate: "Qual è il prezzo del prodotto più costoso a catalogo?", queryTemplate: "SELECT MAX(prezzo) FROM prodotti", brokenCode: "SELECT MAX(prezzo) FROM prodotti", debugHint: "Controlla bene la sintassi, sembra corretta ma forse manca qualcosa?", hints: ["Usa la funzione MAX(prezzo)"], explanation: "MAX() trova il valore più alto.", replacements: {} },
            { titleTemplate: "Prezzo Più Basso", descTemplate: "Qual è il prezzo del prodotto più economico?", queryTemplate: "SELECT MIN(prezzo) FROM prodotti", brokenCode: "SELECT MIN(prezzo) FROM prodotti", debugHint: "Controlla la sintassi.", hints: ["Usa la funzione MIN(prezzo)"], explanation: "MIN() trova il valore più basso.", replacements: {} },
            { titleTemplate: "Voto Migliore", descTemplate: "Qual è il voto più alto mai ricevuto in una recensione?", queryTemplate: "SELECT MAX(voto) FROM recensioni", brokenCode: "SELETC MAX(voto) FROM recensioni", debugHint: "Errore di battitura nella prima parola chiave.", hints: ["Usa MAX(voto)"], explanation: "Il voto massimo possibile.", replacements: {} },
            { titleTemplate: "Voto Peggiore", descTemplate: "Qual è il voto più basso mai ricevuto?", queryTemplate: "SELECT MIN(voto) FROM recensioni", brokenCode: "SELECT MIN(voto)) FROM recensioni", debugHint: "Hai messo troppe parentesi.", hints: ["Usa MIN(voto)"], explanation: "Il voto minimo registrato.", replacements: {} },
            { titleTemplate: "Stock Massimo", descTemplate: "Qual è la giacenza massima registrata per un singolo prodotto?", queryTemplate: "SELECT MAX(stock) FROM prodotti", brokenCode: "SELECT MAX(stock) FORM prodotti", debugHint: "Errore di battitura nella clausola FROM.", hints: ["Usa MAX(stock)"], explanation: "Il prodotto con più pezzi in magazzino.", replacements: {} },
            { titleTemplate: "Stock Minimo", descTemplate: "Qual è la giacenza minima registrata per un singolo prodotto?", queryTemplate: "SELECT MIN(stock) FROM prodotti", brokenCode: "SELECT MIN(stock) prodotti", debugHint: "Manca la parola chiave FROM.", hints: ["Usa MIN(stock)"], explanation: "Il prodotto con meno pezzi in magazzino.", replacements: {} },
            { titleTemplate: "Utenti Premium", descTemplate: "Quanti utenti hanno sottoscritto l'abbonamento Premium?", queryTemplate: "SELECT COUNT(*) FROM utenti WHERE premium = TRUE", brokenCode: "SELECT COUNT(*) FROM utenti WHER premium = TRUE", debugHint: "Errore di battitura nella clausola di filtro.", hints: ["Usa COUNT(*) con WHERE premium = TRUE"], explanation: "Conta solo le righe che soddisfano la condizione.", replacements: {} },
            { titleTemplate: "Prodotti Elettronica", descTemplate: "Quanti prodotti appartengono alla categoria 'Elettronica' (id 1)?", queryTemplate: "SELECT COUNT(*) FROM prodotti WHERE categoria_id = 1", brokenCode: "SELECT COUNT(*) prodotti WHERE categoria_id = 1", debugHint: "Manca la parola chiave FROM.", hints: ["Usa COUNT(*) con WHERE categoria_id = 1"], explanation: "Conteggio filtrato per categoria.", replacements: {} },
            { titleTemplate: "Ordini 2023", descTemplate: "Quanti ordini sono stati effettuati nell'anno 2023?", queryTemplate: "SELECT COUNT(*) FROM ordini WHERE YEAR(data_ordine) = 2023", brokenCode: "SELECT COUNT(*) FROM ordini WHERE YEAR(data_ordine) = 2023;", debugHint: "Rimuovi il punto e virgola.", hints: ["Usa COUNT(*) con WHERE YEAR(data_ordine) = 2023"], explanation: "Conteggio basato su filtro temporale.", replacements: {} },
            { titleTemplate: "Spedizioni DHL", descTemplate: "Quante spedizioni sono state affidate al corriere DHL?", queryTemplate: "SELECT COUNT(*) FROM spedizioni WHERE corriere = 'DHL'", brokenCode: "SELECT COUNT(*) FROM spedizioni WHERE corriere = 'DHL')", debugHint: "C'è una parentesi di troppo.", hints: ["Usa COUNT(*) con WHERE corriere = 'DHL'"], explanation: "Conteggio per specifico corriere.", replacements: {} },
            { titleTemplate: "Recensioni Positive", descTemplate: "Quante recensioni hanno un voto positivo (4 o 5)?", queryTemplate: "SELECT COUNT(*) FROM recensioni WHERE voto >= 4", brokenCode: "SELECT COUNT(*) FROM recensioni WHERE voto >= 4;", debugHint: "Rimuovi il punto e virgola.", hints: ["Usa COUNT(*) con WHERE voto >= 4"], explanation: "Conta le recensioni con voto alto.", replacements: {} },
            { titleTemplate: "Prodotti Costosi", descTemplate: "Quanti prodotti hanno un prezzo superiore a 100€?", queryTemplate: "SELECT COUNT(*) FROM prodotti WHERE prezzo > 100", brokenCode: "SELECT COUNT(*) FROM prodotti WHERE prezzo > 100", debugHint: "Controlla la sintassi.", hints: ["Usa COUNT(*) con WHERE prezzo > 100"], explanation: "Conta i prodotti di fascia alta.", replacements: {} },
            { titleTemplate: "Prodotti Esauriti", descTemplate: "Quanti prodotti sono attualmente esauriti (stock 0)?", queryTemplate: "SELECT COUNT(*) FROM prodotti WHERE stock = 0", brokenCode: "SELECT COUNT(*) FROM prodotti WHERE stock = 0)", debugHint: "Parentesi di troppo.", hints: ["Usa COUNT(*) con WHERE stock = 0"], explanation: "Conta i prodotti non disponibili.", replacements: {} },
            { titleTemplate: "Media Voti Alti", descTemplate: "Qual è la media esatta dei voti considerando solo le recensioni positive (>= 4)?", queryTemplate: "SELECT AVG(voto) FROM recensioni WHERE voto >= 4", brokenCode: "SELECT AVG(voto) FROM recensioni WHERE voto >= 4;", debugHint: "Rimuovi il punto e virgola.", hints: ["Usa AVG(voto) con WHERE voto >= 4"], explanation: "Media calcolata su un sottoinsieme.", replacements: {} },
            { titleTemplate: "Totale Stock Elettronica", descTemplate: "A quanto ammonta lo stock totale per la categoria 'Elettronica' (id 1)?", queryTemplate: "SELECT SUM(stock) FROM prodotti WHERE categoria_id = 1", brokenCode: "SELECT SUM(stock) prodotti WHERE categoria_id = 1", debugHint: "Manca la parola chiave FROM.", hints: ["Usa SUM(stock) con WHERE categoria_id = 1"], explanation: "Totale pezzi per una specifica categoria.", replacements: {} },
            { titleTemplate: "Max Prezzo Fornitore 1", descTemplate: "Qual è il prezzo più alto tra i prodotti del fornitore 1?", queryTemplate: "SELECT MAX(prezzo) FROM prodotti WHERE fornitore_id = 1", brokenCode: "SELECT MAX(prezzo) FROM prodotti WHERE fornitore_id = 1)", debugHint: "Parentesi di troppo.", hints: ["Usa MAX(prezzo) con WHERE fornitore_id = 1"], explanation: "Il prodotto più caro di un fornitore.", replacements: {} },
            { titleTemplate: "Min Prezzo Fornitore 1", descTemplate: "Qual è il prezzo più basso tra i prodotti del fornitore 1?", queryTemplate: "SELECT MIN(prezzo) FROM prodotti WHERE fornitore_id = 1", brokenCode: "SELECT MIN(prezzo) FORM prodotti WHERE fornitore_id = 1", debugHint: "Errore di battitura in FROM.", hints: ["Usa MIN(prezzo) con WHERE fornitore_id = 1"], explanation: "Il prodotto più economico di un fornitore.", replacements: {} },
            { titleTemplate: "Ordini Grandi", descTemplate: "Quanti ordini contengono più di 5 articoli?", queryTemplate: "SELECT COUNT(*) FROM ordini WHERE quantita > 5", brokenCode: "SELECT COUNT(*) FROM ordini WHERE quantita > 5", debugHint: "Controlla la sintassi.", hints: ["Usa COUNT(*) con WHERE quantita > 5"], explanation: "Conta gli ordini voluminosi.", replacements: {} }
        ],
        [Difficulty.Medium]: [
            { titleTemplate: "Ordini per Utente", descTemplate: "Quanti ordini ha effettuato ogni singolo utente?", queryTemplate: "SELECT utente_id, COUNT(*) FROM ordini GROUP BY utente_id", hints: ["Raggruppa per utente e conta i risultati."], explanation: "Mostra il numero di ordini per ciascun cliente.", replacements: {}, brokenCode: "SELECT utente_id, COUNT(*) FROM ordini", debugHint: "Hai usato una funzione di aggregazione senza raggruppare i risultati." },
            { titleTemplate: "Prodotti per Categoria", descTemplate: "Quanti prodotti diversi ci sono in ogni categoria?", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id", hints: ["Raggruppa per categoria e conta i prodotti."], explanation: "Mostra la varietà dell'inventario per categoria.", replacements: {}, brokenCode: "SELECT categoria_id, COUNT(*) FROM prodotti", debugHint: "Manca la clausola che definisce i gruppi." },
            { titleTemplate: "Prodotti per Fornitore", descTemplate: "Quanti prodotti ci fornisce ogni fornitore?", queryTemplate: "SELECT fornitore_id, COUNT(*) FROM prodotti GROUP BY fornitore_id", hints: ["Raggruppa per fornitore e conta i prodotti."], explanation: "Analizza la dipendenza da ciascun fornitore.", replacements: {}, brokenCode: "SELECT fornitore_id, COUNT(*) FROM prodotti", debugHint: "Non puoi selezionare una colonna non aggregata senza GROUP BY." },
            { titleTemplate: "Recensioni per Prodotto", descTemplate: "Quante recensioni ha ricevuto ogni prodotto?", queryTemplate: "SELECT prodotto_id, COUNT(*) FROM recensioni GROUP BY prodotto_id", hints: ["Raggruppa per prodotto e conta le recensioni."], explanation: "Indica la popolarità o la discussione intorno a ogni prodotto.", replacements: {}, brokenCode: "SELECT prodotto_id, COUNT(*) FROM recensioni", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Spedizioni per Corriere", descTemplate: "Quante spedizioni ha gestito ogni corriere?", queryTemplate: "SELECT corriere, COUNT(*) FROM spedizioni GROUP BY corriere", hints: ["Raggruppa per corriere e conta le spedizioni."], explanation: "Mostra il carico di lavoro di ciascun partner logistico.", replacements: {}, brokenCode: "SELECT corriere, COUNT(*) FROM spedizioni", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Stock per Categoria", descTemplate: "Qual è la quantità totale di pezzi (stock) disponibili per ogni categoria?", queryTemplate: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id", hints: ["Raggruppa per categoria e somma lo stock."], explanation: "Mostra la disponibilità fisica di merce per categoria.", replacements: {}, brokenCode: "SELECT categoria_id, SUM(stock) FROM prodotti", debugHint: "Hai dimenticato di raggruppare." },
            { titleTemplate: "Valore Magazzino Categoria", descTemplate: "Qual è il valore economico totale del magazzino per ogni categoria?", queryTemplate: "SELECT categoria_id, SUM(prezzo * stock) FROM prodotti GROUP BY categoria_id", hints: ["Raggruppa per categoria e somma il valore (prezzo * stock)."], explanation: "Analisi del valore immobilizzato per categoria.", replacements: {}, brokenCode: "SELECT categoria_id, SUM(prezzo * stock) FROM prodotti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Media Voti Prodotto", descTemplate: "Qual è il voto medio ottenuto da ogni prodotto?", queryTemplate: "SELECT prodotto_id, AVG(voto) FROM recensioni GROUP BY prodotto_id", hints: ["Raggruppa per prodotto e calcola la media voti."], explanation: "Valutazione della qualità percepita per prodotto.", replacements: {}, brokenCode: "SELECT prodotto_id, AVG(voto) FROM recensioni", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Prezzo Medio Categoria", descTemplate: "Qual è il prezzo medio dei prodotti all'interno di ogni categoria?", queryTemplate: "SELECT categoria_id, AVG(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["Raggruppa per categoria e calcola il prezzo medio."], explanation: "Posizionamento di prezzo per categoria.", replacements: {}, brokenCode: "SELECT categoria_id, AVG(prezzo) FROM prodotti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Prezzo Max Categoria", descTemplate: "Qual è il prezzo del prodotto più costoso in ogni categoria?", queryTemplate: "SELECT categoria_id, MAX(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["Raggruppa per categoria e trova il prezzo massimo."], explanation: "Identifica il prodotto 'flagship' di ogni categoria.", replacements: {}, brokenCode: "SELECT categoria_id, MAX(prezzo) FROM prodotti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Prezzo Min Categoria", descTemplate: "Qual è il prezzo del prodotto più economico in ogni categoria?", queryTemplate: "SELECT categoria_id, MIN(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["Raggruppa per categoria e trova il prezzo minimo."], explanation: "Identifica il prodotto 'entry-level' di ogni categoria.", replacements: {}, brokenCode: "SELECT categoria_id, MIN(prezzo) FROM prodotti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Ordini per Anno", descTemplate: "Quanti ordini abbiamo ricevuto per ogni anno?", queryTemplate: "SELECT YEAR(data_ordine), COUNT(*) FROM ordini GROUP BY YEAR(data_ordine)", hints: ["Raggruppa per anno e conta gli ordini."], explanation: "Trend annuale delle vendite.", replacements: {}, brokenCode: "SELECT YEAR(data_ordine), COUNT(*) FROM ordini", debugHint: "Devi raggruppare per l'anno: GROUP BY YEAR(data_ordine)." },
            { titleTemplate: "Ordini per Mese", descTemplate: "Quanti ordini abbiamo ricevuto per ogni mese (indipendentemente dall'anno)?", queryTemplate: "SELECT MONTH(data_ordine), COUNT(*) FROM ordini GROUP BY MONTH(data_ordine)", hints: ["Raggruppa per mese e conta gli ordini."], explanation: "Stagionalità delle vendite.", replacements: {}, brokenCode: "SELECT MONTH(data_ordine), COUNT(*) FROM ordini", debugHint: "Manca la clausola GROUP BY con la funzione MONTH." },
            { titleTemplate: "Utenti per Nazione", descTemplate: "Quanti utenti sono registrati per ogni nazione?", queryTemplate: "SELECT nazione, COUNT(*) FROM utenti GROUP BY nazione", hints: ["Raggruppa per nazione e conta gli utenti."], explanation: "Distribuzione geografica della clientela.", replacements: {}, brokenCode: "SELECT nazione, COUNT(*) FROM utenti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Fornitori per Nazione", descTemplate: "Quanti fornitori abbiamo in ogni nazione?", queryTemplate: "SELECT nazione, COUNT(*) FROM fornitori GROUP BY nazione", hints: ["Raggruppa per nazione e conta i fornitori."], explanation: "Distribuzione geografica della supply chain.", replacements: {}, brokenCode: "SELECT nazione, COUNT(*) FROM fornitori", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Media Quantità Utente", descTemplate: "Qual è la quantità media di articoli ordinata da ogni utente?", queryTemplate: "SELECT utente_id, AVG(quantita) FROM ordini GROUP BY utente_id", hints: ["Raggruppa per utente e calcola la media quantità."], explanation: "Abitudini di acquisto dei clienti.", replacements: {}, brokenCode: "SELECT utente_id, AVG(quantita) FROM ordini", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Totale Pezzi Utente", descTemplate: "Qual è la somma totale dei pezzi ordinati da ogni utente?", queryTemplate: "SELECT utente_id, SUM(quantita) FROM ordini GROUP BY utente_id", hints: ["Raggruppa per utente e somma le quantità."], explanation: "Volume totale di acquisto per cliente.", replacements: {}, brokenCode: "SELECT utente_id, SUM(quantita) FROM ordini", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Recensioni per Utente", descTemplate: "Quante recensioni ha scritto ogni utente?", queryTemplate: "SELECT utente_id, COUNT(*) FROM recensioni GROUP BY utente_id", hints: ["Raggruppa per utente e conta le recensioni."], explanation: "Livello di engagement degli utenti.", replacements: {}, brokenCode: "SELECT utente_id, COUNT(*) FROM recensioni", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Media Voti Utente", descTemplate: "Qual è il voto medio assegnato da ogni utente nelle sue recensioni?", queryTemplate: "SELECT utente_id, AVG(voto) FROM recensioni GROUP BY utente_id", hints: ["Raggruppa per utente e calcola la media voti."], explanation: "Tendenza di voto di ogni utente (severo vs generoso).", replacements: {}, brokenCode: "SELECT utente_id, AVG(voto) FROM recensioni", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Prodotti per Prezzo", descTemplate: "Quanti prodotti esistono per ogni fascia di prezzo esatta?", queryTemplate: "SELECT prezzo, COUNT(*) FROM prodotti GROUP BY prezzo", hints: ["Raggruppa per prezzo e conta i prodotti."], explanation: "Distribuzione dei prodotti per prezzo.", replacements: {}, brokenCode: "SELECT prezzo, COUNT(*) FROM prodotti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Utenti Premium", descTemplate: "Quanti utenti sono Premium e quanti no?", queryTemplate: "SELECT premium, COUNT(*) FROM utenti GROUP BY premium", hints: ["Raggruppa per stato premium e conta."], explanation: "Composizione della base utenti.", replacements: {}, brokenCode: "SELECT premium, COUNT(*) FROM utenti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Spedizioni per Stato", descTemplate: "Quante spedizioni ci sono per ogni stato di consegna?", queryTemplate: "SELECT stato, COUNT(*) FROM spedizioni GROUP BY stato", hints: ["Raggruppa per stato e conta le spedizioni."], explanation: "Monitoraggio dello stato delle consegne.", replacements: {}, brokenCode: "SELECT stato, COUNT(*) FROM spedizioni", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Stock per Fornitore", descTemplate: "Quanto stock totale abbiamo ricevuto da ogni fornitore?", queryTemplate: "SELECT fornitore_id, SUM(stock) FROM prodotti GROUP BY fornitore_id", hints: ["Raggruppa per fornitore e somma lo stock."], explanation: "Volume di merce gestito per fornitore.", replacements: {}, brokenCode: "SELECT fornitore_id, SUM(stock) FROM prodotti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Media Prezzo Fornitore", descTemplate: "Qual è il prezzo medio dei prodotti offerti da ogni fornitore?", queryTemplate: "SELECT fornitore_id, AVG(prezzo) FROM prodotti GROUP BY fornitore_id", hints: ["Raggruppa per fornitore e calcola il prezzo medio."], explanation: "Posizionamento di prezzo dei fornitori.", replacements: {}, brokenCode: "SELECT fornitore_id, AVG(prezzo) FROM prodotti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Max Stock Categoria", descTemplate: "Qual è la giacenza massima per un singolo prodotto in ogni categoria?", queryTemplate: "SELECT categoria_id, MAX(stock) FROM prodotti GROUP BY categoria_id", hints: ["Raggruppa per categoria e trova lo stock massimo."], explanation: "Picchi di inventario per categoria.", replacements: {}, brokenCode: "SELECT categoria_id, MAX(stock) FROM prodotti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Min Voto Prodotto", descTemplate: "Qual è il voto più basso ricevuto da ogni prodotto?", queryTemplate: "SELECT prodotto_id, MIN(voto) FROM recensioni GROUP BY prodotto_id", hints: ["Raggruppa per prodotto e trova il voto minimo."], explanation: "Punti critici per ogni prodotto.", replacements: {}, brokenCode: "SELECT prodotto_id, MIN(voto) FROM recensioni", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Conteggio e Media Categoria", descTemplate: "Per ogni categoria, quanti prodotti ci sono e qual è il loro prezzo medio?", queryTemplate: "SELECT categoria_id, COUNT(*), AVG(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["Raggruppa per categoria, conta e calcola la media."], explanation: "Panoramica completa per categoria.", replacements: {}, brokenCode: "SELECT categoria_id, COUNT(*), AVG(prezzo) FROM prodotti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Totale e Media Stock Fornitore", descTemplate: "Per ogni fornitore, qual è lo stock totale e quello medio?", queryTemplate: "SELECT fornitore_id, SUM(stock), AVG(stock) FROM prodotti GROUP BY fornitore_id", hints: ["Raggruppa per fornitore, somma e calcola la media."], explanation: "Analisi approfondita dello stock per fornitore.", replacements: {}, brokenCode: "SELECT fornitore_id, SUM(stock), AVG(stock) FROM prodotti", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Distribuzione Voti", descTemplate: "Quante recensioni ci sono per ogni voto (1, 2, 3, 4, 5)?", queryTemplate: "SELECT voto, COUNT(*) FROM recensioni GROUP BY voto", hints: ["Raggruppa per voto e conta le recensioni."], explanation: "Istogramma dei voti.", replacements: {}, brokenCode: "SELECT voto, COUNT(*) FROM recensioni", debugHint: "Manca la clausola GROUP BY." },
            { titleTemplate: "Ordini per Giorno", descTemplate: "Quanti ordini riceviamo per ogni giorno del mese?", queryTemplate: "SELECT DAY(data_ordine), COUNT(*) FROM ordini GROUP BY DAY(data_ordine)", hints: ["Raggruppa per giorno e conta gli ordini."], explanation: "Analisi giornaliera delle vendite.", replacements: {}, brokenCode: "SELECT DAY(data_ordine), COUNT(*) FROM ordini", debugHint: "Manca la clausola GROUP BY con la funzione DAY." }
        ],
        [Difficulty.Hard]: [
            { titleTemplate: "Categorie Popolose", descTemplate: "Quali categorie hanno più di 10 prodotti?", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) > 10", hints: ["Raggruppa per categoria e filtra i gruppi basandoti sul conteggio."], explanation: "Filtra i gruppi che hanno un conteggio superiore a 10.", replacements: {}, brokenCode: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id WHERE COUNT(*) > 10", debugHint: "Usa HAVING invece di WHERE per filtrare i gruppi." },
            { titleTemplate: "Fornitori Importanti", descTemplate: "Quali fornitori ci forniscono più di 5 prodotti diversi?", queryTemplate: "SELECT fornitore_id, COUNT(*) FROM prodotti GROUP BY fornitore_id HAVING COUNT(*) > 5", hints: ["Raggruppa per fornitore e filtra i gruppi con molti prodotti."], explanation: "Identifica i fornitori chiave.", replacements: {}, brokenCode: "SELECT fornitore_id, COUNT(*) FROM prodotti GROUP BY fornitore_id HAVING COUNT(*) > 5", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Prodotti Molto Recensiti", descTemplate: "Quali prodotti hanno ricevuto più di 20 recensioni?", queryTemplate: "SELECT prodotto_id, COUNT(*) FROM recensioni GROUP BY prodotto_id HAVING COUNT(*) > 20", hints: ["Raggruppa per prodotto e filtra quelli con molte recensioni."], explanation: "Identifica i prodotti più discussi.", replacements: {}, brokenCode: "SELECT prodotto_id, COUNT(*) FROM recensioni GROUP BY prodotto_id HAVING COUNT(*) > 20", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Corrieri Attivi", descTemplate: "Quali corrieri hanno gestito più di 50 spedizioni?", queryTemplate: "SELECT corriere, COUNT(*) FROM spedizioni GROUP BY corriere HAVING COUNT(*) > 50", hints: ["Raggruppa per corriere e filtra per volume di spedizioni."], explanation: "Identifica i partner logistici principali.", replacements: {}, brokenCode: "SELECT corriere, COUNT(*) FROM spedizioni GROUP BY corriere HAVING COUNT(*) > 50", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Categorie con Molto Stock", descTemplate: "Quali categorie hanno uno stock totale superiore a 1000 pezzi?", queryTemplate: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id HAVING SUM(stock) > 1000", hints: ["Raggruppa per categoria e filtra in base alla somma dello stock."], explanation: "Filtra le categorie con alta disponibilità.", replacements: {}, brokenCode: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id WHERE SUM(stock) > 1000", debugHint: "Usa HAVING per le aggregazioni." },
            { titleTemplate: "Categorie di Valore", descTemplate: "Quali categorie hanno un valore di magazzino superiore a 5000€?", queryTemplate: "SELECT categoria_id, SUM(prezzo * stock) FROM prodotti GROUP BY categoria_id HAVING SUM(prezzo * stock) > 5000", hints: ["Raggruppa per categoria e filtra in base al valore totale calcolato."], explanation: "Identifica le categorie con più capitale investito.", replacements: {}, brokenCode: "SELECT categoria_id, SUM(prezzo * stock) FROM prodotti GROUP BY categoria_id HAVING SUM(prezzo * stock) > 5000", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Prodotti Apprezzati", descTemplate: "Quali prodotti hanno una media voti superiore a 4.5?", queryTemplate: "SELECT prodotto_id, AVG(voto) FROM recensioni GROUP BY prodotto_id HAVING AVG(voto) > 4.5", hints: ["Raggruppa per prodotto e filtra in base alla media dei voti."], explanation: "Trova i prodotti con rating eccellente.", replacements: {}, brokenCode: "SELECT prodotto_id, AVG(voto) FROM recensioni GROUP BY prodotto_id WHERE AVG(voto) > 4.5", debugHint: "Usa HAVING per le aggregazioni." },
            { titleTemplate: "Prodotti Critici", descTemplate: "Quali prodotti hanno una media voti inferiore a 2?", queryTemplate: "SELECT prodotto_id, AVG(voto) FROM recensioni GROUP BY prodotto_id HAVING AVG(voto) < 2", hints: ["Raggruppa per prodotto e filtra quelli con media voti bassa."], explanation: "Trova i prodotti con gravi problemi di qualità percepita.", replacements: {}, brokenCode: "SELECT prodotto_id, AVG(voto) FROM recensioni GROUP BY prodotto_id HAVING AVG(voto) < 2", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Categorie Costose", descTemplate: "Quali categorie hanno un prezzo medio superiore a 50€?", queryTemplate: "SELECT categoria_id, AVG(prezzo) FROM prodotti GROUP BY categoria_id HAVING AVG(prezzo) > 50", hints: ["Raggruppa per categoria e filtra quelle con prezzo medio alto."], explanation: "Identifica le categorie di fascia alta.", replacements: {}, brokenCode: "SELECT categoria_id, AVG(prezzo) FROM prodotti GROUP BY categoria_id HAVING AVG(prezzo) > 50", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Anni Record", descTemplate: "In quali anni abbiamo ricevuto più di 1000 ordini?", queryTemplate: "SELECT YEAR(data_ordine), COUNT(*) FROM ordini GROUP BY YEAR(data_ordine) HAVING COUNT(*) > 1000", hints: ["Raggruppa per anno e filtra quelli con molti ordini."], explanation: "Identifica gli anni con performance eccezionali.", replacements: {}, brokenCode: "SELECT YEAR(data_ordine), COUNT(*) FROM ordini GROUP BY YEAR(data_ordine) HAVING COUNT(*) > 1000", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Mesi Caldi", descTemplate: "In quali mesi (di qualsiasi anno) si superano i 500 ordini?", queryTemplate: "SELECT MONTH(data_ordine), COUNT(*) FROM ordini GROUP BY MONTH(data_ordine) HAVING COUNT(*) > 500", hints: ["Raggruppa per mese e filtra quelli con molti ordini."], explanation: "Identifica i mesi di picco stagionale.", replacements: {}, brokenCode: "SELECT MONTH(data_ordine), COUNT(*) FROM ordini GROUP BY MONTH(data_ordine) HAVING COUNT(*) > 500", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Nazioni Principali", descTemplate: "Quali nazioni hanno più di 100 utenti registrati?", queryTemplate: "SELECT nazione, COUNT(*) FROM utenti GROUP BY nazione HAVING COUNT(*) > 100", hints: ["Raggruppa per nazione e filtra quelle con molti utenti."], explanation: "Identifica i mercati principali.", replacements: {}, brokenCode: "SELECT nazione, COUNT(*) FROM utenti GROUP BY nazione HAVING COUNT(*) > 100", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Fornitori di Nicchia", descTemplate: "Quali fornitori hanno meno di 3 prodotti a catalogo?", queryTemplate: "SELECT fornitore_id, COUNT(*) FROM prodotti GROUP BY fornitore_id HAVING COUNT(*) < 3", hints: ["Raggruppa per fornitore e filtra quelli con pochi prodotti."], explanation: "Identifica i fornitori minori.", replacements: {}, brokenCode: "SELECT fornitore_id, COUNT(*) FROM prodotti GROUP BY fornitore_id HAVING COUNT(*) < 3", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Categorie Piccole", descTemplate: "Quali categorie hanno meno di 5 prodotti?", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) < 5", hints: ["Raggruppa per categoria e filtra quelle con pochi prodotti."], explanation: "Identifica le categorie meno popolate.", replacements: {}, brokenCode: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) < 5", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Ordini Multipli", descTemplate: "Quali utenti hanno effettuato più di 1 ordine?", queryTemplate: "SELECT utente_id, COUNT(*) FROM ordini GROUP BY utente_id HAVING COUNT(*) > 1", hints: ["Raggruppa per utente e filtra chi ha più ordini."], explanation: "Identifica i clienti ricorrenti.", replacements: {}, brokenCode: "SELECT utente_id, COUNT(*) FROM ordini GROUP BY utente_id HAVING COUNT(*) > 1", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Recensori Attivi", descTemplate: "Quali utenti hanno scritto più di 3 recensioni?", queryTemplate: "SELECT utente_id, COUNT(*) FROM recensioni GROUP BY utente_id HAVING COUNT(*) > 3", hints: ["Raggruppa per utente e filtra chi ha molte recensioni."], explanation: "Identifica i top contributor.", replacements: {}, brokenCode: "SELECT utente_id, COUNT(*) FROM recensioni GROUP BY utente_id HAVING COUNT(*) > 3", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Spedizioni Frequenti", descTemplate: "Quali corrieri hanno gestito più di 100 spedizioni?", queryTemplate: "SELECT corriere, COUNT(*) FROM spedizioni GROUP BY corriere HAVING COUNT(*) > 100", hints: ["Raggruppa per corriere e filtra per alto volume."], explanation: "Identifica i corrieri più utilizzati.", replacements: {}, brokenCode: "SELECT corriere, COUNT(*) FROM spedizioni GROUP BY corriere HAVING COUNT(*) > 100", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Stock Critico Categoria", descTemplate: "Quali categorie hanno uno stock totale inferiore a 50?", queryTemplate: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id HAVING SUM(stock) < 50", hints: ["Raggruppa per categoria e filtra per stock totale basso."], explanation: "Allerta per categorie quasi esaurite.", replacements: {}, brokenCode: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id HAVING SUM(stock) < 50", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Valore Basso Categoria", descTemplate: "Quali categorie hanno un valore totale di magazzino inferiore a 1000€?", queryTemplate: "SELECT categoria_id, SUM(prezzo * stock) FROM prodotti GROUP BY categoria_id HAVING SUM(prezzo * stock) < 1000", hints: ["Raggruppa per categoria e filtra in base al valore totale calcolato."], explanation: "Identifica categorie con poco valore immobilizzato.", replacements: {}, brokenCode: "SELECT categoria_id, SUM(prezzo * stock) FROM prodotti GROUP BY categoria_id HAVING SUM(prezzo * stock) < 1000", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Media Voti Bassa", descTemplate: "Quali prodotti hanno una media voti inferiore a 3?", queryTemplate: "SELECT prodotto_id, AVG(voto) FROM recensioni GROUP BY prodotto_id HAVING AVG(voto) < 3", hints: ["Raggruppa per prodotto e filtra in base alla media dei voti."], explanation: "Prodotti che necessitano attenzione.", replacements: {}, brokenCode: "SELECT prodotto_id, AVG(voto) FROM recensioni GROUP BY prodotto_id HAVING AVG(voto) < 3", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Prezzo Medio Basso", descTemplate: "Quali categorie hanno un prezzo medio inferiore a 20€?", queryTemplate: "SELECT categoria_id, AVG(prezzo) FROM prodotti GROUP BY categoria_id HAVING AVG(prezzo) < 20", hints: ["Raggruppa per categoria e filtra quelle con prezzo medio basso."], explanation: "Identifica categorie budget.", replacements: {}, brokenCode: "SELECT categoria_id, AVG(prezzo) FROM prodotti GROUP BY categoria_id HAVING AVG(prezzo) < 20", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Anni con Pochi Ordini", descTemplate: "In quali anni abbiamo ricevuto meno di 500 ordini?", queryTemplate: "SELECT YEAR(data_ordine), COUNT(*) FROM ordini GROUP BY YEAR(data_ordine) HAVING COUNT(*) < 500", hints: ["Raggruppa per anno e filtra quelli con pochi ordini."], explanation: "Analisi storica dei periodi di calma.", replacements: {}, brokenCode: "SELECT YEAR(data_ordine), COUNT(*) FROM ordini GROUP BY YEAR(data_ordine) HAVING COUNT(*) < 500", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Mesi con Pochi Ordini", descTemplate: "In quali mesi ci sono meno di 100 ordini?", queryTemplate: "SELECT MONTH(data_ordine), COUNT(*) FROM ordini GROUP BY MONTH(data_ordine) HAVING COUNT(*) < 100", hints: ["Raggruppa per mese e filtra quelli con pochi ordini."], explanation: "Identifica la bassa stagionalità.", replacements: {}, brokenCode: "SELECT MONTH(data_ordine), COUNT(*) FROM ordini GROUP BY MONTH(data_ordine) HAVING COUNT(*) < 100", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Nazioni con Pochi Utenti", descTemplate: "Quali nazioni hanno meno di 10 utenti registrati?", queryTemplate: "SELECT nazione, COUNT(*) FROM utenti GROUP BY nazione HAVING COUNT(*) < 10", hints: ["Raggruppa per nazione e filtra quelle con pochi utenti."], explanation: "Identifica aree con poca penetrazione.", replacements: {}, brokenCode: "SELECT nazione, COUNT(*) FROM utenti GROUP BY nazione HAVING COUNT(*) < 10", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Fornitori Esclusivi", descTemplate: "Quali fornitori ci forniscono esattamente 1 prodotto?", queryTemplate: "SELECT fornitore_id, COUNT(*) FROM prodotti GROUP BY fornitore_id HAVING COUNT(*) = 1", hints: ["Raggruppa per fornitore e filtra chi ha un solo prodotto."], explanation: "Identifica fornitori mono-prodotto.", replacements: {}, brokenCode: "SELECT fornitore_id, COUNT(*) FROM prodotti GROUP BY fornitore_id HAVING COUNT(*) = 1", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Categorie Uniche", descTemplate: "Quali categorie hanno esattamente 1 prodotto?", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) = 1", hints: ["Raggruppa per categoria e filtra chi ha un solo prodotto."], explanation: "Identifica categorie mono-prodotto.", replacements: {}, brokenCode: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) = 1", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Utenti Singolo Ordine", descTemplate: "Quali utenti hanno effettuato esattamente 1 ordine?", queryTemplate: "SELECT utente_id, COUNT(*) FROM ordini GROUP BY utente_id HAVING COUNT(*) = 1", hints: ["Raggruppa per utente e filtra chi ha fatto un solo ordine."], explanation: "Identifica clienti one-shot.", replacements: {}, brokenCode: "SELECT utente_id, COUNT(*) FROM ordini GROUP BY utente_id HAVING COUNT(*) = 1", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Recensori Singoli", descTemplate: "Quali utenti hanno scritto esattamente 1 recensione?", queryTemplate: "SELECT utente_id, COUNT(*) FROM recensioni GROUP BY utente_id HAVING COUNT(*) = 1", hints: ["Raggruppa per utente e filtra chi ha scritto una sola recensione."], explanation: "Identifica recensori occasionali.", replacements: {}, brokenCode: "SELECT utente_id, COUNT(*) FROM recensioni GROUP BY utente_id HAVING COUNT(*) = 1", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Corrieri Poco Usati", descTemplate: "Quali corrieri hanno gestito meno di 10 spedizioni?", queryTemplate: "SELECT corriere, COUNT(*) FROM spedizioni GROUP BY corriere HAVING COUNT(*) < 10", hints: ["Raggruppa per corriere e filtra per bassi volumi."], explanation: "Identifica partner logistici marginali.", replacements: {}, brokenCode: "SELECT corriere, COUNT(*) FROM spedizioni GROUP BY corriere HAVING COUNT(*) < 10", debugHint: "Controlla la sintassi." },
            { titleTemplate: "Stock Medio Alto", descTemplate: "Quali categorie hanno uno stock medio superiore a 20?", queryTemplate: "SELECT categoria_id, AVG(stock) FROM prodotti GROUP BY categoria_id HAVING AVG(stock) > 20", hints: ["Raggruppa per categoria e filtra dove la media stock è alta."], explanation: "Identifica categorie con buona disponibilità media.", replacements: {}, brokenCode: "SELECT categoria_id, AVG(stock) FROM prodotti GROUP BY categoria_id HAVING AVG(stock) > 20", debugHint: "Controlla la sintassi." }
        ],
    },
    [TopicId.Case]: {
        [Difficulty.Easy]: [
