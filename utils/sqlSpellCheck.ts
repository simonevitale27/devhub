...
const COMMON_ITALIAN_WORDS = [
  ...
  // Aggettivi & Qualità
  'ALTO', 'BASSO', 'MEDIO', 'GRANDE', 'PICCOLO', 'NUOVO', 'VECCHIO',
  'BUONO', 'CATTIVO', 'OTTIMO', 'PESSIMO', 'PRIMO', 'ULTIMO',
  'GIUSTO', 'ERRATO', 'CORRETTO', 'SBAGLIATO',
  'INTERO', 'PARZIALE', 'LORDO', 'NETTO',
  'UNICO', 'MULTIPLO', 'SINGOLO', 'DOPPIO', 'TRIPLO',
  'MASCHILE', 'FEMMINILE', 'COMUNE', 'SPECIALE', 'GENERALE',
  'PRINCIPALE', 'SECONDARIO', 'ESTERNO', 'INTERNO',
  'NAZIONALE', 'INTERNAZIONALE', 'LOCALE', 'GLOBALE',
  'DIRETTO', 'INDIRETTO', 'ATTIVO', 'PASSIVO',
  'POSITIVO', 'NEGATIVO', 'NEUTRO',
  'ALTA', 'BASSA', 'MEDIA', 'PICCOLA', 'NUOVA', 'VECCHIA',
  'PRIMA', 'ULTIMA', 'VERA', 'FALSA', 'GIUSTA', 'ERRATA',
  'PIENA', 'VUOTA', 'INTERA', 'UNICA', 'MULTIPLA', 'SINGOLA', 'DOPPIA',
...
const COMMON_ENGLISH_WORDS = [
  ...
  'HIGH', 'LOW', 'MEDIUM', 'AVERAGE', 'BIG', 'SMALL', 'LARGE', 'TINY',
  'NEW', 'OLD', 'GOOD', 'BAD', 'BEST', 'WORST', 'FIRST', 'LAST',
  'RIGHT', 'WRONG', 'CORRECT', 'INCORRECT', 'TRUE', 'FALSE',
  'FULL', 'EMPTY', 'WHOLE', 'PARTIAL', 'GROSS', 'NET',
  'SINGLE', 'DOUBLE', 'TRIPLE', 'MULTIPLE', 'UNIQUE',
  'MALE', 'FEMALE', 'COMMON', 'SPECIAL', 'GENERAL',
  'MAIN', 'PRIMARY', 'SECONDARY', 'EXTERNAL', 'INTERNAL',
  'NATIONAL', 'INTERNATIONAL', 'LOCAL', 'GLOBAL',
  'PUBLIC', 'PRIVATE', 'SOCIAL', 'PERSONAL',
  ...
  // Business, Marketing & Tech Terms
  'PREMIUM', 'PLUS', 'PRO', 'MAX', 'ULTRA', 'BASIC', 'STANDARD', 'ADVANCED',
  'ENTERPRISE', 'SUBSCRIPTION', 'PLAN', 'TIER', 'FEATURE', 'UPGRADE', 'DOWNGRADE',
  'TRIAL', 'DEMO', 'BETA', 'ALPHA', 'RELEASE', 'VERSION', 'EDITION', 'BUNDLE',
  'PACKAGE', 'DISCOUNT', 'COUPON', 'VOUCHER', 'LOYALTY', 'REWARD', 'POINT',
  'SCORE', 'RANK', 'LEVEL', 'BADGE', 'ACHIEVEMENT', 'GOAL', 'TARGET', 'KPI',
  'METRIC', 'ANALYTIC', 'REPORT', 'DASHBOARD', 'WIDGET', 'CHART', 'GRAPH',
  'TABLE', 'LIST', 'GRID', 'VIEW', 'FORM', 'INPUT', 'OUTPUT', 'UPLOAD',
  'DOWNLOAD', 'IMPORT', 'EXPORT', 'SYNC', 'BACKUP', 'RESTORE', 'ARCHIVE',
  'TRASH', 'DELETE', 'REMOVE', 'ADD', 'CREATE', 'EDIT', 'UPDATE', 'SAVE',
  'CANCEL', 'CLOSE', 'OPEN', 'LOCK', 'UNLOCK', 'BLOCK', 'UNBLOCK', 'BAN',
  'UNBAN', 'SUSPEND', 'ACTIVATE', 'DEACTIVATE', 'ENABLE', 'DISABLE', 'VERIFY',
  'CONFIRM', 'APPROVE', 'REJECT', 'PENDING', 'PROCESSING', 'COMPLETED',
  'FAILED', 'ERROR', 'SUCCESS', 'WARNING', 'INFO', 'DEBUG', 'TRACE', 'LOG',
  'AUDIT', 'HISTORY', 'SESSION', 'COOKIE', 'CACHE', 'TOKEN', 'KEY', 'SECRET',
  'PASSWORD', 'USERNAME', 'EMAIL', 'PHONE', 'ADDRESS', 'CITY', 'STATE', 'ZIP',
  'COUNTRY', 'LANGUAGE', 'CURRENCY', 'TIMEZONE', 'LOCALE', 'THEME', 'MODE',
  'STYLE', 'COLOR', 'FONT', 'ICON', 'IMAGE', 'VIDEO', 'AUDIO', 'FILE',
  'FOLDER', 'DIRECTORY', 'PATH', 'URL', 'LINK', 'HREF', 'SRC', 'ALT', 'TITLE',
  'DESC', 'CONTENT', 'BODY', 'HEADER', 'FOOTER', 'SIDEBAR', 'MENU', 'NAV',
  'TAB', 'CARD', 'MODAL', 'DIALOG', 'TOAST', 'ALERT', 'NOTIFICATION', 'MESSAGE',
  'CHAT', 'COMMENT', 'POST', 'LIKE', 'SHARE', 'FOLLOW', 'SUBSCRIBE',
  'UNSUBSCRIBE', 'JOIN', 'LEAVE', 'INVITE', 'MEMBER', 'GROUP', 'TEAM', 'ROLE',
  'PERMISSION', 'POLICY', 'RULE', 'SETTING', 'CONFIG', 'OPTION', 'PREFERENCE',
  'PROFILE', 'ACCOUNT', 'BILLING', 'PAYMENT', 'INVOICE', 'RECEIPT', 'ORDER',
  'CART', 'CHECKOUT', 'SHIPPING', 'TAX', 'VAT', 'SUBTOTAL', 'TOTAL', 'AMOUNT',
  'QUANTITY', 'PRICE', 'COST', 'VALUE', 'ID', 'UUID', 'GUID', 'HASH', 'SALT',
  'ENCRYPTION', 'DECRYPTION', 'SECURITY', 'PRIVACY', 'TERMS', 'CONDITION',
  'POLICY', 'AGREEMENT', 'LICENSE', 'COPYRIGHT', 'TRADEMARK', 'BRAND', 'LOGO',
  'BANNER', 'HERO', 'SLIDER', 'CAROUSEL', 'GALLERY', 'LISTING', 'DETAIL',
  'SUMMARY', 'REVIEW', 'RATING', 'STAR', 'VOTE', 'POLL', 'SURVEY', 'QUIZ',
  'TEST', 'EXAM', 'RESULT', 'ANSWER', 'QUESTION', 'FAQ', 'HELP', 'SUPPORT',
  'CONTACT', 'ABOUT', 'HOME', 'LANDING', 'PAGE', 'SITE', 'APP', 'WEB',
  'MOBILE', 'DESKTOP', 'TABLET', 'WATCH', 'TV', 'CAR', 'IOT', 'AI', 'ML',
  'DATA', 'SCIENCE', 'CLOUD', 'SERVER', 'CLIENT', 'API', 'SDK', 'LIB',
  'FRAMEWORK', 'PLUGIN', 'EXTENSION', 'MODULE', 'COMPONENT', 'WIDGET', 'TOOL',
  'UTILITY', 'HELPER', 'SERVICE', 'PROVIDER', 'FACTORY', 'REPOSITORY',
  'CONTROLLER', 'MODEL', 'VIEW', 'ROUTE', 'MIDDLEWARE', 'GUARD', 'INTERCEPTOR',
  'PIPE', 'DIRECTIVE', 'DECORATOR', 'ANNOTATION', 'INTERFACE', 'CLASS', 'ENUM',
  'TYPE', 'CONST', 'VAR', 'LET', 'FUNCTION', 'METHOD', 'PROPERTY', 'FIELD',
  'ATTRIBUTE', 'PARAM', 'ARG', 'RETURN', 'VOID', 'NULL', 'UNDEFINED', 'NAN',
  'INFINITY', 'TRUE', 'FALSE', 'BOOLEAN', 'NUMBER', 'STRING', 'OBJECT',
  'ARRAY', 'MAP', 'SET', 'DATE', 'REGEX', 'PROMISE', 'OBSERVABLE', 'SUBJECT',
  'STREAM', 'EVENT', 'LISTENER', 'HANDLER', 'CALLBACK', 'ASYNC', 'AWAIT',
