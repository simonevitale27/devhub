...
const EditorToggle: React.FC<EditorToggleProps> = ({ activeEditor, onToggle, disabled = false }) => {
    ...
    return (
        <div className="relative flex bg-[#121212]/70 backdrop-blur-xl rounded-xl p-1 shadow-lg shadow-black/20 w-52">
            {/* Sliding Pill */}
            <div
            ...
            <button
                ...
                disabled={disabled}
                className={`relative z-10 flex-1 text-[11px] font-black tracking-widest py-2 px-4 rounded-lg transition-colors text-center flex items-center justify-center gap-2 uppercase ${
                    isSql
