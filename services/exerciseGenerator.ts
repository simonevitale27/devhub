...
const DATA = {
    ...
    names: ['Marco', 'Giulia', 'Luca', 'Alice', 'Matteo', 'Francesca', 'Roberto', 'Elena'],
    categories: ['Elettronica', 'Casa', 'Abbigliamento', 'Libri', 'Giardinaggio', 'Sport', 'Beauty'],
    suppliers: ['TechSolutions', 'SoftWareHouse', 'LogisticaVelocissima', 'FreshFoods', 'GlobalTrade', 'Nordic Supplies'],
...
const QUESTION_DATABASE: Record<string, Record<string, ExerciseBlueprint[]>> = {
        ...
        [Difficulty.Easy]: [
            {
                ...
                descTemplate: "Il Responsabile IT ha richiesto un dump completo della tabella '{table}' per un controllo di sicurezza e integrità dei dati. Esegui una query per estrarre tutte le righe e tutte le colonne.",
                queryTemplate: "SELECT * FROM {table}",
                hints: ["Usa l'asterisco (*) per selezionare tutte le colonne.", "La sintassi base è: SELECT * FROM nome_tabella;", "Assicurati di scrivere correttamente il nome della tabella."],
                explanation: "SELECT * è il comando standard per ispezionare l'intero contenuto di una tabella senza filtri.",
                replacements: { table: ['utenti', 'prodotti', 'ordini', 'fornitori', 'spedizioni', 'categorie', 'recensioni'] }
            },
            {
                titleTemplate: "Estrazione {col} Utenti",
                descTemplate: "Il team di Marketing sta preparando una campagna email. Hanno bisogno di una lista che contenga solo la colonna '{col}' dalla tabella degli utenti, per rispettare le normative sulla privacy ed evitare di esporre dati sensibili non necessari.",
                queryTemplate: "SELECT {col} FROM utenti",
                hints: ["Indica il nome della colonna '{col}' subito dopo SELECT.", "Non usare * se ti serve solo una colonna specifica.", "La sintassi è: SELECT colonna FROM tabella;"],
                explanation: "Selezionare solo le colonne necessarie riduce il traffico di rete e protegge i dati sensibili.",
                replacements: { col: ['email', 'nome', 'paese', 'premium'] }
            },
            {
                titleTemplate: "Listino Prezzi: {col}",
                descTemplate: "Il Direttore Vendite vuole analizzare rapidamente i dati dei prodotti. Genera un report che mostri esclusivamente la colonna '{col}' di tutti i prodotti a catalogo.",
                queryTemplate: "SELECT {col} FROM prodotti",
                hints: ["Scrivi SELECT seguito dal nome della colonna '{col}'.", "Specifica la tabella di origine con FROM prodotti.", "Verifica di non aver incluso altre colonne."],
                explanation: "La proiezione (selezione di colonne specifiche) è fondamentale per report focalizzati.",
            ...
            // NEW EXERCISES FOR BASICS EASY
            {
                ...
                replacements: { table: ['utenti', 'prodotti', 'ordini', 'categorie'] }
            },
            {
        ...
        [Difficulty.Medium]: [
            {
                ...
                descTemplate: "Il report esportato deve avere intestazioni personalizzate. Seleziona la colonna '{col}' dei prodotti e rinominala come 'Info_Principale' utilizzando l'alias AS.",
                queryTemplate: "SELECT {col} AS Info_Principale FROM prodotti",
                hints: ["Usa la keyword AS subito dopo il nome della colonna.", "Sintassi: SELECT {col} AS Info_Principale FROM prodotti"],
                explanation: "Rinominare le colonne nei risultati aiuta a rendere i report più comprensibili.",
                replacements: {
            ...
            },
            {
                ...
                descTemplate: "Il CRM richiede che il campo 'nome' dalla tabella utenti sia etichettato come 'Nome_Cliente'. Estrai i nomi degli utenti applicando esattamente questo alias (scritto con underscore).",
                queryTemplate: "SELECT nome AS Nome_Cliente FROM utenti",
                hints: ["Usa la parola chiave AS seguita dal nuovo nome.", "Sintassi corretta: SELECT nome AS Nome_Cliente FROM utenti"],
                explanation: "Gli alias permettono di rinominare le colonne nei risultati per adattarli alle esigenze di visualiz zazione.",
                replacements: {}
            },
            {
                titleTemplate: "Alias Email Utente",
                descTemplate: "Per l'integrazione con il tool di marketing, estrai la colonna 'email' dalla tabella utenti rinominandola esattamente come 'Indirizzo_Email' (con underscore tra le due parole).",
                queryTemplate: "SELECT email AS Indirizzo_Email FROM utenti",
                hints: ["Sintassi corretta: SELECT email AS Indirizzo_Email FROM utenti", "Attenzione all'underscore e alle maiuscole"],
            ...
            },
            {
                ...
                descTemplate: "Il listino ufficiale richiede che la colonna 'prezzo' dalla tabella prodotti sia mostrata come 'Prezzo_Vendita' (con underscore). Genera la query con questo alias specifico.",
                queryTemplate: "SELECT prezzo AS Prezzo_Vendita FROM prodotti",
                hints: ["Sintassi corretta: SELECT prezzo AS Prezzo_Vendita FROM prodotti", "Rispetta maiuscole e underscore"],
            ...
            },
            {
                ...
                descTemplate: "Il report di inventario deve mostrare la colonna 'stock' dalla tabella prodotti con l'intestazione 'Quantita_Magazzino' (scritto esattamente così, con underscore).",
                queryTemplate: "SELECT stock AS Quantita_Magazzino FROM prodotti",
                hints: ["Sintassi corretta: SELECT stock AS Quantita_Magazzino FROM prodotti", "Questo cambierà solo il nome visualizzato, non quello nel database."],
            ...
            },
            {
                ...
                descTemplate: "Genera un report dalla tabella prodotti dove la colonna 'nome' è rinominata come 'Prodotto' e la colonna 'prezzo' è rinominata come 'Costo' (rispetta le maiuscole esatte).",
                queryTemplate: "SELECT nome AS Prodotto, prezzo AS Costo FROM prodotti",
                hints: ["Puoi usare AS più volte nella stessa query.", "Separa le definizioni di colonna con una virgola."],
                explanation: "Rinominare più colonne aiuta a creare report completamente personalizzati.",
                replacements: {}
            },
            {
                titleTemplate: "Alias Multipli Utenti",
                descTemplate: "Il team internazionale vuole un report dalla tabella utenti con intestazioni standard: rinomina 'nome' come 'Cliente', 'email' come 'Contatto', e 'paese' come 'Nazione' (rispetta le maiuscole esatte).",
                queryTemplate: "SELECT nome AS Cliente, email AS Contatto, paese AS Nazione FROM utenti",
                hints: ["Applica un alias per ciascuna delle tre colonne.", "Mantieni l'ordine richiesto."],
        ...
        [Difficulty.Hard]: [
            {
                ...
                descTemplate: "Vogliamo sapere in quali paesi operiamo effettivamente. Estrai la lista dei paesi dalla tabella utenti, rimuovendo qualsiasi duplicato.",
                queryTemplate: "SELECT DISTINCT paese FROM utenti",
                hints: ["Usa la keyword DISTINCT subito dopo SELECT"],
            ...
            },
            {
                ...
                descTemplate: "Estrai i paesi unici degli utenti e rinominali come 'Nazioni_Operative'.",
                queryTemplate: "SELECT DISTINCT paese AS Nazioni_Operative FROM utenti",
                hints: ["Combina DISTINCT con AS", "SELECT DISTINCT paese AS Nazioni_Operative FROM utenti"],
    ...
    [TopicId.Filtering]: {
        [Difficulty.Easy]: [
            {
                ...
                descTemplate: "Il responsabile di magazzino vuole verificare l'inventario. Trova tutti i prodotti che hanno esattamente {val} unità in giacenza.",
                queryTemplate: "SELECT * FROM prodotti WHERE stock = {val}",
                hints: ["Usa la clausola WHERE per filtrare i risultati.", "L'operatore di uguaglianza è =."],
            ...
            },
            {
                ...
                hints: ["Ricorda di racchiudere i valori di testo tra apici singoli.", "Esempio: WHERE colonna = 'valore'."],
        ...
        [Difficulty.Medium]: [
            {
                ...
                descTemplate: "Trova i prodotti con un prezzo compreso tra {min} e {max} euro inclusi.",
                queryTemplate: "SELECT * FROM prodotti WHERE prezzo BETWEEN {min} AND {max}",
                hints: ["Usa BETWEEN x AND y"],
        ...
        [Difficulty.Hard]: [
            ...
            {
                titleTemplate: "Filtro Data Dinamico",
                descTemplate: "Trova ordini fatti negli ultimi 30 giorni (DATEDIFF).",
                queryTemplate: "SELECT * FROM ordini WHERE DATEDIFF(NOW(), data_ordine) <= 30",
                hints: ["Usa DATEDIFF e NOW()"],
            ...
            },
            {
                ...
                explanation: "Logica complessa con parentesi multiple.",
                replacements: {}
            }
        ]
    },
    [TopicId.Sorting]: {
        [Difficulty.Easy]: [
            ...
            // NEW EXERCISES FOR SORTING EASY
            {
                ...
                descTemplate: "Ordina la tabella {table} per ID crescente.",
                queryTemplate: "SELECT * FROM {table} ORDER BY id ASC",
                hints: ["ORDER BY id"],
                explanation: "Ordinamento standard.",
                replacements: { table: ['utenti', 'prodotti', 'ordini'] }
            },
            {
        ...
        [Difficulty.Medium]: [
            ...
            },
            {
                ...
                descTemplate: "Mostra 5 prodotti, ma salta i primi {skip} (simulazione pagina 2).",
                queryTemplate: "SELECT * FROM prodotti LIMIT 5 OFFSET {skip}",
                hints: ["Usa LIMIT x OFFSET y"],
            ...
            },
            {
                ...
                descTemplate: "Mostra 10 prodotti, salta i primi 10 (pagina 2).",
                queryTemplate: "SELECT * FROM prodotti LIMIT 10 OFFSET 10",
            ...
            },
            {
                ...
                descTemplate: "Mostra 10 prodotti, salta i primi 20 (pagina 3).",
                queryTemplate: "SELECT * FROM prodotti LIMIT 10 OFFSET 20",
            ...
            },
            {
                ...
                descTemplate: "Mostra 5 utenti, salta i primi {skip}.",
                queryTemplate: "SELECT * FROM utenti LIMIT 5 OFFSET {skip}",
            ...
            },
            {
                ...
                descTemplate: "Mostra 10 ordini, salta i primi {skip}.",
                queryTemplate: "SELECT * FROM ordini LIMIT 10 OFFSET {skip}",
            ...
            },
            {
                ...
                descTemplate: "Mostra 5 prodotti, salta i primi 3.",
                queryTemplate: "SELECT * FROM prodotti LIMIT 5 OFFSET 3",
            ...
            },
            {
                ...
                descTemplate: "Mostra 10 prodotti, salta i primi 15.",
                queryTemplate: "SELECT * FROM prodotti LIMIT 10 OFFSET 15",
            ...
            },
            {
                ...
                descTemplate: "Mostra 5 prodotti, salta i primi 25.",
                queryTemplate: "SELECT * FROM prodotti LIMIT 5 OFFSET 25",
            ...
            },
            {
                ...
                descTemplate: "Mostra 8 prodotti, salta i primi 16 (pagina 3 con 8 per pagina).",
                queryTemplate: "SELECT * FROM prodotti LIMIT 8 OFFSET 16",
            ...
            },
            {
                ...
                descTemplate: "Mostra 7 prodotti, salta i primi {skip}.",
                queryTemplate: "SELECT * FROM prodotti LIMIT 7 OFFSET {skip}",
            ...
            },
            {
                ...
                descTemplate: "Mostra 5 record di {table}, saltando i primi 5.",
                queryTemplate: "SELECT * FROM {table} LIMIT 5 OFFSET 5",
                hints: ["LIMIT 5 OFFSET 5"],
                explanation: "Paginazione generica.",
                replacements: { table: ['utenti', 'prodotti'] }
            },
            {
        ...
        [Difficulty.Hard]: [
            {
                ...
                descTemplate: "Ordina gli utenti alfabeticamente per Paese (A-Z), e per chi ha lo stesso paese, ordina per Nome (A-Z).",
    ...
    [TopicId.Dates]: {
        [Difficulty.Easy]: [
            { titleTemplate: "Estrazione Anno Ordine", descTemplate: "Analizziamo le tendenze annuali. Estrai l'anno dalla data di ogni ordine.", queryTemplate: "SELECT YEAR(data_ordine) FROM ordini", hints: ["Usa la funzione YEAR()"], explanation: "YEAR() estrae la parte anno da una data.", replacements: {} },
            { titleTemplate: "Filtro Anno {year}", descTemplate: "Seleziona tutti gli ordini effettuati esclusivamente nel {year}.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) = {year}", hints: ["Usa WHERE YEAR(data) = ..."], explanation: "Filtro su componente data.", replacements: { year: DATA.years } },
            { titleTemplate: "Estrazione Mese Spedizione", descTemplate: "Per reportistica mensile, estrai il mese numerico dalle date di spedizione.", queryTemplate: "SELECT MONTH(data_spedizione) FROM spedizioni", hints: ["Usa MONTH()"], explanation: "MONTH() restituisce da 1 a 12.", replacements: {} },
            { titleTemplate: "Anno Ordini", descTemplate: "Estrai l'anno da ogni data ordine.", queryTemplate: "SELECT YEAR(data_ordine) FROM ordini", hints: ["Usa YEAR(data_ordine)"], explanation: "YEAR() per estrarre anno.", replacements: {} },
            { titleTemplate: "Anno Spedizioni", descTemplate: "Estrai l'anno da ogni data spedizione.", queryTemplate: "SELECT YEAR(data_spedizione) FROM spedizioni", hints: ["Usa YEAR(data_spedizione)"], explanation: "YEAR() su date spedizioni.", replacements: {} },
            { titleTemplate: "Mese Ordini", descTemplate: "Estrai il mese (1-12) da ogni data ordine.", queryTemplate: "SELECT MONTH(data_ordine) FROM ordini", hints: ["Usa MONTH(data_ordine)"], explanation: "MONTH() per estrarre mese.", replacements: {} },
            { titleTemplate: "Mese Spedizioni", descTemplate: "Estrai il mese da ogni data spedizione.", queryTemplate: "SELECT MONTH(data_spedizione) FROM spedizioni", hints: ["Usa MONTH(data_spedizione)"], explanation: "MONTH() su date spedizioni.", replacements: {} },
            { titleTemplate: "Anno e Data Ordine", descTemplate: "Mostra la data ordine completa e l'anno estratto.", queryTemplate: "SELECT data_ordine, YEAR(data_ordine) FROM ordini", hints: ["Mostra data e YEAR()", "SELECT data_ordine, YEAR(data_ordine)"], explanation: "Data completa e anno estratto.", replacements: {} },
            { titleTemplate: "Mese e Data Spedizione", descTemplate: "Mostra la data spedizione completa e il mese estratto.", queryTemplate: "SELECT data_spedizione, MONTH(data_spedizione) FROM spedizioni", hints: ["Mostra data e MONTH()", "SELECT data_spedizione, MONTH(data_spedizione)"], explanation: "Data completa e mese estratto.", replacements: {} },
            { titleTemplate: "Anno e Mese Ordini", descTemplate: "Estrai anno e mese da ogni data ordine.", queryTemplate: "SELECT YEAR(data_ordine), MONTH(data_ordine) FROM ordini", hints: ["Usa YEAR() e MONTH()", "SELECT YEAR(data_ordine), MONTH(data_ordine)"], explanation: "YEAR e MONTH insieme.", replacements: {} },
            { titleTemplate: "Anno e Mese Spedizioni", descTemplate: "Estrai anno e mese da ogni data spedizione.", queryTemplate: "SELECT YEAR(data_spedizione), MONTH(data_spedizione) FROM spedizioni", hints: ["Usa YEAR() e MONTH()", "SELECT YEAR(data_spedizione), MONTH(data_spedizione)"], explanation: "YEAR e MONTH su spedizioni.", replacements: {} },
            { titleTemplate: "Filtro Anno 2022", descTemplate: "Trova tutti gli ordini effettuati nel 2022.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) = 2022", hints: ["WHERE YEAR(data_ordine) = 2022"], explanation: "Filtro per anno specifico.", replacements: {} },
            { titleTemplate: "Filtro Anno 2023", descTemplate: "Trova tutti gli ordini effettuati nel 2023.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) = 2023", hints: ["WHERE YEAR(data_ordine) = 2023"], explanation: "Filtro per anno 2023.", replacements: {} },
            { titleTemplate: "Filtro Anno 2024", descTemplate: "Trova tutti gli ordini effettuati nel 2024.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) = 2024", hints: ["WHERE YEAR(data_ordine) = 2024"], explanation: "Filtro per anno 2024.", replacements: {} },
            { titleTemplate: "Filtro Mese Gennaio", descTemplate: "Trova tutti gli ordini effettuati a Gennaio (mese 1).", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) = 1", hints: ["WHERE MONTH(data_ordine) = 1"], explanation: "Filtro per mese specifico.", replacements: {} },
            { titleTemplate: "Filtro Mese {month}", descTemplate: "Trova tutti gli ordini effettuati nel mese {month}.", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) = {month}", hints: ["WHERE MONTH(data_ordine) = {month}"], explanation: "Filtro per mese variabile.", replacements: { month: DATA.months } },
            { titleTemplate: "Filtro Mese Spedizione {month}", descTemplate: "Trova tutte le spedizioni avvenute nel mese {month}.", queryTemplate: "SELECT * FROM spedizioni WHERE MONTH(data_spedizione) = {month}", hints: ["WHERE MONTH(data_spedizione) = {month}"], explanation: "Filtro mese su spedizioni.", replacements: { month: DATA.months } },
            { titleTemplate: "Data Ordine Completa", descTemplate: "Mostra tutte le date ordine senza estrazioni.", queryTemplate: "SELECT data_ordine FROM ordini", hints: ["SELECT data_ordine FROM ordini"], explanation: "Visualizzazione date complete.", replacements: {} },
            { titleTemplate: "Data Spedizione Completa", descTemplate: "Mostra tutte le date spedizione senza estrazioni.", queryTemplate: "SELECT data_spedizione FROM spedizioni", hints: ["SELECT data_spedizione FROM spedizioni"], explanation: "Visualizzazione date spedizioni.", replacements: {} },
            { titleTemplate: "Ordini con Anno", descTemplate: "Mostra ID ordine, data ordine e anno estratto.", queryTemplate: "SELECT id, data_ordine, YEAR(data_ordine) FROM ordini", hints: ["Mostra id, data e YEAR()", "SELECT id, data_ordine, YEAR(data_ordine)"], explanation: "ID, data e anno insieme.", replacements: {} },
            { titleTemplate: "Spedizioni con Mese", descTemplate: "Mostra ID spedizione, data spedizione e mese estratto.", queryTemplate: "SELECT id, data_spedizione, MONTH(data_spedizione) FROM spedizioni", hints: ["Mostra id, data e MONTH()", "SELECT id, data_spedizione, MONTH(data_spedizione)"], explanation: "ID, data e mese insieme.", replacements: {} },
            { titleTemplate: "Ordini con Anno e Mese", descTemplate: "Mostra data ordine, anno e mese estratti.", queryTemplate: "SELECT data_ordine, YEAR(data_ordine), MONTH(data_ordine) FROM ordini", hints: ["Mostra data, YEAR e MONTH", "SELECT data_ordine, YEAR(data_ordine), MONTH(data_ordine)"], explanation: "Data completa con anno e mese.", replacements: {} },
            { titleTemplate: "Spedizioni con Anno e Mese", descTemplate: "Mostra data spedizione, anno e mese estratti.", queryTemplate: "SELECT data_spedizione, YEAR(data_spedizione), MONTH(data_spedizione) FROM spedizioni", hints: ["Mostra data, YEAR e MONTH", "SELECT data_spedizione, YEAR(data_spedizione), MONTH(data_spedizione)"], explanation: "Data completa con anno e mese spedizioni.", replacements: {} },
            { titleTemplate: "Filtro Data Specifica", descTemplate: "Trova tutti gli ordini effettuati il 1 Gennaio 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine = '2023-01-01'", hints: ["WHERE data_ordine = '2023-01-01'", "Le date sono stringhe 'YYYY-MM-DD'"], explanation: "Filtro per data specifica.", replacements: {} },
            { titleTemplate: "Filtro Data Dopo", descTemplate: "Trova tutti gli ordini effettuati dopo il 1 Gennaio 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine > '2023-01-01'", hints: ["WHERE data_ordine > '2023-01-01'"], explanation: "Filtro per data maggiore.", replacements: {} },
            { titleTemplate: "Filtro Data Prima", descTemplate: "Trova tutti gli ordini effettuati prima del 1 Gennaio 2024.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine < '2024-01-01'", hints: ["WHERE data_ordine < '2024-01-01'"], explanation: "Filtro per data minore.", replacements: {} },
            { titleTemplate: "Filtro Data Dopo o Uguale", descTemplate: "Trova tutti gli ordini dal 1 Gennaio 2023 in poi.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine >= '2023-01-01'", hints: ["WHERE data_ordine >= '2023-01-01'"], explanation: "Filtro per data maggiore o uguale.", replacements: {} },
            { titleTemplate: "Filtro Data Prima o Uguale", descTemplate: "Trova tutti gli ordini fino al 31 Dicembre 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine <= '2023-12-31'", hints: ["WHERE data_ordine <= '2023-12-31'"], explanation: "Filtro per data minore o uguale.", replacements: {} },
            { titleTemplate: "Filtro Range Date", descTemplate: "Trova tutti gli ordini tra il 1 Gennaio 2023 e il 31 Dicembre 2023.", queryTemplate: "SELECT * FROM ordini WHERE data_ordine BETWEEN '2023-01-01' AND '2023-12-31'", hints: ["WHERE data_ordine BETWEEN '...' AND '...'"], explanation: "BETWEEN per range di date.", replacements: {} },
            {
                titleTemplate: "Anno con Alias", descTemplate: "Estrai l'anno dalla data ordine e rinominalo come 'Anno_Ordine'.",
                queryTemplate: "SELECT YEAR(data_ordine) AS Anno_Ordine FROM ordini", hints: ["YEAR(data_ordine) AS Anno_Ordine"], explanation: "YEAR con alias.", replacements: {}
            },
            {
                titleTemplate: "Mese con Alias", descTemplate: "Estrai il mese dalla data spedizione e rinominalo come 'Mese_Spedizione'.",
                queryTemplate: "SELECT MONTH(data_spedizione) AS Mese_Spedizione FROM spedizioni", hints: ["MONTH(data_spedizione) AS Mese_Spedizione"], explanation: "MONTH con alias.", replacements: {}
            },
            // NEW EXERCISES FOR DATES EASY
            { titleTemplate: "Giorno Ordine", descTemplate: "Estrai il giorno (1-31) dalla data ordine.", queryTemplate: "SELECT DAY(data_ordine) FROM ordini", hints: ["DAY()"], explanation: "Estrai giorno.", replacements: {} },
            { titleTemplate: "Giorno Spedizione", descTemplate: "Estrai il giorno (1-31) dalla data spedizione.", queryTemplate: "SELECT DAY(data_spedizione) FROM spedizioni", hints: ["DAY()"], explanation: "Estrai giorno spedizione.", replacements: {} },
            { titleTemplate: "Data Corrente", descTemplate: "Mostra la data e ora corrente.", queryTemplate: "SELECT NOW()", hints: ["NOW()"], explanation: "Timestamp attuale.", replacements: {} },
            { titleTemplate: "Filtro Giorno 1", descTemplate: "Trova ordini fatti il primo del mese.", queryTemplate: "SELECT * FROM ordini WHERE DAY(data_ordine) = 1", hints: ["DAY(...) = 1"], explanation: "Inizio mese.", replacements: {} },
            { titleTemplate: "Filtro Giorno 15", descTemplate: "Trova ordini fatti a metà mese (15).", queryTemplate: "SELECT * FROM ordini WHERE DAY(data_ordine) = 15", hints: ["DAY(...) = 15"], explanation: "Metà mese.", replacements: {} },
            { titleTemplate: "Filtro Anno Passato", descTemplate: "Trova ordini del 2022.", queryTemplate: "SELECT * FROM ordini WHERE YEAR(data_ordine) = 2022", hints: ["YEAR(...) = 2022"], explanation: "Storico.", replacements: {} },
            { titleTemplate: "Filtro Mese Dicembre", descTemplate: "Trova ordini di Dicembre (12).", queryTemplate: "SELECT * FROM ordini WHERE MONTH(data_ordine) = 12", hints: ["MONTH(...) = 12"], explanation: "Fine anno.", replacements: {} },
            { titleTemplate: "Data Ordine Alias", descTemplate: "Seleziona data ordine rinominandola 'Data'.", queryTemplate: "SELECT data_ordine AS Data FROM ordini", hints: ["AS Data"], explanation: "Alias semplice.", replacements: {} },
            { titleTemplate: "Data Spedizione Alias", descTemplate: "Seleziona data spedizione rinominandola 'Spedito_Il'.", queryTemplate: "SELECT data_spedizione AS Spedito_Il FROM spedizioni", hints: ["AS Spedito_Il"], explanation: "Alias descrittivo.", replacements: {} },
            { titleTemplate: "Anno Corrente Alias", descTemplate: "Estrai anno ordine come 'Anno_Rif'.", queryTemplate: "SELECT YEAR(data_ordine) AS Anno_Rif FROM ordini", hints: ["YEAR(...) AS ..."], explanation: "Alias su funzione.", replacements: {} }
        ],
        [Difficulty.Medium]: [
            ...
            { titleTemplate: "Ordini Weekend (Simulato)", descTemplate: "Trova ordini fatti di Domenica (assumendo funzione WEEKDAY, qui simuliamo con filtro manuale su date note o placeholder).", queryTemplate: "SELECT * FROM ordini WHERE DAY(data_ordine) IN (7, 14, 21, 28)", hints: ["Simulazione filtro giorni"], explanation: "Analisi settimanale.", replacements: {} },
    ...
    [TopicId.Joins]: {
        [Difficulty.Easy]: [
            { titleTemplate: "Prodotti e Categorie", descTemplate: "Visualizza il nome del prodotto e il nome della sua categoria associata.", queryTemplate: "SELECT prodotti.nome, categorie.nome FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id", hints: ["Usa JOIN ... ON ...", "Specifica tabella.colonna"], explanation: "Inner Join base per decodificare ID.", replacements: {} },
            { titleTemplate: "Ordini e Utenti", descTemplate: "Mostra l'ID ordine e il nome dell'utente che lo ha effettuato.", queryTemplate: "SELECT ordini.id, utenti.nome FROM ordini JOIN utenti ON ordini.utente_id = utenti.id", hints: ["Collega ordini.utente_id con utenti.id"], explanation: "Relazione uno-a-molti.", replacements: {} },
            { titleTemplate: "Spedizioni e Corrieri", descTemplate: "Collega la tabella spedizioni agli ordini per vedere la data ordine accanto al corriere.", queryTemplate: "SELECT spedizioni.corriere, ordini.data_ordine FROM spedizioni JOIN ordini ON spedizioni.ordine_id = ordini.id", hints: ["JOIN spedizioni ON ordini"], explanation: "Navigare relazioni.", replacements: {} },
            { titleTemplate: "Prodotti e Fornitori", descTemplate: "Visualizza il nome del prodotto e il nome dell'azienda fornitore.", queryTemplate: "SELECT prodotti.nome, fornitori.azienda FROM prodotti JOIN fornitori ON prodotti.fornitore_id = fornitori.id", hints: ["JOIN prodotti con fornitori", "prodotti.fornitore_id = fornitori.id"], explanation: "JOIN per collegare prodotti e fornitori.", replacements: {} },
            { titleTemplate: "Ordini e Prodotti", descTemplate: "Mostra l'ID ordine e il nome del prodotto ordinato.", queryTemplate: "SELECT ordini.id, prodotti.nome FROM ordini JOIN prodotti ON ordini.prodotto_id = prodotti.id", hints: ["JOIN ordini con prodotti", "ordini.prodotto_id = prodotti.id"], explanation: "JOIN per collegare ordini e prodotti.", replacements: {} },
            { titleTemplate: "Recensioni e Prodotti", descTemplate: "Mostra il voto della recensione e il nome del prodotto recensito.", queryTemplate: "SELECT recensioni.voto, prodotti.nome FROM recensioni JOIN prodotti ON recensioni.prodotto_id = prodotti.id", hints: ["JOIN recensioni con prodotti", "recensioni.prodotto_id = prodotti.id"], explanation: "JOIN per collegare recensioni e prodotti.", replacements: {} },
            { titleTemplate: "Recensioni e Utenti", descTemplate: "Mostra il voto della recensione e il nome dell'utente che l'ha scritta.", queryTemplate: "SELECT recensioni.voto, utenti.nome FROM recensioni JOIN utenti ON recensioni.utente_id = utenti.id", hints: ["JOIN recensioni con utenti", "recensioni.utente_id = utenti.id"], explanation: "JOIN per collegare recensioni e utenti.", replacements: {} },
            ...
            { titleTemplate: "Prodotti Categoria Completa", descTemplate: "Mostra nome prodotto, nome categoria e descrizione categoria.", queryTemplate: "SELECT prodotti.nome, categorie.nome, categorie.descrizione FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id", hints: ["JOIN con tre colonne", "SELECT prodotti.nome, categorie.nome, categorie.descrizione"], explanation: "JOIN con più colonne dalla tabella joinata.", replacements: {} },
            { titleTemplate: "Ordini Utente Completo", descTemplate: "Mostra ID ordine, nome utente e email utente.", queryTemplate: "SELECT ordini.id, utenti.nome, utenti.email FROM ordini JOIN utenti ON ordini.utente_id = utenti.id", hints: ["JOIN con tre colonne", "SELECT ordini.id, utenti.nome, utenti.email"], explanation: "JOIN con più colonne utente.", replacements: {} },
            { titleTemplate: "Prodotti Fornitore Completo", descTemplate: "Mostra nome prodotto, azienda fornitore e nazione fornitore.", queryTemplate: "SELECT prodotti.nome, fornitori.azienda, fornitori.nazione FROM prodotti JOIN fornitori ON prodotti.fornitore_id = fornitori.id", hints: ["JOIN con tre colonne", "SELECT prodotti.nome, fornitori.azienda, fornitori.nazione"], explanation: "JOIN con più colonne fornitore.", replacements: {} },
            { titleTemplate: "Ordini Prodotto Completo", descTemplate: "Mostra ID ordine, nome prodotto e prezzo prodotto.", queryTemplate: "SELECT ordini.id, prodotti.nome, prodotti.prezzo FROM ordini JOIN prodotti ON ordini.prodotto_id = prodotti.id", hints: ["JOIN con tre colonne", "SELECT ordini.id, prodotti.nome, prodotti.prezzo"], explanation: "JOIN con più colonne prodotto.", replacements: {} },
            { titleTemplate: "Spedizioni Ordine Completo", descTemplate: "Mostra corriere spedizione, data ordine e quantità ordine.", queryTemplate: "SELECT spedizioni.corriere, ordini.data_ordine, ordini.quantita FROM spedizioni JOIN ordini ON spedizioni.ordine_id = ordini.id", hints: ["JOIN con tre colonne", "SELECT spedizioni.corriere, ordini.data_ordine, ordini.quantita"], explanation: "JOIN con più colonne ordine.", replacements: {} },
            { titleTemplate: "Recensioni Prodotto Completo", descTemplate: "Mostra voto recensione, nome prodotto e prezzo prodotto.", queryTemplate: "SELECT recensioni.voto, prodotti.nome, prodotti.prezzo FROM recensioni JOIN prodotti ON recensioni.prodotto_id = prodotti.id", hints: ["JOIN con tre colonne", "SELECT recensioni.voto, prodotti.nome, prodotti.prezzo"], explanation: "JOIN con più colonne prodotto.", replacements: {} },
            { titleTemplate: "Recensioni Utente Completo", descTemplate: "Mostra voto recensione, nome utente e paese utente.", queryTemplate: "SELECT recensioni.voto, utenti.nome, utenti.paese FROM recensioni JOIN utenti ON recensioni.utente_id = utenti.id", hints: ["JOIN con tre colonne", "SELECT recensioni.voto, utenti.nome, utenti.paese"], explanation: "JOIN con più colonne utente.", replacements: {} },
            { titleTemplate: "Tutte le Colonne Prodotti Categorie", descTemplate: "Mostra tutte le colonne di prodotti e categorie usando SELECT *.", queryTemplate: "SELECT * FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id", hints: ["SELECT * con JOIN", "SELECT * FROM prodotti JOIN categorie ON ..."], explanation: "SELECT * con JOIN mostra tutte le colonne.", replacements: {} },
            { titleTemplate: "Tutte le Colonne Ordini Utenti", descTemplate: "Mostra tutte le colonne di ordini e utenti usando SELECT *.", queryTemplate: "SELECT * FROM ordini JOIN utenti ON ordini.utente_id = utenti.id", hints: ["SELECT * con JOIN", "SELECT * FROM ordini JOIN utenti ON ..."], explanation: "SELECT * con JOIN per vedere tutto.", replacements: {} },
            { titleTemplate: "Tutte le Colonne Prodotti Fornitori", descTemplate: "Mostra tutte le colonne di prodotti e fornitori usando SELECT *.", queryTemplate: "SELECT * FROM prodotti JOIN fornitori ON prodotti.fornitore_id = fornitori.id", hints: ["SELECT * con JOIN", "SELECT * FROM prodotti JOIN fornitori ON ..."], explanation: "SELECT * con JOIN fornitori.", replacements: {} },
            { titleTemplate: "Tutte le Colonne Ordini Prodotti", descTemplate: "Mostra tutte le colonne di ordini e prodotti usando SELECT *.", queryTemplate: "SELECT * FROM ordini JOIN prodotti ON ordini.prodotto_id = prodotti.id", hints: ["SELECT * con JOIN", "SELECT * FROM ordini JOIN prodotti ON ..."], explanation: "SELECT * con JOIN prodotti.", replacements: {} },
            { titleTemplate: "Tutte le Colonne Spedizioni Ordini", descTemplate: "Mostra tutte le colonne di spedizioni e ordini usando SELECT *.", queryTemplate: "SELECT * FROM spedizioni JOIN ordini ON spedizioni.ordine_id = ordini.id", hints: ["SELECT * con JOIN", "SELECT * FROM spedizioni JOIN ordini ON ..."], explanation: "SELECT * con JOIN ordini.", replacements: {} },
            { titleTemplate: "Tutte le Colonne Recensioni Prodotti", descTemplate: "Mostra tutte le colonne di recensioni e prodotti usando SELECT *.", queryTemplate: "SELECT * FROM recensioni JOIN prodotti ON recensioni.prodotto_id = prodotti.id", hints: ["SELECT * con JOIN", "SELECT * FROM recensioni JOIN prodotti ON ..."], explanation: "SELECT * con JOIN prodotti.", replacements: {} },
            { titleTemplate: "Tutte le Colonne Recensioni Utenti", descTemplate: "Mostra tutte le colonne di recensioni e utenti usando SELECT *.", queryTemplate: "SELECT * FROM recensioni JOIN utenti ON recensioni.utente_id = utenti.id", hints: ["SELECT * con JOIN", "SELECT * FROM recensioni JOIN utenti ON ..."], explanation: "SELECT * con JOIN utenti.", replacements: {} },
            { titleTemplate: "Quattro Colonne Prodotti Categorie", descTemplate: "Mostra nome prodotto, prezzo, nome categoria e descrizione categoria.", queryTemplate: "SELECT prodotti.nome, prodotti.prezzo, categorie.nome, categorie.descrizione FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id", hints: ["Quattro colonne", "SELECT prodotti.nome, prodotti.prezzo, categorie.nome, categorie.descrizione"], explanation: "JOIN con quattro colonne.", replacements: {} },
            { titleTemplate: "Quattro Colonne Ordini Utenti", descTemplate: "Mostra ID ordine, data ordine, nome utente e email utente.", queryTemplate: "SELECT ordini.id, ordini.data_ordine, utenti.nome, utenti.email FROM ordini JOIN utenti ON ordini.utente_id = utenti.id", hints: ["Quattro colonne", "SELECT ordini.id, ordini.data_ordine, utenti.nome, utenti.email"], explanation: "JOIN con quattro colonne ordini-utenti.", replacements: {} },
            { titleTemplate: "Quattro Colonne Prodotti Fornitori", descTemplate: "Mostra nome prodotto, prezzo, azienda fornitore e nazione fornitore.", queryTemplate: "SELECT prodotti.nome, prodotti.prezzo, fornitori.azienda, fornitori.nazione FROM prodotti JOIN fornitori ON prodotti.fornitore_id = fornitori.id", hints: ["Quattro colonne", "SELECT prodotti.nome, prodotti.prezzo, fornitori.azienda, fornitori.nazione"], explanation: "JOIN con quattro colonne prodotti-fornitori.", replacements: {} },
            { titleTemplate: "Quattro Colonne Ordini Prodotti", descTemplate: "Mostra ID ordine, quantità, nome prodotto e prezzo prodotto.", queryTemplate: "SELECT ordini.id, ordini.quantita, prodotti.nome, prodotti.prezzo FROM ordini JOIN prodotti ON ordini.prodotto_id = prodotti.id", hints: ["Quattro colonne", "SELECT ordini.id, ordini.quantita, prodotti.nome, prodotti.prezzo"], explanation: "JOIN con quattro colonne ordini-prodotti.", replacements: {} },
            { titleTemplate: "Quattro Colonne Spedizioni Ordini", descTemplate: "Mostra corriere, codice tracking, data ordine e quantità ordine.", queryTemplate: "SELECT spedizioni.corriere, spedizioni.codice_tracking, ordini.data_ordine, ordini.quantita FROM spedizioni JOIN ordini ON spedizioni.ordine_id = ordini.id", hints: ["Quattro colonne", "SELECT spedizioni.corriere, spedizioni.codice_tracking, ordini.data_ordine, ordini.quantita"], explanation: "JOIN con quattro colonne spedizioni-ordini.", replacements: {} },
            { titleTemplate: "Quattro Colonne Recensioni Prodotti", descTemplate: "Mostra voto, commento, nome prodotto e prezzo prodotto.", queryTemplate: "SELECT recensioni.voto, recensioni.commento, prodotti.nome, prodotti.prezzo FROM recensioni JOIN prodotti ON recensioni.prodotto_id = prodotti.id", hints: ["Quattro colonne", "SELECT recensioni.voto, recensioni.commento, prodotti.nome, prodotti.prezzo"], explanation: "JOIN con quattro colonne recensioni-prodotti.", replacements: {} },
            { titleTemplate: "Quattro Colonne Recensioni Utenti", descTemplate: "Mostra voto, commento, nome utente e paese utente.", queryTemplate: "SELECT recensioni.voto, recensioni.commento, utenti.nome, utenti.paese FROM recensioni JOIN utenti ON recensioni.utente_id = utenti.id", hints: ["Quattro colonne", "SELECT recensioni.voto, recensioni.commento, utenti.nome, utenti.paese"], explanation: "JOIN con quattro colonne recensioni-utenti.", replacements: {} },
            { titleTemplate: "Cinque Colonne Complete", descTemplate: "Mostra nome prodotto, prezzo, stock, nome categoria e descrizione categoria.", queryTemplate: "SELECT prodotti.nome, prodotti.prezzo, prodotti.stock, categorie.nome, categorie.descrizione FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id", hints: ["Cinque colonne", "SELECT prodotti.nome, prodotti.prezzo, prodotti.stock, categorie.nome, categorie.descrizione"], explanation: "JOIN con cinque colonne.", replacements: {} },
            // NEW EXERCISES FOR JOINS EASY
            { titleTemplate: "Utenti e Ordini Semplice", descTemplate: "Mostra nome utente e ID ordine.", queryTemplate: "SELECT utenti.nome, ordini.id FROM utenti JOIN ordini ON utenti.id = ordini.utente_id", hints: ["JOIN utenti ordini"], explanation: "Relazione base.", replacements: {} },
            { titleTemplate: "Prodotti e Categorie Semplice", descTemplate: "Mostra nome prodotto e nome categoria.", queryTemplate: "SELECT prodotti.nome, categorie.nome FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id", hints: ["JOIN prodotti categorie"], explanation: "Relazione catalogo.", replacements: {} },
            { titleTemplate: "Prodotti e Fornitori Semplice", descTemplate: "Mostra nome prodotto e azienda fornitrice.", queryTemplate: "SELECT prodotti.nome, fornitori.azienda FROM prodotti JOIN fornitori ON prodotti.fornitore_id = fornitori.id", hints: ["JOIN prodotti fornitori"], explanation: "Relazione supply chain.", replacements: {} },
            { titleTemplate: "Recensioni e Prodotti Semplice", descTemplate: "Mostra voto recensione e nome prodotto.", queryTemplate: "SELECT recensioni.voto, prodotti.nome FROM recensioni JOIN prodotti ON recensioni.prodotto_id = prodotti.id", hints: ["JOIN recensioni prodotti"], explanation: "Relazione feedback.", replacements: {} },
            { titleTemplate: "Spedizioni e Ordini Semplice", descTemplate: "Mostra codice tracking e data ordine.", queryTemplate: "SELECT spedizioni.codice_tracking, ordini.data_ordine FROM spedizioni JOIN ordini ON spedizioni.ordine_id = ordini.id", hints: ["JOIN spedizioni ordini"], explanation: "Relazione logistica.", replacements: {} },
            { titleTemplate: "Utenti e Paesi (Join)", descTemplate: "Mostra nome utente e paese (dalla tabella utenti, ma concettualmente una join se paese fosse tabella a parte - qui è self-contained).", queryTemplate: "SELECT nome, paese FROM utenti", hints: ["SELECT semplice"], explanation: "Selezione colonne.", replacements: {} },
            { titleTemplate: "Ordini con Dettagli Utente", descTemplate: "Mostra ID ordine, data e email utente.", queryTemplate: "SELECT ordini.id, ordini.data_ordine, utenti.email FROM ordini JOIN utenti ON ordini.utente_id = utenti.id", hints: ["JOIN ordini utenti"], explanation: "Dettagli contatto.", replacements: {} },
            { titleTemplate: "Prodotti con Dettagli Categoria", descTemplate: "Mostra nome prodotto, prezzo e descrizione categoria.", queryTemplate: "SELECT prodotti.nome, prodotti.prezzo, categorie.descrizione FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id", hints: ["JOIN prodotti categorie"], explanation: "Dettagli contesto.", replacements: {} },
            { titleTemplate: "Fornitori e Prodotti List", descTemplate: "Mostra azienda fornitore e nome prodotto.", queryTemplate: "SELECT fornitori.azienda, prodotti.nome FROM fornitori JOIN prodotti ON fornitori.id = prodotti.fornitore_id", hints: ["JOIN fornitori prodotti"], explanation: "Lista offerta.", replacements: {} },
            { titleTemplate: "Recensioni con Utente", descTemplate: "Mostra commento recensione e nome utente.", queryTemplate: "SELECT recensioni.commento, utenti.nome FROM recensioni JOIN utenti ON recensioni.utente_id = utenti.id", hints: ["JOIN recensioni utenti"], explanation: "Autore feedback.", replacements: {} }
        ],
        [Difficulty.Medium]: [
    ...
    [TopicId.Aggregation]: {
        [Difficulty.Easy]: [
            { titleTemplate: "Conteggio Utenti", descTemplate: "Quanti utenti sono registrati nel sistema?", queryTemplate: "SELECT COUNT(*) FROM utenti", hints: ["Usa COUNT(*)"], explanation: "Conta tutte le righe.", replacements: {} },
            { titleTemplate: "Totale Stock", descTemplate: "Qual è la somma totale delle unità di merce in magazzino?", queryTemplate: "SELECT SUM(stock) FROM prodotti", hints: ["Usa SUM(colonna)"], explanation: "Somma valori numerici.", replacements: {} },
            { titleTemplate: "Prezzo Medio", descTemplate: "Calcola il prezzo medio di vendita dei prodotti.", queryTemplate: "SELECT AVG(prezzo) FROM prodotti", hints: ["Usa AVG()"], explanation: "Media aritmetica.", replacements: {} },
            { titleTemplate: "Conteggio Prodotti", descTemplate: "Quanti prodotti ci sono nel catalogo?", queryTemplate: "SELECT COUNT(*) FROM prodotti", hints: ["Usa COUNT(*)"], explanation: "Conta tutti i prodotti.", replacements: {} },
            { titleTemplate: "Conteggio Ordini", descTemplate: "Quanti ordini sono stati effettuati?", queryTemplate: "SELECT COUNT(*) FROM ordini", hints: ["Usa COUNT(*)"], explanation: "Conta tutti gli ordini.", replacements: {} },
            { titleTemplate: "Conteggio Recensioni", descTemplate: "Quante recensioni ci sono nel sistema?", queryTemplate: "SELECT COUNT(*) FROM recensioni", hints: ["Usa COUNT(*)"], explanation: "Conta tutte le recensioni.", replacements: {} },
            { titleTemplate: "Conteggio Spedizioni", descTemplate: "Quante spedizioni ci sono nel sistema?", queryTemplate: "SELECT COUNT(*) FROM spedizioni", hints: ["Usa COUNT(*)"], explanation: "Conta tutte le spedizioni.", replacements: {} },
            { titleTemplate: "Conteggio Categorie", descTemplate: "Quante categorie ci sono nel sistema?", queryTemplate: "SELECT COUNT(*) FROM categorie", hints: ["Usa COUNT(*)"], explanation: "Conta tutte le categorie.", replacements: {} },
            { titleTemplate: "Conteggio Fornitori", descTemplate: "Quanti fornitori ci sono nel sistema?", queryTemplate: "SELECT COUNT(*) FROM fornitori", hints: ["Usa COUNT(*)"], explanation: "Conta tutti i fornitori.", replacements: {} },
            { titleTemplate: "Totale Prezzo", descTemplate: "Qual è la somma totale dei prezzi dei prodotti?", queryTemplate: "SELECT SUM(prezzo) FROM prodotti", hints: ["Usa SUM(prezzo)"], explanation: "Somma dei prezzi.", replacements: {} },
            { titleTemplate: "Totale Quantità Ordini", descTemplate: "Qual è la somma totale delle quantità ordinate?", queryTemplate: "SELECT SUM(quantita) FROM ordini", hints: ["Usa SUM(quantita)"], explanation: "Somma delle quantità.", replacements: {} },
            { titleTemplate: "Totale Voti", descTemplate: "Qual è la somma totale dei voti delle recensioni?", queryTemplate: "SELECT SUM(voto) FROM recensioni", hints: ["Usa SUM(voto)"], explanation: "Somma dei voti.", replacements: {} },
            { titleTemplate: "Stock Medio", descTemplate: "Calcola lo stock medio dei prodotti.", queryTemplate: "SELECT AVG(stock) FROM prodotti", hints: ["Usa AVG(stock)"], explanation: "Media dello stock.", replacements: {} },
            { titleTemplate: "Prezzo Massimo", descTemplate: "Qual è il prezzo massimo tra tutti i prodotti?", queryTemplate: "SELECT MAX(prezzo) FROM prodotti", hints: ["Usa MAX(prezzo)"], explanation: "Valore massimo.", replacements: {} },
            { titleTemplate: "Prezzo Minimo", descTemplate: "Qual è il prezzo minimo tra tutti i prodotti?", queryTemplate: "SELECT MIN(prezzo) FROM prodotti", hints: ["Usa MIN(prezzo)"], explanation: "Valore minimo.", replacements: {} },
            { titleTemplate: "Stock Massimo", descTemplate: "Qual è lo stock massimo tra tutti i prodotti?", queryTemplate: "SELECT MAX(stock) FROM prodotti", hints: ["Usa MAX(stock)"], explanation: "Stock massimo.", replacements: {} },
            { titleTemplate: "Stock Minimo", descTemplate: "Qual è lo stock minimo tra tutti i prodotti?", queryTemplate: "SELECT MIN(stock) FROM prodotti", hints: ["Usa MIN(stock)"], explanation: "Stock minimo.", replacements: {} },
            { titleTemplate: "Voto Massimo", descTemplate: "Qual è il voto massimo tra tutte le recensioni?", queryTemplate: "SELECT MAX(voto) FROM recensioni", hints: ["Usa MAX(voto)"], explanation: "Voto massimo.", replacements: {} },
            { titleTemplate: "Voto Minimo", descTemplate: "Qual è il voto minimo tra tutte le recensioni?", queryTemplate: "SELECT MIN(voto) FROM recensioni", hints: ["Usa MIN(voto)"], explanation: "Voto minimo.", replacements: {} },
            { titleTemplate: "Voto Medio", descTemplate: "Calcola il voto medio di tutte le recensioni.", queryTemplate: "SELECT AVG(voto) FROM recensioni", hints: ["Usa AVG(voto)"], explanation: "Media dei voti.", replacements: {} },
            { titleTemplate: "Quantità Media Ordini", descTemplate: "Calcola la quantità media degli ordini.", queryTemplate: "SELECT AVG(quantita) FROM ordini", hints: ["Usa AVG(quantita)"], explanation: "Media delle quantità.", replacements: {} },
            { titleTemplate: "Quantità Massima Ordini", descTemplate: "Qual è la quantità massima tra tutti gli ordini?", queryTemplate: "SELECT MAX(quantita) FROM ordini", hints: ["Usa MAX(quantita)"], explanation: "Quantità massima.", replacements: {} },
            { titleTemplate: "Quantità Minima Ordini", descTemplate: "Qual è la quantità minima tra tutti gli ordini?", queryTemplate: "SELECT MIN(quantita) FROM ordini", hints: ["Usa MIN(quantita)"], explanation: "Quantità minima.", replacements: {} },
            { titleTemplate: "Funzioni Multiple", descTemplate: "Mostra conteggio, somma, media, massimo e minimo dei prezzi prodotti.", queryTemplate: "SELECT COUNT(*), SUM(prezzo), AVG(prezzo), MAX(prezzo), MIN(prezzo) FROM prodotti", hints: ["Combina COUNT, SUM, AVG, MAX, MIN", "SELECT COUNT(*), SUM(prezzo), AVG(prezzo), MAX(prezzo), MIN(prezzo)"], explanation: "Funzioni aggregate multiple.", replacements: {} },
            { titleTemplate: "Funzioni Multiple Stock", descTemplate: "Mostra conteggio, somma, media, massimo e minimo dello stock prodotti.", queryTemplate: "SELECT COUNT(*), SUM(stock), AVG(stock), MAX(stock), MIN(stock) FROM prodotti", hints: ["Combina COUNT, SUM, AVG, MAX, MIN", "SELECT COUNT(*), SUM(stock), AVG(stock), MAX(stock), MIN(stock)"], explanation: "Funzioni aggregate multiple su stock.", replacements: {} },
            { titleTemplate: "Funzioni Multiple Voti", descTemplate: "Mostra conteggio, somma, media, massimo e minimo dei voti recensioni.", queryTemplate: "SELECT COUNT(*), SUM(voto), AVG(voto), MAX(voto), MIN(voto) FROM recensioni", hints: ["Combina COUNT, SUM, AVG, MAX, MIN", "SELECT COUNT(*), SUM(voto), AVG(voto), MAX(voto), MIN(voto)"], explanation: "Funzioni aggregate multiple su voti.", replacements: {} },
            { titleTemplate: "Conteggio con Alias", descTemplate: "Conta gli utenti e rinomina il risultato come 'Totale_Utenti'.", queryTemplate: "SELECT COUNT(*) AS Totale_Utenti FROM utenti", hints: ["COUNT(*) AS Totale_Utenti"], explanation: "COUNT con alias.", replacements: {} },
            { titleTemplate: "Somma con Alias", descTemplate: "Calcola la somma dello stock e rinomina il risultato come 'Stock_Totale'.", queryTemplate: "SELECT SUM(stock) AS Stock_Totale FROM prodotti", hints: ["SUM(stock) AS Stock_Totale"], explanation: "SUM con alias.", replacements: {} },
            { titleTemplate: "Media con Alias", descTemplate: "Calcola la media dei prezzi e rinomina il risultato come 'Prezzo_Medio'.", queryTemplate: "SELECT AVG(prezzo) AS Prezzo_Medio FROM prodotti", hints: ["AVG(prezzo) AS Prezzo_Medio"], explanation: "AVG con alias.", replacements: {} },
            { titleTemplate: "Massimo con Alias", descTemplate: "Trova il prezzo massimo e rinomina il risultato come 'Prezzo_Massimo'.", queryTemplate: "SELECT MAX(prezzo) AS Prezzo_Massimo FROM prodotti", hints: ["MAX(prezzo) AS Prezzo_Massimo"], explanation: "MAX con alias.", replacements: {} },
            { titleTemplate: "Minimo con Alias", descTemplate: "Trova il prezzo minimo e rinomina il risultato come 'Prezzo_Minimo'.", queryTemplate: "SELECT MIN(prezzo) AS Prezzo_Minimo FROM prodotti", hints: ["MIN(prezzo) AS Prezzo_Minimo"], explanation: "MIN con alias.", replacements: {} },
            // NEW EXERCISES FOR AGGREGATION EASY
            { titleTemplate: "Conteggio Utenti Premium", descTemplate: "Conta quanti utenti sono premium.", queryTemplate: "SELECT COUNT(*) FROM utenti WHERE premium = TRUE", hints: ["COUNT con WHERE"], explanation: "Conteggio filtrato.", replacements: {} },
            { titleTemplate: "Somma Stock Elettronica", descTemplate: "Calcola lo stock totale dei prodotti di categoria 1 (Elettronica).", queryTemplate: "SELECT SUM(stock) FROM prodotti WHERE categoria_id = 1", hints: ["SUM con WHERE"], explanation: "Somma filtrata.", replacements: {} },
            { titleTemplate: "Media Prezzo Elettronica", descTemplate: "Calcola il prezzo medio dei prodotti di categoria 1.", queryTemplate: "SELECT AVG(prezzo) FROM prodotti WHERE categoria_id = 1", hints: ["AVG con WHERE"], explanation: "Media filtrata.", replacements: {} },
            { titleTemplate: "Massimo Prezzo Elettronica", descTemplate: "Trova il prezzo massimo nella categoria 1.", queryTemplate: "SELECT MAX(prezzo) FROM prodotti WHERE categoria_id = 1", hints: ["MAX con WHERE"], explanation: "Massimo filtrato.", replacements: {} },
            { titleTemplate: "Minimo Prezzo Elettronica", descTemplate: "Trova il prezzo minimo nella categoria 1.", queryTemplate: "SELECT MIN(prezzo) FROM prodotti WHERE categoria_id = 1", hints: ["MIN con WHERE"], explanation: "Minimo filtrato.", replacements: {} },
            { titleTemplate: "Conteggio Prodotti Costosi", descTemplate: "Conta i prodotti che costano più di 100 euro.", queryTemplate: "SELECT COUNT(*) FROM prodotti WHERE prezzo > 100", hints: ["COUNT con WHERE prezzo"], explanation: "Conteggio con soglia.", replacements: {} },
            { titleTemplate: "Somma Valore Magazzino", descTemplate: "Calcola il valore totale (prezzo * stock) di tutti i prodotti. (Nota: potrebbe richiedere supporto espressioni in SUM)", queryTemplate: "SELECT SUM(prezzo * stock) FROM prodotti", hints: ["SUM(colonna * colonna)"], explanation: "Aggregazione su espressione.", replacements: {} },
            { titleTemplate: "Conteggio Ordini 2023", descTemplate: "Conta gli ordini effettuati nel 2023.", queryTemplate: "SELECT COUNT(*) FROM ordini WHERE YEAR(data_ordine) = 2023", hints: ["COUNT con WHERE YEAR"], explanation: "Conteggio temporale.", replacements: {} },
            { titleTemplate: "Conteggio Spedizioni DHL", descTemplate: "Conta le spedizioni affidate a DHL.", queryTemplate: "SELECT COUNT(*) FROM spedizioni WHERE corriere = 'DHL'", hints: ["COUNT con WHERE corriere"], explanation: "Conteggio per valore.", replacements: {} },
            { titleTemplate: "Media Voto Recensioni Alte", descTemplate: "Calcola la media dei voti per le recensioni con voto >= 4.", queryTemplate: "SELECT AVG(voto) FROM recensioni WHERE voto >= 4", hints: ["AVG con WHERE voto"], explanation: "Media condizionata.", replacements: {} },
            { titleTemplate: "Totale Quantità Ordini Grandi", descTemplate: "Somma le quantità per ordini con quantità > 5.", queryTemplate: "SELECT SUM(quantita) FROM ordini WHERE quantita > 5", hints: ["SUM con WHERE quantita"], explanation: "Somma condizionata.", replacements: {} },
            { titleTemplate: "Conteggio Fornitori Italiani", descTemplate: "Conta i fornitori con sede in Italia.", queryTemplate: "SELECT COUNT(*) FROM fornitori WHERE nazione = 'Italia'", hints: ["COUNT con WHERE nazione"], explanation: "Conteggio geografico.", replacements: {} },
            { titleTemplate: "Conteggio Utenti Gmail", descTemplate: "Conta gli utenti con email che finisce per 'gmail.com'.", queryTemplate: "SELECT COUNT(*) FROM utenti WHERE email LIKE '%gmail.com'", hints: ["COUNT con LIKE"], explanation: "Conteggio pattern matching.", replacements: {} },
            { titleTemplate: "Prezzo Medio Stock Basso", descTemplate: "Calcola prezzo medio prodotti con stock < 10.", queryTemplate: "SELECT AVG(prezzo) FROM prodotti WHERE stock < 10", hints: ["AVG con WHERE stock"], explanation: "Media su sottoinsieme.", replacements: {} },
            { titleTemplate: "Max Prezzo Fornitore 1", descTemplate: "Prezzo massimo prodotti del fornitore 1.", queryTemplate: "SELECT MAX(prezzo) FROM prodotti WHERE fornitore_id = 1", hints: ["MAX con WHERE fornitore"], explanation: "Max su gruppo logico.", replacements: {} }
        ],
        [Difficulty.Medium]: [
            { titleTemplate: "Conteggio per Paese", descTemplate: "Conta quanti utenti ci sono per ogni paese.", queryTemplate: "SELECT paese, COUNT(*) FROM utenti GROUP BY paese", hints: ["GROUP BY paese"], explanation: "Aggregazione per categoria.", replacements: {} },
            { titleTemplate: "Stock per Categoria", descTemplate: "Calcola la somma dello stock raggruppata per ID categoria.", queryTemplate: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY categoria_id"], explanation: "Totali parziali.", replacements: {} },
            { titleTemplate: "Media Voto Prodotti", descTemplate: "Calcola il voto medio ricevuto da ogni prodotto (ID).", queryTemplate: "SELECT prodotto_id, AVG(voto) FROM recensioni GROUP BY prodotto_id", hints: ["GROUP BY prodotto_id", "AVG(voto)"], explanation: "Analisi feedback.", replacements: {} },
            { titleTemplate: "Conteggio per Categoria", descTemplate: "Conta quanti prodotti ci sono per ogni categoria.", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY categoria_id"], explanation: "Conteggio per categoria.", replacements: {} },
            { titleTemplate: "Conteggio per Fornitore", descTemplate: "Conta quanti prodotti ci sono per ogni fornitore.", queryTemplate: "SELECT fornitore_id, COUNT(*) FROM prodotti GROUP BY fornitore_id", hints: ["GROUP BY fornitore_id"], explanation: "Conteggio per fornitore.", replacements: {} },
            { titleTemplate: "Conteggio per Utente", descTemplate: "Conta quanti ordini ha fatto ogni utente.", queryTemplate: "SELECT utente_id, COUNT(*) FROM ordini GROUP BY utente_id", hints: ["GROUP BY utente_id"], explanation: "Conteggio ordini per utente.", replacements: {} },
            { titleTemplate: "Conteggio per Prodotto", descTemplate: "Conta quanti ordini ci sono per ogni prodotto.", queryTemplate: "SELECT prodotto_id, COUNT(*) FROM ordini GROUP BY prodotto_id", hints: ["GROUP BY prodotto_id"], explanation: "Conteggio ordini per prodotto.", replacements: {} },
            { titleTemplate: "Conteggio per Utente Recensioni", descTemplate: "Conta quante recensioni ha scritto ogni utente.", queryTemplate: "SELECT utente_id, COUNT(*) FROM recensioni GROUP BY utente_id", hints: ["GROUP BY utente_id"], explanation: "Conteggio recensioni per utente.", replacements: {} },
            { titleTemplate: "Somma Stock per Categoria", descTemplate: "Calcola la somma dello stock per ogni categoria.", queryTemplate: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY categoria_id", "SUM(stock)"], explanation: "Somma stock per categoria.", replacements: {} },
            { titleTemplate: "Somma Prezzo per Categoria", descTemplate: "Calcola la somma dei prezzi per ogni categoria.", queryTemplate: "SELECT categoria_id, SUM(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY categoria_id", "SUM(prezzo)"], explanation: "Somma prezzi per categoria.", replacements: {} },
            { titleTemplate: "Somma Quantità per Utente", descTemplate: "Calcola la somma delle quantità ordinate per ogni utente.", queryTemplate: "SELECT utente_id, SUM(quantita) FROM ordini GROUP BY utente_id", hints: ["GROUP BY utente_id", "SUM(quantita)"], explanation: "Somma quantità per utente.", replacements: {} },
            { titleTemplate: "Somma Quantità per Prodotto", descTemplate: "Calcola la somma delle quantità ordinate per ogni prodotto.", queryTemplate: "SELECT prodotto_id, SUM(quantita) FROM ordini GROUP BY prodotto_id", hints: ["GROUP BY prodotto_id", "SUM(quantita)"], explanation: "Somma quantità per prodotto.", replacements: {} },
            { titleTemplate: "Media Prezzo per Categoria", descTemplate: "Calcola il prezzo medio per ogni categoria.", queryTemplate: "SELECT categoria_id, AVG(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY categoria_id", "AVG(prezzo)"], explanation: "Media prezzo per categoria.", replacements: {} },
            { titleTemplate: "Media Stock per Categoria", descTemplate: "Calcola lo stock medio per ogni categoria.", queryTemplate: "SELECT categoria_id, AVG(stock) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY categoria_id", "AVG(stock)"], explanation: "Media stock per categoria.", replacements: {} },
            { titleTemplate: "Media Prezzo per Fornitore", descTemplate: "Calcola il prezzo medio per ogni fornitore.", queryTemplate: "SELECT fornitore_id, AVG(prezzo) FROM prodotti GROUP BY fornitore_id", hints: ["GROUP BY fornitore_id", "AVG(prezzo)"], explanation: "Media prezzo per fornitore.", replacements: {} },
            { titleTemplate: "Media Quantità per Utente", descTemplate: "Calcola la quantità media ordinata per ogni utente.", queryTemplate: "SELECT utente_id, AVG(quantita) FROM ordini GROUP BY utente_id", hints: ["GROUP BY utente_id", "AVG(quantita)"], explanation: "Media quantità per utente.", replacements: {} },
            { titleTemplate: "Massimo Prezzo per Categoria", descTemplate: "Trova il prezzo massimo per ogni categoria.", queryTemplate: "SELECT categoria_id, MAX(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY categoria_id", "MAX(prezzo)"], explanation: "Massimo prezzo per categoria.", replacements: {} },
            { titleTemplate: "Minimo Prezzo per Categoria", descTemplate: "Trova il prezzo minimo per ogni categoria.", queryTemplate: "SELECT categoria_id, MIN(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY categoria_id", "MIN(prezzo)"], explanation: "Minimo prezzo per categoria.", replacements: {} },
            { titleTemplate: "Massimo Stock per Categoria", descTemplate: "Trova lo stock massimo per ogni categoria.", queryTemplate: "SELECT categoria_id, MAX(stock) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY categoria_id", "MAX(stock)"], explanation: "Massimo stock per categoria.", replacements: {} },
            { titleTemplate: "Minimo Stock per Categoria", descTemplate: "Trova lo stock minimo per ogni categoria.", queryTemplate: "SELECT categoria_id, MIN(stock) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY categoria_id", "MIN(stock)"], explanation: "Minimo stock per categoria.", replacements: {} },
            { titleTemplate: "Massimo Voto per Prodotto", descTemplate: "Trova il voto massimo per ogni prodotto.", queryTemplate: "SELECT prodotto_id, MAX(voto) FROM recensioni GROUP BY prodotto_id", hints: ["GROUP BY prodotto_id", "MAX(voto)"], explanation: "Massimo voto per prodotto.", replacements: {} },
            { titleTemplate: "Minimo Voto per Prodotto", descTemplate: "Trova il voto minimo per ogni prodotto.", queryTemplate: "SELECT prodotto_id, MIN(voto) FROM recensioni GROUP BY prodotto_id", hints: ["GROUP BY prodotto_id", "MIN(voto)"], explanation: "Minimo voto per prodotto.", replacements: {} },
            { titleTemplate: "Conteggio e Somma", descTemplate: "Conta i prodotti e calcola la somma dello stock per ogni categoria.", queryTemplate: "SELECT categoria_id, COUNT(*), SUM(stock) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY con COUNT e SUM", "SELECT categoria_id, COUNT(*), SUM(stock)"], explanation: "Funzioni aggregate multiple con GROUP BY.", replacements: {} },
            { titleTemplate: "Conteggio e Media", descTemplate: "Conta i prodotti e calcola la media del prezzo per ogni categoria.", queryTemplate: "SELECT categoria_id, COUNT(*), AVG(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY con COUNT e AVG", "SELECT categoria_id, COUNT(*), AVG(prezzo)"], explanation: "COUNT e AVG con GROUP BY.", replacements: {} },
            { titleTemplate: "Somma e Media", descTemplate: "Calcola la somma e la media dello stock per ogni categoria.", queryTemplate: "SELECT categoria_id, SUM(stock), AVG(stock) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY con SUM e AVG", "SELECT categoria_id, SUM(stock), AVG(stock)"], explanation: "SUM e AVG con GROUP BY.", replacements: {} },
            { titleTemplate: "Massimo e Minimo", descTemplate: "Trova il prezzo massimo e minimo per ogni categoria.", queryTemplate: "SELECT categoria_id, MAX(prezzo), MIN(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY con MAX e MIN", "SELECT categoria_id, MAX(prezzo), MIN(prezzo)"], explanation: "MAX e MIN con GROUP BY.", replacements: {} },
            { titleTemplate: "Conteggio e Massimo", descTemplate: "Conta i prodotti e trova il prezzo massimo per ogni categoria.", queryTemplate: "SELECT categoria_id, COUNT(*), MAX(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY con COUNT e MAX", "SELECT categoria_id, COUNT(*), MAX(prezzo)"], explanation: "COUNT e MAX con GROUP BY.", replacements: {} },
            { titleTemplate: "Conteggio e Minimo", descTemplate: "Conta i prodotti e trova il prezzo minimo per ogni categoria.", queryTemplate: "SELECT categoria_id, COUNT(*), MIN(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY con COUNT e MIN", "SELECT categoria_id, COUNT(*), MIN(prezzo)"], explanation: "COUNT e MIN con GROUP BY.", replacements: {} },
            { titleTemplate: "Funzioni Multiple GROUP BY", descTemplate: "Mostra conteggio, somma, media, massimo e minimo per ogni categoria.", queryTemplate: "SELECT categoria_id, COUNT(*), SUM(prezzo), AVG(prezzo), MAX(prezzo), MIN(prezzo) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY con tutte le funzioni", "SELECT categoria_id, COUNT(*), SUM(prezzo), AVG(prezzo), MAX(prezzo), MIN(prezzo)"], explanation: "Tutte le funzioni aggregate con GROUP BY.", replacements: {} },
            { titleTemplate: "GROUP BY con Alias", descTemplate: "Conta i prodotti per categoria e rinomina come 'Numero_Prodotti'.", queryTemplate: "SELECT categoria_id, COUNT(*) AS Numero_Prodotti FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY con alias", "COUNT(*) AS Numero_Prodotti"], explanation: "GROUP BY con alias.", replacements: {} },
            // NEW EXERCISES FOR AGGREGATION MEDIUM
            { titleTemplate: "Totale Valore per Categoria", descTemplate: "Calcola il valore totale (prezzo * stock) per ogni categoria.", queryTemplate: "SELECT categoria_id, SUM(prezzo * stock) FROM prodotti GROUP BY categoria_id", hints: ["GROUP BY e SUM(expr)"], explanation: "Aggregazione complessa per gruppo.", replacements: {} },
            { titleTemplate: "Ordini per Anno", descTemplate: "Conta quanti ordini ci sono per ogni anno.", queryTemplate: "SELECT YEAR(data_ordine), COUNT(*) FROM ordini GROUP BY YEAR(data_ordine)", hints: ["GROUP BY YEAR(...)"], explanation: "Raggruppamento temporale.", replacements: {} },
            { titleTemplate: "Ordini per Mese", descTemplate: "Conta quanti ordini ci sono per ogni mese (indipendentemente dall'anno).", queryTemplate: "SELECT MONTH(data_ordine), COUNT(*) FROM ordini GROUP BY MONTH(data_ordine)", hints: ["GROUP BY MONTH(...)"], explanation: "Raggruppamento stagionale.", replacements: {} },
            { titleTemplate: "Spedizioni per Corriere", descTemplate: "Conta quante spedizioni ha gestito ogni corriere.", queryTemplate: "SELECT corriere, COUNT(*) FROM spedizioni GROUP BY corriere", hints: ["GROUP BY corriere"], explanation: "Analisi partner logistici.", replacements: {} },
            { titleTemplate: "Media Voto per Utente", descTemplate: "Calcola il voto medio dato da ogni utente.", queryTemplate: "SELECT utente_id, AVG(voto) FROM recensioni GROUP BY utente_id", hints: ["GROUP BY utente_id"], explanation: "Profilo recensore.", replacements: {} },
            { titleTemplate: "Max Quantità per Utente", descTemplate: "Trova la quantità massima mai ordinata da ogni utente.", queryTemplate: "SELECT utente_id, MAX(quantita) FROM ordini GROUP BY utente_id", hints: ["GROUP BY utente_id", "MAX(quantita)"], explanation: "Picco ordini utente.", replacements: {} },
            { titleTemplate: "Min Stock per Fornitore", descTemplate: "Trova lo stock minimo tra i prodotti di ogni fornitore.", queryTemplate: "SELECT fornitore_id, MIN(stock) FROM prodotti GROUP BY fornitore_id", hints: ["GROUP BY fornitore_id", "MIN(stock)"], explanation: "Rischio rottura stock fornitore.", replacements: {} },
            { titleTemplate: "Conteggio Prodotti per Prezzo", descTemplate: "Conta quanti prodotti hanno lo stesso prezzo (distribuzione prezzi).", queryTemplate: "SELECT prezzo, COUNT(*) FROM prodotti GROUP BY prezzo", hints: ["GROUP BY prezzo"], explanation: "Distribuzione valori.", replacements: {} },
            { titleTemplate: "Conteggio Utenti per Premium", descTemplate: "Conta quanti utenti sono premium e quanti no.", queryTemplate: "SELECT premium, COUNT(*) FROM utenti GROUP BY premium", hints: ["GROUP BY premium"], explanation: "Segmentazione base.", replacements: {} },
            { titleTemplate: "Somma Quantità per Anno", descTemplate: "Somma le quantità ordinate per ogni anno.", queryTemplate: "SELECT YEAR(data_ordine), SUM(quantita) FROM ordini GROUP BY YEAR(data_ordine)", hints: ["GROUP BY YEAR", "SUM(quantita)"], explanation: "Volume vendite annuale.", replacements: {} },
            { titleTemplate: "Media Giorni Consegna per Corriere", descTemplate: "Calcola la media dei giorni di consegna per ogni corriere (richiede JOIN implicita o simulata se tabella unica, qui assumiamo tabella spedizioni abbia dati sufficienti o semplifichiamo).", queryTemplate: "SELECT corriere, AVG(DATEDIFF(day, data_ordine, data_spedizione)) FROM spedizioni JOIN ordini ON spedizioni.ordine_id = ordini.id GROUP BY corriere", hints: ["GROUP BY corriere", "AVG(DATEDIFF)"], explanation: "Performance corrieri.", replacements: {} },
            { titleTemplate: "Totale Recensioni per Voto", descTemplate: "Conta quante recensioni ci sono per ogni voto (1-5).", queryTemplate: "SELECT voto, COUNT(*) FROM recensioni GROUP BY voto", hints: ["GROUP BY voto"], explanation: "Distribuzione voti.", replacements: {} },
            { titleTemplate: "Prezzo Medio per Nazione Fornitore", descTemplate: "Calcola il prezzo medio dei prodotti raggruppati per nazione del fornitore.", queryTemplate: "SELECT fornitori.nazione, AVG(prodotti.prezzo) FROM prodotti JOIN fornitori ON prodotti.fornitore_id = fornitori.id GROUP BY fornitori.nazione", hints: ["JOIN e GROUP BY nazione"], explanation: "Analisi geografica prezzi.", replacements: {} },
            { titleTemplate: "Stock Totale per Nazione Fornitore", descTemplate: "Somma lo stock per nazione del fornitore.", queryTemplate: "SELECT fornitori.nazione, SUM(prodotti.stock) FROM prodotti JOIN fornitori ON prodotti.fornitore_id = fornitori.id GROUP BY fornitori.nazione", hints: ["JOIN e GROUP BY nazione"], explanation: "Disponibilità geografica.", replacements: {} },
            { titleTemplate: "Conteggio Prodotti per Nazione", descTemplate: "Conta i prodotti per nazione del fornitore.", queryTemplate: "SELECT fornitori.nazione, COUNT(*) FROM prodotti JOIN fornitori ON prodotti.fornitore_id = fornitori.id GROUP BY fornitori.nazione", hints: ["JOIN e GROUP BY nazione"], explanation: "Assortimento geografico.", replacements: {} }
        ],
        [Difficulty.Hard]: [
            { titleTemplate: "Filtro Having (Stock > {val})", descTemplate: "Mostra le categorie che hanno un totale di stock superiore a {val}.", queryTemplate: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id HAVING SUM(stock) > {val}", hints: ["Usa HAVING dopo GROUP BY", "Non usare WHERE per aggregati"], explanation: "HAVING filtra i gruppi, WHERE filtra le righe.", replacements: { val: DATA.stock_thresholds } },
            { titleTemplate: "Clienti Top ({val} Ordini)", descTemplate: "Trova gli utenti che hanno effettuato più di {val} ordini.", queryTemplate: "SELECT utente_id, COUNT(*) FROM ordini GROUP BY utente_id HAVING COUNT(*) > {val}", hints: ["HAVING COUNT(*) > ..."], explanation: "Identificazione power users.", replacements: { val: [1, 2, 3, 4, 5] } },
            { titleTemplate: "Media Prezzo per Fornitore", descTemplate: "Calcola il prezzo medio dei prodotti per ogni fornitore, ma mostra solo i fornitori con media superiore a 50.", queryTemplate: "SELECT fornitore_id, AVG(prezzo) FROM prodotti GROUP BY fornitore_id HAVING AVG(prezzo) > 50", hints: ["GROUP BY e HAVING AVG"], explanation: "Analisi fornitori costosi.", replacements: {} },
            { titleTemplate: "HAVING COUNT > {val}", descTemplate: "Trova le categorie con più di {val} prodotti.", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) > {val}", hints: ["HAVING COUNT(*) > {val}"], explanation: "HAVING con COUNT.", replacements: { val: [2, 3, 5, 10] } },
            { titleTemplate: "HAVING SUM > {val}", descTemplate: "Trova le categorie con somma stock superiore a {val}.", queryTemplate: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id HAVING SUM(stock) > {val}", hints: ["HAVING SUM(stock) > {val}"], explanation: "HAVING con SUM.", replacements: { val: [50, 100, 150, 200] } },
            { titleTemplate: "HAVING AVG > {val}", descTemplate: "Trova le categorie con prezzo medio superiore a {val}.", queryTemplate: "SELECT categoria_id, AVG(prezzo) FROM prodotti GROUP BY categoria_id HAVING AVG(prezzo) > {val}", hints: ["HAVING AVG(prezzo) > {val}"], explanation: "HAVING con AVG.", replacements: { val: [50, 100, 150, 200] } },
            { titleTemplate: "HAVING MAX > {val}", descTemplate: "Trova le categorie con prezzo massimo superiore a {val}.", queryTemplate: "SELECT categoria_id, MAX(prezzo) FROM prodotti GROUP BY categoria_id HAVING MAX(prezzo) > {val}", hints: ["HAVING MAX(prezzo) > {val}"], explanation: "HAVING con MAX.", replacements: { val: [100, 150, 200, 250] } },
            { titleTemplate: "HAVING MIN < {val}", descTemplate: "Trova le categorie con prezzo minimo inferiore a {val}.", queryTemplate: "SELECT categoria_id, MIN(prezzo) FROM prodotti GROUP BY categoria_id HAVING MIN(prezzo) < {val}", hints: ["HAVING MIN(prezzo) < {val}"], explanation: "HAVING con MIN.", replacements: { val: [50, 100, 150] } },
            { titleTemplate: "HAVING COUNT >= {val}", descTemplate: "Trova gli utenti con almeno {val} ordini.", queryTemplate: "SELECT utente_id, COUNT(*) FROM ordini GROUP BY utente_id HAVING COUNT(*) >= {val}", hints: ["HAVING COUNT(*) >= {val}"], explanation: "HAVING con COUNT >=", replacements: { val: [2, 3, 5] } },
            { titleTemplate: "HAVING SUM >= {val}", descTemplate: "Trova gli utenti con somma quantità ordinate >= {val}.", queryTemplate: "SELECT utente_id, SUM(quantita) FROM ordini GROUP BY utente_id HAVING SUM(quantita) >= {val}", hints: ["HAVING SUM(quantita) >= {val}"], explanation: "HAVING con SUM >=", replacements: { val: [10, 20, 30, 50] } },
            { titleTemplate: "HAVING AVG >= {val}", descTemplate: "Trova i prodotti con voto medio >= {val}.", queryTemplate: "SELECT prodotto_id, AVG(voto) FROM recensioni GROUP BY prodotto_id HAVING AVG(voto) >= {val}", hints: ["HAVING AVG(voto) >= {val}"], explanation: "HAVING con AVG >=", replacements: { val: [3, 4, 5] } },
            { titleTemplate: "HAVING COUNT < {val}", descTemplate: "Trova le categorie con meno di {val} prodotti.", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) < {val}", hints: ["HAVING COUNT(*) < {val}"], explanation: "HAVING con COUNT <", replacements: { val: [5, 10, 15] } },
            { titleTemplate: "HAVING SUM < {val}", descTemplate: "Trova le categorie con somma stock < {val}.", queryTemplate: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id HAVING SUM(stock) < {val}", hints: ["HAVING SUM(stock) < {val}"], explanation: "HAVING con SUM <", replacements: { val: [50, 100, 150] } },
            { titleTemplate: "HAVING AVG < {val}", descTemplate: "Trova le categorie con prezzo medio < {val}.", queryTemplate: "SELECT categoria_id, AVG(prezzo) FROM prodotti GROUP BY categoria_id HAVING AVG(prezzo) < {val}", hints: ["HAVING AVG(prezzo) < {val}"], explanation: "HAVING con AVG <", replacements: { val: [50, 100, 150] } },
            { titleTemplate: "HAVING COUNT BETWEEN", descTemplate: "Trova le categorie con numero prodotti tra {min} e {max}.", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) BETWEEN {min} AND {max}", hints: ["HAVING COUNT(*) BETWEEN {min} AND {max}"], explanation: "HAVING con BETWEEN.", replacements: { min: [2, 5], max: [10, 20] } },
            { titleTemplate: "HAVING SUM BETWEEN", descTemplate: "Trova le categorie con somma stock tra {min} e {max}.", queryTemplate: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id HAVING SUM(stock) BETWEEN {min} AND {max}", hints: ["HAVING SUM(stock) BETWEEN {min} AND {max}"], explanation: "HAVING con BETWEEN su SUM.", replacements: { min: [50, 100], max: [200, 300] } },
            { titleTemplate: "HAVING AVG BETWEEN", descTemplate: "Trova le categorie con prezzo medio tra {min} e {max}.", queryTemplate: "SELECT categoria_id, AVG(prezzo) FROM prodotti GROUP BY categoria_id HAVING AVG(prezzo) BETWEEN {min} AND {max}", hints: ["HAVING AVG(prezzo) BETWEEN {min} AND {max}"], explanation: "HAVING con BETWEEN su AVG.", replacements: { min: [50, 100], max: [150, 200] } },
            { titleTemplate: "HAVING con OR", descTemplate: "Trova le categorie con COUNT > {val1} O SUM(stock) > {val2} (mostra conteggio e somma).", queryTemplate: "SELECT categoria_id, COUNT(*), SUM(stock) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) > {val1} OR SUM(stock) > {val2}", hints: ["HAVING con OR", "HAVING COUNT(*) > {val1} OR SUM(stock) > {val2}"], explanation: "HAVING con condizioni alternative.", replacements: { val1: [2, 3], val2: [50, 100] } },
            // NEW EXERCISES FOR AGGREGATION HARD
            { titleTemplate: "Fornitori con Media Prezzo > 100", descTemplate: "Trova fornitori con prezzo medio prodotti > 100 (mostra ID fornitore e media).", queryTemplate: "SELECT fornitore_id, AVG(prezzo) FROM prodotti GROUP BY fornitore_id HAVING AVG(prezzo) > 100", hints: ["HAVING AVG > 100"], explanation: "Fornitori fascia alta.", replacements: {} },
            { titleTemplate: "Categorie con Stock Basso (< 50)", descTemplate: "Trova categorie con stock totale inferiore a 50 (mostra ID categoria e somma).", queryTemplate: "SELECT categoria_id, SUM(stock) FROM prodotti GROUP BY categoria_id HAVING SUM(stock) < 50", hints: ["HAVING SUM < 50"], explanation: "Categorie a rischio.", replacements: {} },
            { titleTemplate: "Utenti con Spesa Totale > 1000 (Simulato)", descTemplate: "Trova utenti che hanno ordinato una quantità totale > 1000 (mostra ID utente e somma).", queryTemplate: "SELECT utente_id, SUM(quantita) FROM ordini GROUP BY utente_id HAVING SUM(quantita) > 1000", hints: ["HAVING SUM > 1000"], explanation: "Top spenders.", replacements: {} },
            { titleTemplate: "Prodotti con Molte Recensioni (> 5)", descTemplate: "Trova prodotti con più di 5 recensioni (mostra ID prodotto e conteggio).", queryTemplate: "SELECT prodotto_id, COUNT(*) FROM recensioni GROUP BY prodotto_id HAVING COUNT(*) > 5", hints: ["HAVING COUNT > 5"], explanation: "Prodotti popolari.", replacements: {} },
            { titleTemplate: "Prodotti con Voto Medio Basso (< 3)", descTemplate: "Trova prodotti con media voto inferiore a 3 (mostra ID prodotto e media).", queryTemplate: "SELECT prodotto_id, AVG(voto) FROM recensioni GROUP BY prodotto_id HAVING AVG(voto) < 3", hints: ["HAVING AVG < 3"], explanation: "Prodotti problematici.", replacements: {} },
            { titleTemplate: "Anni con Molti Ordini (> 100)", descTemplate: "Trova gli anni con più di 100 ordini (mostra anno e conteggio).", queryTemplate: "SELECT YEAR(data_ordine), COUNT(*) FROM ordini GROUP BY YEAR(data_ordine) HAVING COUNT(*) > 100", hints: ["GROUP BY YEAR, HAVING COUNT"], explanation: "Anni record.", replacements: {} },
            { titleTemplate: "Corrieri Molto Attivi (> 50 Spedizioni)", descTemplate: "Trova corrieri con più di 50 spedizioni (mostra corriere e conteggio).", queryTemplate: "SELECT corriere, COUNT(*) FROM spedizioni GROUP BY corriere HAVING COUNT(*) > 50", hints: ["HAVING COUNT > 50"], explanation: "Partner principali.", replacements: {} },
            { titleTemplate: "Categorie con Prezzo Max > 500", descTemplate: "Trova categorie che contengono almeno un prodotto costoso (> 500) (mostra ID categoria e prezzo max).", queryTemplate: "SELECT categoria_id, MAX(prezzo) FROM prodotti GROUP BY categoria_id HAVING MAX(prezzo) > 500", hints: ["HAVING MAX > 500"], explanation: "Categorie premium.", replacements: {} },
            { titleTemplate: "Fornitori con Stock Minimo > 10", descTemplate: "Trova fornitori che non hanno nessun prodotto con stock <= 10 (tutti > 10) (mostra ID fornitore e stock min).", queryTemplate: "SELECT fornitore_id, MIN(stock) FROM prodotti GROUP BY fornitore_id HAVING MIN(stock) > 10", hints: ["HAVING MIN > 10"], explanation: "Affidabilità stock.", replacements: {} },
            { titleTemplate: "Utenti con Media Voti Severa (< 2)", descTemplate: "Trova utenti che danno voti mediamente molto bassi (mostra ID utente e media).", queryTemplate: "SELECT utente_id, AVG(voto) FROM recensioni GROUP BY utente_id HAVING AVG(voto) < 2", hints: ["HAVING AVG < 2"], explanation: "Critici severi.", replacements: {} },
            { titleTemplate: "Utenti con Media Voti Generosa (> 4)", descTemplate: "Trova utenti che danno voti mediamente molto alti (mostra ID utente e media).", queryTemplate: "SELECT utente_id, AVG(voto) FROM recensioni GROUP BY utente_id HAVING AVG(voto) > 4", hints: ["HAVING AVG > 4"], explanation: "Promotori.", replacements: {} },
            { titleTemplate: "Categorie con Range Prezzi Ampio (> 100)", descTemplate: "Trova categorie dove la differenza tra prezzo max e min è > 100 (mostra ID categoria e delta).", queryTemplate: "SELECT categoria_id, MAX(prezzo) - MIN(prezzo) as Delta FROM prodotti GROUP BY categoria_id HAVING (MAX(prezzo) - MIN(prezzo)) > 100", hints: ["HAVING expr > 100"], explanation: "Varietà offerta.", replacements: {} },
            { titleTemplate: "Nazioni con Molti Fornitori (> 2)", descTemplate: "Trova nazioni che hanno più di 2 fornitori (mostra nazione e conteggio).", queryTemplate: "SELECT nazione, COUNT(*) FROM fornitori GROUP BY nazione HAVING COUNT(*) > 2", hints: ["GROUP BY nazione HAVING COUNT"], explanation: "Hub fornitori.", replacements: {} },
            { titleTemplate: "Mesi con Pochi Ordini (< 10)", descTemplate: "Trova mesi con meno di 10 ordini (mostra mese e conteggio).", queryTemplate: "SELECT MONTH(data_ordine), COUNT(*) FROM ordini GROUP BY MONTH(data_ordine) HAVING COUNT(*) < 10", hints: ["GROUP BY MONTH HAVING COUNT"], explanation: "Stagionalità bassa.", replacements: {} },
            { titleTemplate: "Utenti con Unico Ordine", descTemplate: "Trova utenti che hanno fatto esattamente 1 ordine (mostra ID utente e conteggio).", queryTemplate: "SELECT utente_id, COUNT(*) FROM ordini GROUP BY utente_id HAVING COUNT(*) = 1", hints: ["HAVING COUNT = 1"], explanation: "One-time buyers.", replacements: {} },
            { titleTemplate: "Prodotti con Voto Unanime (Min=Max)", descTemplate: "Trova prodotti dove tutti i voti sono uguali (Min = Max) e ci sono almeno 2 voti (mostra ID, min e max).", queryTemplate: "SELECT prodotto_id, MIN(voto), MAX(voto) FROM recensioni GROUP BY prodotto_id HAVING MIN(voto) = MAX(voto) AND COUNT(*) >= 2", hints: ["HAVING MIN=MAX AND COUNT>=2"], explanation: "Consenso totale.", replacements: {} },
            { titleTemplate: "HAVING COUNT e AVG", descTemplate: "Trova i prodotti con più di {val1} recensioni E voto medio >= {val2} (mostra ID, conteggio e media).", queryTemplate: "SELECT prodotto_id, COUNT(*), AVG(voto) FROM recensioni GROUP BY prodotto_id HAVING COUNT(*) > {val1} AND AVG(voto) >= {val2}", hints: ["HAVING con COUNT e AVG", "HAVING COUNT(*) > {val1} AND AVG(voto) >= {val2}"], explanation: "HAVING con COUNT e AVG.", replacements: { val1: [1, 2], val2: [3, 4] } },
            { titleTemplate: "HAVING con ORDER BY", descTemplate: "Trova le categorie con COUNT > {val}, ordinate per COUNT decrescente.", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) > {val} ORDER BY COUNT(*) DESC", hints: ["HAVING con ORDER BY", "HAVING COUNT(*) > {val} ORDER BY COUNT(*) DESC"], explanation: "HAVING con ordinamento.", replacements: { val: [2, 3, 5] } },
            { titleTemplate: "HAVING con ORDER BY AVG", descTemplate: "Trova le categorie con AVG(prezzo) > {val}, ordinate per AVG decrescente.", queryTemplate: "SELECT categoria_id, AVG(prezzo) FROM prodotti GROUP BY categoria_id HAVING AVG(prezzo) > {val} ORDER BY AVG(prezzo) DESC", hints: ["HAVING con ORDER BY AVG", "HAVING AVG(prezzo) > {val} ORDER BY AVG(prezzo) DESC"], explanation: "HAVING con ordinamento su AVG.", replacements: { val: [50, 100, 150] } },
            { titleTemplate: "HAVING con LIMIT", descTemplate: "Trova le prime 5 categorie con COUNT > {val}, ordinate per COUNT decrescente.", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) > {val} ORDER BY COUNT(*) DESC LIMIT 5", hints: ["HAVING con ORDER BY e LIMIT", "HAVING COUNT(*) > {val} ORDER BY COUNT(*) DESC LIMIT 5"], explanation: "HAVING con LIMIT.", replacements: { val: [2, 3, 5] } },
            { titleTemplate: "HAVING Complesso Finale", descTemplate: "Trova le categorie con COUNT > {val1} E AVG(prezzo) > {val2}, ordinate per AVG decrescente, limitate a 5 (mostra ID, conteggio e media).", queryTemplate: "SELECT categoria_id, COUNT(*), AVG(prezzo) FROM prodotti GROUP BY categoria_id HAVING COUNT(*) > {val1} AND AVG(prezzo) > {val2} ORDER BY AVG(prezzo) DESC LIMIT 5", hints: ["HAVING complesso", "HAVING COUNT(*) > {val1} AND AVG(prezzo) > {val2} ORDER BY AVG(prezzo) DESC LIMIT 5"], explanation: "HAVING complesso con filtri multipli, ordinamento e LIMIT.", replacements: { val1: [2, 3], val2: [50, 100] } }
        ]
    },
    [TopicId.Case]: {
        [Difficulty.Easy]: [
            { titleTemplate: "Simple Case", descTemplate: "Classifica lo stock: se > 0 'Disponibile', altrimenti 'Esaurito'.", queryTemplate: "SELECT nome, CASE WHEN stock > 0 THEN 'Disponibile' ELSE 'Esaurito' END FROM prodotti", hints: ["CASE WHEN ... THEN ... ELSE ... END"], explanation: "CASE base con due condizioni.", replacements: {} },
            { titleTemplate: "Case Stock Disponibile", descTemplate: "Classifica lo stock: se > 0 'Disponibile', altrimenti 'Esaurito'.", queryTemplate: "SELECT nome, CASE WHEN stock > 0 THEN 'Disponibile' ELSE 'Esaurito' END AS stato FROM prodotti", hints: ["CASE con alias", "CASE ... END AS stato"], explanation: "CASE con alias.", replacements: {} },
            { titleTemplate: "Case Prezzo Alto", descTemplate: "Classifica il prezzo: se > 100 'Alto', altrimenti 'Basso'.", queryTemplate: "SELECT nome, CASE WHEN prezzo > 100 THEN 'Alto' ELSE 'Basso' END FROM prodotti", hints: ["CASE con confronto numerico", "CASE WHEN prezzo > 100 THEN 'Alto' ELSE 'Basso' END"], explanation: "CASE con confronto numerico.", replacements: {} },
            { titleTemplate: "Case Prezzo Medio", descTemplate: "Classifica il prezzo: se > 50 'Medio', altrimenti 'Basso'.", queryTemplate: "SELECT nome, CASE WHEN prezzo > 50 THEN 'Medio' ELSE 'Basso' END FROM prodotti", hints: ["CASE con soglia 50", "CASE WHEN prezzo > 50 THEN 'Medio' ELSE 'Basso' END"], explanation: "CASE con soglia diversa.", replacements: {} },
            { titleTemplate: "Case Voto Alto", descTemplate: "Classifica il voto: se >= 4 'Alto', altrimenti 'Basso'.", queryTemplate: "SELECT voto, CASE WHEN voto >= 4 THEN 'Alto' ELSE 'Basso' END FROM recensioni", hints: ["CASE con >=", "CASE WHEN voto >= 4 THEN 'Alto' ELSE 'Basso' END"], explanation: "CASE con >=", replacements: {} },
            { titleTemplate: "Case Voto Basso", descTemplate: "Classifica il voto: se < 3 'Basso', altrimenti 'Alto'.", queryTemplate: "SELECT voto, CASE WHEN voto < 3 THEN 'Basso' ELSE 'Alto' END FROM recensioni", hints: ["CASE con <", "CASE WHEN voto < 3 THEN 'Basso' ELSE 'Alto' END"], explanation: "CASE con <", replacements: {} },
            { titleTemplate: "Case Quantità", descTemplate: "Classifica la quantità: se > 5 'Grande', altrimenti 'Piccola'.", queryTemplate: "SELECT quantita, CASE WHEN quantita > 5 THEN 'Grande' ELSE 'Piccola' END FROM ordini", hints: ["CASE su quantità", "CASE WHEN quantita > 5 THEN 'Grande' ELSE 'Piccola' END"], explanation: "CASE su quantità.", replacements: {} },
            { titleTemplate: "Case Premium", descTemplate: "Classifica gli utenti: se premium = TRUE 'Premium', altrimenti 'Standard'.", queryTemplate: "SELECT nome, CASE WHEN premium = TRUE THEN 'Premium' ELSE 'Standard' END FROM utenti", hints: ["CASE con booleano", "CASE WHEN premium = TRUE THEN 'Premium' ELSE 'Standard' END"], explanation: "CASE con booleano.", replacements: {} },
            { titleTemplate: "Case NULL Tracking", descTemplate: "Classifica le spedizioni: se codice_tracking IS NULL 'In Attesa', altrimenti 'Tracciata'.", queryTemplate: "SELECT CASE WHEN codice_tracking IS NULL THEN 'In Attesa' ELSE 'Tracciata' END FROM spedizioni", hints: ["CASE con IS NULL", "CASE WHEN codice_tracking IS NULL THEN 'In Attesa' ELSE 'Tracciata' END"], explanation: "CASE con IS NULL.", replacements: {} },
            { titleTemplate: "Case Stock Zero", descTemplate: "Classifica lo stock: se = 0 'Esaurito', altrimenti 'Disponibile'.", queryTemplate: "SELECT nome, CASE WHEN stock = 0 THEN 'Esaurito' ELSE 'Disponibile' END FROM prodotti", hints: ["CASE con =", "CASE WHEN stock = 0 THEN 'Esaurito' ELSE 'Disponibile' END"], explanation: "CASE con uguaglianza.", replacements: {} },
            { titleTemplate: "Case Prezzo Zero", descTemplate: "Classifica il prezzo: se = 0 'Gratis', altrimenti 'A Pagamento'.", queryTemplate: "SELECT nome, CASE WHEN prezzo = 0 THEN 'Gratis' ELSE 'A Pagamento' END FROM prodotti", hints: ["CASE con = 0", "CASE WHEN prezzo = 0 THEN 'Gratis' ELSE 'A Pagamento' END"], explanation: "CASE con zero.", replacements: {} },
            { titleTemplate: "Case Voto Cinque", descTemplate: "Classifica il voto: se = 5 'Perfetto', altrimenti 'Normale'.", queryTemplate: "SELECT voto, CASE WHEN voto = 5 THEN 'Perfetto' ELSE 'Normale' END FROM recensioni", hints: ["CASE con = 5", "CASE WHEN voto = 5 THEN 'Perfetto' ELSE 'Normale' END"], explanation: "CASE con valore specifico.", replacements: {} },
            { titleTemplate: "Case Quantità Uno", descTemplate: "Classifica la quantità: se = 1 'Singolo', altrimenti 'Multiplo'.", queryTemplate: "SELECT quantita, CASE WHEN quantita = 1 THEN 'Singolo' ELSE 'Multiplo' END FROM ordini", hints: ["CASE con = 1", "CASE WHEN quantita = 1 THEN 'Singolo' ELSE 'Multiplo' END"], explanation: "CASE con uno.", replacements: {} },
            { titleTemplate: "Case Stock Maggiore", descTemplate: "Classifica lo stock: se > 20 'Abbondante', altrimenti 'Limitato'.", queryTemplate: "SELECT nome, CASE WHEN stock > 20 THEN 'Abbondante' ELSE 'Limitato' END FROM prodotti", hints: ["CASE con > 20", "CASE WHEN stock > 20 THEN 'Abbondante' ELSE 'Limitato' END"], explanation: "CASE con soglia stock.", replacements: {} },
            { titleTemplate: "Case Prezzo Minore", descTemplate: "Classifica il prezzo: se < 30 'Economico', altrimenti 'Normale'.", queryTemplate: "SELECT nome, CASE WHEN prezzo < 30 THEN 'Economico' ELSE 'Normale' END FROM prodotti", hints: ["CASE con < 30", "CASE WHEN prezzo < 30 THEN 'Economico' ELSE 'Normale' END"], explanation: "CASE con <", replacements: {} },
            { titleTemplate: "Case Voto Maggiore", descTemplate: "Classifica il voto: se > 3 'Positivo', altrimenti 'Negativo'.", queryTemplate: "SELECT voto, CASE WHEN voto > 3 THEN 'Positivo' ELSE 'Negativo' END FROM recensioni", hints: ["CASE con > 3", "CASE WHEN voto > 3 THEN 'Positivo' ELSE 'Negativo' END"], explanation: "CASE con >", replacements: {} },
            { titleTemplate: "Case Quantità Maggiore", descTemplate: "Classifica la quantità: se > 10 'Grande Ordine', altrimenti 'Piccolo Ordine'.", queryTemplate: "SELECT quantita, CASE WHEN quantita > 10 THEN 'Grande Ordine' ELSE 'Piccolo Ordine' END FROM ordini", hints: ["CASE con > 10", "CASE WHEN quantita > 10 THEN 'Grande Ordine' ELSE 'Piccolo Ordine' END"], explanation: "CASE con soglia alta.", replacements: {} },
            { titleTemplate: "Case Stock Minore", descTemplate: "Classifica lo stock: se < 10 'Basso', altrimenti 'Sufficiente'.", queryTemplate: "SELECT nome, CASE WHEN stock < 10 THEN 'Basso' ELSE 'Sufficiente' END FROM prodotti", hints: ["CASE con < 10", "CASE WHEN stock < 10 THEN 'Basso' ELSE 'Sufficiente' END"], explanation: "CASE con <", replacements: {} },
            { titleTemplate: "Case Prezzo Maggiore Uguale", descTemplate: "Classifica il prezzo: se >= 100 'Costoso', altrimenti 'Accessibile'.", queryTemplate: "SELECT nome, CASE WHEN prezzo >= 100 THEN 'Costoso' ELSE 'Accessibile' END FROM prodotti", hints: ["CASE con >=", "CASE WHEN prezzo >= 100 THEN 'Costoso' ELSE 'Accessibile' END"], explanation: "CASE con >=", replacements: {} },
            { titleTemplate: "Case Voto Minore Uguale", descTemplate: "Classifica il voto: se <= 2 'Basso', altrimenti 'Alto'.", queryTemplate: "SELECT voto, CASE WHEN voto <= 2 THEN 'Basso' ELSE 'Alto' END FROM recensioni", hints: ["CASE con <=", "CASE WHEN voto <= 2 THEN 'Basso' ELSE 'Alto' END"], explanation: "CASE con <=", replacements: {} },
            { titleTemplate: "Case Quantità Minore Uguale", descTemplate: "Classifica la quantità: se <= 3 'Piccolo', altrimenti 'Grande'.", queryTemplate: "SELECT quantita, CASE WHEN quantita <= 3 THEN 'Piccolo' ELSE 'Grande' END FROM ordini", hints: ["CASE con <=", "CASE WHEN quantita <= 3 THEN 'Piccolo' ELSE 'Grande' END"], explanation: "CASE con <=", replacements: {} },
            { titleTemplate: "Case Stock Maggiore Uguale", descTemplate: "Classifica lo stock: se >= 50 'Alto', altrimenti 'Basso'.", queryTemplate: "SELECT nome, CASE WHEN stock >= 50 THEN 'Alto' ELSE 'Basso' END FROM prodotti", hints: ["CASE con >=", "CASE WHEN stock >= 50 THEN 'Alto' ELSE 'Basso' END"], explanation: "CASE con >= su stock.", replacements: {} },
            { titleTemplate: "Case Prezzo Minore Uguale", descTemplate: "Classifica il prezzo: se <= 50 'Economico', altrimenti 'Costoso'.", queryTemplate: "SELECT nome, CASE WHEN prezzo <= 50 THEN 'Economico' ELSE 'Costoso' END FROM prodotti", hints: ["CASE con <=", "CASE WHEN prezzo <= 50 THEN 'Economico' ELSE 'Costoso' END"], explanation: "CASE con <= su prezzo.", replacements: {} },
            { titleTemplate: "Case Voto Maggiore Uguale", descTemplate: "Classifica il voto: se >= 4 'Eccellente', altrimenti 'Normale'.", queryTemplate: "SELECT voto, CASE WHEN voto >= 4 THEN 'Eccellente' ELSE 'Normale' END FROM recensioni", hints: ["CASE con >=", "CASE WHEN voto >= 4 THEN 'Eccellente' ELSE 'Normale' END"], explanation: "CASE con >= su voto.", replacements: {} },
            { titleTemplate: "Case Quantità Maggiore Uguale", descTemplate: "Classifica la quantità: se >= 5 'Media', altrimenti 'Piccola'.", queryTemplate: "SELECT quantita, CASE WHEN quantita >= 5 THEN 'Media' ELSE 'Piccola' END FROM ordini", hints: ["CASE con >=", "CASE WHEN quantita >= 5 THEN 'Media' ELSE 'Piccola' END"], explanation: "CASE con >= su quantità.", replacements: {} },
            { titleTemplate: "Case Stock Minore Uguale", descTemplate: "Classifica lo stock: se <= 5 'Critico', altrimenti 'Normale'.", queryTemplate: "SELECT nome, CASE WHEN stock <= 5 THEN 'Critico' ELSE 'Normale' END FROM prodotti", hints: ["CASE con <=", "CASE WHEN stock <= 5 THEN 'Critico' ELSE 'Normale' END"], explanation: "CASE con <= su stock.", replacements: {} },
            { titleTemplate: "Case Prezzo Non Zero", descTemplate: "Classifica il prezzo: se <> 0 'A Pagamento', altrimenti 'Gratis'.", queryTemplate: "SELECT nome, CASE WHEN prezzo <> 0 THEN 'A Pagamento' ELSE 'Gratis' END FROM prodotti", hints: ["CASE con <>", "CASE WHEN prezzo <> 0 THEN 'A Pagamento' ELSE 'Gratis' END"], explanation: "CASE con <>.", replacements: {} },
            { titleTemplate: "Case Voto Non Cinque", descTemplate: "Classifica il voto: se <> 5 'Migliorabile', altrimenti 'Perfetto'.", queryTemplate: "SELECT voto, CASE WHEN voto <> 5 THEN 'Migliorabile' ELSE 'Perfetto' END FROM recensioni", hints: ["CASE con <>", "CASE WHEN voto <> 5 THEN 'Migliorabile' ELSE 'Perfetto' END"], explanation: "CASE con <> su voto.", replacements: {} },
            { titleTemplate: "Case Quantità Non Uno", descTemplate: "Classifica la quantità: se <> 1 'Multiplo', altrimenti 'Singolo'.", queryTemplate: "SELECT quantita, CASE WHEN quantita <> 1 THEN 'Multiplo' ELSE 'Singolo' END FROM ordini", hints: ["CASE con <>", "CASE WHEN quantita <> 1 THEN 'Multiplo' ELSE 'Singolo' END"], explanation: "CASE con <> su quantità.", replacements: {} },
            { titleTemplate: "Case Stock Non Zero", descTemplate: "Classifica lo stock: se <> 0 'Disponibile', altrimenti 'Esaurito'.", queryTemplate: "SELECT nome, CASE WHEN stock <> 0 THEN 'Disponibile' ELSE 'Esaurito' END FROM prodotti", hints: ["CASE con <>", "CASE WHEN stock <> 0 THEN 'Disponibile' ELSE 'Esaurito' END"], explanation: "CASE con <> su stock.", replacements: {} },
            // NEW EXERCISES FOR CASE EASY
            { titleTemplate: "Case Categoria Elettronica", descTemplate: "Classifica i prodotti: se categoria_id = 1 'Elettronica', altrimenti 'Altro'.", queryTemplate: "SELECT nome, CASE WHEN categoria_id = 1 THEN 'Elettronica' ELSE 'Altro' END FROM prodotti", hints: ["CASE con categoria_id"], explanation: "Classificazione per ID.", replacements: {} },
            { titleTemplate: "Case Fornitore Principale", descTemplate: "Classifica i prodotti: se fornitore_id = 1 'Principale', altrimenti 'Secondario'.", queryTemplate: "SELECT nome, CASE WHEN fornitore_id = 1 THEN 'Principale' ELSE 'Secondario' END FROM prodotti", hints: ["CASE con fornitore_id"], explanation: "Classificazione fornitore.", replacements: {} },
            { titleTemplate: "Case Data Futura", descTemplate: "Classifica gli ordini: se data_ordine > '2024-01-01' 'Futuro', altrimenti 'Passato'.", queryTemplate: "SELECT id, CASE WHEN data_ordine > '2024-01-01' THEN 'Futuro' ELSE 'Passato' END FROM ordini", hints: ["CASE con data"], explanation: "Classificazione temporale.", replacements: {} },
            { titleTemplate: "Case Voto Sufficienza", descTemplate: "Classifica le recensioni: se voto >= 3 'Sufficiente', altrimenti 'Insufficiente'.", queryTemplate: "SELECT voto, CASE WHEN voto >= 3 THEN 'Sufficiente' ELSE 'Insufficiente' END FROM recensioni", hints: ["CASE con >="], explanation: "Soglia su voto.", replacements: {} },
            { titleTemplate: "Case Quantità Minima", descTemplate: "Classifica gli ordini: se quantita < 2 'Minimo', altrimenti 'Standard'.", queryTemplate: "SELECT quantita, CASE WHEN quantita < 2 THEN 'Minimo' ELSE 'Standard' END FROM ordini", hints: ["CASE con <"], explanation: "Soglia quantità.", replacements: {} },
            { titleTemplate: "Case Nome Inizia con A", descTemplate: "Classifica utenti: se nome inizia con 'A' 'Gruppo A', altrimenti 'Altri'.", queryTemplate: "SELECT nome, CASE WHEN nome LIKE 'A%' THEN 'Gruppo A' ELSE 'Altri' END FROM utenti", hints: ["CASE con LIKE"], explanation: "Classificazione stringa.", replacements: {} },
            { titleTemplate: "Case Email Gmail", descTemplate: "Classifica utenti: se email contiene 'gmail' 'Google', altrimenti 'Altro'.", queryTemplate: "SELECT email, CASE WHEN email LIKE '%gmail%' THEN 'Google' ELSE 'Altro' END FROM utenti", hints: ["CASE con LIKE"], explanation: "Classificazione email.", replacements: {} },
            { titleTemplate: "Case Prezzo Pari", descTemplate: "Classifica prezzo: se prezzo % 2 = 0 'Pari', altrimenti 'Dispari'.", queryTemplate: "SELECT prezzo, CASE WHEN prezzo % 2 = 0 THEN 'Pari' ELSE 'Dispari' END FROM prodotti", hints: ["CASE con modulo"], explanation: "Logica aritmetica.", replacements: {} },
            { titleTemplate: "Case Stock Multiplo 10", descTemplate: "Classifica stock: se stock % 10 = 0 'Multiplo 10', altrimenti 'No'.", queryTemplate: "SELECT stock, CASE WHEN stock % 10 = 0 THEN 'Multiplo 10' ELSE 'No' END FROM prodotti", hints: ["CASE con modulo"], explanation: "Logica aritmetica stock.", replacements: {} },
            { titleTemplate: "Case Lunghezza Nome", descTemplate: "Classifica nome: se LENGTH(nome) > 5 'Lungo', altrimenti 'Corto'.", queryTemplate: "SELECT nome, CASE WHEN LENGTH(nome) > 5 THEN 'Lungo' ELSE 'Corto' END FROM prodotti", hints: ["CASE con LENGTH"], explanation: "Logica su stringhe.", replacements: {} },
            { titleTemplate: "Case Mese Estivo", descTemplate: "Classifica ordini: se MONTH(data_ordine) IN (6,7,8) 'Estate', altrimenti 'Altro'.", queryTemplate: "SELECT data_ordine, CASE WHEN MONTH(data_ordine) IN (6,7,8) THEN 'Estate' ELSE 'Altro' END FROM ordini", hints: ["CASE con IN e MONTH"], explanation: "Logica su date.", replacements: {} },
            { titleTemplate: "Case Anno Corrente", descTemplate: "Classifica ordini: se YEAR(data_ordine) = YEAR(NOW()) 'Corrente', altrimenti 'Storico'.", queryTemplate: "SELECT data_ordine, CASE WHEN YEAR(data_ordine) = YEAR(NOW()) THEN 'Corrente' ELSE 'Storico' END FROM ordini", hints: ["CASE con YEAR e NOW"], explanation: "Confronto dinamico.", replacements: {} },
            { titleTemplate: "Case Paese Italia", descTemplate: "Classifica utenti: se paese = 'Italia' 'Nazionale', altrimenti 'Estero'.", queryTemplate: "SELECT paese, CASE WHEN paese = 'Italia' THEN 'Nazionale' ELSE 'Estero' END FROM utenti", hints: ["CASE uguaglianza stringa"], explanation: "Logica geografica.", replacements: {} },
            { titleTemplate: "Case Corriere DHL", descTemplate: "Classifica spedizioni: se corriere = 'DHL' 'Express', altrimenti 'Standard'.", queryTemplate: "SELECT corriere, CASE WHEN corriere = 'DHL' THEN 'Express' ELSE 'Standard' END FROM spedizioni", hints: ["CASE uguaglianza"], explanation: "Logica logistica.", replacements: {} },
            { titleTemplate: "Case Voto Massimo", descTemplate: "Classifica recensioni: se voto = 5 'Top', altrimenti 'Non Top'.", queryTemplate: "SELECT voto, CASE WHEN voto = 5 THEN 'Top' ELSE 'Non Top' END FROM recensioni", hints: ["CASE uguaglianza numerica"], explanation: "Identificazione eccellenza.", replacements: {} }
        ],
        [Difficulty.Medium]: [
            { titleTemplate: "Fasce di Prezzo", descTemplate: "Etichetta i prodotti: 'Economico' (< 50), 'Medio' (50-150), 'Lusso' (> 150).", queryTemplate: "SELECT nome, CASE WHEN prezzo < 50 THEN 'Economico' WHEN prezzo <= 150 THEN 'Medio' ELSE 'Lusso' END FROM prodotti", hints: ["CASE con WHEN multipli", "CASE WHEN ... WHEN ... ELSE ... END"], explanation: "CASE con più condizioni.", replacements: {} },
            { titleTemplate: "Fasce di Stock", descTemplate: "Etichetta lo stock: 'Esaurito' (= 0), 'Basso' (1-10), 'Medio' (11-30), 'Alto' (> 30).", queryTemplate: "SELECT nome, CASE WHEN stock = 0 THEN 'Esaurito' WHEN stock <= 10 THEN 'Basso' WHEN stock <= 30 THEN 'Medio' ELSE 'Alto' END FROM prodotti", hints: ["CASE con tre WHEN", "CASE WHEN ... WHEN ... WHEN ... ELSE ... END"], explanation: "CASE con tre condizioni.", replacements: {} },
            { titleTemplate: "Fasce di Voto", descTemplate: "Etichetta i voti: 'Basso' (1-2), 'Medio' (3), 'Alto' (4-5).", queryTemplate: "SELECT voto, CASE WHEN voto <= 2 THEN 'Basso' WHEN voto = 3 THEN 'Medio' ELSE 'Alto' END FROM recensioni", hints: ["CASE con range", "CASE WHEN voto <= 2 THEN 'Basso' WHEN voto = 3 THEN 'Medio' ELSE 'Alto' END"], explanation: "CASE con range voti.", replacements: {} },
            { titleTemplate: "Fasce di Quantità", descTemplate: "Etichetta le quantità: 'Piccolo' (1-3), 'Medio' (4-7), 'Grande' (> 7).", queryTemplate: "SELECT quantita, CASE WHEN quantita <= 3 THEN 'Piccolo' WHEN quantita <= 7 THEN 'Medio' ELSE 'Grande' END FROM ordini", hints: ["CASE con range quantità", "CASE WHEN quantita <= 3 THEN 'Piccolo' WHEN quantita <= 7 THEN 'Medio' ELSE 'Grande' END"], explanation: "CASE con range quantità.", replacements: {} },
            { titleTemplate: "Fasce Prezzo Quattro", descTemplate: "Etichetta i prezzi: 'Economico' (< 30), 'Medio' (30-80), 'Costoso' (80-150), 'Lusso' (> 150).", queryTemplate: "SELECT nome, CASE WHEN prezzo < 30 THEN 'Economico' WHEN prezzo <= 80 THEN 'Medio' WHEN prezzo <= 150 THEN 'Costoso' ELSE 'Lusso' END FROM prodotti", hints: ["CASE con quattro WHEN", "CASE WHEN ... WHEN ... WHEN ... WHEN ... ELSE ... END"], explanation: "CASE con quattro condizioni.", replacements: {} },
            { titleTemplate: "Fasce Stock Quattro", descTemplate: "Etichetta lo stock: 'Esaurito' (= 0), 'Basso' (1-5), 'Medio' (6-20), 'Alto' (> 20).", queryTemplate: "SELECT nome, CASE WHEN stock = 0 THEN 'Esaurito' WHEN stock <= 5 THEN 'Basso' WHEN stock <= 20 THEN 'Medio' ELSE 'Alto' END FROM prodotti", hints: ["CASE con quattro WHEN", "CASE WHEN stock = 0 THEN 'Esaurito' WHEN stock <= 5 THEN 'Basso' WHEN stock <= 20 THEN 'Medio' ELSE 'Alto' END"], explanation: "CASE con quattro condizioni stock.", replacements: {} },
            { titleTemplate: "Fasce Voto Quattro", descTemplate: "Etichetta i voti: 'Molto Basso' (1), 'Basso' (2), 'Medio' (3), 'Alto' (4-5).", queryTemplate: "SELECT voto, CASE WHEN voto = 1 THEN 'Molto Basso' WHEN voto = 2 THEN 'Basso' WHEN voto = 3 THEN 'Medio' ELSE 'Alto' END FROM recensioni", hints: ["CASE con quattro WHEN", "CASE WHEN voto = 1 THEN 'Molto Basso' WHEN voto = 2 THEN 'Basso' WHEN voto = 3 THEN 'Medio' ELSE 'Alto' END"], explanation: "CASE con quattro condizioni voto.", replacements: {} },
            { titleTemplate: "Fasce Quantità Quattro", descTemplate: "Etichetta le quantità: 'Singolo' (1), 'Piccolo' (2-4), 'Medio' (5-9), 'Grande' (> 9).", queryTemplate: "SELECT quantita, CASE WHEN quantita = 1 THEN 'Singolo' WHEN quantita <= 4 THEN 'Piccolo' WHEN quantita <= 9 THEN 'Medio' ELSE 'Grande' END FROM ordini", hints: ["CASE con quattro WHEN", "CASE WHEN quantita = 1 THEN 'Singolo' WHEN quantita <= 4 THEN 'Piccolo' WHEN quantita <= 9 THEN 'Medio' ELSE 'Grande' END"], explanation: "CASE con quattro condizioni quantità.", replacements: {} },
            { titleTemplate: "Case con AND", descTemplate: "Classifica i prodotti: se prezzo > 100 E stock > 10 'Premium', altrimenti 'Standard'.", queryTemplate: "SELECT nome, CASE WHEN prezzo > 100 AND stock > 10 THEN 'Premium' ELSE 'Standard' END FROM prodotti", hints: ["CASE con AND", "CASE WHEN prezzo > 100 AND stock > 10 THEN 'Premium' ELSE 'Standard' END"], explanation: "CASE con condizione AND.", replacements: {} },
            { titleTemplate: "Case con OR", descTemplate: "Classifica i prodotti: se prezzo < 30 O stock = 0 'Sconto', altrimenti 'Normale'.", queryTemplate: "SELECT nome, CASE WHEN prezzo < 30 OR stock = 0 THEN 'Sconto' ELSE 'Normale' END FROM prodotti", hints: ["CASE con OR", "CASE WHEN prezzo < 30 OR stock = 0 THEN 'Sconto' ELSE 'Normale' END"], explanation: "CASE con condizione OR.", replacements: {} },
            { titleTemplate: "Case con AND e OR", descTemplate: "Classifica i prodotti: se (prezzo > 100 E stock > 20) O prezzo < 20 'Speciale', altrimenti 'Normale'.", queryTemplate: "SELECT nome, CASE WHEN (prezzo > 100 AND stock > 20) OR prezzo < 20 THEN 'Speciale' ELSE 'Normale' END FROM prodotti", hints: ["CASE con AND e OR", "CASE WHEN (prezzo > 100 AND stock > 20) OR prezzo < 20 THEN 'Speciale' ELSE 'Normale' END"], explanation: "CASE con AND e OR.", replacements: {} },
            { titleTemplate: "Case con BETWEEN", descTemplate: "Classifica i prezzi: se tra 50 e 100 'Medio', altrimenti 'Altro'.", queryTemplate: "SELECT nome, CASE WHEN prezzo BETWEEN 50 AND 100 THEN 'Medio' ELSE 'Altro' END FROM prodotti", hints: ["CASE con BETWEEN", "CASE WHEN prezzo BETWEEN 50 AND 100 THEN 'Medio' ELSE 'Altro' END"], explanation: "CASE con BETWEEN.", replacements: {} },
            { titleTemplate: "Case con IN", descTemplate: "Classifica i voti: se in (4, 5) 'Alto', altrimenti 'Basso'.", queryTemplate: "SELECT voto, CASE WHEN voto IN (4, 5) THEN 'Alto' ELSE 'Basso' END FROM recensioni", hints: ["CASE con IN", "CASE WHEN voto IN (4, 5) THEN 'Alto' ELSE 'Basso' END"], explanation: "CASE con IN.", replacements: {} },
            { titleTemplate: "Case con LIKE", descTemplate: "Classifica i nomi prodotti: se inizia con 'Prod' 'Standard', altrimenti 'Altro'.", queryTemplate: "SELECT nome, CASE WHEN nome LIKE 'Prod%' THEN 'Standard' ELSE 'Altro' END FROM prodotti", hints: ["CASE con LIKE", "CASE WHEN nome LIKE 'Prod%' THEN 'Standard' ELSE 'Altro' END"], explanation: "CASE con LIKE.", replacements: {} },
            { titleTemplate: "Case con IS NULL", descTemplate: "Classifica le spedizioni: se codice_tracking IS NULL 'In Attesa', altrimenti 'Tracciata'.", queryTemplate: "SELECT CASE WHEN codice_tracking IS NULL THEN 'In Attesa' ELSE 'Tracciata' END FROM spedizioni", hints: ["CASE con IS NULL", "CASE WHEN codice_tracking IS NULL THEN 'In Attesa' ELSE 'Tracciata' END"], explanation: "CASE con IS NULL.", replacements: {} },
            { titleTemplate: "Case con IS NOT NULL", descTemplate: "Classifica le spedizioni: se codice_tracking IS NOT NULL 'Tracciata', altrimenti 'In Attesa'.", queryTemplate: "SELECT CASE WHEN codice_tracking IS NOT NULL THEN 'Tracciata' ELSE 'In Attesa' END FROM spedizioni", hints: ["CASE con IS NOT NULL", "CASE WHEN codice_tracking IS NOT NULL THEN 'Tracciata' ELSE 'In Attesa' END"], explanation: "CASE con IS NOT NULL.", replacements: {} },
            { titleTemplate: "Case con Alias", descTemplate: "Classifica lo stock come 'Stato' e mostra nome prodotto.", queryTemplate: "SELECT nome, CASE WHEN stock > 0 THEN 'Disponibile' ELSE 'Esaurito' END AS Stato FROM prodotti", hints: ["CASE con alias", "CASE ... END AS Stato"], explanation: "CASE con alias.", replacements: {} },
            { titleTemplate: "Case con Alias Prezzo", descTemplate: "Classifica il prezzo come 'Fascia' e mostra nome prodotto.", queryTemplate: "SELECT nome, CASE WHEN prezzo < 50 THEN 'Economico' WHEN prezzo <= 150 THEN 'Medio' ELSE 'Lusso' END AS Fascia FROM prodotti", hints: ["CASE con alias", "CASE ... END AS Fascia"], explanation: "CASE con alias su prezzo.", replacements: {} },
            { titleTemplate: "Case con Alias Voto", descTemplate: "Classifica il voto come 'Valutazione' e mostra voto.", queryTemplate: "SELECT voto, CASE WHEN voto <= 2 THEN 'Basso' WHEN voto = 3 THEN 'Medio' ELSE 'Alto' END AS Valutazione FROM recensioni", hints: ["CASE con alias", "CASE ... END AS Valutazione"], explanation: "CASE con alias su voto.", replacements: {} },
            { titleTemplate: "Case con Alias Quantità", descTemplate: "Classifica la quantità come 'Dimensione' e mostra quantità.", queryTemplate: "SELECT quantita, CASE WHEN quantita <= 3 THEN 'Piccolo' WHEN quantita <= 7 THEN 'Medio' ELSE 'Grande' END AS Dimensione FROM ordini", hints: ["CASE con alias", "CASE ... END AS Dimensione"], explanation: "CASE con alias su quantità.", replacements: {} },
            { titleTemplate: "Case con Calcolo", descTemplate: "Classifica il valore inventario (prezzo * stock): se > 1000 'Alto', altrimenti 'Basso'.", queryTemplate: "SELECT nome, CASE WHEN (prezzo * stock) > 1000 THEN 'Alto' ELSE 'Basso' END FROM prodotti", hints: ["CASE con calcolo", "CASE WHEN (prezzo * stock) > 1000 THEN 'Alto' ELSE 'Basso' END"], explanation: "CASE con espressione calcolata.", replacements: {} },
            { titleTemplate: "Case con Calcolo Complesso", descTemplate: "Classifica il valore inventario: se (prezzo * stock) > 2000 'Molto Alto', se > 1000 'Alto', altrimenti 'Basso'.", queryTemplate: "SELECT nome, CASE WHEN (prezzo * stock) > 2000 THEN 'Molto Alto' WHEN (prezzo * stock) > 1000 THEN 'Alto' ELSE 'Basso' END FROM prodotti", hints: ["CASE con calcolo multiplo", "CASE WHEN (prezzo * stock) > 2000 THEN 'Molto Alto' WHEN (prezzo * stock) > 1000 THEN 'Alto' ELSE 'Basso' END"], explanation: "CASE con calcolo e più condizioni.", replacements: {} },
            { titleTemplate: "Case con Funzione", descTemplate: "Classifica lo stock: se LENGTH(nome) > 10 'Nome Lungo', altrimenti 'Nome Corto'.", queryTemplate: "SELECT nome, CASE WHEN LENGTH(nome) > 10 THEN 'Nome Lungo' ELSE 'Nome Corto' END FROM prodotti", hints: ["CASE con funzione", "CASE WHEN LENGTH(nome) > 10 THEN 'Nome Lungo' ELSE 'Nome Corto' END"], explanation: "CASE con funzione.", replacements: {} },
            { titleTemplate: "Case con Funzione Data", descTemplate: "Classifica gli ordini: se YEAR(data_ordine) = 2023 '2023', altrimenti 'Altro Anno'.", queryTemplate: "SELECT data_ordine, CASE WHEN YEAR(data_ordine) = 2023 THEN '2023' ELSE 'Altro Anno' END FROM ordini", hints: ["CASE con funzione data", "CASE WHEN YEAR(data_ordine) = 2023 THEN '2023' ELSE 'Altro Anno' END"], explanation: "CASE con funzione data.", replacements: {} },
            { titleTemplate: "Case con JOIN", descTemplate: "Classifica i prodotti: se categoria_id = 1 'Elettronica', altrimenti 'Altro' (usando JOIN).", queryTemplate: "SELECT prodotti.nome, CASE WHEN categorie.nome = 'Elettronica' THEN 'Elettronica' ELSE 'Altro' END FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id", hints: ["CASE con JOIN", "CASE WHEN categorie.nome = 'Elettronica' THEN 'Elettronica' ELSE 'Altro' END"], explanation: "CASE con JOIN.", replacements: {} },
            { titleTemplate: "Case con WHERE", descTemplate: "Classifica i prodotti con prezzo > 50: se stock > 10 'Disponibile', altrimenti 'Limitato'.", queryTemplate: "SELECT nome, CASE WHEN stock > 10 THEN 'Disponibile' ELSE 'Limitato' END FROM prodotti WHERE prezzo > 50", hints: ["CASE con WHERE", "WHERE prezzo > 50"], explanation: "CASE con WHERE.", replacements: {} },
            { titleTemplate: "Case con ORDER BY", descTemplate: "Classifica lo stock e ordina: prima 'Disponibile', poi 'Esaurito'.", queryTemplate: "SELECT nome, CASE WHEN stock > 0 THEN 'Disponibile' ELSE 'Esaurito' END AS stato FROM prodotti ORDER BY CASE WHEN stock > 0 THEN 0 ELSE 1 END", hints: ["CASE in ORDER BY", "ORDER BY CASE WHEN stock > 0 THEN 0 ELSE 1 END"], explanation: "CASE in ORDER BY.", replacements: {} },
            { titleTemplate: "Case Complesso Finale", descTemplate: "Classifica i prodotti: se prezzo > 100 E stock > 20 'Premium Disponibile', se prezzo > 100 'Premium Limitato', se stock > 20 'Economico Disponibile', altrimenti 'Standard'.", queryTemplate: "SELECT nome, CASE WHEN prezzo > 100 AND stock > 20 THEN 'Premium Disponibile' WHEN prezzo > 100 THEN 'Premium Limitato' WHEN stock > 20 THEN 'Economico Disponibile' ELSE 'Standard' END FROM prodotti", hints: ["CASE complesso", "CASE WHEN prezzo > 100 AND stock > 20 THEN 'Premium Disponibile' WHEN prezzo > 100 THEN 'Premium Limitato' WHEN stock > 20 THEN 'Economico Disponibile' ELSE 'Standard' END"], explanation: "CASE complesso con condizioni multiple.", replacements: {} },
            { titleTemplate: "Case con Alias Stock", descTemplate: "Classifica lo stock come 'Livello' e mostra nome prodotto.", queryTemplate: "SELECT nome, CASE WHEN stock > 20 THEN 'Alto' WHEN stock > 10 THEN 'Medio' ELSE 'Basso' END AS Livello FROM prodotti", hints: ["CASE con alias", "CASE ... END AS Livello"], explanation: "CASE con alias su stock.", replacements: {} },
            { titleTemplate: "Case con Alias Quantità", descTemplate: "Classifica la quantità come 'Taglia' e mostra quantità ordine.", queryTemplate: "SELECT quantita, CASE WHEN quantita > 7 THEN 'Grande' WHEN quantita > 3 THEN 'Media' ELSE 'Piccola' END AS Taglia FROM ordini", hints: ["CASE con alias", "CASE ... END AS Taglia"], explanation: "CASE con alias su quantità.", replacements: {} },
        ...
        [Difficulty.Hard]: [
            { titleTemplate: "Case in Order By", descTemplate: "Ordina i prodotti: prima quelli Esauriti (stock=0), poi gli altri per prezzo decrescente.", queryTemplate: "SELECT * FROM prodotti ORDER BY CASE WHEN stock = 0 THEN 0 ELSE 1 END, prezzo DESC", hints: ["CASE in ORDER BY", "ORDER BY CASE WHEN stock = 0 THEN 0 ELSE 1 END, prezzo DESC"], explanation: "CASE per controllare ordinamento.", replacements: {} },
            { titleTemplate: "Case in ORDER BY Prezzo", descTemplate: "Ordina i prodotti: prima quelli costosi (> 100), poi gli altri per prezzo crescente.", queryTemplate: "SELECT * FROM prodotti ORDER BY CASE WHEN prezzo > 100 THEN 0 ELSE 1 END, prezzo ASC", hints: ["CASE in ORDER BY", "ORDER BY CASE WHEN prezzo > 100 THEN 0 ELSE 1 END, prezzo ASC"], explanation: "CASE in ORDER BY con prezzo.", replacements: {} },
            { titleTemplate: "Case in ORDER BY Voto", descTemplate: "Ordina le recensioni: prima quelle con voto alto (>= 4), poi le altre per voto decrescente.", queryTemplate: "SELECT * FROM recensioni ORDER BY CASE WHEN voto >= 4 THEN 0 ELSE 1 END, voto DESC", hints: ["CASE in ORDER BY", "ORDER BY CASE WHEN voto >= 4 THEN 0 ELSE 1 END, voto DESC"], explanation: "CASE in ORDER BY con voto.", replacements: {} },
            { titleTemplate: "Case in ORDER BY Quantità", descTemplate: "Ordina gli ordini: prima quelli grandi (> 5), poi gli altri per quantità crescente.", queryTemplate: "SELECT * FROM ordini ORDER BY CASE WHEN quantita > 5 THEN 0 ELSE 1 END, quantita ASC", hints: ["CASE in ORDER BY", "ORDER BY CASE WHEN quantita > 5 THEN 0 ELSE 1 END, quantita ASC"], explanation: "CASE in ORDER BY con quantità.", replacements: {} },
            { titleTemplate: "Case in ORDER BY Multiplo", descTemplate: "Ordina i prodotti: prima Esauriti, poi Disponibili, entrambi per prezzo decrescente.", queryTemplate: "SELECT * FROM prodotti ORDER BY CASE WHEN stock = 0 THEN 0 ELSE 1 END, prezzo DESC", hints: ["CASE in ORDER BY multiplo", "ORDER BY CASE WHEN stock = 0 THEN 0 ELSE 1 END, prezzo DESC"], explanation: "CASE in ORDER BY multiplo.", replacements: {} },
            { titleTemplate: "Case in WHERE", descTemplate: "Trova i prodotti dove CASE restituisce 'Disponibile' (stock > 0).", queryTemplate: "SELECT * FROM prodotti WHERE CASE WHEN stock > 0 THEN 'Disponibile' ELSE 'Esaurito' END = 'Disponibile'", hints: ["CASE in WHERE", "WHERE CASE ... END = 'Disponibile'"], explanation: "CASE in WHERE.", replacements: {} },
            { titleTemplate: "Case in WHERE Prezzo", descTemplate: "Trova i prodotti dove CASE restituisce 'Costoso' (prezzo > 100).", queryTemplate: "SELECT * FROM prodotti WHERE CASE WHEN prezzo > 100 THEN 'Costoso' ELSE 'Economico' END = 'Costoso'", hints: ["CASE in WHERE", "WHERE CASE ... END = 'Costoso'"], explanation: "CASE in WHERE con prezzo.", replacements: {} },
            { titleTemplate: "Case in SELECT con JOIN", descTemplate: "Classifica i prodotti con categoria: se categoria = 'Elettronica' 'Tech', altrimenti 'Altro'.", queryTemplate: "SELECT prodotti.nome, CASE WHEN categorie.nome = 'Elettronica' THEN 'Tech' ELSE 'Altro' END FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id", hints: ["CASE con JOIN", "CASE WHEN categorie.nome = 'Elettronica' THEN 'Tech' ELSE 'Altro' END"], explanation: "CASE con JOIN in SELECT.", replacements: {} },
            { titleTemplate: "Case in SELECT con Aggregazione", descTemplate: "Classifica le categorie: se COUNT(*) > 5 'Popolare', altrimenti 'Normale'.", queryTemplate: "SELECT categoria_id, CASE WHEN COUNT(*) > 5 THEN 'Popolare' ELSE 'Normale' END FROM prodotti GROUP BY categoria_id", hints: ["CASE con GROUP BY", "CASE WHEN COUNT(*) > 5 THEN 'Popolare' ELSE 'Normale' END"], explanation: "CASE con aggregazione.", replacements: {} },
            { titleTemplate: "Case in HAVING", descTemplate: "Trova le categorie e il numero di prodotti dove CASE restituisce 'Popolare' (COUNT > 5).", queryTemplate: "SELECT categoria_id, COUNT(*) FROM prodotti GROUP BY categoria_id HAVING CASE WHEN COUNT(*) > 5 THEN 'Popolare' ELSE 'Normale' END = 'Popolare'", hints: ["CASE in HAVING", "HAVING CASE ... END = 'Popolare'"], explanation: "CASE in HAVING.", replacements: {} },
            { titleTemplate: "Case Nidificato", descTemplate: "Classifica i prodotti: se prezzo > 100, poi se stock > 20 'Premium Disponibile' altrimenti 'Premium Limitato', altrimenti 'Standard'.", queryTemplate: "SELECT nome, CASE WHEN prezzo > 100 THEN CASE WHEN stock > 20 THEN 'Premium Disponibile' ELSE 'Premium Limitato' END ELSE 'Standard' END FROM prodotti", hints: ["CASE nidificato", "CASE WHEN prezzo > 100 THEN CASE WHEN stock > 20 THEN 'Premium Disponibile' ELSE 'Premium Limitato' END ELSE 'Standard' END"], explanation: "CASE nidificato.", replacements: {} },
            { titleTemplate: "Case con Subquery", descTemplate: "Classifica i prodotti: se prezzo > media 'Sopra Media', altrimenti 'Sotto Media'.", queryTemplate: "SELECT nome, CASE WHEN prezzo > (SELECT AVG(prezzo) FROM prodotti) THEN 'Sopra Media' ELSE 'Sotto Media' END FROM prodotti", hints: ["CASE con subquery", "CASE WHEN prezzo > (SELECT AVG(prezzo) FROM prodotti) THEN 'Sopra Media' ELSE 'Sotto Media' END"], explanation: "CASE con subquery.", replacements: {} },
            { titleTemplate: "Case con Calcolo Complesso", descTemplate: "Classifica il valore inventario: se (prezzo * stock) > 2000 'Alto', se > 1000 'Medio', altrimenti 'Basso'.", queryTemplate: "SELECT nome, CASE WHEN (prezzo * stock) > 2000 THEN 'Alto' WHEN (prezzo * stock) > 1000 THEN 'Medio' ELSE 'Basso' END FROM prodotti", hints: ["CASE con calcolo", "CASE WHEN (prezzo * stock) > 2000 THEN 'Alto' WHEN (prezzo * stock) > 1000 THEN 'Medio' ELSE 'Basso' END"], explanation: "CASE con calcolo complesso.", replacements: {} },
            { titleTemplate: "Case con Funzioni Multiple", descTemplate: "Classifica i prodotti: se LENGTH(nome) > 10 E prezzo > 50 'Lungo Costoso', altrimenti 'Altro'.", queryTemplate: "SELECT nome, CASE WHEN LENGTH(nome) > 10 AND prezzo > 50 THEN 'Lungo Costoso' ELSE 'Altro' END FROM prodotti", hints: ["CASE con funzioni", "CASE WHEN LENGTH(nome) > 10 AND prezzo > 50 THEN 'Lungo Costoso' ELSE 'Altro' END"], explanation: "CASE con funzioni multiple.", replacements: {} },
            { titleTemplate: "Case con ORDER BY Complesso", descTemplate: "Ordina i prodotti: prima Esauriti, poi Disponibili, entrambi per valore inventario (prezzo * stock) decrescente.", queryTemplate: "SELECT * FROM prodotti ORDER BY CASE WHEN stock = 0 THEN 0 ELSE 1 END, (prezzo * stock) DESC", hints: ["CASE in ORDER BY con calcolo", "ORDER BY CASE WHEN stock = 0 THEN 0 ELSE 1 END, (prezzo * stock) DESC"], explanation: "CASE in ORDER BY con calcolo.", replacements: {} },
            { titleTemplate: "Case con WHERE e ORDER BY", descTemplate: "Trova i prodotti con prezzo > 50, classifica lo stock e ordina per stato e prezzo.", queryTemplate: "SELECT nome, CASE WHEN stock > 0 THEN 'Disponibile' ELSE 'Esaurito' END AS stato FROM prodotti WHERE prezzo > 50 ORDER BY CASE WHEN stock > 0 THEN 0 ELSE 1 END, prezzo DESC", hints: ["CASE con WHERE e ORDER BY", "WHERE prezzo > 50 ORDER BY CASE ... END, prezzo DESC"], explanation: "CASE con WHERE e ORDER BY.", replacements: {} },
            { titleTemplate: "Case con JOIN e ORDER BY", descTemplate: "Classifica i prodotti con categoria e ordina: prima 'Tech', poi gli altri per prezzo decrescente.", queryTemplate: "SELECT prodotti.nome, CASE WHEN categorie.nome = 'Elettronica' THEN 'Tech' ELSE 'Altro' END AS tipo FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id ORDER BY CASE WHEN categorie.nome = 'Elettronica' THEN 0 ELSE 1 END, prodotti.prezzo DESC", hints: ["CASE con JOIN e ORDER BY", "ORDER BY CASE ... END, prodotti.prezzo DESC"], explanation: "CASE con JOIN e ORDER BY.", replacements: {} },
            { titleTemplate: "Case con Aggregazione e HAVING", descTemplate: "Classifica le categorie: se COUNT > 5 'Popolare', altrimenti 'Normale', mostra solo quelle 'Popolare'.", queryTemplate: "SELECT categoria_id, CASE WHEN COUNT(*) > 5 THEN 'Popolare' ELSE 'Normale' END AS tipo FROM prodotti GROUP BY categoria_id HAVING CASE WHEN COUNT(*) > 5 THEN 'Popolare' ELSE 'Normale' END = 'Popolare'", hints: ["CASE con GROUP BY e HAVING", "HAVING CASE ... END = 'Popolare'"], explanation: "CASE con aggregazione e HAVING.", replacements: {} },
            { titleTemplate: "Case Complesso Finale", descTemplate: "Classifica i prodotti: se prezzo > 100 E stock > 20 'Premium Disponibile', se prezzo > 100 'Premium Limitato', se stock > 20 'Economico Disponibile', altrimenti 'Standard'. Ordina per tipo e prezzo.", queryTemplate: "SELECT nome, CASE WHEN prezzo > 100 AND stock > 20 THEN 'Premium Disponibile' WHEN prezzo > 100 THEN 'Premium Limitato' WHEN stock > 20 THEN 'Economico Disponibile' ELSE 'Standard' END AS tipo FROM prodotti ORDER BY CASE WHEN prezzo > 100 AND stock > 20 THEN 0 WHEN prezzo > 100 THEN 1 WHEN stock > 20 THEN 2 ELSE 3 END, prezzo DESC", hints: ["CASE complesso con ORDER BY", "ORDER BY CASE ... END, prezzo DESC"], explanation: "CASE complesso con ordinamento personalizzato.", replacements: {} },
            { titleTemplate: "Case in ORDER BY con Calcolo", descTemplate: "Ordina i prodotti: prima quelli con valore inventario > 1000, poi gli altri per prezzo decrescente.", queryTemplate: "SELECT * FROM prodotti ORDER BY CASE WHEN (prezzo * stock) > 1000 THEN 0 ELSE 1 END, prezzo DESC", hints: ["CASE in ORDER BY con calcolo", "ORDER BY CASE WHEN (prezzo * stock) > 1000 THEN 0 ELSE 1 END, prezzo DESC"], explanation: "CASE in ORDER BY con espressione calcolata.", replacements: {} },
            { titleTemplate: "Case in WHERE con Calcolo", descTemplate: "Trova i prodotti dove CASE restituisce 'Alto Valore' (valore inventario > 1000).", queryTemplate: "SELECT * FROM prodotti WHERE CASE WHEN (prezzo * stock) > 1000 THEN 'Alto Valore' ELSE 'Basso Valore' END = 'Alto Valore'", hints: ["CASE in WHERE con calcolo", "WHERE CASE WHEN (prezzo * stock) > 1000 THEN 'Alto Valore' ELSE 'Basso Valore' END = 'Alto Valore'"], explanation: "CASE in WHERE con calcolo.", replacements: {} },
            { titleTemplate: "Case Nidificato Complesso", descTemplate: "Classifica i prodotti: se prezzo > 100, poi se stock > 20 'Premium Disponibile' altrimenti 'Premium Limitato', altrimenti se stock > 20 'Economico Disponibile' altrimenti 'Standard'.", queryTemplate: "SELECT nome, CASE WHEN prezzo > 100 THEN CASE WHEN stock > 20 THEN 'Premium Disponibile' ELSE 'Premium Limitato' END ELSE CASE WHEN stock > 20 THEN 'Economico Disponibile' ELSE 'Standard' END END FROM prodotti", hints: ["CASE nidificato complesso", "CASE WHEN prezzo > 100 THEN CASE ... ELSE CASE ... END END"], explanation: "CASE nidificato con due livelli.", replacements: {} },
            { titleTemplate: "Case con Subquery Media", descTemplate: "Classifica i prodotti: se prezzo > media 'Sopra Media', altrimenti 'Sotto Media'.", queryTemplate: "SELECT nome, CASE WHEN prezzo > (SELECT AVG(prezzo) FROM prodotti) THEN 'Sopra Media' ELSE 'Sotto Media' END FROM prodotti", hints: ["CASE con subquery", "CASE WHEN prezzo > (SELECT AVG(prezzo) FROM prodotti) THEN 'Sopra Media' ELSE 'Sotto Media' END"], explanation: "CASE con subquery per media.", replacements: {} },
            { titleTemplate: "Case con Subquery Massimo", descTemplate: "Classifica i prodotti: se prezzo = massimo 'Più Costoso', altrimenti 'Altro'.", queryTemplate: "SELECT nome, CASE WHEN prezzo = (SELECT MAX(prezzo) FROM prodotti) THEN 'Più Costoso' ELSE 'Altro' END FROM prodotti", hints: ["CASE con subquery", "CASE WHEN prezzo = (SELECT MAX(prezzo) FROM prodotti) THEN 'Più Costoso' ELSE 'Altro' END"], explanation: "CASE con subquery per massimo.", replacements: {} },
            { titleTemplate: "Case con Funzione LENGTH", descTemplate: "Classifica i prodotti: se LENGTH(nome) > 15 'Nome Lungo', se > 10 'Nome Medio', altrimenti 'Nome Corto'.", queryTemplate: "SELECT nome, CASE WHEN LENGTH(nome) > 15 THEN 'Nome Lungo' WHEN LENGTH(nome) > 10 THEN 'Nome Medio' ELSE 'Nome Corto' END FROM prodotti", hints: ["CASE con funzione LENGTH", "CASE WHEN LENGTH(nome) > 15 THEN 'Nome Lungo' WHEN LENGTH(nome) > 10 THEN 'Nome Medio' ELSE 'Nome Corto' END"], explanation: "CASE con funzione LENGTH e più condizioni.", replacements: {} },
            { titleTemplate: "Case con Funzione YEAR", descTemplate: "Classifica gli ordini: se YEAR(data_ordine) = 2024 '2024', se = 2023 '2023', altrimenti 'Altro Anno'.", queryTemplate: "SELECT data_ordine, CASE WHEN YEAR(data_ordine) = 2024 THEN '2024' WHEN YEAR(data_ordine) = 2023 THEN '2023' ELSE 'Altro Anno' END FROM ordini", hints: ["CASE con funzione YEAR", "CASE WHEN YEAR(data_ordine) = 2024 THEN '2024' WHEN YEAR(data_ordine) = 2023 THEN '2023' ELSE 'Altro Anno' END"], explanation: "CASE con funzione YEAR e più condizioni.", replacements: {} },
            { titleTemplate: "Case con JOIN e WHERE", descTemplate: "Classifica i prodotti con categoria: se categoria = 'Elettronica' E prezzo > 100 'Tech Costoso', altrimenti 'Altro'.", queryTemplate: "SELECT prodotti.nome, CASE WHEN categorie.nome = 'Elettronica' AND prodotti.prezzo > 100 THEN 'Tech Costoso' ELSE 'Altro' END FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id", hints: ["CASE con JOIN e WHERE", "CASE WHEN categorie.nome = 'Elettronica' AND prodotti.prezzo > 100 THEN 'Tech Costoso' ELSE 'Altro' END"], explanation: "CASE con JOIN e condizione multipla.", replacements: {} },
            { titleTemplate: "Case con Aggregazione e WHERE", descTemplate: "Classifica le categorie: se COUNT(*) > 5 'Popolare', altrimenti 'Normale', mostra solo quelle con media prezzo > 50.", queryTemplate: "SELECT categoria_id, CASE WHEN COUNT(*) > 5 THEN 'Popolare' ELSE 'Normale' END AS tipo FROM prodotti GROUP BY categoria_id HAVING AVG(prezzo) > 50", hints: ["CASE con GROUP BY e HAVING", "CASE WHEN COUNT(*) > 5 THEN 'Popolare' ELSE 'Normale' END HAVING AVG(prezzo) > 50"], explanation: "CASE con aggregazione e HAVING.", replacements: {} },
            // NEW EXERCISES FOR CASE HARD
            { titleTemplate: "Case in GROUP BY", descTemplate: "Raggruppa i prodotti per fascia di prezzo (Economico/Costoso) e conta.", queryTemplate: "SELECT CASE WHEN prezzo < 50 THEN 'Economico' ELSE 'Costoso' END as Fascia, COUNT(*) FROM prodotti GROUP BY CASE WHEN prezzo < 50 THEN 'Economico' ELSE 'Costoso' END", hints: ["GROUP BY CASE..."], explanation: "Raggruppamento su logica calcolata.", replacements: {} },
            { titleTemplate: "Case in GROUP BY Stock", descTemplate: "Raggruppa prodotti per disponibilità (Sì/No) e calcola valore medio.", queryTemplate: "SELECT CASE WHEN stock > 0 THEN 'Sì' ELSE 'No' END as Disponibile, AVG(prezzo) FROM prodotti GROUP BY CASE WHEN stock > 0 THEN 'Sì' ELSE 'No' END", hints: ["GROUP BY CASE..."], explanation: "Analisi per stato.", replacements: {} },
            { titleTemplate: "Case in ORDER BY Custom", descTemplate: "Ordina prodotti: Elettronica prima, poi Abbigliamento, poi altri.", queryTemplate: "SELECT prodotti.nome, categorie.nome FROM prodotti JOIN categorie ON prodotti.categoria_id = categorie.id ORDER BY CASE WHEN categorie.nome = 'Elettronica' THEN 1 WHEN categorie.nome = 'Abbigliamento' THEN 2 ELSE 3 END", hints: ["ORDER BY CASE..."], explanation: "Ordinamento arbitrario.", replacements: {} },
            { titleTemplate: "Case dentro SUM (Count Conditional)", descTemplate: "Conta quanti prodotti sono costosi (>100) e quanti economici (<50) in una sola query.", queryTemplate: "SELECT SUM(CASE WHEN prezzo > 100 THEN 1 ELSE 0 END) as Costosi, SUM(CASE WHEN prezzo < 50 THEN 1 ELSE 0 END) as Economici FROM prodotti", hints: ["SUM(CASE...)"], explanation: "Pivot table simulata.", replacements: {} },
            { titleTemplate: "Case dentro AVG (Conditional Avg)", descTemplate: "Calcola prezzo medio solo dei prodotti disponibili (stock > 0) senza usare WHERE (per confrontare con totale).", queryTemplate: "SELECT AVG(CASE WHEN stock > 0 THEN prezzo ELSE NULL END) as MediaDisponibili FROM prodotti", hints: ["AVG(CASE... ELSE NULL)"], explanation: "Media condizionale.", replacements: {} },
            { titleTemplate: "Case dentro COUNT (Conditional Count)", descTemplate: "Conta recensioni positive (4-5) e negative (1-2).", queryTemplate: "SELECT COUNT(CASE WHEN voto >= 4 THEN 1 END) as Positive, COUNT(CASE WHEN voto <= 2 THEN 1 END) as Negative FROM recensioni", hints: ["COUNT(CASE...)"], explanation: "Conteggio condizionale.", replacements: {} },
            { titleTemplate: "Case Nidificato 3 Livelli", descTemplate: "Classifica cliente: VIP (Premium+Ordini>5), Fedele (Ordini>5), Promettente (Premium), Standard.", queryTemplate: "SELECT nome, CASE WHEN premium THEN CASE WHEN (SELECT COUNT(*) FROM ordini WHERE utente_id = utenti.id) > 5 THEN 'VIP' ELSE 'Promettente' END ELSE CASE WHEN (SELECT COUNT(*) FROM ordini WHERE utente_id = utenti.id) > 5 THEN 'Fedele' ELSE 'Standard' END END FROM utenti", hints: ["CASE nidificato con subquery"], explanation: "Logica decisionale complessa.", replacements: {} },
            { titleTemplate: "Case in UPDATE (Simulato con SELECT)", descTemplate: "Mostra come cambierebbero i prezzi: +10% se stock < 10, -5% se stock > 100.", queryTemplate: "SELECT prezzo, CASE WHEN stock < 10 THEN prezzo * 1.10 WHEN stock > 100 THEN prezzo * 0.95 ELSE prezzo END as NuovoPrezzo FROM prodotti", hints: ["Calcolo condizionale"], explanation: "Simulazione listino dinamico.", replacements: {} },
            { titleTemplate: "Case con Window Function", descTemplate: "Mostra differenza prezzo dal precedente, ma solo se stessa categoria (Case inutile qui ma per complessità: mostra 'Salto' se diff > 50).", queryTemplate: "SELECT nome, prezzo - LAG(prezzo) OVER (ORDER BY prezzo) as Diff, CASE WHEN (prezzo - LAG(prezzo) OVER (ORDER BY prezzo)) > 50 THEN 'Salto' ELSE 'Normale' END FROM prodotti", hints: ["CASE su Window Function"], explanation: "Analisi sequenziale.", replacements: {} },
            { titleTemplate: "Case per Etichetta Temporale", descTemplate: "Etichetta ordini come 'Weekend' o 'Feriale' (usando DAYOFWEEK, 1=Dom, 7=Sab).", queryTemplate: "SELECT data_ordine, CASE WHEN DAYOFWEEK(data_ordine) IN (1, 7) THEN 'Weekend' ELSE 'Feriale' END FROM ordini", hints: ["DAYOFWEEK"], explanation: "Analisi settimanale.", replacements: {} },
            { titleTemplate: "Case in HAVING Complesso", descTemplate: "Filtra categorie che hanno più prodotti costosi che economici.", queryTemplate: "SELECT categoria_id FROM prodotti GROUP BY categoria_id HAVING SUM(CASE WHEN prezzo > 100 THEN 1 ELSE 0 END) > SUM(CASE WHEN prezzo < 50 THEN 1 ELSE 0 END)", hints: ["HAVING SUM(CASE...)"], explanation: "Filtro su aggregati condizionali.", replacements: {} },
            { titleTemplate: "Case con Subquery Correlata", descTemplate: "Classifica prodotti: 'Sopra Media Categoria' se prezzo > media della sua categoria.", queryTemplate: "SELECT nome, CASE WHEN prezzo > (SELECT AVG(p2.prezzo) FROM prodotti p2 WHERE p2.categoria_id = prodotti.categoria_id) THEN 'Sopra' ELSE 'Sotto' END FROM prodotti", hints: ["Subquery correlata"], explanation: "Confronto relativo.", replacements: {} },
            { titleTemplate: "Case Multi-Colonna", descTemplate: "Se prezzo > 100 'Caro', se stock < 10 'Raro'. Priorità a Raro.", queryTemplate: "SELECT nome, CASE WHEN stock < 10 THEN 'Raro' WHEN prezzo > 100 THEN 'Caro' ELSE 'Normale' END FROM prodotti", hints: ["Ordine condizioni conta"], explanation: "Priorità regole.", replacements: {} },
            { titleTemplate: "Case Null Coalesce Logic", descTemplate: "Se tracking NULL e data spedizione NULL 'Non Spedito', se tracking NULL 'Non Tracciato', else 'Ok'.", queryTemplate: "SELECT id, CASE WHEN codice_tracking IS NULL AND data_spedizione IS NULL THEN 'Non Spedito' WHEN codice_tracking IS NULL THEN 'Non Tracciato' ELSE 'Ok' END FROM spedizioni", hints: ["Logica NULL complessa"], explanation: "Stati logistici.", replacements: {} },
            { titleTemplate: "Case in JOIN Condition", descTemplate: "Join con tabella sconti (simulata): se prezzo > 100 join su sconti_alti, else sconti_bassi (Simulazione logica).", queryTemplate: "SELECT p.nome, s.sconto FROM prodotti p LEFT JOIN sconti s ON s.tipo = CASE WHEN p.prezzo > 100 THEN 'Alto' ELSE 'Basso' END", hints: ["CASE in ON"], explanation: "Join dinamico.", replacements: {} }
        ]
    },
    [TopicId.Advanced]: {
        [Difficulty.Easy]: [
            { titleTemplate: "Subquery Prezzo > Media", descTemplate: "Trova i prodotti che costano più della media generale.", queryTemplate: "SELECT * FROM prodotti WHERE prezzo > (SELECT AVG(prezzo) FROM prodotti)", hints: ["Subquery in WHERE", "WHERE prezzo > (SELECT AVG(prezzo) FROM prodotti)"], explanation: "Subquery per confronto con media.", replacements: {} },
            { titleTemplate: "Subquery Prezzo < Media", descTemplate: "Trova i prodotti che costano meno della media generale.", queryTemplate: "SELECT * FROM prodotti WHERE prezzo < (SELECT AVG(prezzo) FROM prodotti)", hints: ["Subquery in WHERE", "WHERE prezzo < (SELECT AVG(prezzo) FROM prodotti)"], explanation: "Subquery per confronto con media minore.", replacements: {} },
            { titleTemplate: "Subquery Stock > Media", descTemplate: "Trova i prodotti con stock superiore alla media.", queryTemplate: "SELECT * FROM prodotti WHERE stock > (SELECT AVG(stock) FROM prodotti)", hints: ["Subquery in WHERE", "WHERE stock > (SELECT AVG(stock) FROM prodotti)"], explanation: "Subquery per confronto stock.", replacements: {} },
            { titleTemplate: "Subquery Stock < Media", descTemplate: "Trova i prodotti con stock inferiore alla media.", queryTemplate: "SELECT * FROM prodotti WHERE stock < (SELECT AVG(stock) FROM prodotti)", hints: ["Subquery in WHERE", "WHERE stock < (SELECT AVG(stock) FROM prodotti)"], explanation: "Subquery per confronto stock minore.", replacements: {} },
            { titleTemplate: "Subquery Voto > Media", descTemplate: "Trova le recensioni con voto superiore alla media.", queryTemplate: "SELECT * FROM recensioni WHERE voto > (SELECT AVG(voto) FROM recensioni)", hints: ["Subquery in WHERE", "WHERE voto > (SELECT AVG(voto) FROM recensioni)"], explanation: "Subquery per confronto voto.", replacements: {} },
            { titleTemplate: "Subquery Voto < Media", descTemplate: "Trova le recensioni con voto inferiore alla media.", queryTemplate: "SELECT * FROM recensioni WHERE voto < (SELECT AVG(voto) FROM recensioni)", hints: ["Subquery in WHERE", "WHERE voto < (SELECT AVG(voto) FROM recensioni)"], explanation: "Subquery per confronto voto minore.", replacements: {} },
            { titleTemplate: "Subquery Quantità > Media", descTemplate: "Trova gli ordini con quantità superiore alla media.", queryTemplate: "SELECT * FROM ordini WHERE quantita > (SELECT AVG(quantita) FROM ordini)", hints: ["Subquery in WHERE", "WHERE quantita > (SELECT AVG(quantita) FROM ordini)"], explanation: "Subquery per confronto quantità.", replacements: {} },
            { titleTemplate: "Subquery Quantità < Media", descTemplate: "Trova gli ordini con quantità inferiore alla media.", queryTemplate: "SELECT * FROM ordini WHERE quantita < (SELECT AVG(quantita) FROM ordini)", hints: ["Subquery in WHERE", "WHERE quantita < (SELECT AVG(quantita) FROM ordini)"], explanation: "Subquery per confronto quantità minore.", replacements: {} },
            { titleTemplate: "Subquery Prezzo = Massimo", descTemplate: "Trova i prodotti con prezzo uguale al massimo.", queryTemplate: "SELECT * FROM prodotti WHERE prezzo = (SELECT MAX(prezzo) FROM prodotti)", hints: ["Subquery con MAX", "WHERE prezzo = (SELECT MAX(prezzo) FROM prodotti)"], explanation: "Subquery con MAX.", replacements: {} },
            { titleTemplate: "Subquery Prezzo = Minimo", descTemplate: "Trova i prodotti con prezzo uguale al minimo.", queryTemplate: "SELECT * FROM prodotti WHERE prezzo = (SELECT MIN(prezzo) FROM prodotti)", hints: ["Subquery con MIN", "WHERE prezzo = (SELECT MIN(prezzo) FROM prodotti)"], explanation: "Subquery con MIN.", replacements: {} },
            { titleTemplate: "Subquery Stock = Massimo", descTemplate: "Trova i prodotti con stock uguale al massimo.", queryTemplate: "SELECT * FROM prodotti WHERE stock = (SELECT MAX(stock) FROM prodotti)", hints: ["Subquery con MAX", "WHERE stock = (SELECT MAX(stock) FROM prodotti)"], explanation: "Subquery con MAX su stock.", replacements: {} },
            { titleTemplate: "Subquery Stock = Minimo", descTemplate: "Trova i prodotti con stock uguale al minimo.", queryTemplate: "SELECT * FROM prodotti WHERE stock = (SELECT MIN(stock) FROM prodotti)", hints: ["Subquery con MIN", "WHERE stock = (SELECT MIN(stock) FROM prodotti)"], explanation: "Subquery con MIN su stock.", replacements: {} },
            { titleTemplate: "Subquery Voto = Massimo", descTemplate: "Trova le recensioni con voto uguale al massimo.", queryTemplate: "SELECT * FROM recensioni WHERE voto = (SELECT MAX(voto) FROM recensioni)", hints: ["Subquery con MAX", "WHERE voto = (SELECT MAX(voto) FROM recensioni)"], explanation: "Subquery con MAX su voto.", replacements: {} },
            { titleTemplate: "Subquery Voto = Minimo", descTemplate: "Trova le recensioni con voto uguale al minimo.", queryTemplate: "SELECT * FROM recensioni WHERE voto = (SELECT MIN(voto) FROM recensioni)", hints: ["Subquery con MIN", "WHERE voto = (SELECT MIN(voto) FROM recensioni)"], explanation: "Subquery con MIN su voto.", replacements: {} },
            { titleTemplate: "Subquery Quantità = Massimo", descTemplate: "Trova gli ordini con quantità uguale al massimo.", queryTemplate: "SELECT * FROM ordini WHERE quantita = (SELECT MAX(quantita) FROM ordini)", hints: ["Subquery con MAX", "WHERE quantita = (SELECT MAX(quantita) FROM ordini)"], explanation: "Subquery con MAX su quantità.", replacements: {} },
            { titleTemplate: "Subquery Quantità = Minimo", descTemplate: "Trova gli ordini con quantità uguale al minimo.", queryTemplate: "SELECT * FROM ordini WHERE quantita = (SELECT MIN(quantita) FROM ordini)", hints: ["Subquery con MIN", "WHERE quantita = (SELECT MIN(quantita) FROM ordini)"], explanation: "Subquery con MIN su quantità.", replacements: {} },
            { titleTemplate: "Subquery Prezzo >= Media", descTemplate: "Trova i prodotti che costano almeno quanto la media.", queryTemplate: "SELECT * FROM prodotti WHERE prezzo >= (SELECT AVG(prezzo) FROM prodotti)", hints: ["Subquery con >=", "WHERE prezzo >= (SELECT AVG(prezzo) FROM prodotti)"], explanation: "Subquery con >=", replacements: {} },
            { titleTemplate: "Subquery Prezzo <= Media", descTemplate: "Trova i prodotti che costano al massimo quanto la media.", queryTemplate: "SELECT * FROM prodotti WHERE prezzo <= (SELECT AVG(prezzo) FROM prodotti)", hints: ["Subquery con <=", "WHERE prezzo <= (SELECT AVG(prezzo) FROM prodotti)"], explanation: "Subquery con <=", replacements: {} },
            { titleTemplate: "Subquery Stock >= Media", descTemplate: "Trova i prodotti con stock almeno quanto la media.", queryTemplate: "SELECT * FROM prodotti WHERE stock >= (SELECT AVG(stock) FROM prodotti)", hints: ["Subquery con >=", "WHERE stock >= (SELECT AVG(stock) FROM prodotti)"], explanation: "Subquery con >= su stock.", replacements: {} },
            { titleTemplate: "Subquery Stock <= Media", descTemplate: "Trova i prodotti con stock al massimo quanto la media.", queryTemplate: "SELECT * FROM prodotti WHERE stock <= (SELECT AVG(stock) FROM prodotti)", hints: ["Subquery con <=", "WHERE stock <= (SELECT AVG(stock) FROM prodotti)"], explanation: "Subquery con <= su stock.", replacements: {} },
            { titleTemplate: "Subquery Voto >= Media", descTemplate: "Trova le recensioni con voto almeno quanto la media.", queryTemplate: "SELECT * FROM recensioni WHERE voto >= (SELECT AVG(voto) FROM recensioni)", hints: ["Subquery con >=", "WHERE voto >= (SELECT AVG(voto) FROM recensioni)"], explanation: "Subquery con >= su voto.", replacements: {} },
            { titleTemplate: "Subquery Voto <= Media", descTemplate: "Trova le recensioni con voto al massimo quanto la media.", queryTemplate: "SELECT * FROM recensioni WHERE voto <= (SELECT AVG(voto) FROM recensioni)", hints: ["Subquery con <=", "WHERE voto <= (SELECT AVG(voto) FROM recensioni)"], explanation: "Subquery con <= su voto.", replacements: {} },
            { titleTemplate: "Subquery Quantità >= Media", descTemplate: "Trova gli ordini con quantità almeno quanto la media.", queryTemplate: "SELECT * FROM ordini WHERE quantita >= (SELECT AVG(quantita) FROM ordini)", hints: ["Subquery con >=", "WHERE quantita >= (SELECT AVG(quantita) FROM ordini)"], explanation: "Subquery con >= su quantità.", replacements: {} },
            { titleTemplate: "Subquery Quantità <= Media", descTemplate: "Trova gli ordini con quantità al massimo quanto la media.", queryTemplate: "SELECT * FROM ordini WHERE quantita <= (SELECT AVG(quantita) FROM ordini)", hints: ["Subquery con <=", "WHERE quantita <= (SELECT AVG(quantita) FROM ordini)"], explanation: "Subquery con <= su quantità.", replacements: {} },
            { titleTemplate: "Subquery Prezzo > Massimo / 2", descTemplate: "Trova i prodotti che costano più della metà del prezzo massimo.", queryTemplate: "SELECT * FROM prodotti WHERE prezzo > (SELECT MAX(prezzo) / 2 FROM prodotti)", hints: ["Subquery con calcolo", "WHERE prezzo > (SELECT MAX(prezzo) / 2 FROM prodotti)"], explanation: "Subquery con calcolo.", replacements: {} },
            { titleTemplate: "Subquery Stock > Massimo / 2", descTemplate: "Trova i prodotti con stock superiore alla metà dello stock massimo.", queryTemplate: "SELECT * FROM prodotti WHERE stock > (SELECT MAX(stock) / 2 FROM prodotti)", hints: ["Subquery con calcolo", "WHERE stock > (SELECT MAX(stock) / 2 FROM prodotti)"], explanation: "Subquery con calcolo su stock.", replacements: {} },
            { titleTemplate: "Subquery Voto > Massimo / 2", descTemplate: "Trova le recensioni con voto superiore alla metà del voto massimo.", queryTemplate: "SELECT * FROM recensioni WHERE voto > (SELECT MAX(voto) / 2 FROM recensioni)", hints: ["Subquery con calcolo", "WHERE voto > (SELECT MAX(voto) / 2 FROM recensioni)"], explanation: "Subquery con calcolo su voto.", replacements: {} },
            { titleTemplate: "Subquery Quantità > Massimo / 2", descTemplate: "Trova gli ordini con quantità superiore alla metà della quantità massima.", queryTemplate: "SELECT * FROM ordini WHERE quantita > (SELECT MAX(quantita) / 2 FROM ordini)", hints: ["Subquery con calcolo", "WHERE quantita > (SELECT MAX(quantita) / 2 FROM ordini)"], explanation: "Subquery con calcolo su quantità.", replacements: {} },
            { titleTemplate: "Subquery Prezzo > Minimo * 2", descTemplate: "Trova i prodotti che costano più del doppio del prezzo minimo.", queryTemplate: "SELECT * FROM prodotti WHERE prezzo > (SELECT MIN(prezzo) * 2 FROM prodotti)", hints: ["Subquery con calcolo", "WHERE prezzo > (SELECT MIN(prezzo) * 2 FROM prodotti)"], explanation: "Subquery con calcolo minimo.", replacements: {} },
            ...
            { titleTemplate: "Subquery IN Categorie", descTemplate: "Trova prodotti che appartengono alle categorie 'Elettronica' o 'Abbigliamento' usando subquery.", queryTemplate: "SELECT * FROM prodotti WHERE categoria_id IN (SELECT id FROM categorie WHERE nome IN ('Elettronica', 'Abbigliamento'))", hints: ["Subquery con IN"], explanation: "Filtro su relazione.", replacements: {} },
            { titleTemplate: "Subquery NOT IN Categorie", descTemplate: "Trova prodotti che NON appartengono alle categorie 'Elettronica' o 'Abbigliamento' usando subquery.", queryTemplate: "SELECT * FROM prodotti WHERE categoria_id NOT IN (SELECT id FROM categorie WHERE nome IN ('Elettronica', 'Abbigliamento'))", hints: ["Subquery con NOT IN"], explanation: "Esclusione su relazione.", replacements: {} },
            { titleTemplate: "Subquery IN Fornitori", descTemplate: "Trova prodotti forniti da fornitori italiani usando subquery.", queryTemplate: "SELECT * FROM prodotti WHERE fornitore_id IN (SELECT id FROM fornitori WHERE nazione = 'Italia')", hints: ["Subquery con IN"], explanation: "Filtro geografico indiretto.", replacements: {} },
            { titleTemplate: "Subquery ANY Prezzo", descTemplate: "Trova prodotti che costano più di ALMENO UNO dei prodotti della categoria 1 (ANY).", queryTemplate: "SELECT * FROM prodotti WHERE prezzo > ANY (SELECT prezzo FROM prodotti WHERE categoria_id = 1)", hints: ["Subquery con ANY"], explanation: "Confronto con insieme.", replacements: {} },
            { titleTemplate: "Subquery ALL Prezzo", descTemplate: "Trova prodotti che costano più di TUTTI i prodotti della categoria 1 (ALL).", queryTemplate: "SELECT * FROM prodotti WHERE prezzo > ALL (SELECT prezzo FROM prodotti WHERE categoria_id = 1)", hints: ["Subquery con ALL"], explanation: "Confronto totale.", replacements: {} },
            { titleTemplate: "Subquery FROM (Derived Table)", descTemplate: "Seleziona il prezzo medio dalla tabella derivata dei prodotti costosi (>100).", queryTemplate: "SELECT AVG(p.prezzo) FROM (SELECT * FROM prodotti WHERE prezzo > 100) as p", hints: ["Subquery in FROM"], explanation: "Tabella derivata.", replacements: {} },
            { titleTemplate: "Subquery SELECT (Scalare)", descTemplate: "Seleziona nome prodotto e la differenza dal prezzo medio globale.", queryTemplate: "SELECT nome, prezzo - (SELECT AVG(prezzo) FROM prodotti) as DiffMedia FROM prodotti", hints: ["Subquery in SELECT"], explanation: "Calcolo relativo.", replacements: {} },
            { titleTemplate: "Subquery WHERE Data Recente", descTemplate: "Trova ordini fatti nell'ultimo mese disponibile (rispetto alla data massima).", queryTemplate: "SELECT * FROM ordini WHERE data_ordine > (SELECT DATE_SUB(MAX(data_ordine), INTERVAL 1 MONTH) FROM ordini)", hints: ["Subquery data dinamica"], explanation: "Filtro temporale relativo.", replacements: {} },
            { titleTemplate: "Subquery WHERE Utente Attivo", descTemplate: "Trova ordini dell'utente che ha speso di più in totale (limit 1).", queryTemplate: "SELECT * FROM ordini WHERE utente_id = (SELECT utente_id FROM ordini GROUP BY utente_id ORDER BY SUM(quantita * 10) DESC LIMIT 1)", hints: ["Subquery con LIMIT"], explanation: "Targeting utente top.", replacements: {} },
            { titleTemplate: "Subquery WHERE Prodotto Popolare", descTemplate: "Trova recensioni del prodotto più recensito.", queryTemplate: "SELECT * FROM recensioni WHERE prodotto_id = (SELECT prodotto_id FROM recensioni GROUP BY prodotto_id ORDER BY COUNT(*) DESC LIMIT 1)", hints: ["Subquery aggregata"], explanation: "Focus su popolarità.", replacements: {} },
            { titleTemplate: "Subquery IN Utenti Premium", descTemplate: "Trova recensioni scritte da utenti Premium.", queryTemplate: "SELECT * FROM recensioni WHERE utente_id IN (SELECT id FROM utenti WHERE premium = TRUE)", hints: ["Subquery su booleano"], explanation: "Filtro segmento utente.", replacements: {} },
            { titleTemplate: "Subquery NOT IN Utenti Premium", descTemplate: "Trova ordini fatti da utenti NON Premium.", queryTemplate: "SELECT * FROM ordini WHERE utente_id NOT IN (SELECT id FROM utenti WHERE premium = TRUE)", hints: ["Subquery esclusione"], explanation: "Analisi segmento standard.", replacements: {} },
            { titleTemplate: "Subquery WHERE Prezzo > Minimo Categoria", descTemplate: "Trova prodotti che costano più del prezzo minimo della categoria 1.", queryTemplate: "SELECT * FROM prodotti WHERE prezzo > (SELECT MIN(prezzo) FROM prodotti WHERE categoria_id = 1)", hints: ["Subquery specifica"], explanation: "Confronto puntuale.", replacements: {} },
            { titleTemplate: "Subquery WHERE Stock < Media Categoria", descTemplate: "Trova prodotti con stock inferiore alla media della categoria 1.", queryTemplate: "SELECT * FROM prodotti WHERE stock < (SELECT AVG(stock) FROM prodotti WHERE categoria_id = 1)", hints: ["Subquery media parziale"], explanation: "Analisi stock relativa.", replacements: {} },
            { titleTemplate: "Subquery WHERE Voto > Media Prodotto", descTemplate: "Trova recensioni con voto superiore alla media del prodotto 1.", queryTemplate: "SELECT * FROM recensioni WHERE voto > (SELECT AVG(voto) FROM recensioni WHERE prodotto_id = 1)", hints: ["Subquery media specifica"], explanation: "Analisi qualità relativa.", replacements: {} }
        ],
        [Difficulty.Medium]: [
