    ...
    "Easy": [
      {
        ...
        "hints": [
          "Usa l'asterisco * per selezionare tutto",
          "SELECT * FROM ..."
        ],
      ...
      },
      {
        ...
        "hints": [
          "L'asterisco dopo SELECT chiede tutte le colonne senza elencarle.",
          "Ti serve solo indicare la tabella giusta dopo FROM."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa l'asterisco per selezionare tutte le colonne",
          "La tabella degli ordini si chiama Orders"
        ],
        "explanation": "SELECT * seleziona tutte le colonne della tabella. In produzione è meglio specificare le colonne necessarie per performance e chiarezza.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La struttura è la stessa di 'seleziona tutto' che hai già visto.",
          "Cambia solo la tabella: quella che collega ordini e prodotti."
        ],
      ...
      },
      {
        ...
        "hints": [
          "L'asterisco seleziona tutte le colonne disponibili",
          "La tabella dei dipendenti è Employees"
        ],
        "explanation": "SELECT * seleziona tutte le colonne della tabella. In produzione è meglio specificare le colonne necessarie per performance e chiarezza.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Dopo SELECT non sei obbligato a mettere l'asterisco: puoi elencare le colonne che ti servono.",
          "Ti serve una sola colonna, quindi il risultato avrà una sola intestazione."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Seleziona solo il campo email",
          "La tabella degli utenti è Users"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Non ti serve l'asterisco: elenca la colonna che vuoi.",
          "La colonna del paese in Users si chiama country."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Puoi chiedere più colonne insieme, elencandole dopo SELECT.",
          "Separa i due nomi di colonna con una virgola, nell'ordine richiesto."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Seleziona solo la colonna category",
          "La tabella è Products"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Serve la colonna che contiene la data dell'ordine",
          "Il campo si chiama order_date nella tabella Orders"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Cerca il campo che rappresenta lo stato dell'ordine",
          "Il campo si chiama status nella tabella Orders"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Serve la colonna con l'importo totale",
          "Si chiama order_total nella tabella Orders"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Una colonna sola, da una tabella sola.",
          "La quantità venduta sta in OrderItems, non in Orders."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Cerca il prezzo unitario nella tabella giusta",
          "La colonna si chiama unit_price in OrderItems"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Seleziona il campo del dipartimento",
          "La tabella dei dipendenti è Employees"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Seleziona il campo con il nome",
          "La tabella è Employees"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Servono due colonne dalla stessa tabella.",
          "is_premium è una colonna booleana: si seleziona come qualsiasi altra."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Senza una parola chiave in più, ogni paese comparirebbe ripetuto per ogni utente.",
          "La parola che elimina i doppioni va subito dopo SELECT."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il problema da risolvere è: molte righe, poche categorie diverse.",
          "DISTINCT va messo prima del nome della colonna."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Nella SELECT puoi scrivere espressioni matematiche, non solo nomi di colonna.",
          "La metà del prezzo si ottiene dividendo la colonna price per 2."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Aggiungere il 22% equivale a moltiplicare per un unico fattore.",
          "Il fattore è 1.22: applicalo alla colonna price nella SELECT."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Puoi moltiplicare una colonna per un'altra colonna, riga per riga.",
          "Il valore del magazzino di un prodotto è prezzo per giacenza."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il totale di una riga d'ordine è un prodotto tra due colonne.",
          "Le due colonne che ti servono sono quantity e unit_price."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Un alias rinomina la colonna solo nel risultato, non nella tabella.",
          "La parola chiave per assegnare l'alias è AS, subito dopo la colonna."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Rinomina entrambe le colonne usando AS",
          "Separa le colonne con la virgola"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Cerca il campo con la data di registrazione",
          "Il campo si chiama created_at nella tabella Users"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Più dipendenti condividono lo stesso reparto: senza correttivi lo vedresti ripetuto.",
          "DISTINCT sulla colonna department restituisce ogni reparto una volta."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa la keyword DISTINCT per eliminare i duplicati",
          "La colonna da selezionare è status dalla tabella Orders"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Elenca esattamente le tre colonne richieste, nell'ordine dato.",
          "Tutte e tre vivono nella tabella Orders: id, user_id e status."
        ],
    ...
    "Medium": [
      {
        ...
        "hints": [
          "L'alias cambia l'intestazione della colonna nel risultato.",
          "Dopo il nome della colonna metti AS seguito dal nuovo nome."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Rinomina la colonna prezzo con un alias significativo",
          "Usa la keyword AS per creare un alias"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Ogni colonna può avere il suo alias, indipendente dalle altre.",
          "Scrivi coppia colonna AS alias, virgola, seconda coppia."
        ],
        "explanation": "L'alias (AS) rinomina una colonna o il risultato di un'espressione nel set di risultati, migliorando la leggibilità.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Un alias con lo spazio dentro non può stare 'nudo': il parser lo spezzerebbe.",
          "Racchiudi l'alias tra apici per farlo trattare come un nome unico."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Prima l'espressione di calcolo, poi il nome da darle.",
          "L'alias con AS si applica all'intera espressione quantity per unit_price."
        ],
        "explanation": "L'alias (AS) rinomina una colonna o il risultato di un'espressione nel set di risultati, migliorando la leggibilità.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa l'operatore + per sommare valori",
          "Puoi aggiungere un numero fisso a una colonna"
        ],
        "explanation": "L'alias (AS) rinomina una colonna o il risultato di un'espressione nel set di risultati, migliorando la leggibilità.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il 50% di un valore è quel valore per 0.5.",
          "Dai un nome al risultato con AS, come richiesto dal testo."
        ],
      ...
      },
      {
        ...
        "hints": [
          ...
          "Posiziona DISTINCT subito dopo SELECT"
        ],
      ...
      },
      {
        ...
        "queryTemplate": "SELECT DISTINCT country FROM Users",
        "hints": [
          "Usa DISTINCT per ottenere valori unici",
      ...
      },
      {
        ...
        "queryTemplate": "SELECT DISTINCT category FROM Products",
        "hints": [
          "Ti interessa l'elenco dei valori diversi, non tutte le righe.",
          "La parola chiave che deduplica va prima del nome colonna."
        ],
      ...
      },
      {
        ...
        "queryTemplate": "SELECT DISTINCT department FROM Employees",
        "hints": [
          "DISTINCT elimina i valori ripetuti",
          "Il campo del dipartimento si trova nella tabella Employees"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Molti dipendenti condividono lo stesso capo: deduplica i valori.",
          "Nel risultato può comparire anche NULL: è il caso di chi non ha manager."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Un utente con dieci ordini deve comparire una volta sola.",
          "Applica la deduplica alla colonna user_id della tabella Orders."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Devi trovare i valori unici di product_id",
          "Cerca nella tabella OrderItems"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Cerca gli order_id unici",
          "La tabella è OrderItems"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il valore di magazzino è un calcolo tra due colonne della stessa riga.",
          "Moltiplica price per stock e battezza il risultato con AS."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Puoi selezionare un valore fisso: verrà ripetuto per ogni riga della tabella.",
          "Scrivi il numero come se fosse una colonna e dagli un alias."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Qui l'IVA va mostrata da sola, accanto al prezzo pieno.",
          "Seleziona price e, come seconda colonna, price per 0.22 con alias."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il costo di dieci pezzi è il prezzo unitario scalato.",
          "Moltiplica la colonna price per 10 e assegna l'alias richiesto."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il guadagno richiesto è una frazione fissa del prezzo.",
          "Il 40% si esprime moltiplicando per 0.4."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Puoi mescolare colonne con alias e colonne senza.",
          "Solo category va rinominata: name resta con il suo nome."
        ],
        "explanation": "Le espressioni aritmetiche in SQL permettono di creare colonne calcolate al volo, combinando valori delle colonne con operatori matematici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Seleziona dalla tabella Users",
          "Specifica il nome delle colonne dopo SELECT"
        ],
        "explanation": "L'alias (AS) rinomina una colonna o il risultato di un'espressione nel set di risultati, migliorando la leggibilità.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Con più colonne, DISTINCT deduplica la combinazione, non ogni colonna da sola.",
          "Due utenti dello stesso paese ma con premium diverso producono due righe."
        ],
        "explanation": "L'alias (AS) rinomina una colonna o il risultato di un'espressione nel set di risultati, migliorando la leggibilità.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa DISTINCT per eliminare i valori ripetuti",
          "La colonna da rendere unica è category"
        ],
        "explanation": "COUNT(DISTINCT ...) conta i valori unici, eliminando i duplicati prima del conteggio.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La coppia utente-stato è l'unità da deduplicare.",
          "Lo stesso utente può comparire più volte, una per ogni stato diverso dei suoi ordini."
        ],
        "explanation": "DISTINCT elimina le righe duplicate dal risultato, restituendo ogni combinazione di valori una sola volta. È utile per ottenere liste di valori unici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Componi il calcolo in due passi: totale di riga, poi la maggiorazione fissa.",
          "Racchiudi la moltiplicazione tra parentesi e aggiungi 10 fuori, con un alias sul tutto."
        ],
        "explanation": "Le parentesi attorno a quantity * unit_price non cambiano il risultato (la moltiplicazione avrebbe comunque la precedenza sul +) ma rendono l'intenzione leggibile: prima il totale di riga, poi i 10 di spese fisse. L'alias con AS dà un nome all'intera espressione, parentesi comprese.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Seleziona dalla tabella Products",
          "Specifica il nome delle colonne dopo SELECT"
        ],
        "explanation": "L'alias (AS) rinomina una colonna o il risultato di un'espressione nel set di risultati, migliorando la leggibilità.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Per togliere un'IVA già inclusa non si sottrae il 22%: si divide.",
          "Dividi price per 1.22 e dai al risultato l'alias richiesto."
        ],
        "explanation": "Le espressioni aritmetiche in SQL permettono di creare colonne calcolate al volo, combinando valori delle colonne con operatori matematici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Un testo fisso tra apici può essere selezionato come colonna.",
          "La stringa 'Active' verrà ripetuta identica su ogni riga, con il suo alias."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Anche un numero fisso può fare da colonna nel risultato.",
          "Seleziona id e il numero 1 con un alias: ogni riga avrà Flag = 1."
        ],
        "explanation": "L'alias (AS) rinomina una colonna o il risultato di un'espressione nel set di risultati, migliorando la leggibilità.",
        "replacements": {},
    ...
    "Hard": [
      {
        ...
        "hints": [
          "Il risultato va tagliato dopo un certo numero di righe.",
          "La clausola che limita va in fondo alla query, con il numero massimo."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Stessa idea del limite già visto, cambia solo la soglia.",
          "Cinque righe al massimo, dalla tabella Products."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Ti serve una sola riga, qualsiasi essa sia.",
          "LIMIT accetta anche 1: utile per campionare una riga di esempio."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Tabella di dettaglio, tante righe: tagliane la maggior parte.",
          "Limita il risultato alle prime dieci righe."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Solo due righe dalla tabella del personale.",
          "La clausola di limite non cambia con la tabella: sintassi identica."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Per la seconda pagina devi saltare le righe della prima.",
          "OFFSET salta le righe iniziali, LIMIT decide quante mostrarne dopo il salto."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa LIMIT per il numero di righe e OFFSET per saltare le prime",
          "OFFSET 1 salta la prima riga"
        ],
      ...
      },
      {
        ...
        "hints": [
          "LIMIT imposta quante righe prendere, OFFSET quante saltarne",
          "Vuoi solo 1 riga, dopo aver saltato le prime 10"
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "OFFSET indica da dove iniziare, LIMIT quante righe prendere",
          "Salta le prime 2 righe, poi prendi le successive 4"
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Combina LIMIT e OFFSET per la paginazione",
          "Salta il primo dipendente e prendi i successivi 2"
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "NULL può essere selezionato come valore, esattamente come una costante.",
          "Dagli un alias e limita a una riga per non ripeterlo per ogni utente."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Per verificare che una tabella abbia righe non serve leggere colonne vere.",
          "Seleziona la costante 1 e fermati alla prima riga trovata."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Una stringa fissa selezionata da una tabella viene ripetuta per ogni riga.",
          "Alias sulla costante e limite a una riga: ottieni una singola cella 'Test'."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La SELECT sa fare aritmetica anche senza colonne.",
          "Moltiplica le due costanti e limita a una riga sola."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Due clausole insieme: una rinomina, l'altra taglia.",
          "Prima l'alias nella SELECT, poi il limite in fondo."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'ordine di applicazione conta: prima si deduplicano i valori, poi si taglia.",
          "Il limite agisce sull'elenco già deduplicato dei paesi."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Cosa succede se salti più righe di quante esistano?",
          "Un OFFSET oltre la fine non è un errore: il risultato è semplicemente vuoto o parziale."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Per prendere esattamente la quinta riga devi saltarne quattro.",
          "Combina un salto di 4 con un limite di 1."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il calcolo dell'IVA sta nella SELECT, il taglio delle righe in fondo.",
          "Moltiplica per 1.22 con alias, poi limita a tre righe."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Una stringa vuota è comunque un valore selezionabile.",
          "Due apici senza nulla in mezzo, con alias, su una sola riga."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Anche i booleani sono valori selezionabili come costanti.",
          "Scrivi true senza apici: con gli apici diventerebbe testo."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "OFFSET 0 significa non saltare nulla: è il valore implicito.",
          "Scriverlo esplicito è ridondante ma legale, e chiarisce l'intenzione di paginare."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Un calcolo tra colonne e un limite convivono senza problemi.",
          "La moltiplicazione sta nella SELECT, LIMIT 5 chiude la query."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "OFFSET N salta esattamente N righe, poi LIMIT conta da lì.",
          "Con salto 2 e limite 3 ottieni le righe dalla terza alla quinta."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Prima si costruisce l'elenco dei nomi unici, poi lo si taglia.",
          "Occhio: nel DB esistono nomi ripetuti su utenti diversi, DISTINCT li fonde."
        ],
        "explanation": "LIMIT restringe il numero di righe restituite al massimo specificato. Utile per campionamento, paginazione e top-N.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Deduplica le categorie e mostra solo le prime due dell'elenco.",
          "Senza un ORDER BY quali due categorie escano non è garantito: è un dettaglio da ricordare."
        ],
        "explanation": "DISTINCT elimina le righe duplicate dal risultato, restituendo ogni combinazione di valori una sola volta. È utile per ottenere liste di valori unici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Vuoi una fotografia di esempio della tabella, non tutti i dati.",
          "Tutte le colonne, una riga sola: componi asterisco e limite."
        ],
        "explanation": "LIMIT 1 su un SELECT * restituisce una sola riga con tutte le colonne di Employees: un modo rapido per ispezionare la struttura di una tabella senza scaricarla tutta. Nota che senza ORDER BY il database non garantisce QUALE riga arrivi: se ti serve proprio la prima per un criterio, ordinala prima.",
        "replacements": {},
    ...
    "Easy": [
      {
        ...
        "hints": [
          "WHERE tiene solo le righe che rispettano la condizione.",
          "Il paese è testo: il valore di confronto va tra apici singoli."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa WHERE per filtrare le righe",
          "Specifica la condizione dopo WHERE"
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Serve un confronto numerico nella WHERE.",
          "'Costoso' qui significa prezzo sopra i 100: usa il simbolo di maggiore."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Stessa struttura del filtro sui costosi, verso opposto.",
          "Sotto i 20: il simbolo giusto è il minore."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "is_premium è una colonna booleana: si confronta con TRUE o FALSE.",
          "TRUE va scritto senza apici: con gli apici diventerebbe una stringa."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      {
        "titleTemplate": "Dipendenti Sales",
        "descTemplate": "Seleziona tutti i dipendenti del reparto 'Sales'.",
        "queryTemplate": "SELECT * FROM Employees WHERE department = 'Sales'",
        "hints": [
          "Filtra sulla colonna department della tabella Employees.",
          "Il nome del reparto è una stringa: confrontalo con 'Sales' tra apici."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Vuoi le righe con esattamente quel prezzo, non un intervallo.",
          "L'uguaglianza in SQL usa un solo segno di uguale."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Gli id crescono con l'inserimento: id alto, riga recente.",
          "Confronta la colonna id con la soglia 50 usando il maggiore."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "'Almeno 2' include anche il 2 stesso.",
          "Il simbolo che include il limite è >= (maggiore o uguale)."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Vuoi tutto TRANNE una categoria.",
          "Il diverso si scrive <> (o !=), seguito dalla stringa tra apici."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'email identifica una persona sola: uguaglianza secca.",
          "L'indirizzo è una stringa completa, apici compresi."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Nel nostro DB le date sono stringhe 'YYYY-MM-DD'.",
          "Un'uguaglianza con la data tra apici trova gli ordini di quel giorno esatto."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "queryTemplate": "SELECT * FROM Orders WHERE order_date > '2023-01-01'",
        "hints": [
          "Il formato 'YYYY-MM-DD' si ordina bene anche come testo.",
          "'Dopo' una data si esprime con il maggiore e la data tra apici."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
        "brokenCode": "SELECT FROM Orders WHERE order_date > '2023-01-01'",
      ...
      },
      {
        ...
        "hints": [
          "La data di assunzione sta nella colonna hire_date.",
          "Assunti dopo inizio 2022: maggiore di '2022-01-01'."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "queryTemplate": "SELECT * FROM OrderItems WHERE quantity > 1",
        "hints": [
          "'Più di un pezzo' esclude le righe con quantità pari a 1.",
          "Il confronto giusto è quantity maggiore di 1, non maggiore o uguale."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Esaurito significa giacenza esattamente a zero.",
          "Un'uguaglianza con 0 sulla colonna stock basta."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
    ...
    "Medium": [
      {
        ...
        "hints": [
          "Due condizioni devono valere INSIEME sulla stessa riga.",
          "Il connettivo che le richiede entrambe è AND."
        ],
      ...
      },
      {
        ...
        "hints": [
          ...
          "Il connettivo che accontenta almeno una condizione è OR."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Tre uguaglianze in OR si comprimono in un unico operatore.",
          "IN vuole l'elenco dei valori tra parentesi, separati da virgole."
        ],
      ...
      },
      {
        ...
        "hints": [
          "IN funziona anche con le stringhe, non solo coi numeri.",
          "Ogni paese nell'elenco va tra apici, il tutto tra parentesi."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Un intervallo chiuso si esprime con un operatore dedicato.",
          "BETWEEN include entrambi gli estremi: 10 e 50 fanno parte del risultato."
        ],
        "explanation": "IN filtra le righe il cui valore è presente nella lista specificata. È più leggibile di una catena di OR.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "BETWEEN funziona anche sulle date in formato 'YYYY-MM-DD'.",
          "Gli estremi sono il primo e l'ultimo giorno del 2023, tra apici."
        ],
      ...
      },
      {
        ...
        "hints": [
          "NULL non si confronta con l'uguale: email = NULL non trova nulla.",
          "L'operatore dedicato all'assenza di valore è IS NULL."
        ],
        "explanation": "BETWEEN filtra per un intervallo inclusivo di valori, equivalente a >= AND <=. È più leggibile per filtri su range.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Vuoi le righe dove il valore ESISTE.",
          "La negazione di IS NULL si scrive IS NOT NULL, tutto per esteso."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa LIKE per il confronto con pattern",
          "Il simbolo % sostituisce qualsiasi sequenza di caratteri"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Servono entrambe le condizioni vere sulla stessa riga.",
          "Collega il filtro sulla categoria e quello sullo stock con AND."
        ],
        "explanation": "Le due condizioni in AND devono valere sulla stessa riga: la categoria deve essere 'Electronics' E la giacenza sopra lo zero. Se una delle due fallisce, la riga esce dal risultato. È il filtro tipico per 'disponibile a catalogo': esiste nella categoria giusta e c'è fisicamente in magazzino.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'underscore in un pattern LIKE vale UN carattere esatto, il % ne vale quanti vuole.",
          "Conta gli underscore dopo la A: fissano la lunghezza esatta del nome."
        ],
        "explanation": "LIKE filtra le stringhe per pattern: % corrisponde a qualsiasi sequenza di caratteri, _ a un singolo carattere.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "È l'opposto di IN: tieni chi NON sta nell'elenco.",
          "La negazione va prima di IN, con l'elenco dei due id tra parentesi."
        ],
        "explanation": "NOT IN esclude tutte le righe il cui id compare nell'elenco tra parentesi: qui restano tutti i prodotti tranne quelli con id 1 e 2. Occhio all'insidia classica di NOT IN: se l'elenco contenesse un NULL, il risultato diventerebbe vuoto, perché il confronto con NULL non è mai vero.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Vuoi i prezzi FUORI dall'intervallo, estremi compresi nell'esclusione.",
          "NOT davanti a BETWEEN ribalta l'intervallo."
        ],
        "explanation": "IN filtra le righe il cui valore è presente nella lista specificata. È più leggibile di una catena di OR.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Senza parentesi l'AND lega più forte dell'OR e il filtro cambia significato.",
          "Racchiudi le due categorie in parentesi, poi metti la condizione sul prezzo in AND."
        ],
        "explanation": "BETWEEN filtra per un intervallo inclusivo di valori, equivalente a >= AND <=. È più leggibile per filtri su range.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Stato e data sono due filtri che devono valere insieme.",
          "Lo stato è la stringa 'Shipped', la data si confronta con il maggiore."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Due reparti accettabili: potresti scrivere due OR, ma c'è di meglio.",
          "IN con l'elenco dei due nomi tra parentesi è più compatto e leggibile."
        ],
      ...
      },
      {
        ...
        "hints": [
          "'Critico' qui è un intervallo aperto: poco stock ma non zero.",
          "Due condizioni in AND sulla stessa colonna: sotto 5 e sopra 0."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Per verificare i valori nulli usa IS NULL",
          "Non usare = NULL, non funziona in SQL"
        ],
        "explanation": "AND combina più condizioni: tutte devono essere vere perché la riga sia inclusa nel risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Un filtro sulla data e uno sullo stato, entrambi obbligatori.",
          "'Non spedito' si esprime con il diverso: status != 'Shipped'."
        ],
        "explanation": "IS NULL verifica se un valore è NULL (assente). Non si può usare = NULL perché NULL non è un valore, è l'assenza di valore.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa IN per confrontare con una lista di valori",
          "I valori nella lista vanno separati da virgola"
        ],
        "explanation": "AND combina più condizioni: tutte devono essere vere perché la riga sia inclusa nel risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "Il pattern 'M%' tiene i nomi che iniziano con M: la lettera fissa prima, il jolly % dopo, a coprire il resto. Attenzione alla sensibilità alle maiuscole: alcuni motori considerano 'm' e 'M' uguali con LIKE, altri no. Se vuoi un comportamento prevedibile ovunque, normalizza prima con LOWER() o UPPER().",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Cerchi le date esterne a un intervallo, non interne.",
          "Due confronti sulla stessa colonna legati da OR: uno col minore, uno col maggiore."
        ],
        "explanation": "Le due condizioni in OR selezionano ciò che sta FUORI dall'intervallo 2022-2023: o prima del 1 gennaio 2022, o dopo il 31 dicembre 2023. È il complemento di un BETWEEN: quando vuoi l'esterno di un intervallo puoi negare il BETWEEN oppure, come qui, esplicitare i due lati con OR.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "FALSE si scrive senza apici, come TRUE.",
          "Il secondo requisito è la presenza dell'email: serve IS NOT NULL, non un confronto."
        ],
        "explanation": "OR include righe che soddisfano almeno una delle condizioni specificate.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Basta soddisfare una delle due condizioni per restare nel risultato.",
          "Le condizioni stanno su colonne diverse (price e stock): l'OR le unisce comunque."
        ],
        "explanation": "IS NOT NULL seleziona solo le righe dove il campo ha un valore definito, escludendo i NULL.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Tre requisiti, tutti obbligatori: si concatenano con due AND.",
          "Il controllo sull'email non è un confronto ma una verifica di presenza: IS NOT NULL."
        ],
        "explanation": "OR include righe che soddisfano almeno una delle condizioni specificate.",
        "replacements": {},
    ...
    "Hard": [
      {
        ...
        "queryTemplate": "SELECT * FROM Products WHERE (category = 'Electronics' OR category = 'Computers') AND price > 500",
        "hints": [
          "Le due categorie sono alternative tra loro, il prezzo è obbligatorio per entrambe.",
          "Parentesi attorno all'OR delle categorie, poi AND con la soglia di prezzo."
        ],
        "explanation": "IS NOT NULL seleziona solo le righe dove il campo ha un valore definito, escludendo i NULL.",
        "replacements": {},
        "brokenCode": "SELECT * FROM Products WHERE category = 'Electronics' OR category = 'Computers' AND price > 500",
      ...
      },
      {
        ...
        "hints": [
          "È più semplice descrivere chi NON vuoi e negare tutto.",
          "NOT davanti alla parentesi con i due paesi in OR."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il filtro combina lo stato spedito con l'esclusione di un insieme di id.",
          "La lista da escludere arriva da una subquery: NOT IN (SELECT ...)."
        ],
        "explanation": "OR include righe che soddisfano almeno una delle condizioni specificate.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Chi ha ordinato sta in Orders, ma tu vuoi righe di Users.",
          "Confronta l'id dell'utente con l'insieme degli user_id restituiti da una subquery."
        ],
      ...
      },
      {
        ...
        "hints": [
          "È il complemento dell'esercizio sugli utenti con ordini.",
          "Stessa subquery, ma con NOT IN per tenere chi non compare mai in Orders."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Un prodotto venduto compare almeno una volta in OrderItems.",
          "La subquery raccoglie i product_id; IN tiene i prodotti presenti in quell'insieme."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Invenduto significa mai comparso tra le righe d'ordine.",
          "NOT IN sulla subquery dei product_id di OrderItems."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Per ignorare le maiuscole, porta tutto in minuscolo prima del confronto.",
          "Applica LOWER() alla colonna e scrivi il pattern già in minuscolo."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il confronto non è sul prezzo pieno ma su un valore derivato.",
          "Moltiplica price per 0.9 direttamente nella WHERE, poi confronta con la soglia."
        ],
        "explanation": "La WHERE può contenere un'espressione calcolata: qui il prezzo scontato del 10% (price * 0.9) viene calcolato riga per riga e confrontato con 100. Il database non salva quel valore da nessuna parte: lo valuta al volo solo per decidere se tenere la riga. Nota che un filtro su espressione impedisce l'uso di eventuali indici sulla colonna.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Pari o dispari si decide con il resto della divisione per 2.",
          "L'operatore modulo è %: resto diverso da zero significa dispari."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Descrivi prima l'insieme da scartare: giocattoli economici.",
          "NOT davanti alla parentesi con le due condizioni in AND."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Due intervalli separati non si esprimono con un solo BETWEEN.",
          "Ogni BETWEEN tra parentesi, uniti da OR."
        ],
        "explanation": "AND combina più condizioni: tutte devono essere vere perché la riga sia inclusa nel risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Un requisito positivo e uno negativo sulla stessa colonna possono convivere.",
          "LIKE per il pattern richiesto, NOT LIKE per escludere il dominio indesiderato."
        ],
        "explanation": "BETWEEN filtra per un intervallo inclusivo di valori, equivalente a >= AND <=. È più leggibile per filtri su range.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il valore della riga d'ordine non esiste come colonna: va calcolato.",
          "Moltiplica quantity per unit_price dentro la WHERE e confronta con 50."
        ],
      ...
      },
      {
        ...
        "hints": [
          "La soglia non è fissa: la decide una statistica sulla stessa tabella.",
          "La subquery tra parentesi calcola AVG(price) e fa da termine di confronto."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Prima scopri il paese dell'utente 1, poi filtri su quello.",
          "Una subquery che restituisce UN solo valore può stare a destra dell'uguale."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il criterio è: stessa categoria del prodotto con id 10.",
          "Subquery scalare a destra dell'uguale: restituisce la categoria di quel prodotto."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La data di riferimento è quella dell'ordine numero 1.",
          "Uguaglianza con una subquery scalare che pesca order_date dove id = 1."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Descrivi l'insieme da buttare, poi negalo in blocco.",
          "Le parentesi sono la struttura: NOT ( premium AND ( paese1 OR paese2 ) )."
        ],
        "explanation": "Il NOT esterno ribalta l'intera condizione tra parentesi: escludi i premium di Italia o Francia, e tieni tutti gli altri. Leggi la query da dentro a fuori: prima l'OR sui paesi, poi l'AND col flag premium, infine la negazione totale. Per De Morgan equivale a: non premium, OPPURE di un paese diverso da quei due.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Non ti serve leggere i dati dell'ordine: solo sapere che ne esiste almeno uno.",
          "EXISTS con una subquery correlata: il legame è o.user_id = u.id."
        ],
        "explanation": "Combinare AND e OR richiede attenzione alle precedenze: AND ha priorità su OR. Usa le parentesi per controllo esplicito.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Stessa struttura di EXISTS, obiettivo opposto: nessun ordine deve esistere.",
          "NOT EXISTS è la forma più robusta per questo controllo (a differenza di NOT IN non soffre i NULL)."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Due scenari alternativi, ognuno con due requisiti interni.",
          "Ogni scenario tra parentesi con il suo AND; tra i due blocchi un OR."
        ],
        "explanation": "Le parentesi creano due blocchi indipendenti, ciascuno con la sua coppia categoria + soglia di stock, e l'OR li unisce: basta che la riga soddisfi uno dei due blocchi. Quando i due rami condividono la stessa condizione (stock < 10) puoi anche riscriverla raccolta: stock < 10 AND categoria IN ('Tech','Electronics'). Stesso risultato, meno ripetizione.",
        "replacements": {},
    ...
    "Easy": [
      {
        ...
        "hints": [
          "Usa la clausola ORDER BY",
          "L'ordinamento predefinito è ascendente (ASC)"
        ],
      ...
      },
      {
        ...
        "hints": [
          "L'ordinamento alfabetico inverso va dalla Z alla A.",
          "La parola chiave della direzione discendente è DESC, dopo il nome colonna."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Le email si ordinano alfabeticamente come qualsiasi testo.",
          "ASC è la direzione predefinita: puoi scriverla o ometterla."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Stessa colonna dell'esercizio precedente, direzione opposta.",
          "Dalla Z alla A: aggiungi DESC dopo email."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "ORDER BY va dopo il FROM, in fondo alla query.",
          "Ordina per la colonna name in direzione crescente."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Inverso significa dalla Z alla A.",
          "Cambia solo la direzione rispetto all'ordinamento normale: DESC."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordinare per categoria raggruppa visivamente i prodotti simili.",
          "La colonna si chiama category; la direzione crescente è quella di default."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per category in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Gli id vengono assegnati in sequenza: ordinarli ricostruisce la cronologia.",
          "ORDER BY id con direzione crescente (ASC o niente)."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "I più recenti hanno gli id più alti: ti serve l'ordine inverso.",
          "DESC dopo id mette gli ultimi ordini in cima."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordinare per user_id mette insieme gli ordini dello stesso cliente.",
          "È una colonna numerica: l'ordinamento crescente parte dai numeri più bassi."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Stessa colonna, direzione ribaltata.",
          "user_id seguito da DESC."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per id in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per order_id in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Ordina per order_id in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per name in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per name in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per department in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per department in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per price in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per price in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Vuoi vedere prima i prodotti quasi esauriti.",
          "Ordina per stock crescente: lo zero finisce in cima."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Qui invece i più abbondanti devono stare in cima.",
          "stock con DESC ribalta la classifica."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La colonna 'created_at' indica l'iscrizione",
          "Date più vecchie sono 'minori'"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per created_at in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per order_total in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per order_total in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per quantity in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per quantity in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
    ...
    "Medium": [
      {
        ...
        "hints": [
          "Il secondo criterio decide i pareggi del primo.",
          "Elenca country e poi name nell'ORDER BY, separati da virgola."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ogni colonna dell'ORDER BY può avere la SUA direzione.",
          "Categoria in ordine alfabetico, e dentro ogni categoria il prezzo dal più caro."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per order_date in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "A parità di stipendio serve un criterio di spareggio.",
          "Prima salary, poi name: entrambe crescenti."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'id fa da spareggio quando lo stock coincide.",
          "Due colonne nell'ORDER BY, entrambe in direzione crescente."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per LENGTH in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa YEAR() su hire_date",
          "Aggiungi un secondo criterio di ordinamento per i record con lo stesso anno"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Ordina per RANDOM in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Prima crea la colonna calcolata con un alias nella SELECT.",
          "Nell'ORDER BY puoi riusare direttamente quell'alias invece di ripetere il calcolo."
        ],
      ...
      },
      {
        ...
        "hints": [
          "I criteri si applicano in cascata: il successivo rompe i pareggi del precedente.",
          "Tre colonne separate da virgole, nell'ordine di priorità richiesto."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Vuoi forzare le email mancanti IN CIMA: serve una chiave artificiale.",
          "Un CASE che vale 0 per i NULL e 1 per gli altri, seguito dall'email come secondo criterio."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Speculare al nulls-first: stavolta i NULL vanno in fondo.",
          "Ribalta i pesi del CASE: 1 ai NULL, 0 al resto."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Non ordini per la data intera ma per una sua componente.",
          "Applica DAYOFWEEK(order_date) direttamente dentro l'ORDER BY."
        ],
        "explanation": "DAYOFWEEK estrae dal valore data il numero del giorno della settimana, e l'ORDER BY usa quel numero come chiave: gli ordini si raggruppano per lunedì, martedì e così via, indipendentemente dalla settimana in cui cadono. Ordinare per una funzione della colonna, invece che per la colonna stessa, è la tecnica da ricordare qui.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per MONTH in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per LOWER in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "I booleani si ordinano come numeri: FALSE vale 0, TRUE vale 1.",
          "Per avere i premium in cima serve la direzione discendente sul flag, poi il nome come spareggio."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa CASE WHEN nell'ORDER BY per creare un gruppo prioritario (0 per critici, 1 per altri)",
          "Poi ordina normalmente per stock"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La chiave di ordinamento è il prezzo trasformato, non quello originale.",
          "Avvolgi price in ROUND() dentro la clausola ORDER BY."
        ],
        "explanation": "ROUND(price) arrotonda il prezzo all'intero più vicino e l'ORDER BY ordina su quel valore arrotondato: 19.99 e 20.10 diventano entrambi 20 e finiscono vicini, cosa che con l'ordinamento sul prezzo esatto non accadrebbe. Quando ordini per una funzione, il database la calcola riga per riga solo per costruire l'ordine.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il dominio è la parte dell'email dopo la chiocciola.",
          "INSTR trova la posizione della @, SUBSTR taglia da lì in poi: componi le due funzioni."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Entrambi i criteri vanno dal più grande al più piccolo.",
          "DESC va ripetuto su ciascuna colonna: non si eredita."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Le due direzioni sono diverse: una inversa, una normale.",
          "category DESC, poi price senza direzione (ASC implicito)."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordinare per product_id affianca le righe dello stesso prodotto.",
          "Una sola colonna, direzione crescente."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il resto della divisione per 2 distingue pari (0) da dispari (1).",
          "Prima chiave: id % 2. Seconda chiave: id, per ordinare dentro i due gruppi."
        ],
      ...
      },
      {
        ...
        "hints": [
          "La chiave di ordinamento è quanti caratteri ha l'email.",
          "LENGTH(email) con DESC mette le più lunghe in cima."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Tre livelli: reparto, poi stipendio, poi nome come ultimo spareggio.",
          "Elencali in quest'ordine separati da virgole; la direzione crescente è implicita."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Aggiungere una costante non cambia chi sta prima di chi: l'esercizio insegna che ORDER BY accetta espressioni.",
          "Scrivi il calcolo (stock + 10) tra parentesi dentro l'ORDER BY, con DESC."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
    ...
    "Hard": [
      {
        ...
        "hints": [
          "Prima i disponibili, poi gli esauriti: servono due gruppi artificiali.",
          "Un CASE su stock > 0 produce la chiave di gruppo; il nome ordina dentro ciascun gruppo."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per LENGTH in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "LENGTH(name) trasforma ogni nome nel suo numero di caratteri e il DESC ordina da quel numero, dal più lungo al più corto. A parità di lunghezza l'ordine tra i nomi non è garantito: se servisse stabile, aggiungeresti un secondo criterio di spareggio.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Anno e mese vanno estratti dalla data con due funzioni separate.",
          "Anno discendente (i più recenti prima), mese crescente dentro l'anno."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Vuoi spostare UNA riga specifica in fondo, il resto in ordine normale.",
          "Un CASE che pesa 1 solo per id = 1 e 0 per gli altri la manda in coda; poi id come secondo criterio."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Le fasce sono tre gruppi ordinati: economico, medio, caro.",
          "Un CASE con due WHEN e un ELSE assegna 1, 2, 3; il prezzo ordina dentro ogni fascia."
        ],
        "explanation": "CASE WHEN è l'equivalente SQL dell'if-else: valuta condizioni in sequenza e restituisce il valore corrispondente alla prima condizione vera.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per REPLACE in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "REPLACE toglie il prefisso 'www.' da ogni email prima che l'ORDER BY la usi come chiave: così 'www.acme.com' e 'acme.com' si ordinano insieme. La colonna mostrata resta intatta, la trasformazione esiste solo per decidere l'ordine delle righe.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa la funzione SUBSTR per estrarre il primo carattere",
          "Aggiungi id come secondo criterio per risultati stabili"
        ],
      ...
      },
      {
        ...
        "queryTemplate": "SELECT * FROM Products ORDER BY RANDOM()",
        "hints": [
          "Un ordinamento casuale usa una funzione che genera un numero diverso per ogni riga.",
          "Metti la funzione random direttamente come chiave dell'ORDER BY: a ogni esecuzione un ordine diverso."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
        "brokenCode": "SELECT * FROM Products ORDER RANDOM()",
      ...
      },
      {
        ...
        "hints": [
          "Ordina per COALESCE in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY riordina le righe nel risultato finale secondo i valori della colonna specificata.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per SUBSTR in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La priorità dei reparti non è alfabetica: va dichiarata a mano.",
          "La forma compatta CASE department WHEN 'HR' THEN 1 ... assegna il peso a ogni reparto."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per ABS in ordine crescente",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY riordina le righe nel risultato finale secondo i valori della colonna specificata.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La chiave di ordinamento è la fusione di due colonne in un testo unico.",
          "L'operatore di concatenazione è ||: name || id produce la stringa combinata."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Trasforma i NULL in una stringa scelta apposta per cadere nel punto giusto dell'alfabeto.",
          "Il CASE sostituisce l'email mancante con 'M_NULL', che si ordina tra le lettere come una parola qualsiasi."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per stock in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "I due criteri lavorano in cascata con direzioni opposte: lo stock crescente decide l'ordine principale e, quando due prodotti hanno la stessa giacenza, il prezzo discendente rompe il pareggio mettendo prima il più caro. Ogni colonna dell'ORDER BY porta la propria direzione: ASC su una non implica nulla sull'altra.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Vuoi ordinare per il prezzo 'bloccato' a un tetto massimo di 50.",
          "Il CASE restituisce il prezzo vero sotto i 50 e la costante 50 sopra: è un clamp fatto a mano."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Chiediti: spostare TUTTE le date di 7 giorni cambia chi viene prima?",
          "La sintassi passa la data e la stringa di spostamento alla funzione DATE, direttamente nell'ORDER BY."
        ],
        "explanation": "L'ORDER BY qui usa un'espressione che sposta ogni data avanti di 7 giorni prima di confrontarla. Nota il punto istruttivo: aggiungere la stessa costante a tutte le righe NON cambia l'ordine relativo, il risultato è identico a ordinare per la data pura. La tecnica torna utile quando lo spostamento varia da riga a riga (per esempio in base a un'altra colonna).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il gruppo prioritario è definito da DUE condizioni insieme.",
          "Il CASE assegna 0 a chi è premium E italiano, 1 a tutti gli altri; lo 0 sale in cima con ASC."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "LENGTH(name) conta i caratteri di ogni nome prodotto e l'ordinamento crescente parte dai nomi più corti. La colonna calcolata non compare nel risultato: viene valutata solo come chiave di ordinamento. Se due nomi hanno la stessa lunghezza il loro ordine reciproco non è garantito senza un criterio di spareggio.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per ROUND in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ordina per hire_date in ordine decrescente (DESC)",
          "ORDER BY si mette dopo la clausola WHERE (se presente)"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Due trasformazioni diverse dello stesso campo fanno da criteri in cascata.",
          "SUBSTR(name, 1, 1) estrae l'iniziale; a parità di iniziale decide LENGTH(name) discendente."
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
      ...
      {
        "titleTemplate": "Ordina ID come Testo",
        "descTemplate": "Ordina gli utenti trattando l'id come TESTO con CAST(id AS STRING): osserva che 10 viene prima di 2.",
        "queryTemplate": "SELECT * FROM Users ORDER BY CAST(id AS STRING) ASC",
        "hints": [
          "Ordinare numeri come testo produce un ordine 'alfabetico': 1, 10, 100, 2...",
          "Avvolgi la colonna in una CAST verso un tipo testuale dentro l'ORDER BY."
        ],
        "explanation": "CAST(id AS STRING) converte il numero in testo prima dell'ordinamento, e il testo si ordina carattere per carattere: '10' viene prima di '2' perché '1' precede '2' nell'alfabeto. È l'errore classico dei codici salvati come stringa: sembrano numeri ma non si ordinano come numeri. La conversione inversa (da testo a numero) è la cura tipica.",
        "replacements": {},
        "brokenCode": "SELECT * FROM Users ORDER BY CAST(id STRING) ASC",
        "debugHint": "Nella CAST manca la parola AS tra la colonna e il tipo."
      },
      {
        ...
        "hints": [
          "I dipendenti senza capo devono finire in fondo alla lista.",
          "Il CASE dà peso 1 ai manager_id NULL e 0 agli altri; il secondo criterio ordina i valori presenti."
        ],
        "explanation": "ORDER BY con ASC ordina i risultati in ordine crescente (dal più piccolo al più grande, dalla A alla Z). ASC è il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'ultimo bit di un numero dice se è pari o dispari.",
          "id & 1 produce 0 o 1: usalo come prima chiave, con l'id come spareggio."
        ],
        "explanation": "L'espressione id & 1 applica l'AND bit a bit tra l'id e 1: il risultato è 1 per i numeri dispari e 0 per i pari, perché guarda solo l'ultimo bit. Con DESC i dispari (1) salgono in cima, e il secondo criterio ordina per id dentro ciascun gruppo. È un modo compatto, anche se meno leggibile del modulo %, per separare pari e dispari.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          ...
          "Le funzioni aggregate operano sull'intero set se non c'è GROUP BY"
        ],
        "explanation": "ORDER BY con DESC ordina i risultati in ordine decrescente (dal più grande al più piccolo, dalla Z alla A).",
        "replacements": {},
  ...
  "aggregation": {
    "Easy": [
      ...
      },
      {
        ...
        "hints": [
          "COUNT(*) conta le righe, senza guardare i valori delle colonne.",
          "Nessun filtro richiesto: tutta la tabella Products."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il numero totale di ordini è un conteggio di righe.",
          "La funzione va nella SELECT, da sola: il risultato è un numero unico."
        ],
        "explanation": "COUNT(*) conta tutte le righe della tabella o del set filtrato, incluse quelle con valori NULL.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Stesso schema dei conteggi precedenti, tabella diversa.",
          "COUNT(*) sulla tabella del personale."
        ],
        "explanation": "COUNT(*) conta tutte le righe della tabella o del set filtrato, incluse quelle con valori NULL.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il range è la distanza tra il prezzo più alto e il più basso.",
          "Puoi sottrarre due aggregazioni direttamente nella SELECT."
        ],
        "explanation": "MIN() restituisce il valore più piccolo nella colonna, utile per trovare il prezzo minimo, la data più antica, ecc.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Prima filtra le righe del 2023, poi somma solo quelle.",
          "La funzione YEAR estrae l'anno dalla data: confrontala con 2023 nella WHERE."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il massimo va calcolato solo su un sottoinsieme delle righe.",
          "La WHERE con la categoria 'Accessories' filtra PRIMA che MAX guardi i prezzi."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
    ...
    "Medium": [
      {
        ...
        "hints": [
          "Raggruppa per la colonna country",
          "Usa una funzione aggregata come COUNT, SUM o AVG nella SELECT"
        ],
        "explanation": "SUM() calcola la somma totale dei valori nella colonna specificata, ignorando i valori NULL.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Raggruppa per la colonna category",
          "Usa una funzione aggregata come COUNT, SUM o AVG nella SELECT"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Una media per ogni categoria: servono i gruppi.",
          "La colonna nel GROUP BY è la stessa che mostri accanto alla media."
        ],
        "explanation": "GROUP BY raggruppa le righe con lo stesso valore nella colonna specificata. COUNT conta quante righe appartengono a ciascun gruppo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Vuoi un totale di giacenza per ciascuna categoria.",
          "SUM(stock) nella SELECT, category sia in SELECT che in GROUP BY."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Raggruppa per la colonna status",
          "Usa una funzione aggregata come COUNT, SUM o AVG nella SELECT"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Ogni stato dell'ordine diventa una riga con il suo fatturato.",
          "Raggruppa per status e somma order_total dentro ogni gruppo."
        ],
        "explanation": "GROUP BY raggruppa le righe con lo stesso valore nella colonna specificata. COUNT conta quante righe appartengono a ciascun gruppo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Raggruppa per la colonna department",
          "Usa una funzione aggregata come COUNT, SUM o AVG nella SELECT"
        ],
        "explanation": "GROUP BY con SUM calcola il totale per ogni gruppo. È fondamentale per report di vendite, fatturato e volumi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Raggruppa per la colonna user_id",
          "Usa una funzione aggregata come COUNT, SUM o AVG nella SELECT"
        ],
        "explanation": "GROUP BY raggruppa le righe con lo stesso valore nella colonna specificata. COUNT conta quante righe appartengono a ciascun gruppo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La spesa di un utente è la somma dei suoi ordini.",
          "GROUP BY user_id crea un gruppo per cliente; SUM lavora dentro ciascun gruppo."
        ],
        "explanation": "GROUP BY raggruppa le righe con lo stesso valore nella colonna specificata. COUNT conta quante righe appartengono a ciascun gruppo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il mese va estratto dalla data prima di poterci raggruppare sopra.",
          "Dai un alias al mese estratto e riusalo nel GROUP BY."
        ],
        "explanation": "GROUP BY con SUM calcola il totale per ogni gruppo. È fondamentale per report di vendite, fatturato e volumi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il dominio non esiste come colonna: va costruito da email.",
          "SUBSTR con INSTR taglia il testo dopo la chiocciola; l'alias serve al GROUP BY."
        ],
        "explanation": "GROUP BY raggruppa le righe con lo stesso valore nella colonna specificata. COUNT conta quante righe appartengono a ciascun gruppo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il filtro è sul TOTALE del gruppo, non sulle singole righe: WHERE non basta.",
          "HAVING confronta SUM(order_total) con la soglia 50, dopo il raggruppamento."
        ],
        "explanation": "HAVING filtra i gruppi dopo l'aggregazione, a differenza di WHERE che filtra le righe prima del raggruppamento. Si usa con GROUP BY.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Raggruppa per la colonna order_id",
          "Usa una funzione aggregata come COUNT, SUM o AVG nella SELECT"
        ],
        "explanation": "GROUP BY order_id crea un gruppo per ogni ordine e COUNT(*) conta quante righe di dettaglio contiene: cioè quanti articoli diversi compone quell'ordine. Nota la regola d'oro dell'aggregazione: ogni colonna nella SELECT o è raggruppata o è dentro una funzione aggregata.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Un massimo per gruppo, non un massimo globale.",
          "MAX(price) accanto alla categoria, con il GROUP BY sulla categoria."
        ],
        "explanation": "GROUP BY con SUM calcola il totale per ogni gruppo. È fondamentale per report di vendite, fatturato e volumi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il filtro riguarda le singole righe, quindi va applicato prima dei gruppi.",
          "WHERE per il flag premium, poi GROUP BY country e il conteggio."
        ],
        "explanation": "Il filtro is_premium = TRUE sta nella WHERE, quindi agisce PRIMA del raggruppamento: nei gruppi entrano solo gli utenti premium, e il COUNT conta soltanto loro. Se lo stesso filtro fosse in HAVING non funzionerebbe: HAVING ragiona sui gruppi già formati, non sulle righe.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "La WHERE elimina i prodotti esauriti prima che i gruppi si formino: la media per categoria è calcolata solo sulle giacenze positive. È la scelta giusta quando gli zeri falserebbero la statistica. Confrontala mentalmente con l'alternativa senza filtro: stessa query, medie più basse.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ti interessa la media di ciascun utente, e vuoi tenere solo le medie sopra soglia.",
          "Il confronto AVG(order_total) > 20 vive nell'HAVING, perché giudica il gruppo intero."
        ],
        "explanation": "GROUP BY raggruppa le righe con lo stesso valore nella colonna specificata. COUNT conta quante righe appartengono a ciascun gruppo.",
        "replacements": {},
    ...
    "Hard": [
      {
        ...
        "hints": [
          "Vuoi DUE conteggi diversi nella stessa riga per utente.",
          "Ogni conteggio è una SUM su un CASE che vale 1 quando lo stato corrisponde, 0 altrimenti."
        ],
        "explanation": "Ogni SUM(CASE ...) è un contatore selettivo: la prima somma 1 solo per gli ordini spediti, la seconda solo per quelli in attesa. Il risultato è una tabella 'pivot' con una colonna per stato, ottenuta senza JOIN né subquery. Il trucco da ricordare: CASE trasforma la condizione in 0/1, SUM li accumula.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Non conti gli ordini spediti: ne sommi il valore.",
          "Il CASE dentro la SUM restituisce order_total per gli spediti e 0 per il resto."
        ],
      ...
      },
      {
        ...
        "explanation": "La media ponderata pesa ogni prezzo per la sua giacenza: SUM(price * stock) accumula il valore totale del magazzino, SUM(stock) i pezzi, e il rapporto dà il prezzo medio per PEZZO, non per prodotto. Con AVG(price) un articolo raro da 1000 euro conterebbe quanto uno comunissimo da 10: la ponderazione corregge proprio questo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Due condizioni sui gruppi, entrambe obbligatorie.",
          "L'AND collega i due confronti dentro l'HAVING, ognuno con la sua funzione aggregata."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Un gruppo passa se soddisfa ALMENO una delle due condizioni.",
          "Nell'HAVING puoi usare aggregazioni anche non presenti nella SELECT, come AVG(price) qui."
        ],
        "explanation": "HAVING filtra i gruppi dopo l'aggregazione, a differenza di WHERE che filtra le righe prima del raggruppamento. Si usa con GROUP BY.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il rapporto tra due somme si scrive come divisione tra due SUM.",
          "Occhio al denominatore: un gruppo con stock totale 0 darebbe una divisione per zero."
        ],
        "explanation": "Il rapporto divide due somme calcolate nello stesso gruppo: il valore complessivo dei prezzi e i pezzi totali di ogni categoria. Non è una media dei rapporti riga per riga, ma il rapporto dei totali: le due cose danno numeri diversi. Resta il rischio del denominatore: una categoria con stock totale a zero produrrebbe una divisione per zero.",
        "replacements": {},
        "brokenCode": "SELECT category SUM(price) / SUM(stock) as Ratio FROM Products GROUP BY category",
        "debugHint": "Divisione tra SUM."
      },
      {
        "titleTemplate": "Reparti con Più Capi",
        "descTemplate": "Per ogni department, conta i manager distinti (manager_id) e mostra solo i reparti che ne hanno più di uno.",
        "queryTemplate": "SELECT department, COUNT(DISTINCT manager_id) FROM Employees GROUP BY department HAVING COUNT(DISTINCT manager_id) > 1",
        "hints": [
          "Un reparto con dieci dipendenti può avere un capo solo: conta i capi, non le persone.",
          "DISTINCT va DENTRO il COUNT; il filtro sul risultato del conteggio va nell'HAVING."
        ],
        "explanation": "COUNT(DISTINCT manager_id) conta i capi diversi dentro ogni reparto, ignorando i duplicati: dieci persone sotto lo stesso capo valgono 1. L'HAVING poi tiene solo i reparti sopra soglia. DISTINCT dentro l'aggregazione è la differenza chiave: senza, conteresti le righe e non i capi.",
        "replacements": {},
        "brokenCode": "SELECT department, COUNT(DISTINCT manager_id) FROM Employees WHERE COUNT(DISTINCT manager_id) > 1 GROUP BY department",
        "debugHint": "Le funzioni aggregate non possono stare nella WHERE: il filtro sui gruppi si fa con HAVING."
      },
      {
        ...
        "explanation": "YEAR estrae l'anno da ogni data e il GROUP BY su quell'alias conta gli ordini di ciascun anno. La classifica poi si fa ordinando per il conteggio in discesa e tagliando con LIMIT 1: resta solo l'anno col numero più alto. È lo schema standard per 'il gruppo migliore': aggrega, ordina per l'aggregato, prendi il primo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Prima il fatturato di ogni mese, poi la classifica, poi il taglio.",
          "ORDER BY sulla SUM in discesa e LIMIT 1 isolano il mese di picco."
        ],
        "explanation": "GROUP BY raggruppa le righe con lo stesso valore nella colonna specificata. COUNT conta quante righe appartengono a ciascun gruppo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Prima calcola il totale del gruppo, poi etichettalo.",
          "Il CASE sta FUORI dalla SUM: giudica il risultato dell'aggregazione."
        ],
        "explanation": "Qui il CASE avvolge l'aggregazione, non il contrario: prima SUM(stock) calcola la giacenza del gruppo, poi il CASE la classifica in 'High' o 'Low'. Confrontalo con SUM(CASE...), dove la condizione agisce riga per riga: la posizione del CASE decide se stai classificando il totale o filtrando gli addendi.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "L'espressione dentro COUNT(DISTINCT ...) costruisce il dominio di ogni email al volo (il testo dopo la chiocciola) e il conteggio distinto elimina i doppioni dentro ogni paese. Il risultato dice quanti provider email diversi usa ogni nazione. Le funzioni si possono comporre anche dentro un'aggregazione: qui SUBSTR e INSTR lavorano riga per riga, DISTINCT e COUNT sul gruppo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il coefficiente misura quanto è largo il range rispetto alla media.",
          "Tre aggregazioni nella stessa espressione: (MAX meno MIN) diviso AVG."
        ],
        "explanation": "GROUP BY raggruppa le righe con lo stesso valore nella colonna specificata. COUNT conta quante righe appartengono a ciascun gruppo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Gli esauriti si isolano riga per riga, prima dei gruppi.",
          "WHERE stock = 0, poi GROUP BY category con il conteggio nella SELECT."
        ],
        "explanation": "La WHERE tiene solo i prodotti con stock a zero, poi il GROUP BY conta quanti ne ha ogni categoria: è la mappa degli esauriti per reparto. L'ordine logico conta: prima si filtrano le righe (WHERE), poi si formano i gruppi, e infine si conterebbe con HAVING solo se il filtro riguardasse i totali.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Nessun gruppo: le due funzioni guardano tutta la tabella insieme.",
          "Metti SUM e COUNT nella stessa SELECT, separate da virgola."
        ],
        "explanation": "Senza GROUP BY le funzioni aggregate lavorano sull'intera tabella come unico grande gruppo: SUM restituisce il fatturato complessivo e COUNT il numero totale di ordini, in una sola riga di risultato. Più aggregazioni possono convivere nella stessa SELECT, ma non puoi affiancarci colonne normali senza raggrupparle.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il denominatore è il totale GENERALE, che una subquery calcola a parte.",
          "Moltiplica per 100.0 (col punto decimale) per evitare la divisione intera."
        ],
        "explanation": "COUNT(*) conta tutte le righe della tabella o del set filtrato, incluse quelle con valori NULL.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Prima un massimo per ogni categoria, poi la classifica dei massimi.",
          "Puoi riusare MAX(price) direttamente nell'ORDER BY con DESC."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa CASE WHEN per classificare i valori",
          "Ricorda di chiudere con END"
        ],
        "explanation": "GROUP BY con MIN/MAX trova il valore estremo in ogni gruppo, utile per analisi di range e identificazione di outlier.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "LENGTH trasforma ogni nome nella sua lunghezza e AVG fa la media di quei numeri dentro ogni categoria: scopri quanto sono 'verbosi' i nomi dei prodotti per reparto. Comporre una funzione scalare dentro una aggregata è un pattern generale: la scalare lavora riga per riga, l'aggregata riassume il gruppo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Un gruppo per ogni data, poi ordini le date dalla più recente.",
          "Il LIMIT taglia la classifica alle prime tre date: niente funzioni di calendario necessarie."
        ],
        "explanation": "GROUP BY con AVG calcola la media per ogni raggruppamento, utile per confrontare le performance tra categorie o periodi.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "GROUP_CONCAT fonde i valori del gruppo in un'unica stringa: qui gli id degli ordini di ogni utente, uniti dal separatore '|'. È l'aggregazione da usare quando non vuoi un numero ma l'elenco leggibile dei membri del gruppo. Occhio: l'ordine degli elementi concatenati non è garantito senza un ordinamento esplicito.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ogni riga va confrontata con un valore calcolato sull'intera tabella.",
          "La subquery tra parentesi restituisce la media globale e si sottrae come fosse una costante."
        ],
        "explanation": "La subquery calcola la media di TUTTI i prezzi una volta sola, e la query esterna la sottrae dal prezzo di ogni singola riga: ottieni lo scostamento di ciascun prodotto dalla media globale, senza GROUP BY. È il tipo di confronto riga-contro-totale che nei database moderni si fa con le window function; la subquery scalare è l'equivalente portabile.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'idea: butta il più caro e il più economico, media il resto.",
          "Componi SUM, MAX, MIN e COUNT in un'unica espressione aritmetica."
        ],
        "explanation": "La media 'trimmed' esclude i due estremi: dal totale togli il prezzo massimo e quello minimo, e dividi per il numero di prodotti meno 2. Serve quando un valore anomalo (un fuoriprezzo) inquinerebbe la media semplice. Tutte le aggregazioni della formula si calcolano sull'intera tabella in un colpo solo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Raggruppa per categoria e ordina per media stock",
          "Usa DESC e LIMIT 1 per ottenere solo il valore più alto"
        ],
  ...
  "functions": {
    "Easy": [
      ...
      },
      {
        ...
        "hints": [
          "Usa CONCAT()",
          "Separa i campi con una virgola e aggiungi un separatore come ' - '"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa ABS()",
          "Scrivi la sottrazione dentro la funzione"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa LEFT()",
          "Specifica 3 come secondo argomento"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa TRIM()",
          "Utile per pulire l'input utente"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa POWER()",
          "Il secondo argomento è l'esponente (2)"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa REPEAT()",
          "Argomenti: stringa, numero ripetizioni"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa EXP()",
          "Filtra prezzi bassi per evitare overflow"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa REPLACE()",
          "Argomenti: colonna, cerca, sostituisci_con"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa ASCII()",
          "Restituisce il codice del primo carattere"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa BIT_LENGTH()",
          "Solitamente 8x la lunghezza in caratteri (per ASCII)"
        ],
    ...
    "Medium": [
      {
        ...
        "hints": [
          "Usa SUBSTR() o SUBSTRING()",
          "Argomenti: colonna, start, length"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa CONCAT",
          "Mischia stringa fissa e colonna numerica"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa REPLACE()",
          "Sostituisci il simbolo speciale"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa LPAD()",
          "Specifica lunghezza 5 e carattere '0'"
        ],
      ...
      },
      {
        ...
        "hints": [
          "SUBSTR taglia un pezzo di stringa: posizione di partenza e lunghezza.",
          "L'iniziale è il taglio che parte da 1 e prende 1 carattere."
        ],
        "explanation": "Le funzioni stringa SQL permettono di manipolare e trasformare dati testuali direttamente nelle query.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa INSTR per trovare la @",
          "Usa SUBSTR partendo da quella posizione + 1"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Calcola lunghezza come posizione @ - 1",
          "Usa SUBSTR da 1"
        ],
        "explanation": "Le espressioni aritmetiche in SQL permettono di creare colonne calcolate al volo, combinando valori delle colonne con operatori matematici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "ROUND senza precisione taglia all'intero: qui vuoi due decimali.",
          "Il secondo argomento dice quante cifre tenere dopo la virgola."
        ],
        "explanation": "Le espressioni aritmetiche in SQL permettono di creare colonne calcolate al volo, combinando valori delle colonne con operatori matematici.",
        "replacements": {},
      ...
      {
        "titleTemplate": "Quadrato dello Stock",
        "descTemplate": "Per ogni prodotto mostra name e il quadrato dello stock, calcolato con POWER.",
        "queryTemplate": "SELECT name, POWER(stock, 2) AS stock_quadrato FROM Products",
        "hints": [
          "Serve una funzione a due argomenti: base ed esponente.",
          "La base è la colonna stock, l'esponente è la costante 2."
        ],
        "explanation": "POWER(stock, 2) eleva la giacenza al quadrato riga per riga: il primo argomento è la base, il secondo l'esponente. Entrambi possono essere colonne o costanti. L'errore comune è cercare un operatore ^ come in altri linguaggi: in SQL l'elevamento a potenza passa dalla funzione.",
        "replacements": {},
        "brokenCode": "SELECT name, POWER(stock ^ 2) FROM Products",
        "debugHint": "POWER vuole due argomenti separati da virgola: base e esponente. L'operatore ^ non è l'elevamento a potenza in SQL."
      },
      {
      ...
      },
      {
        ...
        "hints": [
          "Vuoi incollare un testo fisso davanti a un valore di colonna.",
          "La funzione di concatenazione accetta il simbolo tra apici e la colonna price."
        ],
        "explanation": "CONCAT unisce il simbolo '$' e il prezzo in un'unica stringa: il numero viene convertito in testo automaticamente. Comodo per la presentazione, con un costo: il risultato non è più un numero, quindi niente somme o confronti numerici su quella colonna. La formattazione va fatta all'ultimo passaggio, mai prima dei calcoli.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa COALESCE()",
          "Il secondo valore è il fallback"
        ],
      ...
      {
        "titleTemplate": "Lunghezza Email (con NULL)",
        "descTemplate": "Per ogni utente mostra name e la lunghezza dell'email, contando 0 per chi non ce l'ha (email NULL).",
        "queryTemplate": "SELECT name, LENGTH(COALESCE(email, '')) FROM Users",
        "hints": [
          "Il problema è cosa succede a LENGTH quando l'email manca.",
          "Sostituisci prima il NULL con '' usando COALESCE, poi misura."
        ],
        "explanation": "COALESCE(email, '') sostituisce i NULL con una stringa vuota PRIMA che LENGTH conti i caratteri: chi non ha email ottiene 0 invece di NULL. L'ordine di composizione è il punto: se applicassi LENGTH direttamente, il NULL attraverserebbe la funzione e arriverebbe NULL fino al risultato.",
        "replacements": {},
        "brokenCode": "SELECT name, LENGTH(email) FROM Users",
        "debugHint": "Su un'email NULL, LENGTH restituisce NULL e non 0: serve COALESCE per sostituire il NULL con una stringa vuota."
      },
      {
        ...
        "hints": [
          "INSTR restituisce la posizione della prima occorrenza di un testo dentro un altro.",
          "Cerca lo spazio ' ' dentro name: se manca, il risultato è 0."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Esistono varianti di TRIM che puliscono un solo lato della stringa.",
          "LTRIM toglie gli spazi solo all'inizio; quelli in coda restano."
        ],
      ...
      },
      {
        ...
        "hints": [
          "SUBSTR può partire da qualsiasi posizione, non solo dalla prima.",
          "Partenza dal secondo carattere, lunghezza tre."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Converti colonna in UPPER",
          "Confronta con costante MAIUSCOLA"
        ],
        "explanation": "UPPER(name) porta il nome in maiuscolo prima del confronto, così 'alice', 'Alice' e 'ALICE' diventano tutte 'ALICE' e l'uguaglianza le trova tutte. Il dettaglio che fa fallire l'esercizio a molti: anche la costante di confronto deve essere già maiuscola, altrimenti normalizzi un lato solo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Confronti la prima lettera di ogni nome con quella di un nome fisso.",
          "SUBSTR su entrambi i lati dell'uguale: colonna a sinistra, costante a destra."
        ],
        "explanation": "Le due SUBSTR estraggono la prima lettera del nome e la prima di 'Alex', e l'uguaglianza tiene chi le condivide: una somiglianza fonetica molto grezza, da cui il titolo. Nota che puoi applicare funzioni a ENTRAMBI i lati di un confronto nella WHERE, anche a una costante.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "NULLIF(points, 0) ritorna NULL se points è 0",
          "N / NULL dà NULL (sicuro)"
        ],
      ...
      },
      {
        ...
        "hints": [
          "COALESCE scorre gli argomenti in ordine e si ferma al primo non NULL.",
          "'Found' viene restituito e 'Ignored' non viene nemmeno valutato."
        ],
    ...
    "Hard": [
      ...
      },
      {
        ...
        "hints": [
          "Estrai parte dopo spazio (Cognome)",
          "Primo carattere (Nome)",
          "Concatena con virgola"
        ],
        "explanation": "La query smonta 'Nome Cognome' e lo rimonta come 'COGNOME, N.': INSTR trova lo spazio, la prima SUBSTR prende tutto ciò che segue (il cognome), la seconda estrae l'iniziale, e CONCAT ricompone con virgola e punto. La WHERE con INSTR > 0 protegge dai nomi senza spazio, che romperebbero la scomposizione.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Calcola score base",
          "Usa CASE per limitare (clamp) a 100"
        ],
        "explanation": "CONCAT() unisce due o più stringhe in una sola, utile per creare campi composti come nome completo o indirizzi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Trova pos '['",
          "Trova pos ']'",
          "Calcola lunghezza come diff"
        ],
        "explanation": "INSTR individua dove sta la prima 'e' nel nome e SUBSTR taglia tre caratteri a partire dalla posizione successiva: un'estrazione ancorata a un carattere trovato, non a una posizione fissa. La WHERE con LIKE garantisce che la 'e' esista: senza, INSTR darebbe 0 e il taglio partirebbe da una posizione senza senso.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Unisci 3 parti",
          "Usa Upper, Left, Lpad, Right"
        ],
        "explanation": "Il codice prodotto nasce da tre pezzi: le prime due lettere della categoria in maiuscolo, l'id trasformato in testo e riempito di zeri a sinistra con LPAD fino a tre cifre, e l'ultimo carattere del nome. CONCAT li salda in un codice tipo 'EL007a'. LPAD è il protagonista: è lui che rende '7' un ordinato '007'.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Confronta primo char con sua versione Lower",
          "Decidi azione"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Ordina per ABS(price - 50)",
          "Prendi il primo"
        ],
        "explanation": "ABS(price - 50) misura la distanza di ogni prezzo dal bersaglio 50, ignorando il segno: 45 e 55 distano entrambi 5. Ordinando per quella distanza e tagliando con LIMIT 1 resta il prodotto più vicino al prezzo cercato. È lo schema generale del 'più vicino a X': ordina per distanza assoluta, prendi il primo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il report è un'unica stringa che mescola etichette fisse e valori calcolati.",
          "Ultimo carattere: SUBSTR con posizione pari alla lunghezza del nome e lunghezza 1."
        ],
        "explanation": "CONCAT accetta molti argomenti e alterna qui testo fisso e valori calcolati: la lunghezza del nome, il primo carattere e l'ultimo (SUBSTR che parte da LENGTH(name) e prende 1). Il risultato è una riga descrittiva per prodotto, costruita interamente in SQL. Nota come le funzioni si annidino: SUBSTR usa LENGTH come argomento di posizione.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Tre pulizie in sequenza: spazi, maiuscole, carattere indesiderato.",
          "Le funzioni si annidano da dentro a fuori: prima TRIM, poi LOWER, poi REPLACE."
        ],
        "explanation": "LENGTH() restituisce il numero di caratteri della stringa, utile per validazione e filtri sulla dimensione del testo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Subquery calcola AVG(LENGTH)",
          "Confronta LENGTH(name)"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il formato bersaglio è (id, stock) con parentesi e virgola letterali.",
          "Ogni pezzo fisso è una stringa tra apici dentro la CONCAT."
        ],
      ...
      },
      {
        ...
        "hints": [
          "ASCII trasforma un carattere nel suo codice numerico.",
          "Estrai primo e ultimo carattere con SUBSTR e moltiplica i due codici."
        ],
        "explanation": "CONCAT() unisce due o più stringhe in una sola, utile per creare campi composti come nome completo o indirizzi.",
        "replacements": {},
      ...
      {
        "titleTemplate": "Progressione da ID",
        "descTemplate": "Per ogni utente costruisci la stringa 'id-doppio-triplo' (es. per id 2: '2-4-6') usando CONCAT.",
        "queryTemplate": "SELECT CONCAT(id, '-', id * 2, '-', id * 3) AS progressione FROM Users",
        "hints": [
          "Ogni elemento della progressione è un calcolo sull'id.",
          "Alterna in CONCAT i tre valori e i due trattini, separando tutto con virgole."
        ],
        "explanation": "CONCAT alterna il valore dell'id, i suoi multipli calcolati al volo e i trattini fissi: i numeri diventano testo automaticamente durante la concatenazione. L'esercizio mostra che gli argomenti di una funzione possono essere espressioni intere (id * 2), non solo colonne o costanti.",
        "replacements": {},
        "brokenCode": "SELECT CONCAT(id '-' id * 2 '-' id * 3) FROM Users",
        "debugHint": "Gli argomenti di CONCAT vanno separati da virgole: gli apici da soli non bastano a unirli."
      },
      {
        ...
        "hints": [
          "La colonna mostrata dipende da una condizione sull'utente.",
          "Il CASE restituisce l'email vera ai premium e la maschera '***' agli altri."
        ],
        "explanation": "Le espressioni aritmetiche in SQL permettono di creare colonne calcolate al volo, combinando valori delle colonne con operatori matematici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "NULLIF(cat, '') gestisce stringa vuota",
          "COALESCE gestisce NULL",
          "UPPER alla fine"
        ],
        "explanation": "La catena gestisce DUE tipi di 'vuoto': NULLIF trasforma la stringa vuota in NULL, COALESCE rimpiazza ogni NULL (originale o appena creato) con 'Generico', e UPPER uniforma il risultato. È il pattern completo di normalizzazione di un campo sporco: prima pareggi i casi anomali, poi applichi il default, infine formatti.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Tre fasce di giacenza: servono due soglie in cascata.",
          "I WHEN si valutano in ordine: sotto 10 scatta il primo, sotto 50 il secondo, il resto cade nell'ELSE."
        ],
        "explanation": "UPPER() converte tutti i caratteri in maiuscolo. Utile per standardizzare dati e per confronti case-insensitive.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "INSTR trova la posizione del cancelletto dentro 'Order #123' e SUBSTR taglia da lì in avanti: la parte numerica dopo il separatore. Chiamata senza terzo argomento, SUBSTR prende tutto fino alla fine. È l'estrazione tipo 'ciò che segue un delimitatore', la stessa che useresti per il dominio di un'email dopo la chiocciola.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Seleziona dalla tabella tabella",
          "Specifica il nome delle colonne dopo SELECT"
        ],
        "explanation": "Le espressioni aritmetiche in SQL permettono di creare colonne calcolate al volo, combinando valori delle colonne con operatori matematici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Con caratteri semplici (ASCII), un carattere occupa un byte.",
          "LENGTH conta i caratteri: qui fa anche da stima dei byte."
        ],
        "explanation": "CONCAT() unisce due o più stringhe in una sola, utile per creare campi composti come nome completo o indirizzi.",
        "replacements": {},
      ...
      {
        "titleTemplate": "Indice Ultimo Carattere",
        "descTemplate": "Per ogni utente mostra l'indice (1-based) dell'ultimo carattere del nome, cioè la sua lunghezza.",
        "queryTemplate": "SELECT LENGTH(name) FROM Users",
        "hints": [
          "Se le posizioni partono da 1, dove cade l'ultimo carattere?",
          "Non serve nessuna sottrazione: la lunghezza coincide con l'indice cercato."
        ],
        "explanation": "In SQL le stringhe si indicizzano da 1, quindi l'ultimo carattere sta esattamente alla posizione LENGTH(name): la lunghezza È l'indice finale. È il complemento da ricordare quando componi SUBSTR: per l'ultimo carattere tagli da LENGTH(name) con lunghezza 1, senza fare LENGTH - 1.",
        "replacements": {},
        "brokenCode": "SELCET LENGTH(name) FROM Users",
        "debugHint": "Controlla attentamente la sintassi SQL e i nomi delle colonne e tabelle."
      },
      ...
      },
      {
        ...
        "hints": [
          "Il booleano va tradotto in un testo leggibile.",
          "Un CASE con il flag come condizione: 'Sì' nel ramo vero, 'No' nell'ELSE."
        ],
        "explanation": "CONCAT() unisce due o più stringhe in una sola, utile per creare campi composti come nome completo o indirizzi.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "NULLIF(stock, 0) trasforma lo zero in NULL, e una divisione per NULL produce NULL invece di un errore: il crash della divisione per zero sparisce alla radice. COALESCE poi converte quel NULL nel valore di ripiego 0. È l'idioma standard della divisione sicura: neutralizza il denominatore, poi scegli il default.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Pari o dispari si decide con il resto della divisione per 2.",
          "MOD(id, 2) vale 1 per i dispari: è la condizione della WHERE."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Due normalizzazioni in una: via gli spazi, tutto in maiuscolo.",
          "TRIM dentro, UPPER fuori: l'ordine qui non cambia il risultato, la leggibilità sì."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
  ...
  "dates": {
    "Easy": [
      {
        ...
        "hints": [
          "C'è una funzione che restituisce l'anno da una data",
          "Applica la funzione alla colonna created_at"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Cerca una funzione per ottenere il mese",
          "Il risultato deve essere un numero"
        ],
        "explanation": "YEAR() estrae il componente anno da una data, fondamentale per raggruppamenti e filtri su base annuale.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Estrai la parte del giorno dalla data",
          "Funzione DAY o DAYOFMONTH"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa NOW() per ottenere il momento corrente",
          "Usa HOUR() per estrarre l'ora"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Esiste una funzione che restituisce la data di oggi, senza orario.",
          "Si chiama senza argomenti: parentesi vuote."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Esiste una funzione per il nome del giorno",
          "DAYNAME restituisce la stringa in inglese"
        ],
      ...
      },
      {
        ...
        "hints": [
          "C'è una funzione speculare a DAYNAME",
          "Restituisce la stringa del mese in inglese"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Seleziona dalla tabella Orders",
          "Specifica il nome delle colonne dopo SELECT"
        ],
      ...
      },
      {
        ...
        "hints": [
          "created_at contiene anche l'orario: a te serve solo il giorno.",
          "La funzione DATE() scarta la parte oraria e tiene la data."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Qui serve anche l'orario, non solo il giorno.",
          "NOW() restituisce data e ora correnti insieme."
        ],
        "explanation": "Le funzioni di data SQL permettono di estrarre, calcolare e formattare componenti temporali per analisi cronologiche.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Estrai separatamente le due componenti dalla data.",
          "YEAR e MONTH producono numeri: uniscili col trattino usando CONCAT."
        ],
        "explanation": "Le funzioni di data SQL permettono di estrarre, calcolare e formattare componenti temporali per analisi cronologiche.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'approssimazione ignora mese e giorno: bastano gli anni.",
          "Sottrai l'anno di created_at dall'anno di NOW()."
        ],
        "explanation": "YEAR() estrae il componente anno da una data, fondamentale per raggruppamenti e filtri su base annuale.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "DAYOFWEEK restituisce 1 per Domenica (standard ODBC)",
          "Confronta con 1"
        ],
        "explanation": "NOW() restituisce la data e ora correnti del server, utile per calcoli relativi al presente.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "È un sinonimo storico della funzione per il timestamp corrente.",
          "Alcuni database la chiamano SYSDATE, altri NOW: qui esistono entrambe."
        ],
        "explanation": "Le funzioni di data SQL permettono di estrarre, calcolare e formattare componenti temporali per analisi cronologiche.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Aggiungere zero giorni non cambia la data: l'esercizio insegna la SINTASSI.",
          "La forma è DATE_ADD(data, INTERVAL n DAY), con n uguale a 0."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Una stringa in formato ISO può diventare una data vera.",
          "Passa la stringa alla funzione DATE() per la conversione esplicita."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il primo del mese ha sempre lo stesso giorno: 01.",
          "Costruisci la data incollando anno corrente, mese corrente e '-01'."
        ],
        "explanation": "Le espressioni aritmetiche in SQL permettono di creare colonne calcolate al volo, combinando valori delle colonne con operatori matematici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Tra ieri e oggi c'è esattamente un giorno: il risultato atteso è 1.",
          "TIMESTAMPDIFF vuole l'unità, la data di partenza e quella di arrivo, in quest'ordine."
        ],
    ...
    "Medium": [
      {
        ...
        "hints": [
          "Quanto è vecchio ogni ordine, misurato in giorni interi.",
          "L'unità 'DAY' come primo argomento, poi la data ordine e NOW()."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Se oggi è il 15, tornare al primo del mese significa sottrarre 14 giorni.",
          "DAY(order_date) - 1 è esattamente il numero di giorni da sottrarre."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Stessa funzione della differenza tra date, applicata alla registrazione.",
          "Dalla data di iscrizione a oggi, contando in giorni."
        ],
        "explanation": "Le funzioni di data SQL permettono di estrarre, calcolare e formattare componenti temporali per analisi cronologiche.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "WEEKDAY restituisce indice (0=Mon...)",
          "Logica modulo 7"
        ],
        "explanation": "Le funzioni di data SQL permettono di estrarre, calcolare e formattare componenti temporali per analisi cronologiche.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Le settimane sono un'unità valida per INTERVAL, non solo giorni e mesi.",
          "INTERVAL 2 WEEK dentro DATE_ADD sposta avanti di quattordici giorni."
        ],
        "explanation": "Le funzioni di data SQL permettono di estrarre, calcolare e formattare componenti temporali per analisi cronologiche.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il formato 'YYYY-MM-DD' rende il confronto testuale equivalente a quello cronologico.",
          "Basta il maggiore con la stringa della data tra apici: nessuna funzione."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Dividi i giorni totali per 365.25",
      ...
      },
      {
        ...
        "hints": [
          "La seconda metà dell'anno inizia con un certo numero di mese.",
          "Estrai il mese con MONTH() e confrontalo con 6 usando >=."
        ],
        "explanation": "NOW() restituisce la data e ora correnti del server, utile per calcoli relativi al presente.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Costruisci la data del 31 dicembre",
          "Usa TIMESTAMPDIFF per la differenza"
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          ...
          "Costruisci YYYYMM con matematica"
        ],
        "explanation": "PERIOD_DIFF confronta due periodi scritti come numero YYYYMM: anno per 100 più mese. La moltiplicazione costruisce quel formato al volo (2024 * 100 + 3 dà 202403) e la funzione restituisce i mesi interi tra i due periodi. È il conteggio di mesi di anzianità che ignora completamente i giorni.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il compleanno di quest'anno ricicla mese e giorno originali con l'anno corrente.",
          "DATE_FORMAT con '%m-%d' estrae mese-giorno; davanti incolli YEAR(NOW())."
        ],
        "explanation": "NOW() restituisce la data e ora correnti del server, utile per calcoli relativi al presente.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Devi tornare indietro di un numero di giorni che dipende dal giorno attuale.",
          "La formula (WEEKDAY + 3) % 7 misura la distanza dall'ultimo venerdì; il modulo gestisce il giro della settimana."
        ],
        "explanation": "DATE_FORMAT formatta una data secondo il pattern specificato, permettendo di visualizzare date in formati personalizzati.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il formato ISO 8601 separa data e ora con una T letterale.",
          "In DATE_FORMAT, %T espande l'orario completo HH:mm:ss."
        ],
        "explanation": "NOW() restituisce la data e ora correnti del server, utile per calcoli relativi al presente.",
        "replacements": {},
    ...
    "Hard": [
      ...
      },
      {
        ...
        "hints": [
          "WEEKDAY numera i giorni partendo dal lunedì a 0.",
          "I giorni lavorativi sono quelli con indice da 0 a 4: confronta con < 5."
        ],
        "explanation": "NOW() restituisce la data e ora correnti del server, utile per calcoli relativi al presente.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Aggiungi 3 mesi per shiftare Ottobre a Gennaio",
          "Estrai l'anno"
        ],
        "explanation": "TIMESTAMPDIFF calcola la differenza tra due date/timestamp nell'unità specificata (SECOND, MINUTE, HOUR, DAY, MONTH, YEAR).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "MAKEDATE(Year, 1) = 1 Gen",
          "Aggiungi 1 anno, togli 1 giorno"
        ],
        "explanation": "YEAR() estrae il componente anno da una data, fondamentale per raggruppamenti e filtri su base annuale.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Diff tra NOW e Inizio prox mese",
          "Inizio prox mese = LAST_DAY + 1 day"
        ],
        "explanation": "YEAR() estrae il componente anno da una data, fondamentale per raggruppamenti e filtri su base annuale.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Sottrarre l'indice del giorno riporta ogni data al suo lunedì.",
          "WEEKDAY(order_date) è quanti giorni sono passati da inizio settimana: usalo come INTERVAL."
        ],
        "explanation": "DATE_FORMAT formatta una data secondo il pattern specificato, permettendo di visualizzare date in formati personalizzati.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il periodo '2023-05' è una stringa costruita dalla data.",
          "DATE_FORMAT con '%Y-%m' crea la chiave; il GROUP BY può usare il suo alias."
        ],
        "explanation": "Le funzioni di data SQL permettono di estrarre, calcolare e formattare componenti temporali per analisi cronologiche.",
        "replacements": {},
      ...
      },
      {
        ...
        "queryTemplate": "SELECT MAKEDATE(YEAR(NOW()), 1) + INTERVAL QUARTER(NOW()) * 3 - 3 MONTH",
        "hints": [
          "Ancòrati al primo gennaio, poi spostati a blocchi di tre mesi.",
          "Il trimestre corrente moltiplicato per 3, meno 3, dà i mesi di spostamento."
        ],
        "explanation": "MAKEDATE(anno, 1) costruisce il primo gennaio dell'anno corrente e l'INTERVAL in mesi lo spinge fino all'inizio del trimestre attuale: QUARTER(NOW()) * 3 - 3 vale 0, 3, 6 o 9 mesi a seconda del trimestre. È aritmetica di calendario pura: parti da un ancoraggio fisso e sposti di un multiplo di tre mesi.",
        "replacements": {},
        "brokenCode": "SELECT MAKEDATE(YEAR(NOW()), 1) INTERVAL QUARTER(NOW()) * 3 - 3 MONTH",
        "debugHint": "Assicurati di avere GROUP BY e che tutte le colonne non aggregate siano nel raggruppamento."
      },
      {
        ...
        "descTemplate": "Stima le ore lavorative trascorse dalla registrazione di ogni utente: giorni trascorsi per 8 ore al giorno.",
        "queryTemplate": "SELECT TIMESTAMPDIFF('DAY', created_at, NOW()) * 8 FROM Users",
        "hints": [
          "Prima i giorni trascorsi, poi la conversione in ore.",
          "Moltiplica la differenza in giorni per 8 direttamente nella SELECT."
        ],
        "explanation": "La differenza in giorni tra la registrazione e oggi, moltiplicata per le 8 ore di una giornata lavorativa, dà una stima grossolana delle ore lavorative trascorse. Il punto tecnico: il risultato di TIMESTAMPDIFF è un numero come un altro, e puoi trattarlo con la normale aritmetica.",
        "replacements": {},
        "brokenCode": "SELCET YEAR(NOW()) - YEAR(created_at) FROM Users",
      ...
      },
      {
        ...
        "hints": [
          "Convertire fuso qui significa spostare l'orario di un'ora fissa.",
          "DATE_ADD con INTERVAL 1 HOUR: l'unità orario esiste come le altre."
        ],
        "explanation": "NOW() restituisce la data e ora correnti del server, utile per calcoli relativi al presente.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Se compleanno passato, target year = year+1",
          "Costruisci target date"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Raggruppa per la colonna DAYNAME",
          "Usa una funzione aggregata come COUNT, SUM o AVG nella SELECT"
        ],
        "explanation": "Le espressioni aritmetiche in SQL permettono di creare colonne calcolate al volo, combinando valori delle colonne con operatori matematici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "I centomila secondi partono dall'epoca Unix, non da oggi.",
          "Prima la conversione completa con FROM_UNIXTIME, poi TIME() per isolare l'orario."
        ],
        "explanation": "FROM_UNIXTIME converte i secondi dall'epoca Unix (1 gennaio 1970) in un timestamp leggibile, e TIME() ne isola la sola parte oraria. Centomila secondi sono poco più di un giorno: il risultato mostra l'orario del punto in cui si cade. La coppia di funzioni è il ponte tra i tempi 'da macchina' e quelli leggibili.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'approssimazione usa il mese come frazione dell'anno: marzo è 3/12.",
          "Dividi MONTH per 12, moltiplica per 100 e arrotonda a due decimali."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Lo spostamento cambia da riga a riga: l'INTERVAL può essere una colonna.",
          "INTERVAL id MINUTE sposta ogni utente di un numero di minuti pari al suo id."
        ],
      ...
      },
      {
        ...
        "explanation": "WEEK con modalità 1 conta le settimane dell'anno facendole iniziare di lunedì, vicino allo standard ISO: la stessa data può cadere in settimane diverse a seconda della modalità scelta. Il secondo argomento di WEEK è proprio questa convenzione: quando confronti numeri di settimana tra sistemi, verifica sempre quale modalità usano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La stringa usa i punti come separatori: il parser va istruito.",
          "In STR_TO_DATE il secondo argomento descrive il formato, punti compresi: '%Y.%m.%d'."
        ],
        "explanation": "Le funzioni di data SQL permettono di estrarre, calcolare e formattare componenti temporali per analisi cronologiche.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'ultimo istante del giorno ha un orario fisso e noto.",
          "Incolla la data di oggi (DATE di NOW) con la stringa ' 23:59:59'."
        ],
      ...
      },
      {
        ...
        "hints": [
          "La stringa contiene data E orario: il tipo di destinazione deve tenerli entrambi.",
          "CAST con AS DATETIME converte esplicitamente, senza affidarsi alla conversione implicita."
        ],
        "explanation": "NOW() restituisce la data e ora correnti del server, utile per calcoli relativi al presente.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Due spostamenti con unità diverse si concatenano.",
          "Il risultato del primo DATE_ADD fa da primo argomento del secondo."
        ],
        "explanation": "Le espressioni aritmetiche in SQL permettono di creare colonne calcolate al volo, combinando valori delle colonne con operatori matematici.",
        "replacements": {},
      ...
      {
        "titleTemplate": "Punto Medio (Sim)",
        "descTemplate": "Per ogni utente calcola quanti giorni dista il punto medio tra la sua registrazione e oggi (metà dei giorni trascorsi, arrotondata).",
        "queryTemplate": "SELECT ROUND(TIMESTAMPDIFF('DAY', created_at, NOW()) / 2) AS giorni_meta FROM Users",
        "hints": [
          "Prima misuri l'intero periodo in giorni, poi lo dimezzi.",
          "La differenza con TIMESTAMPDIFF si divide per 2 come un numero qualsiasi."
        ],
        "explanation": "La metà dei giorni trascorsi dalla registrazione individua il punto medio del periodo: per trovarlo come data basterebbe aggiungerla a created_at con DATE_ADD. La divisione di una differenza tra date è aritmetica normale; ROUND la riporta a giorni interi. È l'idea alla base del calcolo di una mediana temporale.",
        "replacements": {},
    ...
    "Easy": [
      {
        ...
        "hints": [
          "Usa CASE WHEN con condizioni a cascata",
      ...
      },
      {
        ...
        "hints": [
          "Il campo is_premium è booleano (true/false)",
          "Usa THEN e ELSE"
        ],
      ...
      },
      {
        ...
        "hints": [
          "La soglia della spedizione gratuita è 1000, incluso il 1000 stesso.",
          "Il CASE ha due soli esiti: un WHEN con >= e l'ELSE per tutto il resto."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Ogni stato inglese ha la sua traduzione: un WHEN per ciascuno.",
          "I WHEN si valutano in ordine e l'ELSE raccoglie gli stati non tradotti."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Un solo confronto testuale decide il reparto.",
          "WHEN sulla categoria 'Electronics', ELSE per tutte le altre."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Come si verifica se un campo è vuoto in SQL?",
          "Usa IS NULL"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il criterio è il finale dell'indirizzo email.",
          "Dentro il WHEN puoi usare LIKE con il pattern '%.com'."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il dato mancante si riconosce con l'operatore dedicato ai NULL.",
          "IS NULL dentro il WHEN: l'uguale con NULL non funzionerebbe."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il valore dell'asset è un calcolo: prezzo per giacenza.",
          "La moltiplicazione sta dentro la condizione del WHEN, confrontata con 5000."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Lo sconto scatta da dieci pezzi in su, dieci compreso.",
          "Un solo WHEN con >= 10 e l'ELSE per il prezzo pieno."
        ],
    ...
    "Medium": [
      {
        ...
        "hints": [
          "Le fasce si valutano in ordine: la prima condizione vera vince.",
          "Metti la soglia più bassa per prima; l'ELSE raccoglie il segmento più alto."
        ],
      ...
      },
      {
        ...
        "hints": [
          "L'ordinamento richiesto non è alfabetico: è una priorità di business.",
          "Il CASE dentro l'ORDER BY converte ogni stato in un numero; la data fa da spareggio."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Chi non ha manager fa riferimento a se stesso.",
          "COALESCE restituisce il primo valore non NULL: prova manager_id, ripiega su id."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il pericolo è la divisione quando lo stock vale zero.",
          "NULLIF trasforma lo 0 in NULL: la divisione produce NULL invece di un errore."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Due stati confluiscono nella stessa macro-fase.",
          "Dentro il WHEN, IN ('Processing', 'Shipped') sostituisce due OR."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Tre scaglioni di spesa, dal più alto al più basso.",
          "Ordina i WHEN dalla soglia maggiore: chi supera 1000 non deve cadere nella tariffa dei 100."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Le coorti si separano per data di registrazione.",
          "Le date in formato 'YYYY-MM-DD' si confrontano direttamente come stringhe nei WHEN."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Ogni categoria ha il suo moltiplicatore; le altre restano invariate.",
          "I WHEN restituiscono price moltiplicato per il fattore; l'ELSE restituisce price puro."
        ],
      ...
      },
      {
        ...
        "hints": [
          "I due rami costruiscono stringhe diverse con la concatenazione.",
          "L'operatore || unisce testo e colonne; anche l'id numerico si concatena."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il primo premio richiede DUE requisiti insieme: reparto e anzianità.",
          "AND dentro il WHEN; i WHEN successivi gestiscono gli altri reparti."
        ],
    ...
    "Hard": [
      {
        ...
        "hints": [
          "Usa SUM(CASE...) per ogni colonna pivot",
          "Non serve GROUP BY se vuoi il totale globale"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Serve JOIN e GROUP BY",
          "Il CASE va sull'aggregato SUM(order_total)"
        ],
      ...
      },
      {
        ...
        "hints": [
          "GROUP BY 1 raggruppa per la prima colonna (il CASE)",
          "Definisci i range temporali"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Logica annidata o sequenziale",
          "Critical ha due condizioni AND"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il CASE restituisce il moltiplicatore",
          "Moltiplica price per il risultato del CASE"
        ],
      ...
      },
      {
        ...
        "hints": [
          "'In Ritardo' scatta solo con stato e data sbagliati insieme.",
          "L'ordine dei WHEN conta: prima il caso chiuso, poi il ritardo con AND, poi il resto."
        ],
        "explanation": "CASE WHEN è l'equivalente SQL dell'if-else: valuta condizioni in sequenza e restituisce il valore corrispondente alla prima condizione vera.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Se MIN(cat) == MAX(cat) == 'Electronics', allora ci sono solo prodotti Electronics",
          "Serve tripla JOIN"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Gestisci denominatore zero",
          "Gestisci numeratore negativo"
        ],
        "explanation": "CASE WHEN è l'equivalente SQL dell'if-else: valuta condizioni in sequenza e restituisce il valore corrispondente alla prima condizione vera.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Subquery scalare sommata a un CASE",
          "Oppure JOIN e GROUP BY"
        ],
        "explanation": "CASE WHEN è l'equivalente SQL dell'if-else: valuta condizioni in sequenza e restituisce il valore corrispondente alla prima condizione vera.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Conta i prodotti a rischio",
          "Se count > 0 allora status risk"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Data cleaning logico",
          "Imposta a NULL i dati sporchi"
        ],
        "explanation": "Combinare CASE WHEN dentro una funzione aggregata come SUM permette di contare o sommare solo le righe che soddisfano una condizione specifica.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il resto della divisione per 2 distingue pari e dispari.",
          "id % 2 = 0 è la condizione del WHEN per i pari."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Subquery per vedere se è manager di qualcuno",
          "Gerarchia ad albero"
        ],
        "explanation": "CASE WHEN è l'equivalente SQL dell'if-else: valuta condizioni in sequenza e restituisce il valore corrispondente alla prima condizione vera.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Esercizio simulato (non abbiamo region)",
          "Simuliamo logica complessa"
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il prodotto civetta è economico E della categoria giusta.",
          "Le due condizioni stanno nello stesso WHEN, legate da AND."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Tre criteri in cascata: premium prima, poi ordini grossi, poi la data.",
          "Ogni CASE nell'ORDER BY produce 0 o 1: lo 0 sale in cima."
        ],
        "explanation": "CASE WHEN è l'equivalente SQL dell'if-else: valuta condizioni in sequenza e restituisce il valore corrispondente alla prima condizione vera.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "WEEKDAY numera da lunedì = 0, quindi il weekend è 5 e 6.",
          "IN (5, 6) dentro il WHEN evita il doppio confronto."
        ],
        "explanation": "CASE WHEN è l'equivalente SQL dell'if-else: valuta condizioni in sequenza e restituisce il valore corrispondente alla prima condizione vera.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'aliquota dipende dal paese dell'utente, che vive in un'altra tabella.",
          "La subquery scalare sul country entra nel WHEN; il CASE moltiplica l'aliquota per il totale."
        ],
        "explanation": "CASE WHEN è l'equivalente SQL dell'if-else: valuta condizioni in sequenza e restituisce il valore corrispondente alla prima condizione vera.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Le soglie non sono fisse: derivano dalla media di magazzino.",
          "Le subquery su AVG(stock) si usano dentro i WHEN come normali valori di confronto."
        ],
        "explanation": "Combinare CASE WHEN dentro una funzione aggregata come SUM permette di contare o sommare solo le righe che soddisfano una condizione specifica.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Qui il CASE confronta una sola colonna con valori diversi: esiste una forma compatta.",
          "CASE country WHEN 'Italy' THEN ... evita di ripetere la colonna in ogni ramo."
        ],
        "explanation": "CASE WHEN è l'equivalente SQL dell'if-else: valuta condizioni in sequenza e restituisce il valore corrispondente alla prima condizione vera.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "L'id cresce nel tempo: le soglie sull'id simulano l'età del prodotto.",
          "Due WHEN per gli estremi (vecchi e nuovi), l'ELSE per la fascia centrale."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Collega le tabelle Users e Orders",
          "Usa la clausola ON per specificare la condizione di collegamento"
        ],
        "explanation": "CASE WHEN è l'equivalente SQL dell'if-else: valuta condizioni in sequenza e restituisce il valore corrispondente alla prima condizione vera.",
        "replacements": {},
  ...
  "joins": {
    "Easy": [
      {
        ...
        "hints": [
          "Usa JOIN tra Users e Orders",
          "Collega le tabelle tramite Users.id = Orders.user_id"
        ],
      ...
      },
      {
        ...
        "hints": [
          "OrderItems contiene product_id",
          "Products contiene name"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa OrderItems come punto di partenza",
          "Prendi il prezzo da Products"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Le due informazioni vivono in tabelle diverse: serve unirle.",
          "La condizione ON collega l'id dell'utente al user_id dell'ordine."
        ],
      ...
      },
      {
        ...
        "hints": [
          "La categoria sta in Products, la riga di vendita in OrderItems.",
          "Il ponte tra le due tabelle è product_id contro id."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Dopo la JOIN puoi pescare colonne da entrambe le tabelle nella stessa SELECT.",
          "Qualifica le colonne col nome tabella per evitare ambiguità."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Tutte le informazioni richieste stanno già nella stessa tabella.",
          "Escludi chi non ha capo: il manager_id mancante si intercetta con IS NOT NULL."
        ],
        "explanation": "Qui non serve nessuna JOIN: la coppia dipendente-manager sta già nella stessa riga, con il capo indicato da manager_id. Il filtro IS NOT NULL esclude chi un capo non ce l'ha. Il passo successivo, mostrare il NOME del capo invece del suo id, richiederebbe la self join che vedrai negli esercizi più avanti.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Prima unisci le righe di vendita ai prodotti, poi filtra sulla quantità.",
          "La condizione è quantity maggiore di 1, sulla tabella OrderItems."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il paese sta su Users, ma le colonne richieste su Orders.",
          "La JOIN porta il country accanto a ogni ordine: poi filtri su 'USA'."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Parti dagli ordini spediti e risali all'email del proprietario.",
          "Il filtro sullo status va nella WHERE, dopo la JOIN."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Collega le tabelle OrderItems e Products",
          "Usa la clausola ON per specificare la condizione di collegamento"
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Gli alias abbreviano i nomi tabella in tutta la query.",
          "Dichiarali nel FROM (Users u) e usali ovunque: u.name, o.id."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il totale di riga moltiplica una colonna di OrderItems per una di Products.",
          "Il calcolo va nella SELECT, dopo che la JOIN ha affiancato le due tabelle."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Un utente con tre ordini recenti comparirebbe tre volte.",
          "DISTINCT sul nome elimina le ripetizioni causate dalla JOIN."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La categoria vive su Products, l'order_id su OrderItems.",
          "JOIN sul product_id, filtro WHERE sulla categoria."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Collega le tabelle Orders e Users",
          "Usa la clausola ON per specificare la condizione di collegamento"
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Stesso schema del valore di riga: quantità per prezzo.",
          "Gli alias oi e p accorciano la moltiplicazione: oi.quantity * p.price."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "È la join più comune: chiave esterna contro chiave primaria.",
          "oi.product_id punta a p.id: questa è la condizione ON."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Seleziona dalla tabella Employees",
          "Specifica il nome delle colonne dopo SELECT"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Internazionale qui significa: paese diverso dall'Italia.",
          "La disuguaglianza != si applica alla colonna country dopo la JOIN."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Il filtro sul prezzo riguarda la tabella agganciata, non quella di partenza.",
          "Dopo la JOIN, la WHERE può usare p.price come qualsiasi colonna."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa DISTINCT per eliminare i valori ripetuti",
          "La colonna da rendere unica è u"
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Testata e dettaglio si collegano con l'id dell'ordine.",
          "o.id contro oi.order_id nella ON; poi selezioni una colonna per tabella."
        ],
        "explanation": "La JOIN tra Orders e OrderItems affianca ogni riga d'ordine alla testata: da una parte peschi lo user_id, dall'altra il product_id. È il ponte che collega chi compra a cosa compra. Nota che il risultato ha una riga per ogni RIGA D'ORDINE: lo stesso utente compare tante volte quanti articoli ha acquistato.",
        "replacements": {},
      ...
      },
      {
        ...
        "queryTemplate": "SELECT u.name, o.id FROM Users u JOIN Orders o ON u.id = o.user_id",
        "hints": [
          "Senza la clausola ON ogni riga si accoppierebbe con TUTTE le altre.",
          "Il prodotto cartesiano si evita dichiarando la condizione di collegamento."
        ],
    ...
    "Medium": [
      ...
      },
      {
        ...
        "hints": [
          "Devono comparire anche gli utenti senza nemmeno un ordine.",
          "La LEFT JOIN tiene tutte le righe della tabella di sinistra; gli ordini mancanti diventano NULL."
        ],
      ...
      },
      {
        ...
        "hints": [
          "LEFT JOIN tra Products e OrderItems",
          "Check NULL su OrderItems.id"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Join e poi Group By Users.name",
          "SUM(order_total)"
        ],
        "explanation": "LEFT JOIN restituisce tutte le righe dalla tabella di sinistra, anche quelle senza corrispondenza nella tabella destra (con NULL per le colonne mancanti).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Prima la JOIN porta il paese accanto a ogni ordine, poi si contano i gruppi.",
          "GROUP BY sul country, COUNT sugli id degli ordini."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Tre passaggi: unisci, raggruppa, filtra i totali.",
          "La soglia sui pezzi venduti va nell'HAVING, perché giudica la SUM del gruppo."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Da Users a Products non c'è un legame diretto: passi per Orders e OrderItems.",
          "Ogni anello della catena ha la sua ON; il filtro categoria chiude, il DISTINCT pulisce."
        ],
        "explanation": "La catena di quattro tabelle segue le chiavi: l'utente possiede ordini, gli ordini hanno righe, le righe puntano ai prodotti. Solo arrivati a Products puoi filtrare per categoria. Il DISTINCT finale è necessario perché chi ha comprato tre articoli Electronics comparirebbe tre volte.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Le colonne del calcolo vengono da tabelle diverse.",
          "Moltiplica oi.quantity per p.price nella SELECT e battezza il risultato con AS."
        ],
        "explanation": "Il subtotale moltiplica la quantità (che sta su OrderItems) per il prezzo (che sta su Products): il calcolo attraversa le due tabelle, ed è possibile solo dopo che la JOIN le ha affiancate riga per riga. L'alias sul risultato rende leggibile la colonna calcolata.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Chiediti dove sta l'informazione: ti serve davvero un'altra tabella?",
          "Raggruppa per order_id e filtra i gruppi con più di una riga usando HAVING."
        ],
        "explanation": "Non serve alcuna JOIN: order_id dentro OrderItems basta a contare quante righe ha ogni ordine. GROUP BY forma un gruppo per ordine e l'HAVING con COUNT(*) > 1 tiene solo quelli con più di un articolo. La lezione è saper riconoscere quando i dati necessari vivono già tutti nella stessa tabella.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "Il MAX sulla data, calcolato dentro i gruppi creati da GROUP BY sul nome, isola la data più recente per ciascun cliente: la JOIN serve solo a portare il nome accanto agli ordini. Attenzione a un limite di questo approccio: se due utenti si chiamassero uguale, i loro ordini finirebbero nello stesso gruppo (meglio raggruppare per id in produzione).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Collega le tabelle Employees e Employees",
          "Usa la clausola ON per specificare la condizione di collegamento"
        ],
        "explanation": "La self join tratta Employees come DUE tabelle distinte grazie agli alias: e1 è il dipendente, e2 il capo, e la ON aggancia il manager_id del primo all'id del secondo. Chi non ha manager sparisce dal risultato, perché la JOIN interna scarta i NULL: per tenerli servirebbe una LEFT JOIN.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "LEFT JOIN per non perdere prodotti invenduti",
          "COALESCE per trasformare NULL in 0"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Un filtro per tabella: paese sull'utente, importo sull'ordine.",
          "Le due condizioni convivono nella stessa WHERE legate da AND; il DISTINCT evita i doppioni."
        ],
        "explanation": "LEFT JOIN restituisce tutte le righe dalla tabella di sinistra, anche quelle senza corrispondenza nella tabella destra (con NULL per le colonne mancanti).",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Parti dalle righe d'ordine e risali al prodotto per leggerne lo stock.",
          "stock = 0 nella WHERE; DISTINCT perché lo stesso ordine può avere più prodotti esauriti."
        ],
        "explanation": "COUNT(DISTINCT ...) conta i valori unici, eliminando i duplicati prima del conteggio.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "AVG(order_total) calcolato nei gruppi per country dà il ticket medio di ogni nazione: la JOIN serve a portare il paese dell'utente accanto a ogni suo ordine prima del raggruppamento. Il flusso mentale è: unisci, raggruppa, aggrega. Ogni paese esce una volta con la sua media.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Self Join su department",
          "e1.id < e2.id per evitare duplicati/riflessi"
        ],
        "explanation": "La self join su department accoppia i colleghi dello stesso reparto, e la condizione e1.id < e2.id è il trucco chiave: elimina sia gli accoppiamenti di una persona con se stessa sia le coppie specchiate (A-B e B-A). Senza quel filtro ogni coppia comparirebbe due volte più gli auto-accoppiamenti.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "LEFT JOIN",
          "COUNT(o.id) conta solo i non-nulli"
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Disegna il percorso: ordine, utente, righe, prodotti.",
          "Ogni JOIN ha la sua ON; l'ordine delle JOIN segue il percorso delle chiavi."
        ],
        "explanation": "Quattro tabelle in catena: la testata ordine porta all'utente da un lato (per l'email) e alle righe di dettaglio dall'altro, che a loro volta puntano ai prodotti. Ogni ON usa la coppia chiave esterna e chiave primaria del passaggio. Il risultato ha una riga per ogni ARTICOLO ordinato, con email e nome prodotto affiancati.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          ...
          "Confronta campo calcolato e campo salvato"
        ],
        "explanation": "Combinare JOIN con GROUP BY permette di aggregare dati provenienti da più tabelle correlate, come calcolare totali per utente dagli ordini.",
        "replacements": {},
      ...
      {
        "titleTemplate": "Utenti che Sono Dipendenti",
        "descTemplate": "Trova gli utenti il cui nome compare anche nella tabella Employees (stessa persona cliente e dipendente).",
        "queryTemplate": "SELECT u.name FROM Users u JOIN Employees e ON u.name = e.name",
        "hints": [
          "Il legame tra le due tabelle è il nome, non un id.",
          "JOIN con ON sui due campi name; rifletti su cosa succederebbe con gli omonimi."
        ],
        "explanation": "La JOIN qui non usa una chiave esterna ma un campo descrittivo: il nome. Funziona per l'esercizio, ma è fragile per definizione: due persone diverse con lo stesso nome produrrebbero falsi abbinamenti. È il motivo per cui i modelli seri collegano le tabelle con id dedicati, non con dati anagrafici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Collega le tabelle Users e Products",
          "Usa la clausola ON per specificare la condizione di collegamento"
        ],
      ...
      },
      {
        ...
        "hints": [
          "FULL OUTER JOIN non esiste in questo motore: si costruisce in due metà.",
          "Una LEFT JOIN per lato, unite da UNION che elimina le righe doppie."
        ],
      ...
      },
      {
        ...
        "explanation": "GROUP BY sull'id dell'ordine conta le righe di dettaglio di ciascuno, e l'HAVING tiene solo chi arriva ad almeno tre articoli. Il conteggio usa COUNT sulle righe della tabella agganciata. WHERE non potrebbe fare questo filtro: il numero di articoli esiste solo DOPO il raggruppamento.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "La catena completa da Users a Products serve a scoprire COSA ha comprato una persona: si filtra sul nome dell'utente e si raccolgono le categorie dei prodotti nei suoi ordini. Il DISTINCT compatta le ripetizioni (due smartphone comprati = una sola riga 'Electronics'). Occhio che nel DB esistono più utenti di nome Alice: il filtro le prende tutte.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa DISTINCT per eliminare i valori ripetuti",
          "La colonna da rendere unica è o"
        ],
        "explanation": "DISTINCT elimina le righe duplicate dal risultato, restituendo ogni combinazione di valori una sola volta. È utile per ottenere liste di valori unici.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il nome del prodotto sta in fondo alla catena di join.",
          "Filtra p.name = 'Laptop' e proietta l'email con DISTINCT."
        ],
        "explanation": "DISTINCT elimina le righe duplicate dal risultato, restituendo ogni combinazione di valori una sola volta. È utile per ottenere liste di valori unici.",
        "replacements": {},
      ...
      },
      {
        ...
        "descTemplate": "Mostra nome utente e id ordine per gli ordini effettuati nell'anno corrente.",
        "queryTemplate": "SELECT u.name, o.id FROM Users u JOIN Orders o ON u.id = o.user_id WHERE YEAR(o.order_date) = YEAR(NOW())",
        "hints": [
          "Il filtro deve restare valido anche cambiando anno: niente valori fissi.",
          "Confronta YEAR(order_date) con YEAR(NOW()) nella WHERE."
        ],
        "explanation": "YEAR estrae l'anno sia dalla data dell'ordine sia da NOW(), e l'uguaglianza tiene solo gli ordini dell'anno in corso: un filtro relativo, che continua a funzionare anche l'anno prossimo senza toccare la query. La JOIN porta il nome dell'utente accanto a ogni ordine filtrato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Una JOIN basilare: ogni ordine con il nome del suo proprietario.",
          "Seleziona u.name e o.status dopo aver collegato le tabelle sulla chiave utente."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
    ...
    "Hard": [
      ...
      },
      {
        ...
        "hints": [
          "Self Join: Employees E, Employees M",
          "Confronta E.salary > M.salary"
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Left Join con subquery o Left Join + condition in ON/Where",
          "Filtra IS NULL"
        ],
        "explanation": "Un self-join collega una tabella con sé stessa, utile per gerarchie come dipendente-manager dove la relazione è nella stessa tabella.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Filter order_total in Where",
          "Filter count in Having"
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Self Join OrderItems on order_id",
          "P1 < P2 per evitare duplicati speculari"
        ],
        "explanation": "Combinare JOIN con GROUP BY permette di aggregare dati provenienti da più tabelle correlate, come calcolare totali per utente dagli ordini.",
        "replacements": {},
      ...
      {
        "titleTemplate": "Utenti Multi-Categoria",
        "descTemplate": "Trova gli utenti che hanno acquistato prodotti di ALMENO 2 categorie diverse.",
        ...
        "hints": [
          "Conta le categorie DIVERSE per utente, non gli acquisti.",
          "COUNT(DISTINCT p.category) nell'HAVING, confrontato con 2."
        ],
        "explanation": "Combinare JOIN con GROUP BY permette di aggregare dati provenienti da più tabelle correlate, come calcolare totali per utente dagli ordini.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Left Join Products-OrderItems",
          "Calcoli aggregati vs scalari"
        ],
        "explanation": "Combinare JOIN con GROUP BY permette di aggregare dati provenienti da più tabelle correlate, come calcolare totali per utente dagli ordini.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Anche chi non ha capo deve comparire nel risultato.",
          "La LEFT JOIN sulla self join lascia il Boss a NULL per i vertici della gerarchia."
        ],
      ...
      },
      {
        ...
        "hints": [
          "La condizione sulla data va nella ON, non nella WHERE: cambia tutto.",
          "I 'senza ordini recenti' sono le righe dove la parte destra della LEFT JOIN è rimasta NULL."
        ],
        "explanation": "Il trucco sta nel mettere la condizione temporale DENTRO la ON invece che nella WHERE: la LEFT JOIN prova ad agganciare solo gli ordini recenti, e per chi non ne ha lascia le colonne di Orders a NULL. La WHERE finale con o.id IS NULL cattura esattamente quei clienti: presenti in anagrafica, assenti tra gli acquirenti recenti. Spostare quella condizione nella WHERE trasformerebbe la LEFT JOIN in una JOIN normale.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Blocca un ordine di riferimento e cerca chi condivide la sua data.",
          "La ON aggancia le due copie di Orders sulla data; la WHERE fissa l'id di riferimento ed esclude se stesso."
        ],
        "explanation": "La self join su Orders accoppia l'ordine 9301 con tutti gli altri ordini che condividono la stessa data: o1 fa da riferimento fisso (bloccato dalla WHERE), o2 raccoglie i compagni di giornata, e la condizione o2.id != 9301 esclude l'auto-abbinamento. È lo schema per 'trova righe simili a una riga data' senza conoscere in anticipo il valore di confronto.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Due insiemi: chi ha comprato il Laptop e chi ha comprato una Cover.",
          "Il primo insieme si costruisce con le join; il secondo si esclude con NOT IN su una subquery gemella."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il totale 'giusto' va ricalcolato dalle righe di dettaglio.",
          "La subquery nel FROM aggrega i dettagli per ordine; la JOIN confronta il totale salvato con quello calcolato."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La classifica è per anno E per prodotto: due chiavi di raggruppamento.",
          "YEAR(order_date) con alias entra sia nel GROUP BY che nell'ORDER BY; i pezzi si sommano da OrderItems."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Join con subquery aggregata per dept",
          "manager_id IS NULL identifica manager/capi (o logica specifica)"
        ],
        "explanation": "Combinare JOIN con GROUP BY permette di aggregare dati provenienti da più tabelle correlate, come calcolare totali per utente dagli ordini.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Group By User",
          "HAVING MIN(cat) = MAX(cat) = 'Electronics' è un trick per dire 'solo questa categoria'"
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "'Successivo' qui è definito dagli id: il seguente ha id + 1.",
          "Aggancia le due copie di Orders sullo stesso utente e confronta i due totali nella WHERE."
        ],
        "explanation": "La self join accoppia ordini consecutivi dello stesso utente sfruttando gli id sequenziali: o1.id = o2.id + 1 significa 'o1 è l'ordine successivo a o2'. Il confronto sui totali isola i casi in cui il nuovo ordine vale meno del precedente. È una simulazione della window function LAG, costruita solo con join e aritmetica sugli id.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Collega le tabelle Orders e Products",
          "Usa la clausola ON per specificare la condizione di collegamento"
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Servono DUE condizioni: aver comprato in passato, non aver comprato di recente.",
          "La JOIN dà lo storico; il NOT IN su una subquery filtrata per data toglie i clienti attivi."
        ],
        "explanation": "La query combina due insiemi: la JOIN garantisce che l'utente abbia una storia d'acquisti, la subquery con NOT IN esclude chi ha comprato negli ultimi tre mesi. Restano i clienti 'dormienti': attivi in passato, fermi di recente. Il DISTINCT compatta i nomi ripetuti dalla JOIN sugli ordini storici.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "Il fatturato di ogni prodotto nasce moltiplicando i pezzi venduti (OrderItems) per il prezzo (Products), sommando tutto nel gruppo del prodotto e ordinando per quel totale in discesa. L'alias rev definito nella SELECT si può riusare nell'ORDER BY. In un sistema reale il prezzo andrebbe preso dalla riga d'ordine (unit_price), perché il listino può cambiare nel tempo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Serve un JOIN tra Orders e Users",
          "Filtra per status = 'Shipped'"
        ],
      ...
      {
        "titleTemplate": "Clienti Abituali",
        "descTemplate": "Trova gli utenti che hanno effettuato più di 5 ordini.",
        "queryTemplate": "SELECT u.name FROM Users u JOIN Orders o ON u.id = o.user_id GROUP BY u.name HAVING COUNT(o.id) > 5",
        "hints": [
          "Conta gli ordini per utente, poi filtra i conteggi alti.",
          "Il COUNT vive nell'HAVING: la soglia è maggiore di 5."
        ],
        "explanation": "JOIN collega righe di tabelle diverse attraverso una condizione di corrispondenza, permettendo di combinare informazioni correlate in un unico risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il giorno della settimana si estrae dalla data con una funzione dedicata.",
          "Raggruppa sull'indice restituito da WEEKDAY e conta le righe di ogni gruppo."
        ],
        "explanation": "WEEKDAY converte ogni data nel suo indice di giorno della settimana (0 il lunedì) e il GROUP BY su quell'alias conta gli ordini di ciascun giorno: ne esce la distribuzione settimanale delle vendite. Nessuna JOIN necessaria: la data basta a se stessa. Per leggere meglio il risultato potresti mappare l'indice sul nome del giorno con un CASE.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Prima individua gli ordini con UN solo articolo.",
          "Quella lista è una subquery nel FROM: la JOIN successiva risale ai nomi dei prodotti."
        ],
        "explanation": "GROUP BY raggruppa le righe con lo stesso valore nella colonna specificata. COUNT conta quante righe appartengono a ciascun gruppo.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Cerchi coppie di righe che condividono il nome ma non l'email.",
          "Due condizioni nella ON della self join: nome uguale E email diversa."
        ],
        "explanation": "La self join su Users accoppia le righe con lo stesso nome ma email diversa: il primo confronto trova gli omonimi, il secondo esclude la riga accoppiata con se stessa (stessa email = stessa riga). È la tecnica per scovare probabili duplicati anagrafici. Ogni coppia esce due volte (A-B e B-A): per dimezzare aggiungeresti u1.id < u2.id.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Numeratore: tutte le righe. Denominatore: gli ordini diversi.",
          "Converti uno dei due termini a FLOAT, o la divisione tra interi tronca il risultato."
        ],
        "explanation": "Il rapporto tra il numero totale di righe e il numero di ordini distinti dà la media di articoli per ordine, calcolata sull'intera tabella senza GROUP BY. Il CAST a FLOAT è il dettaglio decisivo: senza, la divisione tra interi taglierebbe i decimali e una media di 2.7 diventerebbe 2.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Ogni livello gerarchico in più è un'altra copia di Employees da agganciare.",
          "Due LEFT JOIN in cascata: il capo del capo si aggancia sul manager_id del capo."
        ],
        "explanation": "L'alias (AS) rinomina una colonna o il risultato di un'espressione nel set di risultati, migliorando la leggibilità.",
        "replacements": {},
    ...
    "Easy": [
      {
        ...
        "queryTemplate": "SELECT * FROM Products WHERE price > (SELECT AVG(price) FROM Products)",
        "hints": [
          "Calcola prima la media dei prezzi con una subquery (SELECT AVG(price) FROM Products)",
          "Nella query principale, filtra i prodotti che hanno un prezzo maggiore del risultato di quella subquery"
        ],
      ...
      },
      {
        ...
        "queryTemplate": "SELECT * FROM Users WHERE id IN (SELECT user_id FROM Orders)",
        "hints": [
          "Usa IN per filtrare gli utenti",
          "La subquery deve selezionare user_id da Orders"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Scrivi una subquery che seleziona l'attributo category filtrando per name='Monitor 4K'",
          "Usa questo risultato per filtrare la tabella Products principale"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa una subquery per trovare la data più recente (MAX order_date) degli ordini dell'utente 1",
          "Seleziona gli ordini con order_date maggiore di quella data"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Scrivi due query separate: una per i nomi degli Employees e una per i nomi degli Users",
          "Uniscile con l'operatore UNION per ottenere una lista unica senza duplicati"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Due popolazioni distinte da fondere in un elenco unico.",
          "UNION unisce i risultati e scarta da sola le email presenti in entrambi i gruppi."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa NOT IN",
          "La subquery seleziona product_id da OrderItems"
        ],
        "explanation": "La subquery raccoglie tutti i product_id mai comparsi in una riga d'ordine, e il NOT IN tiene i prodotti fuori da quell'elenco: mai venduti nemmeno una volta. Il rovescio della medaglia di NOT IN: se la subquery restituisse un NULL, l'intero risultato diventerebbe vuoto. Qui product_id non è mai NULL, quindi la forma è sicura.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Calcola la media globale di order_total con una subquery (SELECT AVG...)",
          "Seleziona gli ordini che superano questo valore"
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Un manager è chiunque compaia come manager_id di qualcun altro.",
          "La subquery estrae l'elenco dei manager_id; IN verifica l'appartenenza."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Usa IN insieme a una subquery",
          "La subquery deve trovare le categorie dei prodotti che costano più di 1000 (SELECT category FROM Products WHERE price > 1000)"
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Le due query restituiscono id: una dagli ordini, una dai premium.",
          "UNION deduplica da sola chi appartiene a entrambi gli insiemi."
        ],
        "explanation": "La UNION fonde due insiemi di id di natura diversa: chi ha comprato (user_id da Orders) e chi è premium (id da Users). I duplicati spariscono automaticamente, quindi un premium che ha anche ordinato compare una volta sola. Per tenere le ripetizioni servirebbe UNION ALL.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il paese di riferimento non lo conosci: lo conosce il database.",
          "Subquery scalare a destra dell'uguale: restituisce il country dell'utente 100."
        ],
        "explanation": "La subquery scalare pesca il paese dell'utente con id 100 e la query esterna trova tutti i connazionali: il valore di confronto non è scritto a mano ma scoperto dal database al momento dell'esecuzione. Se l'utente 100 cambiasse paese, la query resterebbe corretta senza modifiche.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Popolare significa: comparso in più di due righe d'ordine.",
          "La subquery raggruppa per product_id e filtra con HAVING sul conteggio; IN chiude il cerchio."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Due stati accettabili, due SELECT unite.",
          "UNION fonde i due elenchi di id; in alternativa un IN con i due stati farebbe lo stesso."
        ],
      ...
      },
      {
        ...
        "hints": [
          "La soglia dipende dai dati: metà della media di magazzino.",
          "La subquery con AVG(stock)/2 fa da termine di confronto nella WHERE."
        ],
        "explanation": "La soglia di 'stock basso' non è fissa: la subquery calcola la metà della giacenza media e la query esterna confronta ogni prodotto con quel valore. Cambiando i dati cambia anche la soglia, senza toccare la query. La divisione può stare direttamente dentro la subquery.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Gli ordini conoscono solo lo user_id: il paese sta in Users.",
          "La subquery seleziona gli id degli utenti USA; IN filtra gli ordini su quell'elenco."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Segui la catena a ritroso: dal prodotto alle righe, dalle righe agli ordini, dagli ordini agli utenti.",
          "Tre subquery annidate, una per passaggio; la più interna trova l'id del Monitor 4K."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "queryTemplate": "SELECT * FROM Users WHERE id NOT IN (SELECT user_id FROM Orders)",
        "hints": [
          "Cerchi chi NON compare mai tra i compratori.",
          "NOT IN sull'elenco degli user_id presenti in Orders."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
        "brokenCode": "SELECT * FROM Users WERE id NOT IN (SELECT user_id FROM Orders)",
      ...
      },
      {
        ...
        "hints": [
          "La categoria da escludere va scoperta partendo dal nome di un prodotto.",
          "La subquery con LIMIT 1 garantisce un valore solo; il != esclude quella categoria."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Trova il MIN(price) per Electronics",
          "Seleziona prodotto con quel prezzo"
        ],
      ...
      },
      {
        ...
        "hints": [
          "DAYOFWEEK numera i giorni partendo dalla domenica a 1.",
          "Il weekend è quindi la coppia di indici 1 e 7: perfetta per un IN."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Trova category del prodotto più caro",
          "Filtra per quella category"
        ],
        "explanation": "IN filtra le righe il cui valore è presente nella lista specificata. È più leggibile di una catena di OR.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Seleziona la colonna email dalla tabella Employees",
          "Usa UNION per unirla alla selezione della colonna email dalla tabella Users"
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Due estrazioni con lo stesso criterio su tabelle diverse.",
          "Ogni SELECT ha il suo filtro id < 4; la UNION fonde i nomi risultanti."
        ],
        "explanation": "UNION combina i risultati di due SELECT in un unico set, eliminando i duplicati. Usa UNION ALL per mantenere tutti i duplicati.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "La media di confronto è calcolata SOLO sull'elettronica.",
          "La subquery ha la sua WHERE sulla categoria; il confronto esterno vale per tutti i prodotti."
        ],
        "explanation": "WHERE filtra le righe della tabella in base a una condizione, restituendo solo quelle che la soddisfano.",
        "replacements": {},
    ...
    "Medium": [
      {
        ...
        "hints": [
          "Questa query richiede una 'Subquery Correlata': la subquery deve sapere quale è la categoria della riga esterna",
          "Nella subquery calcola AVG(price) ma aggiungi una WHERE che colleghi le due tabelle (es. WHERE p2.category = p1.category)"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Filtra gli ordini con total > 1000",
          "Prendi gli user_id"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Per ogni dipendente, devi trovare la data di assunzione del suo manager",
          "Usa una subquery che seleziona hire_date da Employees dove id corrisponde al manager_id del dipendente corrente"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Trova il prezzo massimo globale con MAX(price)",
          "Seleziona la categoria del prodotto con quel prezzo"
        ],
      ...
      },
      {
        ...
        "hints": [
          ...
          "Correda la subquery con u.id = o.user_id"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Escludi i prodotti ordinati da utenti NON premium",
          "Assicurati che siano stati ordinati almeno una volta"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Scrivi la subquery al posto di una colonna",
          "Correlala con Orders.user_id"
        ],
        "explanation": "La subquery vive dentro la lista delle colonne: per ogni ordine cerca il nome dell'utente corrispondente, agganciandosi con Orders.user_id. È una subquery correlata, rieseguita riga per riga. La JOIN otterrebbe lo stesso risultato in modo più efficiente su tanti dati, ma questa forma è comoda quando serve UN solo campo dall'altra tabella.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Trova categorie con stock > 0",
          "Filtra quelle che NON sono in quella lista"
        ],
        "explanation": "La subquery elenca le categorie che hanno ALMENO un prodotto disponibile, e il NOT IN tiene le altre: categorie dove ogni singolo articolo è a stock zero. Il DISTINCT evita di ripetere la stessa categoria per ogni suo prodotto esaurito. Nota la logica insiemistica: 'tutte esaurite' si esprime come 'nessuna disponibile'.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "Il doppio della media dei prezzi fa da soglia di anomalia: la subquery la calcola una volta sola e la query esterna tiene i prodotti che la superano. È una caccia agli outlier fatta con gli strumenti di base: aggregazione in subquery e confronto in WHERE. Moltiplicare dentro la subquery o fuori non cambia il risultato.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Il criterio 'più di un ordine' nasce da un conteggio per utente.",
          "La subquery raggruppa per user_id con HAVING COUNT > 1; IN recupera i profili completi."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Trova chi ha ordinato nel 2023",
          "Escludili con NOT IN"
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Calcola SUM(total) in subquery",
          "Dividi order_total / SUM * 100"
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "OrderItems count distinct product_id >= 2",
          "Risali agli Users"
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Best seller: venduto più spesso della media dei prodotti.",
          "La media di vendite per prodotto è righe totali diviso prodotti distinti: quella subquery fa da soglia nell'HAVING."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Confronti la media di OGNI utente con quella globale.",
          "AVG nel gruppo contro AVG nella subquery: il confronto vive nell'HAVING."
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Un manager 'importante' compare come capo di più di due persone.",
          "Raggruppa i manager_id e conta le occorrenze nella subquery; IN risale ai profili."
        ],
        "explanation": "HAVING filtra i gruppi dopo l'aggregazione, a differenza di WHERE che filtra le righe prima del raggruppamento. Si usa con GROUP BY.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Due condizioni di acquisto sulla stessa persona: entrambe obbligatorie.",
          "Ogni ramo dell'AND è una catena di subquery che parte dal nome del prodotto."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Trova prodotti ordinati recentemente",
          "Usa NOT IN"
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "La catena di join collega gli acquisti di una persona specifica ai prezzi dei prodotti comprati, e AVG li riassume in un solo numero: il prezzo medio degli articoli di Mario Rossi. Senza GROUP BY l'aggregazione lavora su tutte le righe filtrate insieme. Occhio agli omonimi: il filtro per nome prende entrambi i Mario Rossi del DB.",
        "replacements": {},
      ...
      },
      {
        ...
        "explanation": "L'ordinamento discendente mette il prodotto più caro in cima, l'OFFSET salta esattamente quella prima riga e il LIMIT si ferma alla successiva: resta il secondo più caro. È il metodo posizionale per gli 'ennesimi': semplice ma fragile con i pareggi, perché due prodotti allo stesso prezzo massimo darebbero un 'secondo' discutibile.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Trova MAX(total) user 2",
          "Confronta"
        ],
        "explanation": "La subquery trova la spesa massima dell'utente 2 e la query esterna la usa come asticella: restano gli ordini di CHIUNQUE che la superano. Confrontarsi con un aggregato calcolato su un sottoinsieme (i soli ordini di un utente) è il passo in più rispetto alla solita media globale.",
        "replacements": {},
      ...
      },
      {
        ...
        "queryTemplate": "SELECT * FROM Products WHERE price > (SELECT AVG(price) FROM Products WHERE category = 'Electronics')",
        "hints": [
          "Soglia settoriale, confronto globale: leggi bene cosa filtra ciascuna parte.",
          "La WHERE della subquery limita SOLO il calcolo della media, non il risultato esterno."
        ],
        "explanation": "La media qui è di parte: la subquery la calcola solo sui prodotti Electronics, ma il confronto esterno coinvolge l'intero catalogo. Il risultato mescola quindi prodotti di ogni categoria che superano il prezzo medio dell'elettronica. Se volessi solo elettronica sopra la sua media, aggiungeresti lo stesso filtro anche fuori.",
        "replacements": {},
        "brokenCode": "SELECT * FROM Products WHERE price > (SELECT AVG(price) FROM Products WHERE category == 'Electronics')",
        "debugHint": "Controlla che la clausola JOIN abbia sia la tabella che la condizione ON."
      },
      {
        ...
        "hints": [
          "La subquery restituisce una costante: è un espediente didattico per la forma scalare.",
          "SELECT 'Italy' FROM ... WHERE id = 1 produce un solo valore, usabile a destra dell'uguale."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Anomalo: più articoli della media di articoli per ordine.",
          "La media globale è righe totali diviso ordini distinti; il confronto sta nell'HAVING del gruppo."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "'Solo elettronica' significa: zero prodotti di altre categorie.",
          "Il CASE dentro il COUNT conta i prodotti NON elettronici: il gruppo passa se quel conteggio è 0."
        ],
        "explanation": "Le subquery permettono di annidare una query dentro un'altra, creando filtri o calcoli basati su risultati intermedi.",
        "replacements": {},
    ...
    "Hard": [
      {
        ...
        "hints": [
          "Lavora su OrderItems: raggruppa per product_id e calcola la somma delle quantità",
          "Ordina il risultato in modo decrescente e usa LIMIT 1 per prendere solo l'ID del prodotto più venduto",
          "Usa questo ID per trovare il nome del prodotto nella tabella Products"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Trova chi HA ordinato dopo la data",
          "Escludili con NOT IN"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Fai join con Products",
          "Conta le categorie distinte per ordine",
          "HAVING COUNT >= 2"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Filtra manager_id IS NULL per trovare il CEO",
          "Assicurati che il suo ID non sia presente tra i manager_id di altri dipendenti (NOT IN)"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Usa LEFT JOIN",
          "Filtra dove la parte destra è NULL"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Per ogni ordine, usa una subquery per trovare il valore massimo di una singola riga (unit_price * quantity) nella tabella OrderItems",
          "Confronta questo valore con la metà del totale dell'ordine (order_total * 0.5)"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Questa è complessa: Step 1) Calcola la spesa totale per ogni utente Premium",
          "Step 2) Calcola la MEDIA di queste spese totali",
          "Step 3) Filtra gli utenti che hanno speso più di questa media"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Cerchi ordini il cui proprietario non esiste in anagrafica.",
          "Confronta user_id con l'elenco degli id reali di Users, in negativo."
        ],
        "explanation": "Un ordine fantasma punta a uno user_id che in Users non esiste: la subquery elenca gli id legittimi e il NOT IN scova i riferimenti orfani. Nel DB c'è proprio un ordine seminato così (user_id 9999). In un database con vincoli di chiave esterna attivi questa situazione sarebbe impossibile: la query è il controllo di integrità fatto a mano.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Trova max price category Home",
          "Filtra products > quel valore"
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Cerca items con unit_price < p.price",
          "Usa NOT EXISTS"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Raggruppa per dipartimento e ragiona per conteggi: quanti membri ha il reparto e quanti di questi sono assunzioni recenti?",
          "Se il numero di assunti dopo la data coincide con il totale dei membri, allora non c'è nessun veterano nel gruppo. Un SUM con CASE dentro l'HAVING ti dà quel conteggio condizionale."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Escludi utenti che hanno comprato roba economica",
          "Doppia negazione"
        ],
        "explanation": "La doppia negazione fa il lavoro: per ogni ordine, la subquery cerca almeno un articolo da 100 o meno, e NOT EXISTS promuove solo gli ordini dove quella ricerca fallisce. Tradotta: ordini composti esclusivamente da articoli sopra i 100. 'Tutti costosi' non si scrive direttamente in SQL: si scrive 'non esiste un economico'.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Filtra prodotti venduti recentemente",
          "Escludili dalla lista prodotti con stock"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Conta quanti prodotti nella stessa categoria costano PIÙ di me",
          "Se sono meno di 3, io sono nei top 3"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Ti servono due condizioni sullo stesso utente: una che deve esistere e una che non deve esistere.",
          "Correla le sottoquery all'utente esterno (o.user_id = u.id) e usa EXISTS per la presenza del Monitor, NOT EXISTS per l'assenza della Keyboard."
        ],
      ...
      },
      {
        ...
        "hints": [
          "Per ogni ordine, usa una subquery correlata per calcolare la media (AVG) degli order_total per quello user_id",
          "Filtra per order_total maggiore della media calcolata"
        ],
      ...
      },
      {
        ...
        "hints": [
          "I due prodotti devono stare nello STESSO ordine, non solo nello stesso utente.",
          "Due EXISTS correlati sull'order_id corrente, uno per prodotto, legati da AND."
        ],
        "explanation": "I due EXISTS ispezionano lo STESSO ordine: il legame i.order_id = o.id àncora entrambe le ricerche alla riga corrente di Orders. Uno verifica la presenza dello Smartphone, l'altro della Cover: passano solo gli ordini che contengono entrambi. La correlazione sull'ordine (e non sull'utente) è ciò che distingue 'comprati insieme' da 'comprati in momenti diversi'.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Devono verificarsi due condizioni indipendenti",
          "Usa la logica combinando due condizioni EXISTS separate con AND"
        ],
      ...
      },
      {
        ...
        "explanation": "Il GROUP BY sul mese estratto dalla data accumula il fatturato di ogni mese attraverso TUTTI gli anni: gennaio 2022 e gennaio 2023 finiscono nello stesso gruppo, ed è proprio questo che rende la query una misura di stagionalità. L'ordinamento per la SUM in discesa e il LIMIT 1 isolano il mese storicamente più forte.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Filtra per created_at",
          "NOT IN Orders"
        ],
        "explanation": "Le due condizioni fotografano l'utente dormiente: registrato prima del 2023 (quindi con tutto il tempo di comprare) e mai comparso in un ordine. Il filtro sulla data è un confronto diretto di stringhe ISO, l'assenza di acquisti passa dal NOT IN sulla subquery degli user_id. Insieme, separano i curiosi mai convertiti dai clienti veri.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Conta quanti costano meno",
          "Confronta con metà del count totale"
        ],
        "explanation": "Una subquery con IN filtra le righe il cui valore è presente nel set restituito dalla query interna. Questo approccio è leggibile e modulare.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Esegui una divisione relazionale contando!",
          "Combina le tre tabelle (Ordini, Dettagli, Prodotti), raggruppa per user_id, e filtra con HAVING per matchare il COUNT(DISTINCT id) di quei prodotti acquistati nella categoria con il COUNT totale dei prodotti nella stessa categoria"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Per ogni paese, check se esiste order > 500",
          "Se non esiste, selezionalo"
        ],
        "explanation": "La query scorre i paesi e per ciascuno chiede: esiste almeno un connazionale con un ordine sopra i 500? Il NOT EXISTS tiene i paesi dove la risposta è no. La subquery è correlata sul country della riga esterna (u2.country = u1.country): è quel legame a trasformare un controllo globale in un controllo per paese.",
        "replacements": {},
      ...
      {
        "titleTemplate": "Manager di Nuova Nomina",
        "descTemplate": "Trova i dipendenti assunti dopo inizio 2021 che risultano già manager di qualcuno.",
        "queryTemplate": "SELECT * FROM Employees WHERE hire_date > '2021-01-01' AND id IN (SELECT manager_id FROM Employees)",
        "hints": [
          "Filtra data",
          "Check se sono manager"
        ],
        "explanation": "Le due condizioni si intrecciano: l'assunzione recente si legge dalla hire_date, il ruolo di capo dal comparire nell'elenco dei manager_id altrui. La subquery costruisce quell'elenco e l'IN verifica l'appartenenza. Nel DB il caso esiste davvero: l'Underpaid Manager, assunto nel 2022, gestisce già una persona.",
        "replacements": {},
      ...
      },
      {
        ...
        "hints": [
          "Raggruppa per order_id e conta in modo unito (COUNT DISTINCT) le categorie di quel calcolo",
          "Confrontalo (con un HAVING uguaglianza) rispetto alla query (SELECT COUNT(DISTINCT category) FROM Products) in una subquery"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Definisci la CTE all'inizio: WITH avg_price AS (SELECT AVG(price) AS media FROM Products)",
          "Poi includi la CTE nella FROM insieme a Products (FROM Products p, avg_price) e filtra con WHERE p.price > avg_price.media"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Crea una CTE 'user_totals' che raggruppa per user_id e calcola il fatturato as totale",
          "Nella query principale (che viene eseguita dopo), estrai i flag e limita con un normale WHERE (poiché totale a quel punto è considerata una colonna statica calcolata)"
        ],
      ...
      },
      {
        ...
        "hints": [
          "La posizione di un prodotto è pari a quanti prodotti costano PIÙ di lui, più 1",
          "Usa una subquery correlata che conta le righe con p2.price > p1.price, dando due alias diversi (p1 e p2) alla stessa tabella"
        ],
      ...
      },
      {
        ...
        "hints": [
          "Lavora dentro la stessa categoria: la subquery deve filtrare p2.category = p1.category",
          "Per non lasciare buchi conta i PREZZI DISTINTI più alti con COUNT(DISTINCT p2.price), non le righe; poi aggiungi 1"
        ],
      ...
      },
      {
        ...
        "hints": [
          "La funzione pura ROW_NUMBER() assegna unicamente numeri seriali continui crescenti, ignorando del tutto i pareggi statistici",
          "Usa la finestra protetta OVER configurandola in modo che segua l'ordinamento cronologico crescente di hire_date"
        ],
